...
import (
	...
	file "github.com/golingon/terraproviders/archive/2.4.2/file"
	"io"
)
...
func (f fileAttributes) ExcludeSymlinkDirectories() terra.BoolValue {
...
func (f fileAttributes) OutputBase64Sha512() terra.StringValue {
...
func (f fileAttributes) OutputSha256() terra.StringValue {
...
func (f fileAttributes) OutputSha512() terra.StringValue {
