...
func (asb awsSecretBackendAttributes) IdentityTokenAudience() terra.StringValue {
	return terra.ReferenceAsString(asb.ref.Append("identity_token_audience"))
}

// IdentityTokenKey returns a reference to field identity_token_key of vault_aws_secret_backend.
func (asb awsSecretBackendAttributes) IdentityTokenKey() terra.StringValue {
	return terra.ReferenceAsString(asb.ref.Append("identity_token_key"))
}

// IdentityTokenTtl returns a reference to field identity_token_ttl of vault_aws_secret_backend.
func (asb awsSecretBackendAttributes) IdentityTokenTtl() terra.NumberValue {
	return terra.ReferenceAsNumber(asb.ref.Append("identity_token_ttl"))
}

// Local returns a reference to field local of vault_aws_secret_backend.
func (asb awsSecretBackendAttributes) Local() terra.BoolValue {
...
func (asb awsSecretBackendAttributes) RoleArn() terra.StringValue {
	return terra.ReferenceAsString(asb.ref.Append("role_arn"))
}
