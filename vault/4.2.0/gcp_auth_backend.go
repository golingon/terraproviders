...
import (
	...
	gcpauthbackend "github.com/golingon/terraproviders/vault/4.2.0/gcpauthbackend"
	"io"
)
...
type GcpAuthBackendArgs struct {
	...
	// Tune: min=0
	Tune []gcpauthbackend.Tune `hcl:"tune,block" validate:"min=0"`
...
func (gab gcpAuthBackendAttributes) Accessor() terra.StringValue {
...
func (gab gcpAuthBackendAttributes) Tune() terra.SetValue[gcpauthbackend.TuneAttributes] {
	return terra.ReferenceAsSet[gcpauthbackend.TuneAttributes](gab.ref.Append("tune"))
}
...
type gcpAuthBackendState struct {
	...
	Tune           []gcpauthbackend.TuneState           `json:"tune"`
