...
import (
	...
	azuresecretbackendrole "github.com/golingon/terraproviders/vault/4.2.0/azuresecretbackendrole"
	"io"
)
...
func (asbr azureSecretBackendRoleAttributes) PermanentlyDelete() terra.BoolValue {
	return terra.ReferenceAsBool(asbr.ref.Append("permanently_delete"))
}
...
func (asbr azureSecretBackendRoleAttributes) SignInAudience() terra.StringValue {
	return terra.ReferenceAsString(asbr.ref.Append("sign_in_audience"))
}

// Tags returns a reference to field tags of vault_azure_secret_backend_role.
func (asbr azureSecretBackendRoleAttributes) Tags() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](asbr.ref.Append("tags"))
}
