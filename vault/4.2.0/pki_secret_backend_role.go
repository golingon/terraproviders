...
import (
	...
	pkisecretbackendrole "github.com/golingon/terraproviders/vault/4.2.0/pkisecretbackendrole"
	"io"
)
...
func (psbr pkiSecretBackendRoleAttributes) AllowWildcardCertificates() terra.BoolValue {
	return terra.ReferenceAsBool(psbr.ref.Append("allow_wildcard_certificates"))
}
...
func (psbr pkiSecretBackendRoleAttributes) AllowedUriSansTemplate() terra.BoolValue {
	return terra.ReferenceAsBool(psbr.ref.Append("allowed_uri_sans_template"))
}

// AllowedUserIds returns a reference to field allowed_user_ids of vault_pki_secret_backend_role.
func (psbr pkiSecretBackendRoleAttributes) AllowedUserIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](psbr.ref.Append("allowed_user_ids"))
}
...
func (psbr pkiSecretBackendRoleAttributes) ExtKeyUsageOids() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](psbr.ref.Append("ext_key_usage_oids"))
}
...
func (psbr pkiSecretBackendRoleAttributes) IssuerRef() terra.StringValue {
	return terra.ReferenceAsString(psbr.ref.Append("issuer_ref"))
}
