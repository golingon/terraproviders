...
// GroupName returns a reference to field group_name of vault_identity_group_member_entity_ids.
func (igmei identityGroupMemberEntityIdsAttributes) GroupName() terra.StringValue {
	return terra.ReferenceAsString(igmei.ref.Append("group_name"))
}
