...
func (dsbsr databaseSecretBackendStaticRoleAttributes) RotationSchedule() terra.StringValue {
	return terra.ReferenceAsString(dsbsr.ref.Append("rotation_schedule"))
}
...
func (dsbsr databaseSecretBackendStaticRoleAttributes) RotationWindow() terra.NumberValue {
	return terra.ReferenceAsNumber(dsbsr.ref.Append("rotation_window"))
}
