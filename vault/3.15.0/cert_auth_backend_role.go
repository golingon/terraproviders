...
type CertAuthBackendRoleArgs struct {
	...
	// AllowedOrganizationUnits: set of string, optional
	AllowedOrganizationUnits terra.SetValue[terra.StringValue] `hcl:"allowed_organization_units,attr"`
...
// AllowedOrganizationUnits returns a reference to field allowed_organization_units of vault_cert_auth_backend_role.
func (cabr certAuthBackendRoleAttributes) AllowedOrganizationUnits() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](cabr.ref.Append("allowed_organization_units"))
}
...
type certAuthBackendRoleState struct {
	...
	AllowedOrganizationUnits   []string `json:"allowed_organization_units"`
