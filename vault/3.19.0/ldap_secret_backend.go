...
// Length returns a reference to field length of vault_ldap_secret_backend.
func (lsb ldapSecretBackendAttributes) Length() terra.NumberValue {
	return terra.ReferenceAsNumber(lsb.ref.Append("length"))
}
