...
func (a ActionAttributes) SourceNatActiveRanges() terra.SetValue[terra.StringValue] {
...
func (a ActionAttributes) SourceNatDrainRanges() terra.SetValue[terra.StringValue] {
