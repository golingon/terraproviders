...
func (cp ControlPlaneAttributes) InstancePlacement() terra.ListValue[InstancePlacementAttributes] {
	return terra.ReferenceAsList[InstancePlacementAttributes](cp.ref.Append("instance_placement"))
}
