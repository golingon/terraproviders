...
type SSlInfo struct {
	...
	// SSlInfoCommonName: optional
	CommonName *SSlInfoCommonName `hcl:"common_name,block"`
}

type SSlInfoCommonName struct {
...
func (ssi SSlInfoAttributes) CommonName() terra.ListValue[SSlInfoCommonNameAttributes] {
	return terra.ReferenceAsList[SSlInfoCommonNameAttributes](ssi.ref.Append("common_name"))
}
...
func (cn SSlInfoCommonNameAttributes) InternalWithRef(ref terra.Reference) SSlInfoCommonNameAttributes {
	return SSlInfoCommonNameAttributes{ref: ref}
}
...
type SSlInfoState struct {
	...
	CommonName             []SSlInfoCommonNameState `json:"common_name"`
}

type SSlInfoCommonNameState struct {
