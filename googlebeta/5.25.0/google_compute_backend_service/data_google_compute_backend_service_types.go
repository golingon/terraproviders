...
func (cb DataCircuitBreakersAttributes) ConnectTimeout() terra.ListValue[DataCircuitBreakersConnectTimeoutAttributes] {
	return terra.ReferenceAsList[DataCircuitBreakersConnectTimeoutAttributes](cb.ref.Append("connect_timeout"))
}

type DataCircuitBreakersConnectTimeoutAttributes struct {
	ref terra.Reference
}

func (ct DataCircuitBreakersConnectTimeoutAttributes) InternalRef() (terra.Reference, error) {
	return ct.ref, nil
}

func (ct DataCircuitBreakersConnectTimeoutAttributes) InternalWithRef(ref terra.Reference) DataCircuitBreakersConnectTimeoutAttributes {
	return DataCircuitBreakersConnectTimeoutAttributes{ref: ref}
}

func (ct DataCircuitBreakersConnectTimeoutAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ct.ref.InternalTokens()
}

func (ct DataCircuitBreakersConnectTimeoutAttributes) Nanos() terra.NumberValue {
	return terra.ReferenceAsNumber(ct.ref.Append("nanos"))
}

func (ct DataCircuitBreakersConnectTimeoutAttributes) Seconds() terra.NumberValue {
...
type DataCircuitBreakersState struct {
	...
	ConnectTimeout           []DataCircuitBreakersConnectTimeoutState `json:"connect_timeout"`
}

type DataCircuitBreakersConnectTimeoutState struct {
