...
type ClientConnectionConfig struct {
	// RequireConnectors: bool, optional
	RequireConnectors terra.BoolValue `hcl:"require_connectors,attr"`
	// ClientConnectionConfigSslConfig: optional
	SslConfig *ClientConnectionConfigSslConfig `hcl:"ssl_config,block"`
}

type ClientConnectionConfigSslConfig struct {
...
func (ccc ClientConnectionConfigAttributes) InternalWithRef(ref terra.Reference) ClientConnectionConfigAttributes {
	return ClientConnectionConfigAttributes{ref: ref}
}
...
func (ccc ClientConnectionConfigAttributes) RequireConnectors() terra.BoolValue {
	return terra.ReferenceAsBool(ccc.ref.Append("require_connectors"))
}

func (ccc ClientConnectionConfigAttributes) SslConfig() terra.ListValue[ClientConnectionConfigSslConfigAttributes] {
	return terra.ReferenceAsList[ClientConnectionConfigSslConfigAttributes](ccc.ref.Append("ssl_config"))
}
...
func (sc ClientConnectionConfigSslConfigAttributes) InternalWithRef(ref terra.Reference) ClientConnectionConfigSslConfigAttributes {
	return ClientConnectionConfigSslConfigAttributes{ref: ref}
}
...
func (sc ClientConnectionConfigSslConfigAttributes) SslMode() terra.StringValue {
	return terra.ReferenceAsString(sc.ref.Append("ssl_mode"))
}
...
type ClientConnectionConfigState struct {
	RequireConnectors bool                                   `json:"require_connectors"`
	SslConfig         []ClientConnectionConfigSslConfigState `json:"ssl_config"`
}
