...
type Provider struct {
	...
	// ApiGatewayCustomEndpoint: string, optional
	ApiGatewayCustomEndpoint terra.StringValue `hcl:"api_gateway_custom_endpoint,attr"`
	...
	// BackupDrCustomEndpoint: string, optional
	BackupDrCustomEndpoint terra.StringValue `hcl:"backup_dr_custom_endpoint,attr"`
	...
	// DataformCustomEndpoint: string, optional
	DataformCustomEndpoint terra.StringValue `hcl:"dataform_custom_endpoint,attr"`
	...
	// FirebaseCustomEndpoint: string, optional
	FirebaseCustomEndpoint terra.StringValue `hcl:"firebase_custom_endpoint,attr"`
	// FirebaseDatabaseCustomEndpoint: string, optional
	FirebaseDatabaseCustomEndpoint terra.StringValue `hcl:"firebase_database_custom_endpoint,attr"`
	// FirebaseExtensionsCustomEndpoint: string, optional
	FirebaseExtensionsCustomEndpoint terra.StringValue `hcl:"firebase_extensions_custom_endpoint,attr"`
	// FirebaseHostingCustomEndpoint: string, optional
	FirebaseHostingCustomEndpoint terra.StringValue `hcl:"firebase_hosting_custom_endpoint,attr"`
	// FirebaseStorageCustomEndpoint: string, optional
	FirebaseStorageCustomEndpoint terra.StringValue `hcl:"firebase_storage_custom_endpoint,attr"`
	...
	// ParallelstoreCustomEndpoint: string, optional
	ParallelstoreCustomEndpoint terra.StringValue `hcl:"parallelstore_custom_endpoint,attr"`
	...
	// RuntimeConfigCustomEndpoint: string, optional
	RuntimeConfigCustomEndpoint terra.StringValue `hcl:"runtime_config_custom_endpoint,attr"`
	// RuntimeconfigCustomEndpoint: string, optional
	RuntimeconfigCustomEndpoint terra.StringValue `hcl:"runtimeconfig_custom_endpoint,attr"`
	...
	// SecurityScannerCustomEndpoint: string, optional
	SecurityScannerCustomEndpoint terra.StringValue `hcl:"security_scanner_custom_endpoint,attr"`
	...
	// ServiceDirectoryCustomEndpoint: string, optional
	ServiceDirectoryCustomEndpoint terra.StringValue `hcl:"service_directory_custom_endpoint,attr"`
	...
	// TpuV2CustomEndpoint: string, optional
	TpuV2CustomEndpoint terra.StringValue `hcl:"tpu_v2_custom_endpoint,attr"`
	...
	// WorkstationsCustomEndpoint: string, optional
	WorkstationsCustomEndpoint terra.StringValue `hcl:"workstations_custom_endpoint,attr"`
