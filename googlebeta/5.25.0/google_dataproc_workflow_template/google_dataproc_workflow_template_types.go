...
type PlacementManagedClusterConfig struct {
	...
	// PlacementManagedClusterConfigGkeClusterConfig: optional
	GkeClusterConfig *PlacementManagedClusterConfigGkeClusterConfig `hcl:"gke_cluster_config,block"`
	...
	// PlacementManagedClusterConfigMetastoreConfig: optional
	MetastoreConfig *PlacementManagedClusterConfigMetastoreConfig `hcl:"metastore_config,block"`
...
type PlacementManagedClusterConfigGkeClusterConfig struct {
	// PlacementManagedClusterE4F95360: optional
	NamespacedGkeDeploymentTarget *PlacementManagedClusterE4F95360 `hcl:"namespaced_gke_deployment_target,block"`
}

type PlacementManagedClusterE4F95360 struct {
...
type PlacementManagedClusterConfigMetastoreConfig struct {
...
func (c PlacementManagedClusterConfigAttributes) GkeClusterConfig() terra.ListValue[PlacementManagedClusterConfigGkeClusterConfigAttributes] {
	return terra.ReferenceAsList[PlacementManagedClusterConfigGkeClusterConfigAttributes](c.ref.Append("gke_cluster_config"))
}
...
func (c PlacementManagedClusterConfigAttributes) MetastoreConfig() terra.ListValue[PlacementManagedClusterConfigMetastoreConfigAttributes] {
	return terra.ReferenceAsList[PlacementManagedClusterConfigMetastoreConfigAttributes](c.ref.Append("metastore_config"))
}
...
type PlacementManagedClusterConfigGkeClusterConfigAttributes struct {
	ref terra.Reference
}

func (gcc PlacementManagedClusterConfigGkeClusterConfigAttributes) InternalRef() (terra.Reference, error) {
	return gcc.ref, nil
}

func (gcc PlacementManagedClusterConfigGkeClusterConfigAttributes) InternalWithRef(ref terra.Reference) PlacementManagedClusterConfigGkeClusterConfigAttributes {
	return PlacementManagedClusterConfigGkeClusterConfigAttributes{ref: ref}
}

func (gcc PlacementManagedClusterConfigGkeClusterConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return gcc.ref.InternalTokens()
}

func (gcc PlacementManagedClusterConfigGkeClusterConfigAttributes) NamespacedGkeDeploymentTarget() terra.ListValue[PlacementManagedClusterE4F95360Attributes] {
	return terra.ReferenceAsList[PlacementManagedClusterE4F95360Attributes](gcc.ref.Append("namespaced_gke_deployment_target"))
}

type PlacementManagedClusterE4F95360Attributes struct {
	ref terra.Reference
}

func (ngdt PlacementManagedClusterE4F95360Attributes) InternalRef() (terra.Reference, error) {
	return ngdt.ref, nil
}

func (ngdt PlacementManagedClusterE4F95360Attributes) InternalWithRef(ref terra.Reference) PlacementManagedClusterE4F95360Attributes {
	return PlacementManagedClusterE4F95360Attributes{ref: ref}
}

func (ngdt PlacementManagedClusterE4F95360Attributes) InternalTokens() (hclwrite.Tokens, error) {
	return ngdt.ref.InternalTokens()
}

func (ngdt PlacementManagedClusterE4F95360Attributes) ClusterNamespace() terra.StringValue {
	return terra.ReferenceAsString(ngdt.ref.Append("cluster_namespace"))
}

func (ngdt PlacementManagedClusterE4F95360Attributes) TargetGkeCluster() terra.StringValue {
...
type PlacementManagedClusterConfigMetastoreConfigAttributes struct {
	ref terra.Reference
}

func (mc PlacementManagedClusterConfigMetastoreConfigAttributes) InternalRef() (terra.Reference, error) {
	return mc.ref, nil
}

func (mc PlacementManagedClusterConfigMetastoreConfigAttributes) InternalWithRef(ref terra.Reference) PlacementManagedClusterConfigMetastoreConfigAttributes {
	return PlacementManagedClusterConfigMetastoreConfigAttributes{ref: ref}
}

func (mc PlacementManagedClusterConfigMetastoreConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return mc.ref.InternalTokens()
}

func (mc PlacementManagedClusterConfigMetastoreConfigAttributes) DataprocMetastoreService() terra.StringValue {
...
type PlacementManagedClusterConfigState struct {
	...
	GkeClusterConfig      []PlacementManagedClusterConfigGkeClusterConfigState      `json:"gke_cluster_config"`
	...
	MetastoreConfig       []PlacementManagedClusterConfigMetastoreConfigState       `json:"metastore_config"`
...
type PlacementManagedClusterConfigGkeClusterConfigState struct {
	NamespacedGkeDeploymentTarget []PlacementManagedClusterE4F95360State `json:"namespaced_gke_deployment_target"`
}

type PlacementManagedClusterE4F95360State struct {
...
type PlacementManagedClusterConfigMetastoreConfigState struct {
