...
func (ghds googleHealthcareDicomStoreAttributes) StreamConfigs() terra.ListValue[StreamConfigsAttributes] {
	return terra.ReferenceAsList[StreamConfigsAttributes](ghds.ref.Append("stream_configs"))
}
