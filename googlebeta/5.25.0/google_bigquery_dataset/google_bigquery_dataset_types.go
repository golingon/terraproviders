...
type Access struct {
	...
	// AccessRoutine: optional
	Routine *AccessRoutine `hcl:"routine,block"`
	// AccessView: optional
	View *AccessView `hcl:"view,block"`
}
...
type AccessDataset struct {
	...
	// AccessDatasetDataset: required
	Dataset *AccessDatasetDataset `hcl:"dataset,block" validate:"required"`
}

type AccessDatasetDataset struct {
...
func (a AccessAttributes) Routine() terra.ListValue[AccessRoutineAttributes] {
	return terra.ReferenceAsList[AccessRoutineAttributes](a.ref.Append("routine"))
}

func (a AccessAttributes) View() terra.ListValue[AccessViewAttributes] {
	return terra.ReferenceAsList[AccessViewAttributes](a.ref.Append("view"))
}
...
func (d AccessDatasetAttributes) Dataset() terra.ListValue[AccessDatasetDatasetAttributes] {
	return terra.ReferenceAsList[AccessDatasetDatasetAttributes](d.ref.Append("dataset"))
}
...
func (d AccessDatasetDatasetAttributes) InternalWithRef(ref terra.Reference) AccessDatasetDatasetAttributes {
	return AccessDatasetDatasetAttributes{ref: ref}
}
...
func (r AccessRoutineAttributes) InternalWithRef(ref terra.Reference) AccessRoutineAttributes {
	return AccessRoutineAttributes{ref: ref}
}
...
func (v AccessViewAttributes) InternalWithRef(ref terra.Reference) AccessViewAttributes {
	return AccessViewAttributes{ref: ref}
}
...
type AccessState struct {
	...
	Routine      []AccessRoutineState `json:"routine"`
	View         []AccessViewState    `json:"view"`
}

type AccessDatasetState struct {
	TargetTypes []string                    `json:"target_types"`
	Dataset     []AccessDatasetDatasetState `json:"dataset"`
}

type AccessDatasetDatasetState struct {
	DatasetId string `json:"dataset_id"`
	ProjectId string `json:"project_id"`
}

type AccessRoutineState struct {
	DatasetId string `json:"dataset_id"`
	ProjectId string `json:"project_id"`
	RoutineId string `json:"routine_id"`
}

type AccessViewState struct {
	DatasetId string `json:"dataset_id"`
	ProjectId string `json:"project_id"`
