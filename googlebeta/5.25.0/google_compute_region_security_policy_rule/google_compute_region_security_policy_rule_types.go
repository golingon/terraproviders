...
type Match struct {
	...
	// MatchConfig: optional
	Config *MatchConfig `hcl:"config,block"`
}
...
type NetworkMatch struct {
	...
	// NetworkMatchUserDefinedFields: min=0
	UserDefinedFields []NetworkMatchUserDefinedFields `hcl:"user_defined_fields,block" validate:"min=0"`
}

type NetworkMatchUserDefinedFields struct {
...
func (nm NetworkMatchAttributes) UserDefinedFields() terra.ListValue[NetworkMatchUserDefinedFieldsAttributes] {
	return terra.ReferenceAsList[NetworkMatchUserDefinedFieldsAttributes](nm.ref.Append("user_defined_fields"))
}
...
func (udf NetworkMatchUserDefinedFieldsAttributes) InternalWithRef(ref terra.Reference) NetworkMatchUserDefinedFieldsAttributes {
	return NetworkMatchUserDefinedFieldsAttributes{ref: ref}
}
...
type NetworkMatchState struct {
	...
	UserDefinedFields []NetworkMatchUserDefinedFieldsState `json:"user_defined_fields"`
}

type NetworkMatchUserDefinedFieldsState struct {
