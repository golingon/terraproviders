...
type Bgp struct {
	...
	// IdentifierRange: string, optional
	IdentifierRange terra.StringValue `hcl:"identifier_range,attr"`
...
func (b BgpAttributes) IdentifierRange() terra.StringValue {
	return terra.ReferenceAsString(b.ref.Append("identifier_range"))
}
...
type BgpState struct {
	...
	IdentifierRange    string                       `json:"identifier_range"`
