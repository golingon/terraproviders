...
func (gvaf googleVertexAiFeaturestoreAttributes) OnlineStorageTtlDays() terra.NumberValue {
	return terra.ReferenceAsNumber(gvaf.ref.Append("online_storage_ttl_days"))
}
