...
func (ghfs googleHealthcareFhirStoreAttributes) EnableHistoryModifications() terra.BoolValue {
	return terra.ReferenceAsBool(ghfs.ref.Append("enable_history_modifications"))
}
...
func (ghfs googleHealthcareFhirStoreAttributes) NotificationConfigs() terra.ListValue[NotificationConfigsAttributes] {
	return terra.ReferenceAsList[NotificationConfigsAttributes](ghfs.ref.Append("notification_configs"))
}
