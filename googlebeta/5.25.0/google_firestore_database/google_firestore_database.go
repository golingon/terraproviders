...
type Args struct {
	...
	// CmekConfig: optional
	CmekConfig *CmekConfig `hcl:"cmek_config,block"`
	// Timeouts: optional
...
func (gfd googleFirestoreDatabaseAttributes) CmekConfig() terra.ListValue[CmekConfigAttributes] {
	return terra.ReferenceAsList[CmekConfigAttributes](gfd.ref.Append("cmek_config"))
}
...
type googleFirestoreDatabaseState struct {
	...
	CmekConfig                    []CmekConfigState `json:"cmek_config"`
