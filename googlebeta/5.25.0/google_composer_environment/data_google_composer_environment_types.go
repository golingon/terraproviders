...
func (c DataConfigAttributes) EnablePrivateBuildsOnly() terra.BoolValue {
	return terra.ReferenceAsBool(c.ref.Append("enable_private_builds_only"))
}

func (c DataConfigAttributes) EnablePrivateEnvironment() terra.BoolValue {
...
func (nc DataConfigNodeConfigAttributes) ComposerInternalIpv4CidrBlock() terra.StringValue {
	return terra.ReferenceAsString(nc.ref.Append("composer_internal_ipv4_cidr_block"))
}

func (nc DataConfigNodeConfigAttributes) ComposerNetworkAttachment() terra.StringValue {
...
func (nc DataConfigNodeConfigAttributes) MaxPodsPerNode() terra.NumberValue {
...
func (sc DataConfigSoftwareConfigAttributes) WebServerPluginsMode() terra.StringValue {
	return terra.ReferenceAsString(sc.ref.Append("web_server_plugins_mode"))
}

func (sc DataConfigSoftwareConfigAttributes) CloudDataLineageIntegration() terra.ListValue[DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes] {
	return terra.ReferenceAsList[DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes](sc.ref.Append("cloud_data_lineage_integration"))
}

type DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes struct {
	ref terra.Reference
}

func (cdli DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes) InternalRef() (terra.Reference, error) {
	return cdli.ref, nil
}

func (cdli DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes) InternalWithRef(ref terra.Reference) DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes {
	return DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes{ref: ref}
}

func (cdli DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return cdli.ref.InternalTokens()
}

func (cdli DataConfigSoftwareConfigCloudDataLineageIntegrationAttributes) Enabled() terra.BoolValue {
...
func (wc DataConfigWorkloadsConfigAttributes) DagProcessor() terra.ListValue[DataConfigWorkloadsConfigDagProcessorAttributes] {
	return terra.ReferenceAsList[DataConfigWorkloadsConfigDagProcessorAttributes](wc.ref.Append("dag_processor"))
}
...
type DataConfigWorkloadsConfigDagProcessorAttributes struct {
	ref terra.Reference
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) InternalRef() (terra.Reference, error) {
	return dp.ref, nil
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) InternalWithRef(ref terra.Reference) DataConfigWorkloadsConfigDagProcessorAttributes {
	return DataConfigWorkloadsConfigDagProcessorAttributes{ref: ref}
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return dp.ref.InternalTokens()
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) Count() terra.NumberValue {
	return terra.ReferenceAsNumber(dp.ref.Append("count"))
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) Cpu() terra.NumberValue {
	return terra.ReferenceAsNumber(dp.ref.Append("cpu"))
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) MemoryGb() terra.NumberValue {
	return terra.ReferenceAsNumber(dp.ref.Append("memory_gb"))
}

func (dp DataConfigWorkloadsConfigDagProcessorAttributes) StorageGb() terra.NumberValue {
...
type DataConfigSoftwareConfigState struct {
	...
	CloudDataLineageIntegration []DataConfigSoftwareConfigCloudDataLineageIntegrationState `json:"cloud_data_lineage_integration"`
}

type DataConfigSoftwareConfigCloudDataLineageIntegrationState struct {
	Enabled bool `json:"enabled"`
}
...
type DataConfigWorkloadsConfigState struct {
	DagProcessor []DataConfigWorkloadsConfigDagProcessorState `json:"dag_processor"`
...
type DataConfigWorkloadsConfigDagProcessorState struct {
