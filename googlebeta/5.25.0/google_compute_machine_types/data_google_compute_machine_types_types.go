...
func (mt DataMachineTypesAttributes) BundledLocalSsds() terra.SetValue[DataMachineTypesBundledLocalSsdsAttributes] {
	return terra.ReferenceAsSet[DataMachineTypesBundledLocalSsdsAttributes](mt.ref.Append("bundled_local_ssds"))
}
...
type DataMachineTypesBundledLocalSsdsAttributes struct {
	ref terra.Reference
}

func (bls DataMachineTypesBundledLocalSsdsAttributes) InternalRef() (terra.Reference, error) {
	return bls.ref, nil
}

func (bls DataMachineTypesBundledLocalSsdsAttributes) InternalWithRef(ref terra.Reference) DataMachineTypesBundledLocalSsdsAttributes {
	return DataMachineTypesBundledLocalSsdsAttributes{ref: ref}
}

func (bls DataMachineTypesBundledLocalSsdsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return bls.ref.InternalTokens()
}

func (bls DataMachineTypesBundledLocalSsdsAttributes) DefaultInterface() terra.StringValue {
	return terra.ReferenceAsString(bls.ref.Append("default_interface"))
}

func (bls DataMachineTypesBundledLocalSsdsAttributes) PartitionCount() terra.NumberValue {
...
type DataMachineTypesState struct {
	...
	BundledLocalSsds             []DataMachineTypesBundledLocalSsdsState `json:"bundled_local_ssds"`
...
type DataMachineTypesBundledLocalSsdsState struct {
