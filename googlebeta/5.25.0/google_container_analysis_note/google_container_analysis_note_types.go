...
type AttestationAuthority struct {
	// AttestationAuthorityHint: required
	Hint *AttestationAuthorityHint `hcl:"hint,block" validate:"required"`
}
...
func (aa AttestationAuthorityAttributes) Hint() terra.ListValue[AttestationAuthorityHintAttributes] {
	return terra.ReferenceAsList[AttestationAuthorityHintAttributes](aa.ref.Append("hint"))
}

type AttestationAuthorityHintAttributes struct {
	ref terra.Reference
}

func (h AttestationAuthorityHintAttributes) InternalRef() (terra.Reference, error) {
	return h.ref, nil
}

func (h AttestationAuthorityHintAttributes) InternalWithRef(ref terra.Reference) AttestationAuthorityHintAttributes {
	return AttestationAuthorityHintAttributes{ref: ref}
}

func (h AttestationAuthorityHintAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return h.ref.InternalTokens()
}

func (h AttestationAuthorityHintAttributes) HumanReadableName() terra.StringValue {
...
type AttestationAuthorityState struct {
	Hint []AttestationAuthorityHintState `json:"hint"`
}

type AttestationAuthorityHintState struct {
