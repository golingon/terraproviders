...
type Args struct {
	...
	VectorSearchConfig *VectorSearchConfig `hcl:"vector_search_config,block"`
}
...
func (gvafosf googleVertexAiFeatureOnlineStoreFeatureviewAttributes) VectorSearchConfig() terra.ListValue[VectorSearchConfigAttributes] {
	return terra.ReferenceAsList[VectorSearchConfigAttributes](gvafosf.ref.Append("vector_search_config"))
}
...
type googleVertexAiFeatureOnlineStoreFeatureviewState struct {
	...
	VectorSearchConfig    []VectorSearchConfigState    `json:"vector_search_config"`
}
