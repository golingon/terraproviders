...
type TrainingPhrases struct {
	...
	// TrainingPhrasesParts: min=1
	Parts []TrainingPhrasesParts `hcl:"parts,block" validate:"min=1"`
}

type TrainingPhrasesParts struct {
...
func (tp TrainingPhrasesAttributes) Parts() terra.ListValue[TrainingPhrasesPartsAttributes] {
	return terra.ReferenceAsList[TrainingPhrasesPartsAttributes](tp.ref.Append("parts"))
}

type TrainingPhrasesPartsAttributes struct {
	ref terra.Reference
}

func (p TrainingPhrasesPartsAttributes) InternalRef() (terra.Reference, error) {
	return p.ref, nil
}

func (p TrainingPhrasesPartsAttributes) InternalWithRef(ref terra.Reference) TrainingPhrasesPartsAttributes {
	return TrainingPhrasesPartsAttributes{ref: ref}
}

func (p TrainingPhrasesPartsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return p.ref.InternalTokens()
}

func (p TrainingPhrasesPartsAttributes) ParameterId() terra.StringValue {
	return terra.ReferenceAsString(p.ref.Append("parameter_id"))
}

func (p TrainingPhrasesPartsAttributes) Text() terra.StringValue {
...
type TrainingPhrasesState struct {
	...
	Parts       []TrainingPhrasesPartsState `json:"parts"`
}

type TrainingPhrasesPartsState struct {
