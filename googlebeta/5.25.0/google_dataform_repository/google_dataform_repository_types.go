...
type GitRemoteSettings struct {
	...
	// GitRemoteSettingsSshAuthenticationConfig: optional
	SshAuthenticationConfig *GitRemoteSettingsSshAuthenticationConfig `hcl:"ssh_authentication_config,block"`
}

type GitRemoteSettingsSshAuthenticationConfig struct {
...
func (grs GitRemoteSettingsAttributes) SshAuthenticationConfig() terra.ListValue[GitRemoteSettingsSshAuthenticationConfigAttributes] {
	return terra.ReferenceAsList[GitRemoteSettingsSshAuthenticationConfigAttributes](grs.ref.Append("ssh_authentication_config"))
}

type GitRemoteSettingsSshAuthenticationConfigAttributes struct {
	ref terra.Reference
}

func (sac GitRemoteSettingsSshAuthenticationConfigAttributes) InternalRef() (terra.Reference, error) {
	return sac.ref, nil
}

func (sac GitRemoteSettingsSshAuthenticationConfigAttributes) InternalWithRef(ref terra.Reference) GitRemoteSettingsSshAuthenticationConfigAttributes {
	return GitRemoteSettingsSshAuthenticationConfigAttributes{ref: ref}
}

func (sac GitRemoteSettingsSshAuthenticationConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return sac.ref.InternalTokens()
}

func (sac GitRemoteSettingsSshAuthenticationConfigAttributes) HostPublicKey() terra.StringValue {
	return terra.ReferenceAsString(sac.ref.Append("host_public_key"))
}

func (sac GitRemoteSettingsSshAuthenticationConfigAttributes) UserPrivateKeySecretVersion() terra.StringValue {
...
type GitRemoteSettingsState struct {
	...
	Url                              string                                          `json:"url"`
	SshAuthenticationConfig          []GitRemoteSettingsSshAuthenticationConfigState `json:"ssh_authentication_config"`
}

type GitRemoteSettingsSshAuthenticationConfigState struct {
