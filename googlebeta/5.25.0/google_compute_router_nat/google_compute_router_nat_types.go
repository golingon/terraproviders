...
type RulesAction struct {
	...
	// SourceNatActiveRanges: set of string, optional
	SourceNatActiveRanges terra.SetValue[terra.StringValue] `hcl:"source_nat_active_ranges,attr"`
	// SourceNatDrainIps: set of string, optional
	SourceNatDrainIps terra.SetValue[terra.StringValue] `hcl:"source_nat_drain_ips,attr"`
	// SourceNatDrainRanges: set of string, optional
	SourceNatDrainRanges terra.SetValue[terra.StringValue] `hcl:"source_nat_drain_ranges,attr"`
}
...
func (a RulesActionAttributes) SourceNatActiveIps() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](a.ref.Append("source_nat_active_ips"))
}

func (a RulesActionAttributes) SourceNatActiveRanges() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](a.ref.Append("source_nat_active_ranges"))
}

func (a RulesActionAttributes) SourceNatDrainIps() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](a.ref.Append("source_nat_drain_ips"))
}

func (a RulesActionAttributes) SourceNatDrainRanges() terra.SetValue[terra.StringValue] {
