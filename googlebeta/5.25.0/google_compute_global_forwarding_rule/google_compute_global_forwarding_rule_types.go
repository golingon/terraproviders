...
type MetadataFilters struct {
	...
	// MetadataFiltersFilterLabels: min=1,max=64
	FilterLabels []MetadataFiltersFilterLabels `hcl:"filter_labels,block" validate:"min=1,max=64"`
}

type MetadataFiltersFilterLabels struct {
...
type ServiceDirectoryRegistrations struct {
	...
	// ServiceDirectoryRegion: string, optional
	ServiceDirectoryRegion terra.StringValue `hcl:"service_directory_region,attr"`
}
...
func (mf MetadataFiltersAttributes) FilterLabels() terra.ListValue[MetadataFiltersFilterLabelsAttributes] {
	return terra.ReferenceAsList[MetadataFiltersFilterLabelsAttributes](mf.ref.Append("filter_labels"))
}

type MetadataFiltersFilterLabelsAttributes struct {
	ref terra.Reference
}

func (fl MetadataFiltersFilterLabelsAttributes) InternalRef() (terra.Reference, error) {
	return fl.ref, nil
}

func (fl MetadataFiltersFilterLabelsAttributes) InternalWithRef(ref terra.Reference) MetadataFiltersFilterLabelsAttributes {
	return MetadataFiltersFilterLabelsAttributes{ref: ref}
}

func (fl MetadataFiltersFilterLabelsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return fl.ref.InternalTokens()
}

func (fl MetadataFiltersFilterLabelsAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(fl.ref.Append("name"))
}

func (fl MetadataFiltersFilterLabelsAttributes) Value() terra.StringValue {
...
type MetadataFiltersState struct {
	...
	FilterLabels        []MetadataFiltersFilterLabelsState `json:"filter_labels"`
}

type MetadataFiltersFilterLabelsState struct {
