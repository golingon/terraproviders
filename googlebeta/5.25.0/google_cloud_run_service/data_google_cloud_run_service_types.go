...
func (v DataTemplateSpecVolumesAttributes) Csi() terra.ListValue[DataTemplateSpecVolumesCsiAttributes] {
	return terra.ReferenceAsList[DataTemplateSpecVolumesCsiAttributes](v.ref.Append("csi"))
}

func (v DataTemplateSpecVolumesAttributes) EmptyDir() terra.ListValue[DataTemplateSpecVolumesEmptyDirAttributes] {
	return terra.ReferenceAsList[DataTemplateSpecVolumesEmptyDirAttributes](v.ref.Append("empty_dir"))
}
...
type DataTemplateSpecVolumesCsiAttributes struct {
	ref terra.Reference
}

func (c DataTemplateSpecVolumesCsiAttributes) InternalRef() (terra.Reference, error) {
	return c.ref, nil
}

func (c DataTemplateSpecVolumesCsiAttributes) InternalWithRef(ref terra.Reference) DataTemplateSpecVolumesCsiAttributes {
	return DataTemplateSpecVolumesCsiAttributes{ref: ref}
}

func (c DataTemplateSpecVolumesCsiAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return c.ref.InternalTokens()
}

func (c DataTemplateSpecVolumesCsiAttributes) Driver() terra.StringValue {
	return terra.ReferenceAsString(c.ref.Append("driver"))
}

func (c DataTemplateSpecVolumesCsiAttributes) ReadOnly() terra.BoolValue {
	return terra.ReferenceAsBool(c.ref.Append("read_only"))
}

func (c DataTemplateSpecVolumesCsiAttributes) VolumeAttributes() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](c.ref.Append("volume_attributes"))
}

type DataTemplateSpecVolumesEmptyDirAttributes struct {
	ref terra.Reference
}

func (ed DataTemplateSpecVolumesEmptyDirAttributes) InternalRef() (terra.Reference, error) {
	return ed.ref, nil
}

func (ed DataTemplateSpecVolumesEmptyDirAttributes) InternalWithRef(ref terra.Reference) DataTemplateSpecVolumesEmptyDirAttributes {
	return DataTemplateSpecVolumesEmptyDirAttributes{ref: ref}
}

func (ed DataTemplateSpecVolumesEmptyDirAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ed.ref.InternalTokens()
}

func (ed DataTemplateSpecVolumesEmptyDirAttributes) Medium() terra.StringValue {
	return terra.ReferenceAsString(ed.ref.Append("medium"))
}

func (ed DataTemplateSpecVolumesEmptyDirAttributes) SizeLimit() terra.StringValue {
...
type DataTemplateSpecVolumesState struct {
	Name     string                                 `json:"name"`
	Csi      []DataTemplateSpecVolumesCsiState      `json:"csi"`
	EmptyDir []DataTemplateSpecVolumesEmptyDirState `json:"empty_dir"`
	Secret   []DataTemplateSpecVolumesSecretState   `json:"secret"`
}

type DataTemplateSpecVolumesCsiState struct {
	Driver           string            `json:"driver"`
	ReadOnly         bool              `json:"read_only"`
	VolumeAttributes map[string]string `json:"volume_attributes"`
}

type DataTemplateSpecVolumesEmptyDirState struct {
