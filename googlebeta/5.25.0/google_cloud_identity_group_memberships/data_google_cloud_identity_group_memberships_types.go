...
func (m DataMembershipsAttributes) MemberKey() terra.ListValue[DataMembershipsMemberKeyAttributes] {
	return terra.ReferenceAsList[DataMembershipsMemberKeyAttributes](m.ref.Append("member_key"))
}
...
type DataMembershipsMemberKeyAttributes struct {
	ref terra.Reference
}

func (mk DataMembershipsMemberKeyAttributes) InternalRef() (terra.Reference, error) {
	return mk.ref, nil
}

func (mk DataMembershipsMemberKeyAttributes) InternalWithRef(ref terra.Reference) DataMembershipsMemberKeyAttributes {
	return DataMembershipsMemberKeyAttributes{ref: ref}
}

func (mk DataMembershipsMemberKeyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return mk.ref.InternalTokens()
}

func (mk DataMembershipsMemberKeyAttributes) Id() terra.StringValue {
	return terra.ReferenceAsString(mk.ref.Append("id"))
}

func (mk DataMembershipsMemberKeyAttributes) Namespace() terra.StringValue {
...
type DataMembershipsState struct {
	...
	MemberKey          []DataMembershipsMemberKeyState          `json:"member_key"`
...
type DataMembershipsMemberKeyState struct {
	Id        string `json:"id"`
