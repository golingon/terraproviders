...
func (rsrr RecentScheduledReleaseRecordsAttributes) ErrorStatus() terra.ListValue[RecentScheduledReleaseRecordsErrorStatusAttributes] {
	return terra.ReferenceAsList[RecentScheduledReleaseRecordsErrorStatusAttributes](rsrr.ref.Append("error_status"))
}
...
func (es RecentScheduledReleaseRecordsErrorStatusAttributes) InternalWithRef(ref terra.Reference) RecentScheduledReleaseRecordsErrorStatusAttributes {
	return RecentScheduledReleaseRecordsErrorStatusAttributes{ref: ref}
}
...
type RecentScheduledReleaseRecordsState struct {
	...
	ErrorStatus       []RecentScheduledReleaseRecordsErrorStatusState `json:"error_status"`
}

type RecentScheduledReleaseRecordsErrorStatusState struct {
