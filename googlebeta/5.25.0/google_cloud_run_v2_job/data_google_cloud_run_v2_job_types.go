...
func (v DataTemplateTemplateVolumesAttributes) EmptyDir() terra.ListValue[DataTemplateTemplateVolumesEmptyDirAttributes] {
	return terra.ReferenceAsList[DataTemplateTemplateVolumesEmptyDirAttributes](v.ref.Append("empty_dir"))
}

func (v DataTemplateTemplateVolumesAttributes) Gcs() terra.ListValue[DataTemplateTemplateVolumesGcsAttributes] {
	return terra.ReferenceAsList[DataTemplateTemplateVolumesGcsAttributes](v.ref.Append("gcs"))
}

func (v DataTemplateTemplateVolumesAttributes) Nfs() terra.ListValue[DataTemplateTemplateVolumesNfsAttributes] {
	return terra.ReferenceAsList[DataTemplateTemplateVolumesNfsAttributes](v.ref.Append("nfs"))
}
...
func (ed DataTemplateTemplateVolumesEmptyDirAttributes) InternalRef() (terra.Reference, error) {
	return ed.ref, nil
}

func (ed DataTemplateTemplateVolumesEmptyDirAttributes) InternalWithRef(ref terra.Reference) DataTemplateTemplateVolumesEmptyDirAttributes {
	return DataTemplateTemplateVolumesEmptyDirAttributes{ref: ref}
}

func (ed DataTemplateTemplateVolumesEmptyDirAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ed.ref.InternalTokens()
}

func (ed DataTemplateTemplateVolumesEmptyDirAttributes) Medium() terra.StringValue {
	return terra.ReferenceAsString(ed.ref.Append("medium"))
}

func (ed DataTemplateTemplateVolumesEmptyDirAttributes) SizeLimit() terra.StringValue {
...
func (g DataTemplateTemplateVolumesGcsAttributes) InternalRef() (terra.Reference, error) {
	return g.ref, nil
}

func (g DataTemplateTemplateVolumesGcsAttributes) InternalWithRef(ref terra.Reference) DataTemplateTemplateVolumesGcsAttributes {
	return DataTemplateTemplateVolumesGcsAttributes{ref: ref}
}

func (g DataTemplateTemplateVolumesGcsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return g.ref.InternalTokens()
}

func (g DataTemplateTemplateVolumesGcsAttributes) Bucket() terra.StringValue {
	return terra.ReferenceAsString(g.ref.Append("bucket"))
}

func (g DataTemplateTemplateVolumesGcsAttributes) ReadOnly() terra.BoolValue {
...
func (n DataTemplateTemplateVolumesNfsAttributes) InternalRef() (terra.Reference, error) {
	return n.ref, nil
}

func (n DataTemplateTemplateVolumesNfsAttributes) InternalWithRef(ref terra.Reference) DataTemplateTemplateVolumesNfsAttributes {
	return DataTemplateTemplateVolumesNfsAttributes{ref: ref}
}

func (n DataTemplateTemplateVolumesNfsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return n.ref.InternalTokens()
}

func (n DataTemplateTemplateVolumesNfsAttributes) Path() terra.StringValue {
	return terra.ReferenceAsString(n.ref.Append("path"))
}

func (n DataTemplateTemplateVolumesNfsAttributes) ReadOnly() terra.BoolValue {
	return terra.ReferenceAsBool(n.ref.Append("read_only"))
}

func (n DataTemplateTemplateVolumesNfsAttributes) Server() terra.StringValue {
