...
func (gvafe googleVertexAiFeaturestoreEntitytypeAttributes) OfflineStorageTtlDays() terra.NumberValue {
	return terra.ReferenceAsNumber(gvafe.ref.Append("offline_storage_ttl_days"))
}
