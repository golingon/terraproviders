...
func (pp PasswordPolicyAttributes) Status() terra.ListValue[PasswordPolicyStatusAttributes] {
	return terra.ReferenceAsList[PasswordPolicyStatusAttributes](pp.ref.Append("status"))
}

type PasswordPolicyStatusAttributes struct {
	ref terra.Reference
}

func (s PasswordPolicyStatusAttributes) InternalRef() (terra.Reference, error) {
	return s.ref, nil
}

func (s PasswordPolicyStatusAttributes) InternalWithRef(ref terra.Reference) PasswordPolicyStatusAttributes {
	return PasswordPolicyStatusAttributes{ref: ref}
}

func (s PasswordPolicyStatusAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return s.ref.InternalTokens()
}

func (s PasswordPolicyStatusAttributes) Locked() terra.BoolValue {
	return terra.ReferenceAsBool(s.ref.Append("locked"))
}

func (s PasswordPolicyStatusAttributes) PasswordExpirationTime() terra.StringValue {
...
type PasswordPolicyState struct {
	...
	Status                     []PasswordPolicyStatusState `json:"status"`
}

type PasswordPolicyStatusState struct {
