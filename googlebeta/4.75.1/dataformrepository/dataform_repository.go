...
type GitRemoteSettings struct {
	// AuthenticationTokenSecretVersion: string, required
	AuthenticationTokenSecretVersion terra.StringValue `hcl:"authentication_token_secret_version,attr" validate:"required"`
