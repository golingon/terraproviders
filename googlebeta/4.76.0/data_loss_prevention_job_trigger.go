...
import (
	"encoding/json"
	"fmt"
	datalosspreventionjobtrigger "github.com/golingon/terraproviders/googlebeta/4.76.0/datalosspreventionjobtrigger"
...
func (dlpjt dataLossPreventionJobTriggerAttributes) TriggerId() terra.StringValue {
	return terra.ReferenceAsString(dlpjt.ref.Append("trigger_id"))
}
