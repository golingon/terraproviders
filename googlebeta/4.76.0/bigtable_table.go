...
import (
	"encoding/json"
	"fmt"
	bigtabletable "github.com/golingon/terraproviders/googlebeta/4.76.0/bigtabletable"
...
func (bt bigtableTableAttributes) ChangeStreamRetention() terra.StringValue {
	return terra.ReferenceAsString(bt.ref.Append("change_stream_retention"))
}
