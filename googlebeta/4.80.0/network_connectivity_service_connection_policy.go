...
import (
	"encoding/json"
	"fmt"
	networkconnectivityserviceconnectionpolicy "github.com/golingon/terraproviders/googlebeta/4.80.0/networkconnectivityserviceconnectionpolicy"
...
// PscConnections returns a reference to field psc_connections of google_network_connectivity_service_connection_policy.
func (ncscp networkConnectivityServiceConnectionPolicyAttributes) PscConnections() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](ncscp.ref.Append("psc_connections"))
}
...
type networkConnectivityServiceConnectionPolicyState struct {
	...
	PscConnections []string                                                    `json:"psc_connections"`
