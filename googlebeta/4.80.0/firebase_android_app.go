...
import (
	"encoding/json"
	"fmt"
	firebaseandroidapp "github.com/golingon/terraproviders/googlebeta/4.80.0/firebaseandroidapp"
...
func (faa firebaseAndroidAppAttributes) ApiKeyId() terra.StringValue {
