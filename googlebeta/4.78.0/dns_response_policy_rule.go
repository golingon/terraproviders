...
import (
	"encoding/json"
	"fmt"
	dnsresponsepolicyrule "github.com/golingon/terraproviders/googlebeta/4.78.0/dnsresponsepolicyrule"
...
type DnsResponsePolicyRuleArgs struct {
	...
	Behavior terra.StringValue `hcl:"behavior,attr"`
...
// Behavior returns a reference to field behavior of google_dns_response_policy_rule.
func (drpr dnsResponsePolicyRuleAttributes) Behavior() terra.StringValue {
	return terra.ReferenceAsString(drpr.ref.Append("behavior"))
}
