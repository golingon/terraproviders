...
import (
	"encoding/json"
	"fmt"
	gkeonpremvmwarecluster "github.com/golingon/terraproviders/googlebeta/4.72.1/gkeonpremvmwarecluster"
...
type GkeonpremVmwareClusterArgs struct {
	...
	// Vcenter: min=0
	Vcenter []gkeonpremvmwarecluster.Vcenter `hcl:"vcenter,block" validate:"min=0"`
