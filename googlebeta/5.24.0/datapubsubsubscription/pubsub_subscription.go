...
type CloudStorageConfig struct {
	// AvroConfig: min=0
	AvroConfig []AvroConfig `hcl:"avro_config,block" validate:"min=0"`
}
...
func (csc CloudStorageConfigAttributes) AvroConfig() terra.ListValue[AvroConfigAttributes] {
	return terra.ReferenceAsList[AvroConfigAttributes](csc.ref.Append("avro_config"))
}

type AvroConfigAttributes struct {
	ref terra.Reference
}

func (ac AvroConfigAttributes) InternalRef() (terra.Reference, error) {
	return ac.ref, nil
}

func (ac AvroConfigAttributes) InternalWithRef(ref terra.Reference) AvroConfigAttributes {
	return AvroConfigAttributes{ref: ref}
}

func (ac AvroConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ac.ref.InternalTokens()
}

func (ac AvroConfigAttributes) WriteMetadata() terra.BoolValue {
...
type CloudStorageConfigState struct {
	...
	AvroConfig     []AvroConfigState `json:"avro_config"`
}

type AvroConfigState struct {
	WriteMetadata bool `json:"write_metadata"`
}
