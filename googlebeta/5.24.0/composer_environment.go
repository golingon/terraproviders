...
import (
	...
	composerenvironment "github.com/golingon/terraproviders/googlebeta/5.24.0/composerenvironment"
	"io"
)
...
type ComposerEnvironmentArgs struct {
	...
	StorageConfig *composerenvironment.StorageConfig `hcl:"storage_config,block"`
	// Timeouts: optional
...
func (ce composerEnvironmentAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ce.ref.Append("effective_labels"))
}
...
func (ce composerEnvironmentAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ce.ref.Append("terraform_labels"))
}
...
func (ce composerEnvironmentAttributes) StorageConfig() terra.ListValue[composerenvironment.StorageConfigAttributes] {
	return terra.ReferenceAsList[composerenvironment.StorageConfigAttributes](ce.ref.Append("storage_config"))
}
...
type composerEnvironmentState struct {
	...
	StorageConfig   []composerenvironment.StorageConfigState `json:"storage_config"`
