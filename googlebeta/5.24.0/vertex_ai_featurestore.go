...
import (
	...
	vertexaifeaturestore "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaifeaturestore"
	"io"
)
...
func (vaf vertexAiFeaturestoreAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vaf.ref.Append("effective_labels"))
}
...
func (vaf vertexAiFeaturestoreAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vaf.ref.Append("terraform_labels"))
}
