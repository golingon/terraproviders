...
import (
	...
	activedirectorydomain "github.com/golingon/terraproviders/googlebeta/5.24.0/activedirectorydomain"
	"io"
)
...
func (add activeDirectoryDomainAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](add.ref.Append("effective_labels"))
}
...
func (add activeDirectoryDomainAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](add.ref.Append("terraform_labels"))
}
