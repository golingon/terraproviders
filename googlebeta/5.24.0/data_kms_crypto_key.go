...
import (
	...
	datakmscryptokey "github.com/golingon/terraproviders/googlebeta/5.24.0/datakmscryptokey"
)
...
type DataKmsCryptoKeyArgs struct {
	...
	// Primary: min=0
	Primary []datakmscryptokey.Primary `hcl:"primary,block" validate:"min=0"`
...
func (kck dataKmsCryptoKeyAttributes) CryptoKeyBackend() terra.StringValue {
...
func (kck dataKmsCryptoKeyAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (kck dataKmsCryptoKeyAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](kck.ref.Append("terraform_labels"))
}

func (kck dataKmsCryptoKeyAttributes) Primary() terra.ListValue[datakmscryptokey.PrimaryAttributes] {
	return terra.ReferenceAsList[datakmscryptokey.PrimaryAttributes](kck.ref.Append("primary"))
}
