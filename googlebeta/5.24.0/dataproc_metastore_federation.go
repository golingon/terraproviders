...
import (
	...
	dataprocmetastorefederation "github.com/golingon/terraproviders/googlebeta/5.24.0/dataprocmetastorefederation"
	"io"
)
...
func (dmf dataprocMetastoreFederationAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dmf.ref.Append("effective_labels"))
}
...
func (dmf dataprocMetastoreFederationAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dmf.ref.Append("terraform_labels"))
}
