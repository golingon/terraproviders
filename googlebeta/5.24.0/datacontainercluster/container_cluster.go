...
type AddonsConfig struct {
	...
	// IstioConfig: min=0
	IstioConfig []IstioConfig `hcl:"istio_config,block" validate:"min=0"`
	// KalmConfig: min=0
	KalmConfig []KalmConfig `hcl:"kalm_config,block" validate:"min=0"`
...
type IpAllocationPolicy struct {
	// AdditionalPodRangesConfig: min=0
	AdditionalPodRangesConfig []AdditionalPodRangesConfig `hcl:"additional_pod_ranges_config,block" validate:"min=0"`
...
type MonitoringConfig struct {
	// AdvancedDatapathObservabilityConfig: min=0
	AdvancedDatapathObservabilityConfig []AdvancedDatapathObservabilityConfig `hcl:"advanced_datapath_observability_config,block" validate:"min=0"`
...
type NodeConfig struct {
	...
	// NodeConfigConfidentialNodes: min=0
	ConfidentialNodes []NodeConfigConfidentialNodes `hcl:"confidential_nodes,block" validate:"min=0"`
	// NodeConfigEffectiveTaints: min=0
	EffectiveTaints []NodeConfigEffectiveTaints `hcl:"effective_taints,block" validate:"min=0"`
	// NodeConfigEphemeralStorageConfig: min=0
	EphemeralStorageConfig []NodeConfigEphemeralStorageConfig `hcl:"ephemeral_storage_config,block" validate:"min=0"`
	...
	// NodeConfigFastSocket: min=0
	FastSocket []NodeConfigFastSocket `hcl:"fast_socket,block" validate:"min=0"`
	...
	// NodeConfigSandboxConfig: min=0
	SandboxConfig []NodeConfigSandboxConfig `hcl:"sandbox_config,block" validate:"min=0"`
...
type NodePool struct {
	...
	// QueuedProvisioning: min=0
	QueuedProvisioning []QueuedProvisioning `hcl:"queued_provisioning,block" validate:"min=0"`
...
type NetworkConfig struct {
	...
	NetworkPerformanceConfig []NetworkPerformanceConfig `hcl:"network_performance_config,block" validate:"min=0"`
...
type NodePoolNodeConfig struct {
	...
	// NodePoolNodeConfigConfidentialNodes: min=0
	ConfidentialNodes []NodePoolNodeConfigConfidentialNodes `hcl:"confidential_nodes,block" validate:"min=0"`
	...
	// NodePoolNodeConfigEphemeralStorageConfig: min=0
	EphemeralStorageConfig []NodePoolNodeConfigEphemeralStorageConfig `hcl:"ephemeral_storage_config,block" validate:"min=0"`
	...
	// NodePoolNodeConfigFastSocket: min=0
	FastSocket []NodePoolNodeConfigFastSocket `hcl:"fast_socket,block" validate:"min=0"`
	...
	// NodePoolNodeConfigSandboxConfig: min=0
	SandboxConfig []NodePoolNodeConfigSandboxConfig `hcl:"sandbox_config,block" validate:"min=0"`
...
type NodePoolAutoConfig struct {
	// NetworkTags: min=0
	NetworkTags []NetworkTags `hcl:"network_tags,block" validate:"min=0"`
}
...
type NodeConfigDefaults struct {
	// NodeConfigDefaultsGcfsConfig: min=0
	GcfsConfig []NodeConfigDefaultsGcfsConfig `hcl:"gcfs_config,block" validate:"min=0"`
}
...
type ProtectConfig struct {
	// WorkloadConfig: min=0
	WorkloadConfig []WorkloadConfig `hcl:"workload_config,block" validate:"min=0"`
}
...
func (adoc AdvancedDatapathObservabilityConfigAttributes) EnableRelay() terra.BoolValue {
...
func (np NodePoolAttributes) QueuedProvisioning() terra.ListValue[QueuedProvisioningAttributes] {
	return terra.ReferenceAsList[QueuedProvisioningAttributes](np.ref.Append("queued_provisioning"))
}
...
func (nc NetworkConfigAttributes) NetworkPerformanceConfig() terra.ListValue[NetworkPerformanceConfigAttributes] {
	return terra.ReferenceAsList[NetworkPerformanceConfigAttributes](nc.ref.Append("network_performance_config"))
}
