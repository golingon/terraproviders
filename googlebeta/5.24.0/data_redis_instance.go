...
import (
	...
	dataredisinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/dataredisinstance"
)
...
func (ri dataRedisInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ri.ref.Append("effective_labels"))
}
...
func (ri dataRedisInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ri.ref.Append("terraform_labels"))
}
