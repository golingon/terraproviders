...
import (
	...
	storagebucketobject "github.com/golingon/terraproviders/googlebeta/5.24.0/storagebucketobject"
	"io"
)
...
type StorageBucketObjectArgs struct {
	...
	// Retention: optional
	Retention *storagebucketobject.Retention `hcl:"retention,block"`
	// Timeouts: optional
...
func (sbo storageBucketObjectAttributes) Retention() terra.ListValue[storagebucketobject.RetentionAttributes] {
	return terra.ReferenceAsList[storagebucketobject.RetentionAttributes](sbo.ref.Append("retention"))
}
...
type storageBucketObjectState struct {
	...
	Retention          []storagebucketobject.RetentionState          `json:"retention"`
