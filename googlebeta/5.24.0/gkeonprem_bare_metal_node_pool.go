...
import (
	...
	gkeonprembaremetalnodepool "github.com/golingon/terraproviders/googlebeta/5.24.0/gkeonprembaremetalnodepool"
	"io"
)
...
func (gbmnp gkeonpremBareMetalNodePoolAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](gbmnp.ref.Append("effective_annotations"))
}
