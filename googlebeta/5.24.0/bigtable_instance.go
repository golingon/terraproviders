...
import (
	...
	bigtableinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/bigtableinstance"
	"io"
)
...
func (bi bigtableInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bi.ref.Append("effective_labels"))
}
...
func (bi bigtableInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bi.ref.Append("terraform_labels"))
}
