...
import (
	...
	dataformrepository "github.com/golingon/terraproviders/googlebeta/5.24.0/dataformrepository"
	"io"
)
...
func (dr dataformRepositoryAttributes) DisplayName() terra.StringValue {
...
func (dr dataformRepositoryAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dr.ref.Append("effective_labels"))
}
...
func (dr dataformRepositoryAttributes) Labels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dr.ref.Append("labels"))
}
...
func (dr dataformRepositoryAttributes) NpmrcEnvironmentVariablesSecretVersion() terra.StringValue {
	return terra.ReferenceAsString(dr.ref.Append("npmrc_environment_variables_secret_version"))
}
...
func (dr dataformRepositoryAttributes) ServiceAccount() terra.StringValue {
	return terra.ReferenceAsString(dr.ref.Append("service_account"))
}

// TerraformLabels returns a reference to field terraform_labels of google_dataform_repository.
func (dr dataformRepositoryAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dr.ref.Append("terraform_labels"))
}
