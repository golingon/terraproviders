...
import (
	...
	healthcarefhirstore "github.com/golingon/terraproviders/googlebeta/5.24.0/healthcarefhirstore"
	"io"
)
...
func (hfs healthcareFhirStoreAttributes) DefaultSearchHandlingStrict() terra.BoolValue {
	return terra.ReferenceAsBool(hfs.ref.Append("default_search_handling_strict"))
}
...
func (hfs healthcareFhirStoreAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hfs.ref.Append("effective_labels"))
}
...
// EnableHistoryModifications returns a reference to field enable_history_modifications of google_healthcare_fhir_store.
func (hfs healthcareFhirStoreAttributes) EnableHistoryModifications() terra.BoolValue {
	return terra.ReferenceAsBool(hfs.ref.Append("enable_history_modifications"))
}
...
func (hfs healthcareFhirStoreAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hfs.ref.Append("terraform_labels"))
}
...
type healthcareFhirStoreState struct {
	...
	EnableHistoryModifications      bool                                           `json:"enable_history_modifications"`
