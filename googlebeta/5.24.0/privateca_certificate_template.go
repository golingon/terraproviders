...
import (
	...
	privatecacertificatetemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/privatecacertificatetemplate"
	"io"
)
...
func (pct privatecaCertificateTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](pct.ref.Append("effective_labels"))
}
...
func (pct privatecaCertificateTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](pct.ref.Append("terraform_labels"))
}
