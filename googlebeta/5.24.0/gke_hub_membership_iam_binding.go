...
import (
	...
	gkehubmembershipiambinding "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubmembershipiambinding"
	"io"
)
...
func (ghmib gkeHubMembershipIamBindingAttributes) Location() terra.StringValue {
	return terra.ReferenceAsString(ghmib.ref.Append("location"))
}
