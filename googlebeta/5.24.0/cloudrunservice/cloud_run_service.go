...
func (v VolumesAttributes) Csi() terra.ListValue[CsiAttributes] {
	return terra.ReferenceAsList[CsiAttributes](v.ref.Append("csi"))
}
...
type CsiAttributes struct {
	ref terra.Reference
}

func (c CsiAttributes) InternalRef() (terra.Reference, error) {
	return c.ref, nil
}

func (c CsiAttributes) InternalWithRef(ref terra.Reference) CsiAttributes {
	return CsiAttributes{ref: ref}
}

func (c CsiAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return c.ref.InternalTokens()
}

func (c CsiAttributes) Driver() terra.StringValue {
	return terra.ReferenceAsString(c.ref.Append("driver"))
}

func (c CsiAttributes) ReadOnly() terra.BoolValue {
	return terra.ReferenceAsBool(c.ref.Append("read_only"))
}

func (c CsiAttributes) VolumeAttributes() terra.MapValue[terra.StringValue] {
