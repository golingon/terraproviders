...
import (
	...
	redisinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/redisinstance"
	"io"
)
...
func (ri redisInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (ri redisInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
