...
import (
	...
	datapubsubtopic "github.com/golingon/terraproviders/googlebeta/5.24.0/datapubsubtopic"
)
...
type DataPubsubTopicArgs struct {
	...
	// IngestionDataSourceSettings: min=0
	IngestionDataSourceSettings []datapubsubtopic.IngestionDataSourceSettings `hcl:"ingestion_data_source_settings,block" validate:"min=0"`
...
func (pt dataPubsubTopicAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (pt dataPubsubTopicAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](pt.ref.Append("terraform_labels"))
}

func (pt dataPubsubTopicAttributes) IngestionDataSourceSettings() terra.ListValue[datapubsubtopic.IngestionDataSourceSettingsAttributes] {
	return terra.ReferenceAsList[datapubsubtopic.IngestionDataSourceSettingsAttributes](pt.ref.Append("ingestion_data_source_settings"))
}
