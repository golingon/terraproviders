...
import (
	...
	recaptchaenterprisekey "github.com/golingon/terraproviders/googlebeta/5.24.0/recaptchaenterprisekey"
	"io"
)
...
type RecaptchaEnterpriseKeyArgs struct {
	...
	WafSettings *recaptchaenterprisekey.WafSettings `hcl:"waf_settings,block"`
...
func (rek recaptchaEnterpriseKeyAttributes) WafSettings() terra.ListValue[recaptchaenterprisekey.WafSettingsAttributes] {
	return terra.ReferenceAsList[recaptchaenterprisekey.WafSettingsAttributes](rek.ref.Append("waf_settings"))
}
...
type recaptchaEnterpriseKeyState struct {
	...
	WafSettings     []recaptchaenterprisekey.WafSettingsState     `json:"waf_settings"`
