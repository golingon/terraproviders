...
import (
	...
	memcacheinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/memcacheinstance"
	"io"
)
...
func (mi memcacheInstanceAttributes) ReservedIpRangeId() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](mi.ref.Append("reserved_ip_range_id"))
}
