...
import (
	...
	networkmanagementconnectivitytest "github.com/golingon/terraproviders/googlebeta/5.24.0/networkmanagementconnectivitytest"
	"io"
)
...
func (nmct networkManagementConnectivityTestAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nmct.ref.Append("effective_labels"))
}
...
func (nmct networkManagementConnectivityTestAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nmct.ref.Append("terraform_labels"))
}
