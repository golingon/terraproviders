...
import (
	...
	healthcareconsentstore "github.com/golingon/terraproviders/googlebeta/5.24.0/healthcareconsentstore"
	"io"
)
...
func (hcs healthcareConsentStoreAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hcs.ref.Append("effective_labels"))
}
...
func (hcs healthcareConsentStoreAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hcs.ref.Append("terraform_labels"))
}
