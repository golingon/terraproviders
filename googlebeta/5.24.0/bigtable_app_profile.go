...
import (
	...
	bigtableappprofile "github.com/golingon/terraproviders/googlebeta/5.24.0/bigtableappprofile"
	"io"
)
...
type BigtableAppProfileArgs struct {
	...
	StandardIsolation *bigtableappprofile.StandardIsolation `hcl:"standard_isolation,block"`
	// Timeouts: optional
...
func (bap bigtableAppProfileAttributes) StandardIsolation() terra.ListValue[bigtableappprofile.StandardIsolationAttributes] {
	return terra.ReferenceAsList[bigtableappprofile.StandardIsolationAttributes](bap.ref.Append("standard_isolation"))
}
...
type bigtableAppProfileState struct {
	...
	StandardIsolation             []bigtableappprofile.StandardIsolationState    `json:"standard_isolation"`
