...
import (
	...
	loggingprojectbucketconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/loggingprojectbucketconfig"
	"io"
)
...
type LoggingProjectBucketConfigArgs struct {
	...
	IndexConfigs []loggingprojectbucketconfig.IndexConfigs `hcl:"index_configs,block" validate:"min=0,max=20"`
}
...
func (lpbc loggingProjectBucketConfigAttributes) IndexConfigs() terra.SetValue[loggingprojectbucketconfig.IndexConfigsAttributes] {
	return terra.ReferenceAsSet[loggingprojectbucketconfig.IndexConfigsAttributes](lpbc.ref.Append("index_configs"))
}
...
type loggingProjectBucketConfigState struct {
	...
	IndexConfigs    []loggingprojectbucketconfig.IndexConfigsState `json:"index_configs"`
}
