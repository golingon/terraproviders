...
import (
	...
	networkconnectivityhub "github.com/golingon/terraproviders/googlebeta/5.24.0/networkconnectivityhub"
	"io"
)
...
func (nch networkConnectivityHubAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nch.ref.Append("effective_labels"))
}
...
func (nch networkConnectivityHubAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nch.ref.Append("terraform_labels"))
}
