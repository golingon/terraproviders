...
import (
	...
	computeglobaladdress "github.com/golingon/terraproviders/googlebeta/5.24.0/computeglobaladdress"
	"io"
)
...
func (cga computeGlobalAddressAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cga.ref.Append("effective_labels"))
}
...
func (cga computeGlobalAddressAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cga.ref.Append("terraform_labels"))
}
