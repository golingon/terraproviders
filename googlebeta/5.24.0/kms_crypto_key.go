...
import (
	...
	kmscryptokey "github.com/golingon/terraproviders/googlebeta/5.24.0/kmscryptokey"
	"io"
)
...
type KmsCryptoKeyArgs struct {
	...
	// Primary: min=0
	Primary []kmscryptokey.Primary `hcl:"primary,block" validate:"min=0"`
	// Timeouts: optional
...
func (kck kmsCryptoKeyAttributes) CryptoKeyBackend() terra.StringValue {
	return terra.ReferenceAsString(kck.ref.Append("crypto_key_backend"))
}
...
func (kck kmsCryptoKeyAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](kck.ref.Append("effective_labels"))
}
...
func (kck kmsCryptoKeyAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](kck.ref.Append("terraform_labels"))
}

func (kck kmsCryptoKeyAttributes) Primary() terra.ListValue[kmscryptokey.PrimaryAttributes] {
	return terra.ReferenceAsList[kmscryptokey.PrimaryAttributes](kck.ref.Append("primary"))
}
...
type kmsCryptoKeyState struct {
	...
	Primary                    []kmscryptokey.PrimaryState         `json:"primary"`
