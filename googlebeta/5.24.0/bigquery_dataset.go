...
import (
	...
	bigquerydataset "github.com/golingon/terraproviders/googlebeta/5.24.0/bigquerydataset"
	"io"
)
...
type BigqueryDatasetArgs struct {
	...
	ExternalDatasetReference *bigquerydataset.ExternalDatasetReference `hcl:"external_dataset_reference,block"`
	// Timeouts: optional
...
func (bd bigqueryDatasetAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (bd bigqueryDatasetAttributes) StorageBillingModel() terra.StringValue {
...
func (bd bigqueryDatasetAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (bd bigqueryDatasetAttributes) ExternalDatasetReference() terra.ListValue[bigquerydataset.ExternalDatasetReferenceAttributes] {
	return terra.ReferenceAsList[bigquerydataset.ExternalDatasetReferenceAttributes](bd.ref.Append("external_dataset_reference"))
}
...
type bigqueryDatasetState struct {
	...
	ExternalDatasetReference       []bigquerydataset.ExternalDatasetReferenceState       `json:"external_dataset_reference"`
