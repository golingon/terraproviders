...
import (
	...
	computeserviceattachment "github.com/golingon/terraproviders/googlebeta/5.24.0/computeserviceattachment"
	"io"
)
...
func (csa computeServiceAttachmentAttributes) ReconcileConnections() terra.BoolValue {
	return terra.ReferenceAsBool(csa.ref.Append("reconcile_connections"))
}
...
func (csa computeServiceAttachmentAttributes) ConsumerAcceptLists() terra.SetValue[computeserviceattachment.ConsumerAcceptListsAttributes] {
	return terra.ReferenceAsSet[computeserviceattachment.ConsumerAcceptListsAttributes](csa.ref.Append("consumer_accept_lists"))
}
