...
import (
	...
	dataplexdatascan "github.com/golingon/terraproviders/googlebeta/5.24.0/dataplexdatascan"
	"io"
)
...
func (dd dataplexDatascanAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dd.ref.Append("effective_labels"))
}
...
func (dd dataplexDatascanAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dd.ref.Append("terraform_labels"))
}
