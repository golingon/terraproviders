...
import (
	...
	loggingbillingaccountbucketconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/loggingbillingaccountbucketconfig"
	"io"
)
...
type LoggingBillingAccountBucketConfigArgs struct {
	...
	IndexConfigs []loggingbillingaccountbucketconfig.IndexConfigs `hcl:"index_configs,block" validate:"min=0,max=20"`
}
...
func (lbabc loggingBillingAccountBucketConfigAttributes) IndexConfigs() terra.SetValue[loggingbillingaccountbucketconfig.IndexConfigsAttributes] {
	return terra.ReferenceAsSet[loggingbillingaccountbucketconfig.IndexConfigsAttributes](lbabc.ref.Append("index_configs"))
}
...
type loggingBillingAccountBucketConfigState struct {
	...
	IndexConfigs   []loggingbillingaccountbucketconfig.IndexConfigsState `json:"index_configs"`
}
