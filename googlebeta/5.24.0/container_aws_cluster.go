...
import (
	...
	containerawscluster "github.com/golingon/terraproviders/googlebeta/5.24.0/containerawscluster"
	"io"
)
...
type ContainerAwsClusterArgs struct {
	...
	BinaryAuthorization *containerawscluster.BinaryAuthorization `hcl:"binary_authorization,block"`
...
func (cac containerAwsClusterAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (cac containerAwsClusterAttributes) BinaryAuthorization() terra.ListValue[containerawscluster.BinaryAuthorizationAttributes] {
	return terra.ReferenceAsList[containerawscluster.BinaryAuthorizationAttributes](cac.ref.Append("binary_authorization"))
}
...
type containerAwsClusterState struct {
	...
	BinaryAuthorization    []containerawscluster.BinaryAuthorizationState    `json:"binary_authorization"`
