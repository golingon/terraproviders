...
import (
	...
	computeinstancefromtemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/computeinstancefromtemplate"
	"io"
)
...
func (cift computeInstanceFromTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cift.ref.Append("effective_labels"))
}
...
func (cift computeInstanceFromTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cift.ref.Append("terraform_labels"))
}
