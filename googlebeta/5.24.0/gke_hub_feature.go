...
import (
	...
	gkehubfeature "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubfeature"
	"io"
)
...
type GkeHubFeatureArgs struct {
	...
	FleetDefaultMemberConfig *gkehubfeature.FleetDefaultMemberConfig `hcl:"fleet_default_member_config,block"`
	// Spec: optional
...
func (ghf gkeHubFeatureAttributes) FleetDefaultMemberConfig() terra.ListValue[gkehubfeature.FleetDefaultMemberConfigAttributes] {
	return terra.ReferenceAsList[gkehubfeature.FleetDefaultMemberConfigAttributes](ghf.ref.Append("fleet_default_member_config"))
}
...
type gkeHubFeatureState struct {
	...
	FleetDefaultMemberConfig []gkehubfeature.FleetDefaultMemberConfigState `json:"fleet_default_member_config"`
