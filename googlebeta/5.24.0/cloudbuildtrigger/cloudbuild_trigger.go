...
type Artifacts struct {
	// Images: list of string, optional
	Images terra.ListValue[terra.StringValue] `hcl:"images,attr"`
	// MavenArtifacts: min=0
	MavenArtifacts []MavenArtifacts `hcl:"maven_artifacts,block" validate:"min=0"`
	// NpmPackages: min=0
	NpmPackages []NpmPackages `hcl:"npm_packages,block" validate:"min=0"`
	// Objects: optional
	Objects *Objects `hcl:"objects,block"`
	// PythonPackages: min=0
	PythonPackages []PythonPackages `hcl:"python_packages,block" validate:"min=0"`
}
...
func (a ArtifactsAttributes) MavenArtifacts() terra.ListValue[MavenArtifactsAttributes] {
	return terra.ReferenceAsList[MavenArtifactsAttributes](a.ref.Append("maven_artifacts"))
}

func (a ArtifactsAttributes) NpmPackages() terra.ListValue[NpmPackagesAttributes] {
	return terra.ReferenceAsList[NpmPackagesAttributes](a.ref.Append("npm_packages"))
}
...
func (a ArtifactsAttributes) PythonPackages() terra.ListValue[PythonPackagesAttributes] {
	return terra.ReferenceAsList[PythonPackagesAttributes](a.ref.Append("python_packages"))
}

type MavenArtifactsAttributes struct {
	ref terra.Reference
}

func (ma MavenArtifactsAttributes) InternalRef() (terra.Reference, error) {
	return ma.ref, nil
}

func (ma MavenArtifactsAttributes) InternalWithRef(ref terra.Reference) MavenArtifactsAttributes {
	return MavenArtifactsAttributes{ref: ref}
}

func (ma MavenArtifactsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ma.ref.InternalTokens()
}

func (ma MavenArtifactsAttributes) ArtifactId() terra.StringValue {
	return terra.ReferenceAsString(ma.ref.Append("artifact_id"))
}

func (ma MavenArtifactsAttributes) GroupId() terra.StringValue {
	return terra.ReferenceAsString(ma.ref.Append("group_id"))
}

func (ma MavenArtifactsAttributes) Path() terra.StringValue {
	return terra.ReferenceAsString(ma.ref.Append("path"))
}

func (ma MavenArtifactsAttributes) Repository() terra.StringValue {
	return terra.ReferenceAsString(ma.ref.Append("repository"))
}

func (ma MavenArtifactsAttributes) Version() terra.StringValue {
	return terra.ReferenceAsString(ma.ref.Append("version"))
}

type NpmPackagesAttributes struct {
	ref terra.Reference
}

func (np NpmPackagesAttributes) InternalRef() (terra.Reference, error) {
	return np.ref, nil
}

func (np NpmPackagesAttributes) InternalWithRef(ref terra.Reference) NpmPackagesAttributes {
	return NpmPackagesAttributes{ref: ref}
}

func (np NpmPackagesAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return np.ref.InternalTokens()
}

func (np NpmPackagesAttributes) PackagePath() terra.StringValue {
	return terra.ReferenceAsString(np.ref.Append("package_path"))
}

func (np NpmPackagesAttributes) Repository() terra.StringValue {
...
type PythonPackagesAttributes struct {
	ref terra.Reference
}

func (pp PythonPackagesAttributes) InternalRef() (terra.Reference, error) {
	return pp.ref, nil
}

func (pp PythonPackagesAttributes) InternalWithRef(ref terra.Reference) PythonPackagesAttributes {
	return PythonPackagesAttributes{ref: ref}
}

func (pp PythonPackagesAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return pp.ref.InternalTokens()
}

func (pp PythonPackagesAttributes) Paths() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](pp.ref.Append("paths"))
}

func (pp PythonPackagesAttributes) Repository() terra.StringValue {
...
type ArtifactsState struct {
	Images         []string              `json:"images"`
	MavenArtifacts []MavenArtifactsState `json:"maven_artifacts"`
	NpmPackages    []NpmPackagesState    `json:"npm_packages"`
	Objects        []ObjectsState        `json:"objects"`
	PythonPackages []PythonPackagesState `json:"python_packages"`
}

type MavenArtifactsState struct {
...
type PythonPackagesState struct {
	Paths      []string `json:"paths"`
	Repository string   `json:"repository"`
}
