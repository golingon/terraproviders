...
func (ne NetworkEndpointsAttributes) AccessConfig() terra.ListValue[AccessConfigAttributes] {
	return terra.ReferenceAsList[AccessConfigAttributes](ne.ref.Append("access_config"))
}
...
func (ac AccessConfigAttributes) ExternalIp() terra.StringValue {
