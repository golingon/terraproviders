...
import (
	...
	datapubsubsubscription "github.com/golingon/terraproviders/googlebeta/5.24.0/datapubsubsubscription"
)
...
func (ps dataPubsubSubscriptionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ps.ref.Append("effective_labels"))
}
...
func (ps dataPubsubSubscriptionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ps.ref.Append("terraform_labels"))
}
