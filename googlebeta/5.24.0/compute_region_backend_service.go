...
import (
	...
	computeregionbackendservice "github.com/golingon/terraproviders/googlebeta/5.24.0/computeregionbackendservice"
	"io"
)
...
func (crbs computeRegionBackendServiceAttributes) GeneratedId() terra.NumberValue {
	return terra.ReferenceAsNumber(crbs.ref.Append("generated_id"))
}
...
func (crbs computeRegionBackendServiceAttributes) SecurityPolicy() terra.StringValue {
	return terra.ReferenceAsString(crbs.ref.Append("security_policy"))
}
