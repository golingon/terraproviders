...
import (
	...
	firestoreindex "github.com/golingon/terraproviders/googlebeta/5.24.0/firestoreindex"
	"io"
)
...
func (fi firestoreIndexAttributes) ApiScope() terra.StringValue {
	return terra.ReferenceAsString(fi.ref.Append("api_scope"))
}
