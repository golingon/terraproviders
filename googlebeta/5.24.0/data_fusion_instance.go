...
import (
	...
	datafusioninstance "github.com/golingon/terraproviders/googlebeta/5.24.0/datafusioninstance"
	"io"
)
...
func (dfi dataFusionInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dfi.ref.Append("effective_labels"))
}
...
func (dfi dataFusionInstanceAttributes) ServiceAccount() terra.StringValue {
	return terra.ReferenceAsString(dfi.ref.Append("service_account"))
}
...
func (dfi dataFusionInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dfi.ref.Append("terraform_labels"))
}
