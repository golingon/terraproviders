...
import (
	...
	computeexternalvpngateway "github.com/golingon/terraproviders/googlebeta/5.24.0/computeexternalvpngateway"
	"io"
)
...
func (cevg computeExternalVpnGatewayAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cevg.ref.Append("effective_labels"))
}
...
func (cevg computeExternalVpnGatewayAttributes) LabelFingerprint() terra.StringValue {
	return terra.ReferenceAsString(cevg.ref.Append("label_fingerprint"))
}
...
func (cevg computeExternalVpnGatewayAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cevg.ref.Append("terraform_labels"))
}
