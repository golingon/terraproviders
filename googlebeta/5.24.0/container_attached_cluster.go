...
import (
	...
	containerattachedcluster "github.com/golingon/terraproviders/googlebeta/5.24.0/containerattachedcluster"
	"io"
)
...
type ContainerAttachedClusterArgs struct {
	...
	BinaryAuthorization *containerattachedcluster.BinaryAuthorization `hcl:"binary_authorization,block"`
	// Fleet: required
	...
	ProxyConfig *containerattachedcluster.ProxyConfig `hcl:"proxy_config,block"`
	// Timeouts: optional
...
func (cac containerAttachedClusterAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cac.ref.Append("effective_annotations"))
}
...
func (cac containerAttachedClusterAttributes) BinaryAuthorization() terra.ListValue[containerattachedcluster.BinaryAuthorizationAttributes] {
	return terra.ReferenceAsList[containerattachedcluster.BinaryAuthorizationAttributes](cac.ref.Append("binary_authorization"))
}
...
func (cac containerAttachedClusterAttributes) ProxyConfig() terra.ListValue[containerattachedcluster.ProxyConfigAttributes] {
	return terra.ReferenceAsList[containerattachedcluster.ProxyConfigAttributes](cac.ref.Append("proxy_config"))
}
...
type containerAttachedClusterState struct {
	...
	BinaryAuthorization    []containerattachedcluster.BinaryAuthorizationState    `json:"binary_authorization"`
	...
	ProxyConfig            []containerattachedcluster.ProxyConfigState            `json:"proxy_config"`
