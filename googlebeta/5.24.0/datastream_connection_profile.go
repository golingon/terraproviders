...
import (
	...
	datastreamconnectionprofile "github.com/golingon/terraproviders/googlebeta/5.24.0/datastreamconnectionprofile"
	"io"
)
...
func (dcp datastreamConnectionProfileAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dcp.ref.Append("effective_labels"))
}
...
func (dcp datastreamConnectionProfileAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dcp.ref.Append("terraform_labels"))
}
