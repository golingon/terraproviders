...
import (
	...
	accesscontextmanageraccesslevelcondition "github.com/golingon/terraproviders/googlebeta/5.24.0/accesscontextmanageraccesslevelcondition"
	"io"
)
...
type AccessContextManagerAccessLevelConditionArgs struct {
	...
	VpcNetworkSources []accesscontextmanageraccesslevelcondition.VpcNetworkSources `hcl:"vpc_network_sources,block" validate:"min=0"`
}
...
func (acmalc accessContextManagerAccessLevelConditionAttributes) VpcNetworkSources() terra.ListValue[accesscontextmanageraccesslevelcondition.VpcNetworkSourcesAttributes] {
	return terra.ReferenceAsList[accesscontextmanageraccesslevelcondition.VpcNetworkSourcesAttributes](acmalc.ref.Append("vpc_network_sources"))
}
...
type accessContextManagerAccessLevelConditionState struct {
	...
	VpcNetworkSources    []accesscontextmanageraccesslevelcondition.VpcNetworkSourcesState `json:"vpc_network_sources"`
}
