...
import (
	...
	beyondcorpappgateway "github.com/golingon/terraproviders/googlebeta/5.24.0/beyondcorpappgateway"
	"io"
)
...
func (bag beyondcorpAppGatewayAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (bag beyondcorpAppGatewayAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
