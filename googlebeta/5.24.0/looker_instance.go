...
import (
	...
	lookerinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/lookerinstance"
	"io"
)
...
type LookerInstanceArgs struct {
	...
	CustomDomain *lookerinstance.CustomDomain `hcl:"custom_domain,block"`
...
func (li lookerInstanceAttributes) CustomDomain() terra.ListValue[lookerinstance.CustomDomainAttributes] {
	return terra.ReferenceAsList[lookerinstance.CustomDomainAttributes](li.ref.Append("custom_domain"))
}
...
type lookerInstanceState struct {
	...
	CustomDomain          []lookerinstance.CustomDomainState          `json:"custom_domain"`
