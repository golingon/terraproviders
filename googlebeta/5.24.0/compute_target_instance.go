...
import (
	...
	computetargetinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/computetargetinstance"
	"io"
)
...
func (cti computeTargetInstanceAttributes) SecurityPolicy() terra.StringValue {
	return terra.ReferenceAsString(cti.ref.Append("security_policy"))
}
