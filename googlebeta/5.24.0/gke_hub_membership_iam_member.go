...
import (
	...
	gkehubmembershipiammember "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubmembershipiammember"
	"io"
)
...
func (ghmim gkeHubMembershipIamMemberAttributes) Location() terra.StringValue {
	return terra.ReferenceAsString(ghmim.ref.Append("location"))
}
