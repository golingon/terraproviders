...
import (
	...
	beyondcorpappconnector "github.com/golingon/terraproviders/googlebeta/5.24.0/beyondcorpappconnector"
	"io"
)
...
func (bac beyondcorpAppConnectorAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (bac beyondcorpAppConnectorAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
