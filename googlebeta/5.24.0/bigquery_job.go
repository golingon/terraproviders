...
import (
	...
	bigqueryjob "github.com/golingon/terraproviders/googlebeta/5.24.0/bigqueryjob"
	"io"
)
...
func (bj bigqueryJobAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bj.ref.Append("effective_labels"))
}
...
func (bj bigqueryJobAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bj.ref.Append("terraform_labels"))
}
