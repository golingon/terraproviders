...
import (
	...
	vertexaifeaturestoreentitytypefeature "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaifeaturestoreentitytypefeature"
	"io"
)
...
func (vafef vertexAiFeaturestoreEntitytypeFeatureAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vafef.ref.Append("effective_labels"))
}
...
func (vafef vertexAiFeaturestoreEntitytypeFeatureAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vafef.ref.Append("terraform_labels"))
}
