...
import (
	...
	vertexaifeaturestoreentitytype "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaifeaturestoreentitytype"
	"io"
)
...
func (vafe vertexAiFeaturestoreEntitytypeAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vafe.ref.Append("effective_labels"))
}
...
func (vafe vertexAiFeaturestoreEntitytypeAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vafe.ref.Append("terraform_labels"))
}
