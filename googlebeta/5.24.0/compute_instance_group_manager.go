...
import (
	...
	computeinstancegroupmanager "github.com/golingon/terraproviders/googlebeta/5.24.0/computeinstancegroupmanager"
	"io"
)
...
func (cigm computeInstanceGroupManagerAttributes) CreationTimestamp() terra.StringValue {
