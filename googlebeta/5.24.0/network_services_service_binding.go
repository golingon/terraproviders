...
import (
	...
	networkservicesservicebinding "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicesservicebinding"
	"io"
)
...
func (nssb networkServicesServiceBindingAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nssb.ref.Append("effective_labels"))
}
...
func (nssb networkServicesServiceBindingAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nssb.ref.Append("terraform_labels"))
}
