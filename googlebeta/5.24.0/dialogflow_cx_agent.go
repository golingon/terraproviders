...
import (
	...
	dialogflowcxagent "github.com/golingon/terraproviders/googlebeta/5.24.0/dialogflowcxagent"
	"io"
)
...
type DialogflowCxAgentArgs struct {
	...
	AdvancedSettings *dialogflowcxagent.AdvancedSettings `hcl:"advanced_settings,block"`
	// GitIntegrationSettings: optional
	GitIntegrationSettings *dialogflowcxagent.GitIntegrationSettings `hcl:"git_integration_settings,block"`
	...
	TextToSpeechSettings *dialogflowcxagent.TextToSpeechSettings `hcl:"text_to_speech_settings,block"`
	// Timeouts: optional
...
func (dca dialogflowCxAgentAttributes) AdvancedSettings() terra.ListValue[dialogflowcxagent.AdvancedSettingsAttributes] {
	return terra.ReferenceAsList[dialogflowcxagent.AdvancedSettingsAttributes](dca.ref.Append("advanced_settings"))
}

func (dca dialogflowCxAgentAttributes) GitIntegrationSettings() terra.ListValue[dialogflowcxagent.GitIntegrationSettingsAttributes] {
	return terra.ReferenceAsList[dialogflowcxagent.GitIntegrationSettingsAttributes](dca.ref.Append("git_integration_settings"))
}
...
func (dca dialogflowCxAgentAttributes) TextToSpeechSettings() terra.ListValue[dialogflowcxagent.TextToSpeechSettingsAttributes] {
	return terra.ReferenceAsList[dialogflowcxagent.TextToSpeechSettingsAttributes](dca.ref.Append("text_to_speech_settings"))
}
...
type dialogflowCxAgentState struct {
	...
	AdvancedSettings         []dialogflowcxagent.AdvancedSettingsState       `json:"advanced_settings"`
	GitIntegrationSettings   []dialogflowcxagent.GitIntegrationSettingsState `json:"git_integration_settings"`
	SpeechToTextSettings     []dialogflowcxagent.SpeechToTextSettingsState   `json:"speech_to_text_settings"`
	TextToSpeechSettings     []dialogflowcxagent.TextToSpeechSettingsState   `json:"text_to_speech_settings"`
