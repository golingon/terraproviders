...
import (
	...
	networkservicesedgecacheorigin "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicesedgecacheorigin"
	"io"
)
...
func (nseco networkServicesEdgeCacheOriginAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nseco.ref.Append("effective_labels"))
}
...
func (nseco networkServicesEdgeCacheOriginAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nseco.ref.Append("terraform_labels"))
}
