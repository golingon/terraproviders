...
import (
	...
	notebooksinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/notebooksinstance"
	"io"
)
...
func (ni notebooksInstanceAttributes) DesiredState() terra.StringValue {
	return terra.ReferenceAsString(ni.ref.Append("desired_state"))
}
...
func (ni notebooksInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ni.ref.Append("effective_labels"))
}
...
func (ni notebooksInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ni.ref.Append("terraform_labels"))
}
