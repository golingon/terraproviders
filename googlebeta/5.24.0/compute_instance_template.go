...
import (
	...
	computeinstancetemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/computeinstancetemplate"
	"io"
)
...
func (cit computeInstanceTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cit computeInstanceTemplateAttributes) ResourceManagerTags() terra.MapValue[terra.StringValue] {
...
func (cit computeInstanceTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
