...
import (
	...
	vertexaiindex "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaiindex"
	"io"
)
...
func (vai vertexAiIndexAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (vai vertexAiIndexAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
