...
import (
	...
	computeglobalforwardingrule "github.com/golingon/terraproviders/googlebeta/5.24.0/computeglobalforwardingrule"
	"io"
)
...
type ComputeGlobalForwardingRuleArgs struct {
	...
	ServiceDirectoryRegistrations *computeglobalforwardingrule.ServiceDirectoryRegistrations `hcl:"service_directory_registrations,block"`
	// Timeouts: optional
...
func (cgfr computeGlobalForwardingRuleAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cgfr computeGlobalForwardingRuleAttributes) Subnetwork() terra.StringValue {
...
func (cgfr computeGlobalForwardingRuleAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (cgfr computeGlobalForwardingRuleAttributes) ServiceDirectoryRegistrations() terra.ListValue[computeglobalforwardingrule.ServiceDirectoryRegistrationsAttributes] {
	return terra.ReferenceAsList[computeglobalforwardingrule.ServiceDirectoryRegistrationsAttributes](cgfr.ref.Append("service_directory_registrations"))
}
...
type computeGlobalForwardingRuleState struct {
	...
	ServiceDirectoryRegistrations []computeglobalforwardingrule.ServiceDirectoryRegistrationsState `json:"service_directory_registrations"`
