...
import (
	...
	apigatewayapiconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/apigatewayapiconfig"
	"io"
)
...
func (agac apiGatewayApiConfigAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](agac.ref.Append("effective_labels"))
}
...
func (agac apiGatewayApiConfigAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](agac.ref.Append("terraform_labels"))
}
