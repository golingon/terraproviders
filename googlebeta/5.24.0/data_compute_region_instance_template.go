...
import (
	...
	datacomputeregioninstancetemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputeregioninstancetemplate"
)
...
func (crit dataComputeRegionInstanceTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (crit dataComputeRegionInstanceTemplateAttributes) ResourceManagerTags() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](crit.ref.Append("resource_manager_tags"))
}
...
func (crit dataComputeRegionInstanceTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
