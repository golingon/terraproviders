...
import (
	...
	datacomposerenvironment "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomposerenvironment"
)
...
type DataComposerEnvironmentArgs struct {
	...
	// StorageConfig: min=0
	StorageConfig []datacomposerenvironment.StorageConfig `hcl:"storage_config,block" validate:"min=0"`
}
...
func (ce dataComposerEnvironmentAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (ce dataComposerEnvironmentAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (ce dataComposerEnvironmentAttributes) StorageConfig() terra.ListValue[datacomposerenvironment.StorageConfigAttributes] {
	return terra.ReferenceAsList[datacomposerenvironment.StorageConfigAttributes](ce.ref.Append("storage_config"))
}
