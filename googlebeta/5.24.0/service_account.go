...
import (
	...
	serviceaccount "github.com/golingon/terraproviders/googlebeta/5.24.0/serviceaccount"
	"io"
)
...
func (sa serviceAccountAttributes) CreateIgnoreAlreadyExists() terra.BoolValue {
	return terra.ReferenceAsBool(sa.ref.Append("create_ignore_already_exists"))
}
