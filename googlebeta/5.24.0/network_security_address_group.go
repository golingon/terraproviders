...
import (
	...
	networksecurityaddressgroup "github.com/golingon/terraproviders/googlebeta/5.24.0/networksecurityaddressgroup"
	"io"
)
...
func (nsag networkSecurityAddressGroupAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsag.ref.Append("effective_labels"))
}
...
func (nsag networkSecurityAddressGroupAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsag.ref.Append("terraform_labels"))
}
