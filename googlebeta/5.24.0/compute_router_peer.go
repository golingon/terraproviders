...
import (
	...
	computerouterpeer "github.com/golingon/terraproviders/googlebeta/5.24.0/computerouterpeer"
	"io"
)
...
type ComputeRouterPeerArgs struct {
	...
	Md5AuthenticationKey *computerouterpeer.Md5AuthenticationKey `hcl:"md5_authentication_key,block"`
	// Timeouts: optional
...
func (crp computeRouterPeerAttributes) Md5AuthenticationKey() terra.ListValue[computerouterpeer.Md5AuthenticationKeyAttributes] {
	return terra.ReferenceAsList[computerouterpeer.Md5AuthenticationKeyAttributes](crp.ref.Append("md5_authentication_key"))
}
...
type computeRouterPeerState struct {
	...
	Md5AuthenticationKey    []computerouterpeer.Md5AuthenticationKeyState `json:"md5_authentication_key"`
