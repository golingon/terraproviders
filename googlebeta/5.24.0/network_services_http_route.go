...
import (
	...
	networkserviceshttproute "github.com/golingon/terraproviders/googlebeta/5.24.0/networkserviceshttproute"
	"io"
)
...
func (nshr networkServicesHttpRouteAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nshr.ref.Append("effective_labels"))
}
...
func (nshr networkServicesHttpRouteAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nshr.ref.Append("terraform_labels"))
}
