...
import (
	...
	loggingfolderbucketconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/loggingfolderbucketconfig"
	"io"
)
...
type LoggingFolderBucketConfigArgs struct {
	...
	IndexConfigs []loggingfolderbucketconfig.IndexConfigs `hcl:"index_configs,block" validate:"min=0,max=20"`
}
...
func (lfbc loggingFolderBucketConfigAttributes) IndexConfigs() terra.SetValue[loggingfolderbucketconfig.IndexConfigsAttributes] {
	return terra.ReferenceAsSet[loggingfolderbucketconfig.IndexConfigsAttributes](lfbc.ref.Append("index_configs"))
}
...
type loggingFolderBucketConfigState struct {
	...
	IndexConfigs   []loggingfolderbucketconfig.IndexConfigsState `json:"index_configs"`
}
