...
import (
	...
	dataprivatecacertificateauthority "github.com/golingon/terraproviders/googlebeta/5.24.0/dataprivatecacertificateauthority"
)
...
func (pca dataPrivatecaCertificateAuthorityAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (pca dataPrivatecaCertificateAuthorityAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
