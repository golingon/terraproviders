...
import (
	...
	cloudbuildv2connection "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudbuildv2connection"
	"io"
)
...
func (cc cloudbuildv2ConnectionAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cc.ref.Append("effective_annotations"))
}
