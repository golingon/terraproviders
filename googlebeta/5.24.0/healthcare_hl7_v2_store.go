...
import (
	...
	healthcarehl7v2store "github.com/golingon/terraproviders/googlebeta/5.24.0/healthcarehl7v2store"
	"io"
)
...
func (hhvs healthcareHl7V2StoreAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hhvs.ref.Append("effective_labels"))
}
...
func (hhvs healthcareHl7V2StoreAttributes) RejectDuplicateMessage() terra.BoolValue {
	return terra.ReferenceAsBool(hhvs.ref.Append("reject_duplicate_message"))
}
...
func (hhvs healthcareHl7V2StoreAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hhvs.ref.Append("terraform_labels"))
}
