...
import (
	...
	beyondcorpappconnection "github.com/golingon/terraproviders/googlebeta/5.24.0/beyondcorpappconnection"
	"io"
)
...
func (bac beyondcorpAppConnectionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (bac beyondcorpAppConnectionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
