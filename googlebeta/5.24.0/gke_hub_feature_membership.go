...
import (
	...
	gkehubfeaturemembership "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubfeaturemembership"
	"io"
)
...
type GkeHubFeatureMembershipArgs struct {
	...
	Policycontroller *gkehubfeaturemembership.Policycontroller `hcl:"policycontroller,block"`
	// Timeouts: optional
...
func (ghfm gkeHubFeatureMembershipAttributes) MembershipLocation() terra.StringValue {
	return terra.ReferenceAsString(ghfm.ref.Append("membership_location"))
}
...
func (ghfm gkeHubFeatureMembershipAttributes) Policycontroller() terra.ListValue[gkehubfeaturemembership.PolicycontrollerAttributes] {
	return terra.ReferenceAsList[gkehubfeaturemembership.PolicycontrollerAttributes](ghfm.ref.Append("policycontroller"))
}
...
type gkeHubFeatureMembershipState struct {
	...
	Policycontroller   []gkehubfeaturemembership.PolicycontrollerState `json:"policycontroller"`
