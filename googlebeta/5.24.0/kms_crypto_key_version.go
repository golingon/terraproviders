...
import (
	...
	kmscryptokeyversion "github.com/golingon/terraproviders/googlebeta/5.24.0/kmscryptokeyversion"
	"io"
)
...
type KmsCryptoKeyVersionArgs struct {
	...
	ExternalProtectionLevelOptions *kmscryptokeyversion.ExternalProtectionLevelOptions `hcl:"external_protection_level_options,block"`
	// Timeouts: optional
...
func (kckv kmsCryptoKeyVersionAttributes) ExternalProtectionLevelOptions() terra.ListValue[kmscryptokeyversion.ExternalProtectionLevelOptionsAttributes] {
	return terra.ReferenceAsList[kmscryptokeyversion.ExternalProtectionLevelOptionsAttributes](kckv.ref.Append("external_protection_level_options"))
}
...
type kmsCryptoKeyVersionState struct {
	...
	ExternalProtectionLevelOptions []kmscryptokeyversion.ExternalProtectionLevelOptionsState `json:"external_protection_level_options"`
