...
import (
	...
	dialogflowcxintent "github.com/golingon/terraproviders/googlebeta/5.24.0/dialogflowcxintent"
	"io"
)
...
func (dci dialogflowCxIntentAttributes) IsDefaultNegativeIntent() terra.BoolValue {
	return terra.ReferenceAsBool(dci.ref.Append("is_default_negative_intent"))
}

// IsDefaultWelcomeIntent returns a reference to field is_default_welcome_intent of google_dialogflow_cx_intent.
func (dci dialogflowCxIntentAttributes) IsDefaultWelcomeIntent() terra.BoolValue {
	return terra.ReferenceAsBool(dci.ref.Append("is_default_welcome_intent"))
}
