...
import (
	...
	computeregiontargethttpsproxy "github.com/golingon/terraproviders/googlebeta/5.24.0/computeregiontargethttpsproxy"
	"io"
)
...
func (crthp computeRegionTargetHttpsProxyAttributes) CertificateManagerCertificates() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](crthp.ref.Append("certificate_manager_certificates"))
}
