...
import (
	...
	servicedirectorynamespace "github.com/golingon/terraproviders/googlebeta/5.24.0/servicedirectorynamespace"
	"io"
)
...
func (sdn serviceDirectoryNamespaceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](sdn.ref.Append("effective_labels"))
}
...
func (sdn serviceDirectoryNamespaceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](sdn.ref.Append("terraform_labels"))
}
