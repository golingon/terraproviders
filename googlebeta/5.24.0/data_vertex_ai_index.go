...
import (
	...
	datavertexaiindex "github.com/golingon/terraproviders/googlebeta/5.24.0/datavertexaiindex"
)
...
func (vai dataVertexAiIndexAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vai.ref.Append("effective_labels"))
}
...
func (vai dataVertexAiIndexAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vai.ref.Append("terraform_labels"))
}
