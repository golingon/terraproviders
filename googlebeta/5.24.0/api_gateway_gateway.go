...
import (
	...
	apigatewaygateway "github.com/golingon/terraproviders/googlebeta/5.24.0/apigatewaygateway"
	"io"
)
...
func (agg apiGatewayGatewayAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](agg.ref.Append("effective_labels"))
}
...
func (agg apiGatewayGatewayAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](agg.ref.Append("terraform_labels"))
}
