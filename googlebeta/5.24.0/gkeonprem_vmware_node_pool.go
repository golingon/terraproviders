...
import (
	...
	gkeonpremvmwarenodepool "github.com/golingon/terraproviders/googlebeta/5.24.0/gkeonpremvmwarenodepool"
	"io"
)
...
func (gvnp gkeonpremVmwareNodePoolAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](gvnp.ref.Append("effective_annotations"))
}
