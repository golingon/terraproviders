...
import (
	...
	certificatemanagertrustconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/certificatemanagertrustconfig"
	"io"
)
...
func (cmtc certificateManagerTrustConfigAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmtc.ref.Append("effective_labels"))
}
...
func (cmtc certificateManagerTrustConfigAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmtc.ref.Append("terraform_labels"))
}
