...
import (
	...
	datastreamstream "github.com/golingon/terraproviders/googlebeta/5.24.0/datastreamstream"
	"io"
)
...
func (ds datastreamStreamAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ds.ref.Append("effective_labels"))
}
...
func (ds datastreamStreamAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ds.ref.Append("terraform_labels"))
}
