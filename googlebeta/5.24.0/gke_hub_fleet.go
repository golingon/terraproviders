...
import (
	...
	gkehubfleet "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubfleet"
	"io"
)
...
type GkeHubFleetArgs struct {
	...
	DefaultClusterConfig *gkehubfleet.DefaultClusterConfig `hcl:"default_cluster_config,block"`
	// Timeouts: optional
...
func (ghf gkeHubFleetAttributes) DefaultClusterConfig() terra.ListValue[gkehubfleet.DefaultClusterConfigAttributes] {
	return terra.ReferenceAsList[gkehubfleet.DefaultClusterConfigAttributes](ghf.ref.Append("default_cluster_config"))
}
...
type gkeHubFleetState struct {
	...
	DefaultClusterConfig []gkehubfleet.DefaultClusterConfigState `json:"default_cluster_config"`
