...
import (
	...
	cloudfunctionsfunction "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudfunctionsfunction"
	"io"
)
...
func (cf cloudfunctionsFunctionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cf cloudfunctionsFunctionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (cf cloudfunctionsFunctionAttributes) VersionId() terra.StringValue {
