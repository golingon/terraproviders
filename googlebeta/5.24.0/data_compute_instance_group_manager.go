...
import (
	...
	datacomputeinstancegroupmanager "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputeinstancegroupmanager"
)
...
type DataComputeInstanceGroupManagerArgs struct {
	...
	// AllInstancesConfig: min=0
	AllInstancesConfig []datacomputeinstancegroupmanager.AllInstancesConfig `hcl:"all_instances_config,block" validate:"min=0"`
	...
	// InstanceLifecyclePolicy: min=0
	InstanceLifecyclePolicy []datacomputeinstancegroupmanager.InstanceLifecyclePolicy `hcl:"instance_lifecycle_policy,block" validate:"min=0"`
	// NamedPort: min=0
	...
	StatefulExternalIp []datacomputeinstancegroupmanager.StatefulExternalIp `hcl:"stateful_external_ip,block" validate:"min=0"`
	// StatefulInternalIp: min=0
	StatefulInternalIp []datacomputeinstancegroupmanager.StatefulInternalIp `hcl:"stateful_internal_ip,block" validate:"min=0"`
	// Status: min=0
...
func (cigm dataComputeInstanceGroupManagerAttributes) CreationTimestamp() terra.StringValue {
	return terra.ReferenceAsString(cigm.ref.Append("creation_timestamp"))
}
...
func (cigm dataComputeInstanceGroupManagerAttributes) AllInstancesConfig() terra.ListValue[datacomputeinstancegroupmanager.AllInstancesConfigAttributes] {
	return terra.ReferenceAsList[datacomputeinstancegroupmanager.AllInstancesConfigAttributes](cigm.ref.Append("all_instances_config"))
}
...
func (cigm dataComputeInstanceGroupManagerAttributes) InstanceLifecyclePolicy() terra.ListValue[datacomputeinstancegroupmanager.InstanceLifecyclePolicyAttributes] {
	return terra.ReferenceAsList[datacomputeinstancegroupmanager.InstanceLifecyclePolicyAttributes](cigm.ref.Append("instance_lifecycle_policy"))
}
...
func (cigm dataComputeInstanceGroupManagerAttributes) StatefulExternalIp() terra.ListValue[datacomputeinstancegroupmanager.StatefulExternalIpAttributes] {
	return terra.ReferenceAsList[datacomputeinstancegroupmanager.StatefulExternalIpAttributes](cigm.ref.Append("stateful_external_ip"))
}

func (cigm dataComputeInstanceGroupManagerAttributes) StatefulInternalIp() terra.ListValue[datacomputeinstancegroupmanager.StatefulInternalIpAttributes] {
	return terra.ReferenceAsList[datacomputeinstancegroupmanager.StatefulInternalIpAttributes](cigm.ref.Append("stateful_internal_ip"))
}
