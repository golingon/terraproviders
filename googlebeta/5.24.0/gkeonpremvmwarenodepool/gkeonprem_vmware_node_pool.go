...
type Config struct {
	...
	// VsphereConfig: optional
	VsphereConfig *VsphereConfig `hcl:"vsphere_config,block"`
}
...
func (vc VsphereConfigAttributes) HostGroups() terra.ListValue[terra.StringValue] {
