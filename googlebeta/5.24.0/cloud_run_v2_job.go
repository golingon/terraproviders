...
import (
	...
	cloudrunv2job "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudrunv2job"
	"io"
)
...
func (crvj cloudRunV2JobAttributes) CreateTime() terra.StringValue {
...
func (crvj cloudRunV2JobAttributes) Creator() terra.StringValue {
...
func (crvj cloudRunV2JobAttributes) DeleteTime() terra.StringValue {
...
func (crvj cloudRunV2JobAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (crvj cloudRunV2JobAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (crvj cloudRunV2JobAttributes) ExpireTime() terra.StringValue {
...
func (crvj cloudRunV2JobAttributes) LastModifier() terra.StringValue {
...
func (crvj cloudRunV2JobAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (crvj cloudRunV2JobAttributes) UpdateTime() terra.StringValue {
