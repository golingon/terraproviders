...
import (
	...
	datacomputedisk "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputedisk"
)
...
func (cd dataComputeDiskAttributes) DiskId() terra.StringValue {
...
func (cd dataComputeDiskAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cd dataComputeDiskAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
