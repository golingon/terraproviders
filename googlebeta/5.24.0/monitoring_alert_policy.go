...
import (
	...
	monitoringalertpolicy "github.com/golingon/terraproviders/googlebeta/5.24.0/monitoringalertpolicy"
	"io"
)
...
func (_map monitoringAlertPolicyAttributes) Severity() terra.StringValue {
	return terra.ReferenceAsString(_map.ref.Append("severity"))
}
