...
import (
	...
	computevpntunnel "github.com/golingon/terraproviders/googlebeta/5.24.0/computevpntunnel"
	"io"
)
...
func (cvt computeVpnTunnelAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cvt.ref.Append("effective_labels"))
}
...
func (cvt computeVpnTunnelAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cvt.ref.Append("terraform_labels"))
}
