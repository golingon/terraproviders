...
import (
	...
	gkehubmembership "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubmembership"
	"io"
)
...
func (ghm gkeHubMembershipAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ghm.ref.Append("effective_labels"))
}
...
func (ghm gkeHubMembershipAttributes) Location() terra.StringValue {
	return terra.ReferenceAsString(ghm.ref.Append("location"))
}
...
func (ghm gkeHubMembershipAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ghm.ref.Append("terraform_labels"))
}
