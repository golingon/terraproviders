...
import (
	...
	alloydbcluster "github.com/golingon/terraproviders/googlebeta/5.24.0/alloydbcluster"
	"io"
)
...
type AlloydbClusterArgs struct {
	...
	NetworkConfig *alloydbcluster.NetworkConfig `hcl:"network_config,block"`
	...
	SecondaryConfig *alloydbcluster.SecondaryConfig `hcl:"secondary_config,block"`
	// Timeouts: optional
...
func (ac alloydbClusterAttributes) Annotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ac.ref.Append("annotations"))
}
...
func (ac alloydbClusterAttributes) ClusterType() terra.StringValue {
...
func (ac alloydbClusterAttributes) DeletionPolicy() terra.StringValue {
	return terra.ReferenceAsString(ac.ref.Append("deletion_policy"))
}
...
func (ac alloydbClusterAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ac.ref.Append("effective_annotations"))
}

// EffectiveLabels returns a reference to field effective_labels of google_alloydb_cluster.
func (ac alloydbClusterAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ac.ref.Append("effective_labels"))
}

// Etag returns a reference to field etag of google_alloydb_cluster.
func (ac alloydbClusterAttributes) Etag() terra.StringValue {
	return terra.ReferenceAsString(ac.ref.Append("etag"))
}
...
func (ac alloydbClusterAttributes) Reconciling() terra.BoolValue {
	return terra.ReferenceAsBool(ac.ref.Append("reconciling"))
}

// State returns a reference to field state of google_alloydb_cluster.
func (ac alloydbClusterAttributes) State() terra.StringValue {
...
func (ac alloydbClusterAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ac.ref.Append("terraform_labels"))
}
...
func (ac alloydbClusterAttributes) NetworkConfig() terra.ListValue[alloydbcluster.NetworkConfigAttributes] {
	return terra.ReferenceAsList[alloydbcluster.NetworkConfigAttributes](ac.ref.Append("network_config"))
}
...
func (ac alloydbClusterAttributes) SecondaryConfig() terra.ListValue[alloydbcluster.SecondaryConfigAttributes] {
	return terra.ReferenceAsList[alloydbcluster.SecondaryConfigAttributes](ac.ref.Append("secondary_config"))
}
...
type alloydbClusterState struct {
	...
	NetworkConfig                 []alloydbcluster.NetworkConfigState                 `json:"network_config"`
	...
	SecondaryConfig               []alloydbcluster.SecondaryConfigState               `json:"secondary_config"`
