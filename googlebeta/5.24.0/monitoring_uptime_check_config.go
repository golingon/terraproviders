...
import (
	...
	monitoringuptimecheckconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/monitoringuptimecheckconfig"
	"io"
)
...
func (mucc monitoringUptimeCheckConfigAttributes) UserLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](mucc.ref.Append("user_labels"))
}
