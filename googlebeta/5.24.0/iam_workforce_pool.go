...
import (
	...
	iamworkforcepool "github.com/golingon/terraproviders/googlebeta/5.24.0/iamworkforcepool"
	"io"
)
...
type IamWorkforcePoolArgs struct {
	...
	AccessRestrictions *iamworkforcepool.AccessRestrictions `hcl:"access_restrictions,block"`
	// Timeouts: optional
...
func (iwp iamWorkforcePoolAttributes) AccessRestrictions() terra.ListValue[iamworkforcepool.AccessRestrictionsAttributes] {
	return terra.ReferenceAsList[iamworkforcepool.AccessRestrictionsAttributes](iwp.ref.Append("access_restrictions"))
}
...
type iamWorkforcePoolState struct {
	...
	AccessRestrictions []iamworkforcepool.AccessRestrictionsState `json:"access_restrictions"`
