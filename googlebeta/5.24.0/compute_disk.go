...
import (
	...
	computedisk "github.com/golingon/terraproviders/googlebeta/5.24.0/computedisk"
	"io"
)
...
func (cd computeDiskAttributes) DiskId() terra.StringValue {
	return terra.ReferenceAsString(cd.ref.Append("disk_id"))
}

// EffectiveLabels returns a reference to field effective_labels of google_compute_disk.
func (cd computeDiskAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cd.ref.Append("effective_labels"))
}

// EnableConfidentialCompute returns a reference to field enable_confidential_compute of google_compute_disk.
func (cd computeDiskAttributes) EnableConfidentialCompute() terra.BoolValue {
...
func (cd computeDiskAttributes) Interface() terra.StringValue {
...
func (cd computeDiskAttributes) MultiWriter() terra.BoolValue {
...
func (cd computeDiskAttributes) ResourcePolicies() terra.ListValue[terra.StringValue] {
...
func (cd computeDiskAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cd.ref.Append("terraform_labels"))
}
