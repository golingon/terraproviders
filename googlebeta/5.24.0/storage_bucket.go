...
import (
	...
	storagebucket "github.com/golingon/terraproviders/googlebeta/5.24.0/storagebucket"
	"io"
)
...
type StorageBucketArgs struct {
	...
	SoftDeletePolicy *storagebucket.SoftDeletePolicy `hcl:"soft_delete_policy,block"`
	// Timeouts: optional
...
func (sb storageBucketAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (sb storageBucketAttributes) EnableObjectRetention() terra.BoolValue {
...
func (sb storageBucketAttributes) ProjectNumber() terra.NumberValue {
...
func (sb storageBucketAttributes) Rpo() terra.StringValue {
...
func (sb storageBucketAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (sb storageBucketAttributes) SoftDeletePolicy() terra.ListValue[storagebucket.SoftDeletePolicyAttributes] {
	return terra.ReferenceAsList[storagebucket.SoftDeletePolicyAttributes](sb.ref.Append("soft_delete_policy"))
}
...
type storageBucketState struct {
	...
	SoftDeletePolicy         []storagebucket.SoftDeletePolicyState      `json:"soft_delete_policy"`
