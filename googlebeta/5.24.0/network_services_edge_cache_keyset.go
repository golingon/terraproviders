...
import (
	...
	networkservicesedgecachekeyset "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicesedgecachekeyset"
	"io"
)
...
func (nseck networkServicesEdgeCacheKeysetAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nseck.ref.Append("effective_labels"))
}
...
func (nseck networkServicesEdgeCacheKeysetAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nseck.ref.Append("terraform_labels"))
}
