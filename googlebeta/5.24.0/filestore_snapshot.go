...
import (
	...
	filestoresnapshot "github.com/golingon/terraproviders/googlebeta/5.24.0/filestoresnapshot"
	"io"
)
...
func (fs filestoreSnapshotAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](fs.ref.Append("effective_labels"))
}
...
func (fs filestoreSnapshotAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](fs.ref.Append("terraform_labels"))
}
