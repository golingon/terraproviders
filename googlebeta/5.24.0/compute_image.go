...
import (
	...
	computeimage "github.com/golingon/terraproviders/googlebeta/5.24.0/computeimage"
	"io"
)
...
func (ci computeImageAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (ci computeImageAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
