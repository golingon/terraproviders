...
import (
	...
	networkservicesmesh "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicesmesh"
	"io"
)
...
func (nsm networkServicesMeshAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsm.ref.Append("effective_labels"))
}
...
func (nsm networkServicesMeshAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsm.ref.Append("terraform_labels"))
}
