...
import (
	...
	iamworkloadidentitypoolprovider "github.com/golingon/terraproviders/googlebeta/5.24.0/iamworkloadidentitypoolprovider"
	"io"
)
...
type IamWorkloadIdentityPoolProviderArgs struct {
	...
	// Saml: optional
	Saml *iamworkloadidentitypoolprovider.Saml `hcl:"saml,block"`
	// Timeouts: optional
...
func (iwipp iamWorkloadIdentityPoolProviderAttributes) Saml() terra.ListValue[iamworkloadidentitypoolprovider.SamlAttributes] {
	return terra.ReferenceAsList[iamworkloadidentitypoolprovider.SamlAttributes](iwipp.ref.Append("saml"))
}
...
type iamWorkloadIdentityPoolProviderState struct {
	...
	Saml                           []iamworkloadidentitypoolprovider.SamlState    `json:"saml"`
