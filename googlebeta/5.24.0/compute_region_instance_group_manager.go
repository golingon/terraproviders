...
import (
	...
	computeregioninstancegroupmanager "github.com/golingon/terraproviders/googlebeta/5.24.0/computeregioninstancegroupmanager"
	"io"
)
...
func (crigm computeRegionInstanceGroupManagerAttributes) CreationTimestamp() terra.StringValue {
	return terra.ReferenceAsString(crigm.ref.Append("creation_timestamp"))
}
