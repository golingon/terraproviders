...
import (
	...
	datacomputesnapshot "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputesnapshot"
)
...
func (cs dataComputeSnapshotAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cs.ref.Append("effective_labels"))
}
...
func (cs dataComputeSnapshotAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cs.ref.Append("terraform_labels"))
}
