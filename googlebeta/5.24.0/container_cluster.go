...
import (
	...
	containercluster "github.com/golingon/terraproviders/googlebeta/5.24.0/containercluster"
	"io"
)
...
type ContainerClusterArgs struct {
	...
	// Fleet: optional
	Fleet *containercluster.Fleet `hcl:"fleet,block"`
	...
	WorkloadAltsConfig *containercluster.WorkloadAltsConfig `hcl:"workload_alts_config,block"`
...
func (cc containerClusterAttributes) DeletionProtection() terra.BoolValue {
...
func (cc containerClusterAttributes) EnableCiliumClusterwideNetworkPolicy() terra.BoolValue {
...
func (cc containerClusterAttributes) Fleet() terra.ListValue[containercluster.FleetAttributes] {
	return terra.ReferenceAsList[containercluster.FleetAttributes](cc.ref.Append("fleet"))
}
...
func (cc containerClusterAttributes) WorkloadAltsConfig() terra.ListValue[containercluster.WorkloadAltsConfigAttributes] {
	return terra.ReferenceAsList[containercluster.WorkloadAltsConfigAttributes](cc.ref.Append("workload_alts_config"))
}
...
type containerClusterState struct {
	...
	Fleet                                []containercluster.FleetState                          `json:"fleet"`
	...
	WorkloadAltsConfig                   []containercluster.WorkloadAltsConfigState             `json:"workload_alts_config"`
