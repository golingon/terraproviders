...
type Scheduling struct {
	...
	// MaxRunDuration: min=0
	MaxRunDuration []MaxRunDuration `hcl:"max_run_duration,block" validate:"min=0"`
...
func (ip InitializeParamsAttributes) EnableConfidentialCompute() terra.BoolValue {
...
func (ip InitializeParamsAttributes) ProvisionedIops() terra.NumberValue {
	return terra.ReferenceAsNumber(ip.ref.Append("provisioned_iops"))
}

func (ip InitializeParamsAttributes) ProvisionedThroughput() terra.NumberValue {
