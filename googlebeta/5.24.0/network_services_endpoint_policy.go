...
import (
	...
	networkservicesendpointpolicy "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicesendpointpolicy"
	"io"
)
...
func (nsep networkServicesEndpointPolicyAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsep.ref.Append("effective_labels"))
}
...
func (nsep networkServicesEndpointPolicyAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nsep.ref.Append("terraform_labels"))
}
