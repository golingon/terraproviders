...
type CleanupPolicies struct {
	...
	// MostRecentVersions: optional
	MostRecentVersions *MostRecentVersions `hcl:"most_recent_versions,block"`
}
...
type RemoteRepositoryConfig struct {
	...
	// UpstreamCredentials: optional
	UpstreamCredentials *UpstreamCredentials `hcl:"upstream_credentials,block"`
...
type UpstreamCredentials struct {
	// UsernamePasswordCredentials: optional
	UsernamePasswordCredentials *UsernamePasswordCredentials `hcl:"username_password_credentials,block"`
}
