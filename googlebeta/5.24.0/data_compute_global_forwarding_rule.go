...
import (
	...
	datacomputeglobalforwardingrule "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputeglobalforwardingrule"
)
...
type DataComputeGlobalForwardingRuleArgs struct {
	...
	ServiceDirectoryRegistrations []datacomputeglobalforwardingrule.ServiceDirectoryRegistrations `hcl:"service_directory_registrations,block" validate:"min=0"`
}
...
func (cgfr dataComputeGlobalForwardingRuleAttributes) AllowPscGlobalAccess() terra.BoolValue {
...
func (cgfr dataComputeGlobalForwardingRuleAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cgfr.ref.Append("effective_labels"))
}
...
func (cgfr dataComputeGlobalForwardingRuleAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cgfr.ref.Append("terraform_labels"))
}
...
func (cgfr dataComputeGlobalForwardingRuleAttributes) ServiceDirectoryRegistrations() terra.ListValue[datacomputeglobalforwardingrule.ServiceDirectoryRegistrationsAttributes] {
	return terra.ReferenceAsList[datacomputeglobalforwardingrule.ServiceDirectoryRegistrationsAttributes](cgfr.ref.Append("service_directory_registrations"))
}
