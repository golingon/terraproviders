...
import (
	...
	cloudidentitygroup "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudidentitygroup"
	"io"
)
...
type CloudIdentityGroupArgs struct {
	...
	AdditionalGroupKeys []cloudidentitygroup.AdditionalGroupKeys `hcl:"additional_group_keys,block" validate:"min=0"`
	// GroupKey: required
...
func (cig cloudIdentityGroupAttributes) AdditionalGroupKeys() terra.ListValue[cloudidentitygroup.AdditionalGroupKeysAttributes] {
	return terra.ReferenceAsList[cloudidentitygroup.AdditionalGroupKeysAttributes](cig.ref.Append("additional_group_keys"))
}
...
type cloudIdentityGroupState struct {
	...
	AdditionalGroupKeys []cloudidentitygroup.AdditionalGroupKeysState `json:"additional_group_keys"`
