...
import (
	...
	networkservicestcproute "github.com/golingon/terraproviders/googlebeta/5.24.0/networkservicestcproute"
	"io"
)
...
func (nstr networkServicesTcpRouteAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nstr.ref.Append("effective_labels"))
}
...
func (nstr networkServicesTcpRouteAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nstr.ref.Append("terraform_labels"))
}
