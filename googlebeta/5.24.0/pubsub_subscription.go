...
import (
	...
	pubsubsubscription "github.com/golingon/terraproviders/googlebeta/5.24.0/pubsubsubscription"
	"io"
)
...
func (ps pubsubSubscriptionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (ps pubsubSubscriptionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
