...
import (
	...
	datacomputeforwardingrule "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputeforwardingrule"
)
...
func (cfr dataComputeForwardingRuleAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cfr dataComputeForwardingRuleAttributes) IpVersion() terra.StringValue {
...
func (cfr dataComputeForwardingRuleAttributes) NoAutomateDnsZone() terra.BoolValue {
...
func (cfr dataComputeForwardingRuleAttributes) RecreateClosedPsc() terra.BoolValue {
	return terra.ReferenceAsBool(cfr.ref.Append("recreate_closed_psc"))
}
...
func (cfr dataComputeForwardingRuleAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
