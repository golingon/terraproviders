...
import (
	...
	spannerinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/spannerinstance"
	"io"
)
...
type SpannerInstanceArgs struct {
	...
	AutoscalingConfig *spannerinstance.AutoscalingConfig `hcl:"autoscaling_config,block"`
	// Timeouts: optional
...
func (si spannerInstanceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (si spannerInstanceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](si.ref.Append("terraform_labels"))
}

func (si spannerInstanceAttributes) AutoscalingConfig() terra.ListValue[spannerinstance.AutoscalingConfigAttributes] {
	return terra.ReferenceAsList[spannerinstance.AutoscalingConfigAttributes](si.ref.Append("autoscaling_config"))
}
...
type spannerInstanceState struct {
	...
	AutoscalingConfig []spannerinstance.AutoscalingConfigState `json:"autoscaling_config"`
