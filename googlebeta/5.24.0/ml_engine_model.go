...
import (
	...
	mlenginemodel "github.com/golingon/terraproviders/googlebeta/5.24.0/mlenginemodel"
	"io"
)
...
func (mem mlEngineModelAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](mem.ref.Append("effective_labels"))
}
...
func (mem mlEngineModelAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](mem.ref.Append("terraform_labels"))
}
