...
import (
	...
	databeyondcorpappconnection "github.com/golingon/terraproviders/googlebeta/5.24.0/databeyondcorpappconnection"
)
...
func (bac dataBeyondcorpAppConnectionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bac.ref.Append("effective_labels"))
}
...
func (bac dataBeyondcorpAppConnectionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bac.ref.Append("terraform_labels"))
}
