...
import (
	...
	dataprocworkflowtemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/dataprocworkflowtemplate"
	"io"
)
...
func (dwt dataprocWorkflowTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dwt.ref.Append("effective_labels"))
}
...
func (dwt dataprocWorkflowTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dwt.ref.Append("terraform_labels"))
}
