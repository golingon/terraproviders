...
func (p dataProjectAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (p dataProjectAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
