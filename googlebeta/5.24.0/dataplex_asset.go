...
import (
	...
	dataplexasset "github.com/golingon/terraproviders/googlebeta/5.24.0/dataplexasset"
	"io"
)
...
func (da dataplexAssetAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](da.ref.Append("effective_labels"))
}
...
func (da dataplexAssetAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](da.ref.Append("terraform_labels"))
}
