...
import (
	...
	alloydbinstance "github.com/golingon/terraproviders/googlebeta/5.24.0/alloydbinstance"
	"io"
)
...
type AlloydbInstanceArgs struct {
	...
	ClientConnectionConfig *alloydbinstance.ClientConnectionConfig `hcl:"client_connection_config,block"`
...
func (ai alloydbInstanceAttributes) ClientConnectionConfig() terra.ListValue[alloydbinstance.ClientConnectionConfigAttributes] {
	return terra.ReferenceAsList[alloydbinstance.ClientConnectionConfigAttributes](ai.ref.Append("client_connection_config"))
}
...
type alloydbInstanceState struct {
	...
	ClientConnectionConfig []alloydbinstance.ClientConnectionConfigState `json:"client_connection_config"`
