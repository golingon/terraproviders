...
import (
	...
	dialogflowcxflow "github.com/golingon/terraproviders/googlebeta/5.24.0/dialogflowcxflow"
	"io"
)
...
type DialogflowCxFlowArgs struct {
	...
	AdvancedSettings *dialogflowcxflow.AdvancedSettings `hcl:"advanced_settings,block"`
	// EventHandlers: min=0
...
func (dcf dialogflowCxFlowAttributes) IsDefaultStartFlow() terra.BoolValue {
	return terra.ReferenceAsBool(dcf.ref.Append("is_default_start_flow"))
}
...
func (dcf dialogflowCxFlowAttributes) AdvancedSettings() terra.ListValue[dialogflowcxflow.AdvancedSettingsAttributes] {
	return terra.ReferenceAsList[dialogflowcxflow.AdvancedSettingsAttributes](dcf.ref.Append("advanced_settings"))
}
...
type dialogflowCxFlowState struct {
	...
	AdvancedSettings      []dialogflowcxflow.AdvancedSettingsState `json:"advanced_settings"`
