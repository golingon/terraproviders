...
import (
	...
	gkehubscope "github.com/golingon/terraproviders/googlebeta/5.24.0/gkehubscope"
	"io"
)
...
func (ghs gkeHubScopeAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ghs.ref.Append("effective_labels"))
}
...
func (ghs gkeHubScopeAttributes) NamespaceLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ghs.ref.Append("namespace_labels"))
}
...
func (ghs gkeHubScopeAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ghs.ref.Append("terraform_labels"))
}
