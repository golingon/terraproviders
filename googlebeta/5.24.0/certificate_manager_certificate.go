...
import (
	...
	certificatemanagercertificate "github.com/golingon/terraproviders/googlebeta/5.24.0/certificatemanagercertificate"
	"io"
)
...
func (cmc certificateManagerCertificateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmc.ref.Append("effective_labels"))
}
...
func (cmc certificateManagerCertificateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmc.ref.Append("terraform_labels"))
}
