...
import (
	...
	workstationsworkstationcluster "github.com/golingon/terraproviders/googlebeta/5.24.0/workstationsworkstationcluster"
	"io"
)
...
type WorkstationsWorkstationClusterArgs struct {
	...
	DomainConfig *workstationsworkstationcluster.DomainConfig `hcl:"domain_config,block"`
...
func (wwc workstationsWorkstationClusterAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (wwc workstationsWorkstationClusterAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (wwc workstationsWorkstationClusterAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (wwc workstationsWorkstationClusterAttributes) DomainConfig() terra.ListValue[workstationsworkstationcluster.DomainConfigAttributes] {
	return terra.ReferenceAsList[workstationsworkstationcluster.DomainConfigAttributes](wwc.ref.Append("domain_config"))
}
...
type workstationsWorkstationClusterState struct {
	...
	DomainConfig         []workstationsworkstationcluster.DomainConfigState         `json:"domain_config"`
