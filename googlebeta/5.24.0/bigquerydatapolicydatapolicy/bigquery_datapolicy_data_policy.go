...
type DataMaskingPolicy struct {
	// PredefinedExpression: string, required
	PredefinedExpression terra.StringValue `hcl:"predefined_expression,attr" validate:"required"`
}
...
type DataMaskingPolicyAttributes struct {
	ref terra.Reference
}
...
type DataMaskingPolicyState struct {
	PredefinedExpression string `json:"predefined_expression"`
}
