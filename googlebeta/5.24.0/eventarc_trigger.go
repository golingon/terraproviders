...
import (
	...
	eventarctrigger "github.com/golingon/terraproviders/googlebeta/5.24.0/eventarctrigger"
	"io"
)
...
func (et eventarcTriggerAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](et.ref.Append("effective_labels"))
}
...
func (et eventarcTriggerAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](et.ref.Append("terraform_labels"))
}
