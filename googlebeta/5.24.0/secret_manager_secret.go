...
import (
	...
	secretmanagersecret "github.com/golingon/terraproviders/googlebeta/5.24.0/secretmanagersecret"
	"io"
)
...
func (sms secretManagerSecretAttributes) Annotations() terra.MapValue[terra.StringValue] {
...
func (sms secretManagerSecretAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (sms secretManagerSecretAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (sms secretManagerSecretAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (sms secretManagerSecretAttributes) VersionAliases() terra.MapValue[terra.StringValue] {
