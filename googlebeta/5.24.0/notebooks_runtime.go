...
import (
	...
	notebooksruntime "github.com/golingon/terraproviders/googlebeta/5.24.0/notebooksruntime"
	"io"
)
...
func (nr notebooksRuntimeAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nr.ref.Append("effective_labels"))
}
...
func (nr notebooksRuntimeAttributes) Labels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nr.ref.Append("labels"))
}
...
func (nr notebooksRuntimeAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](nr.ref.Append("terraform_labels"))
}
