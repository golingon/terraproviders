...
import (
	...
	dataartifactregistryrepository "github.com/golingon/terraproviders/googlebeta/5.24.0/dataartifactregistryrepository"
)
...
type DataArtifactRegistryRepositoryArgs struct {
	...
	CleanupPolicies []dataartifactregistryrepository.CleanupPolicies `hcl:"cleanup_policies,block" validate:"min=0"`
	// DockerConfig: min=0
...
func (arr dataArtifactRegistryRepositoryAttributes) CleanupPolicyDryRun() terra.BoolValue {
...
func (arr dataArtifactRegistryRepositoryAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (arr dataArtifactRegistryRepositoryAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (arr dataArtifactRegistryRepositoryAttributes) CleanupPolicies() terra.SetValue[dataartifactregistryrepository.CleanupPoliciesAttributes] {
	return terra.ReferenceAsSet[dataartifactregistryrepository.CleanupPoliciesAttributes](arr.ref.Append("cleanup_policies"))
}
