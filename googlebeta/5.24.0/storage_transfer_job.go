...
import (
	...
	storagetransferjob "github.com/golingon/terraproviders/googlebeta/5.24.0/storagetransferjob"
	"io"
)
...
type StorageTransferJobArgs struct {
	...
	EventStream *storagetransferjob.EventStream `hcl:"event_stream,block"`
...
func (stj storageTransferJobAttributes) EventStream() terra.ListValue[storagetransferjob.EventStreamAttributes] {
	return terra.ReferenceAsList[storagetransferjob.EventStreamAttributes](stj.ref.Append("event_stream"))
}
...
type storageTransferJobState struct {
	...
	EventStream          []storagetransferjob.EventStreamState        `json:"event_stream"`
