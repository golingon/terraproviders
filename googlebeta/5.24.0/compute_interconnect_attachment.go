...
import (
	...
	computeinterconnectattachment "github.com/golingon/terraproviders/googlebeta/5.24.0/computeinterconnectattachment"
	"io"
)
...
func (cia computeInterconnectAttachmentAttributes) CloudRouterIpv6Address() terra.StringValue {
	return terra.ReferenceAsString(cia.ref.Append("cloud_router_ipv6_address"))
}
...
func (cia computeInterconnectAttachmentAttributes) CustomerRouterIpv6Address() terra.StringValue {
	return terra.ReferenceAsString(cia.ref.Append("customer_router_ipv6_address"))
}
...
func (cia computeInterconnectAttachmentAttributes) StackType() terra.StringValue {
	return terra.ReferenceAsString(cia.ref.Append("stack_type"))
}
