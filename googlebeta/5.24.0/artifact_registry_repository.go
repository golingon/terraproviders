...
import (
	...
	artifactregistryrepository "github.com/golingon/terraproviders/googlebeta/5.24.0/artifactregistryrepository"
	"io"
)
...
type ArtifactRegistryRepositoryArgs struct {
	...
	CleanupPolicies []artifactregistryrepository.CleanupPolicies `hcl:"cleanup_policies,block" validate:"min=0"`
...
func (arr artifactRegistryRepositoryAttributes) CleanupPolicyDryRun() terra.BoolValue {
	return terra.ReferenceAsBool(arr.ref.Append("cleanup_policy_dry_run"))
}
...
func (arr artifactRegistryRepositoryAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](arr.ref.Append("effective_labels"))
}
...
func (arr artifactRegistryRepositoryAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](arr.ref.Append("terraform_labels"))
}
...
func (arr artifactRegistryRepositoryAttributes) CleanupPolicies() terra.SetValue[artifactregistryrepository.CleanupPoliciesAttributes] {
	return terra.ReferenceAsSet[artifactregistryrepository.CleanupPoliciesAttributes](arr.ref.Append("cleanup_policies"))
}
...
type artifactRegistryRepositoryState struct {
	...
	CleanupPolicies         []artifactregistryrepository.CleanupPoliciesState         `json:"cleanup_policies"`
