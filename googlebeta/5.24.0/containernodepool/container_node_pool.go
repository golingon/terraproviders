...
type NodeConfig struct {
	...
	// EffectiveTaints: min=0
	EffectiveTaints []EffectiveTaints `hcl:"effective_taints,block" validate:"min=0"`
	...
	// FastSocket: optional
	FastSocket *FastSocket `hcl:"fast_socket,block"`
	// GcfsConfig: optional
	GcfsConfig *GcfsConfig `hcl:"gcfs_config,block"`
	// Gvnic: optional
	Gvnic *Gvnic `hcl:"gvnic,block"`
	// HostMaintenancePolicy: optional
	HostMaintenancePolicy *HostMaintenancePolicy `hcl:"host_maintenance_policy,block"`
...
func (nc NodeConfigAttributes) EffectiveTaints() terra.ListValue[EffectiveTaintsAttributes] {
	return terra.ReferenceAsList[EffectiveTaintsAttributes](nc.ref.Append("effective_taints"))
}
...
func (nc NodeConfigAttributes) ConfidentialNodes() terra.ListValue[ConfidentialNodesAttributes] {
	return terra.ReferenceAsList[ConfidentialNodesAttributes](nc.ref.Append("confidential_nodes"))
}
...
func (nc NodeConfigAttributes) FastSocket() terra.ListValue[FastSocketAttributes] {
	return terra.ReferenceAsList[FastSocketAttributes](nc.ref.Append("fast_socket"))
}
...
func (nc NodeConfigAttributes) HostMaintenancePolicy() terra.ListValue[HostMaintenancePolicyAttributes] {
	return terra.ReferenceAsList[HostMaintenancePolicyAttributes](nc.ref.Append("host_maintenance_policy"))
}
...
type EffectiveTaintsAttributes struct {
	ref terra.Reference
}

func (et EffectiveTaintsAttributes) InternalRef() (terra.Reference, error) {
	return et.ref, nil
}

func (et EffectiveTaintsAttributes) InternalWithRef(ref terra.Reference) EffectiveTaintsAttributes {
	return EffectiveTaintsAttributes{ref: ref}
}

func (et EffectiveTaintsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return et.ref.InternalTokens()
}

func (et EffectiveTaintsAttributes) Effect() terra.StringValue {
	return terra.ReferenceAsString(et.ref.Append("effect"))
}

func (et EffectiveTaintsAttributes) Key() terra.StringValue {
	return terra.ReferenceAsString(et.ref.Append("key"))
}

func (et EffectiveTaintsAttributes) Value() terra.StringValue {
...
type FastSocketAttributes struct {
	ref terra.Reference
}

func (fs FastSocketAttributes) InternalRef() (terra.Reference, error) {
	return fs.ref, nil
}

func (fs FastSocketAttributes) InternalWithRef(ref terra.Reference) FastSocketAttributes {
	return FastSocketAttributes{ref: ref}
}

func (fs FastSocketAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return fs.ref.InternalTokens()
}

func (fs FastSocketAttributes) Enabled() terra.BoolValue {
...
type HostMaintenancePolicyAttributes struct {
	ref terra.Reference
}

func (hmp HostMaintenancePolicyAttributes) InternalRef() (terra.Reference, error) {
	return hmp.ref, nil
}

func (hmp HostMaintenancePolicyAttributes) InternalWithRef(ref terra.Reference) HostMaintenancePolicyAttributes {
	return HostMaintenancePolicyAttributes{ref: ref}
}

func (hmp HostMaintenancePolicyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return hmp.ref.InternalTokens()
}

func (hmp HostMaintenancePolicyAttributes) MaintenanceInterval() terra.StringValue {
...
func (lnc LinuxNodeConfigAttributes) CgroupMode() terra.StringValue {
...
type NodeConfigState struct {
	...
	EffectiveTaints                []EffectiveTaintsState                `json:"effective_taints"`
	...
	FastSocket                     []FastSocketState                     `json:"fast_socket"`
	GcfsConfig                     []GcfsConfigState                     `json:"gcfs_config"`
	Gvnic                          []GvnicState                          `json:"gvnic"`
	HostMaintenancePolicy          []HostMaintenancePolicyState          `json:"host_maintenance_policy"`
...
type EffectiveTaintsState struct {
...
type HostMaintenancePolicyState struct {
