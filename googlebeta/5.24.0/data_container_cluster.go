...
import (
	...
	datacontainercluster "github.com/golingon/terraproviders/googlebeta/5.24.0/datacontainercluster"
)
...
type DataContainerClusterArgs struct {
	...
	// ClusterTelemetry: min=0
	ClusterTelemetry []datacontainercluster.ClusterTelemetry `hcl:"cluster_telemetry,block" validate:"min=0"`
	...
	// Fleet: min=0
	Fleet []datacontainercluster.Fleet `hcl:"fleet,block" validate:"min=0"`
	// GatewayApiConfig: min=0
	GatewayApiConfig []datacontainercluster.GatewayApiConfig `hcl:"gateway_api_config,block" validate:"min=0"`
	// IdentityServiceConfig: min=0
	IdentityServiceConfig []datacontainercluster.IdentityServiceConfig `hcl:"identity_service_config,block" validate:"min=0"`
	...
	// NodePoolAutoConfig: min=0
	NodePoolAutoConfig []datacontainercluster.NodePoolAutoConfig `hcl:"node_pool_auto_config,block" validate:"min=0"`
	...
	// PodSecurityPolicyConfig: min=0
	PodSecurityPolicyConfig []datacontainercluster.PodSecurityPolicyConfig `hcl:"pod_security_policy_config,block" validate:"min=0"`
	...
	// ProtectConfig: min=0
	ProtectConfig []datacontainercluster.ProtectConfig `hcl:"protect_config,block" validate:"min=0"`
	...
	// TpuConfig: min=0
	TpuConfig []datacontainercluster.TpuConfig `hcl:"tpu_config,block" validate:"min=0"`
	...
	// WorkloadAltsConfig: min=0
	WorkloadAltsConfig []datacontainercluster.WorkloadAltsConfig `hcl:"workload_alts_config,block" validate:"min=0"`
...
func (cc dataContainerClusterAttributes) DeletionProtection() terra.BoolValue {
	return terra.ReferenceAsBool(cc.ref.Append("deletion_protection"))
}
...
func (cc dataContainerClusterAttributes) EnableCiliumClusterwideNetworkPolicy() terra.BoolValue {
	return terra.ReferenceAsBool(cc.ref.Append("enable_cilium_clusterwide_network_policy"))
}

// EnableFqdnNetworkPolicy returns a reference to field enable_fqdn_network_policy of google_container_cluster.
func (cc dataContainerClusterAttributes) EnableFqdnNetworkPolicy() terra.BoolValue {
...
func (cc dataContainerClusterAttributes) EnableMultiNetworking() terra.BoolValue {
...
func (cc dataContainerClusterAttributes) ClusterTelemetry() terra.ListValue[datacontainercluster.ClusterTelemetryAttributes] {
	return terra.ReferenceAsList[datacontainercluster.ClusterTelemetryAttributes](cc.ref.Append("cluster_telemetry"))
}
...
func (cc dataContainerClusterAttributes) Fleet() terra.ListValue[datacontainercluster.FleetAttributes] {
	return terra.ReferenceAsList[datacontainercluster.FleetAttributes](cc.ref.Append("fleet"))
}
...
func (cc dataContainerClusterAttributes) IdentityServiceConfig() terra.ListValue[datacontainercluster.IdentityServiceConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.IdentityServiceConfigAttributes](cc.ref.Append("identity_service_config"))
}
...
func (cc dataContainerClusterAttributes) NodePoolAutoConfig() terra.ListValue[datacontainercluster.NodePoolAutoConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.NodePoolAutoConfigAttributes](cc.ref.Append("node_pool_auto_config"))
}
...
func (cc dataContainerClusterAttributes) PodSecurityPolicyConfig() terra.ListValue[datacontainercluster.PodSecurityPolicyConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.PodSecurityPolicyConfigAttributes](cc.ref.Append("pod_security_policy_config"))
}
...
func (cc dataContainerClusterAttributes) ProtectConfig() terra.ListValue[datacontainercluster.ProtectConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.ProtectConfigAttributes](cc.ref.Append("protect_config"))
}
...
func (cc dataContainerClusterAttributes) TpuConfig() terra.ListValue[datacontainercluster.TpuConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.TpuConfigAttributes](cc.ref.Append("tpu_config"))
}
...
func (cc dataContainerClusterAttributes) WorkloadAltsConfig() terra.ListValue[datacontainercluster.WorkloadAltsConfigAttributes] {
	return terra.ReferenceAsList[datacontainercluster.WorkloadAltsConfigAttributes](cc.ref.Append("workload_alts_config"))
}
