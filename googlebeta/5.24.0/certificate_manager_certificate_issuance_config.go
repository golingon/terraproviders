...
import (
	...
	certificatemanagercertificateissuanceconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/certificatemanagercertificateissuanceconfig"
	"io"
)
...
func (cmcic certificateManagerCertificateIssuanceConfigAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmcic.ref.Append("effective_labels"))
}
...
func (cmcic certificateManagerCertificateIssuanceConfigAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmcic.ref.Append("terraform_labels"))
}
