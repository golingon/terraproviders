...
import (
	...
	containerazurenodepool "github.com/golingon/terraproviders/googlebeta/5.24.0/containerazurenodepool"
	"io"
)
...
type ContainerAzureNodePoolArgs struct {
	...
	// Management: optional
	Management *containerazurenodepool.Management `hcl:"management,block"`
...
func (canp containerAzureNodePoolAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (canp containerAzureNodePoolAttributes) Management() terra.ListValue[containerazurenodepool.ManagementAttributes] {
	return terra.ReferenceAsList[containerazurenodepool.ManagementAttributes](canp.ref.Append("management"))
}
...
type containerAzureNodePoolState struct {
	...
	Management            []containerazurenodepool.ManagementState        `json:"management"`
