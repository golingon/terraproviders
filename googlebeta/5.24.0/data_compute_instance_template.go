...
import (
	...
	datacomputeinstancetemplate "github.com/golingon/terraproviders/googlebeta/5.24.0/datacomputeinstancetemplate"
)
...
func (cit dataComputeInstanceTemplateAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cit.ref.Append("effective_labels"))
}

// EnableDisplay returns a reference to field enable_display of google_compute_instance_template.
func (cit dataComputeInstanceTemplateAttributes) EnableDisplay() terra.BoolValue {
...
func (cit dataComputeInstanceTemplateAttributes) ResourceManagerTags() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cit.ref.Append("resource_manager_tags"))
}
...
func (cit dataComputeInstanceTemplateAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cit.ref.Append("terraform_labels"))
}
