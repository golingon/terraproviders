...
import (
	...
	containerazurecluster "github.com/golingon/terraproviders/googlebeta/5.24.0/containerazurecluster"
	"io"
)
...
type ContainerAzureClusterArgs struct {
	...
	LoggingConfig *containerazurecluster.LoggingConfig `hcl:"logging_config,block"`
	// Networking: required
...
func (cac containerAzureClusterAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (cac containerAzureClusterAttributes) LoggingConfig() terra.ListValue[containerazurecluster.LoggingConfigAttributes] {
	return terra.ReferenceAsList[containerazurecluster.LoggingConfigAttributes](cac.ref.Append("logging_config"))
}
...
type containerAzureClusterState struct {
	...
	LoggingConfig               []containerazurecluster.LoggingConfigState               `json:"logging_config"`
