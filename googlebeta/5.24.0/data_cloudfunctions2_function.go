...
import (
	...
	datacloudfunctions2function "github.com/golingon/terraproviders/googlebeta/5.24.0/datacloudfunctions2function"
)
...
func (cf dataCloudfunctions2FunctionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cf dataCloudfunctions2FunctionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
