...
type Config struct {
	...
	// DataRetentionConfig: optional
	DataRetentionConfig *DataRetentionConfig `hcl:"data_retention_config,block"`
...
type DataRetentionConfig struct {
	// TaskLogsRetentionConfig: min=1
	TaskLogsRetentionConfig []TaskLogsRetentionConfig `hcl:"task_logs_retention_config,block" validate:"min=1"`
}
...
type SoftwareConfig struct {
	...
	// CloudDataLineageIntegration: optional
	CloudDataLineageIntegration *CloudDataLineageIntegration `hcl:"cloud_data_lineage_integration,block"`
}
...
type WorkloadsConfig struct {
	// DagProcessor: optional
	DagProcessor *DagProcessor `hcl:"dag_processor,block"`
	// Scheduler: optional
	Scheduler *Scheduler `hcl:"scheduler,block"`
	// Triggerer: optional
	Triggerer *Triggerer `hcl:"triggerer,block"`
	// WebServer: optional
