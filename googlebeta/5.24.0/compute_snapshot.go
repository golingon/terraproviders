...
import (
	...
	computesnapshot "github.com/golingon/terraproviders/googlebeta/5.24.0/computesnapshot"
	"io"
)
...
func (cs computeSnapshotAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cs computeSnapshotAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
