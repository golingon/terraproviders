...
import (
	...
	dialogflowcxpage "github.com/golingon/terraproviders/googlebeta/5.24.0/dialogflowcxpage"
	"io"
)
...
type DialogflowCxPageArgs struct {
	...
	AdvancedSettings *dialogflowcxpage.AdvancedSettings `hcl:"advanced_settings,block"`
...
func (dcp dialogflowCxPageAttributes) AdvancedSettings() terra.ListValue[dialogflowcxpage.AdvancedSettingsAttributes] {
	return terra.ReferenceAsList[dialogflowcxpage.AdvancedSettingsAttributes](dcp.ref.Append("advanced_settings"))
}
...
type dialogflowCxPageState struct {
	...
	AdvancedSettings      []dialogflowcxpage.AdvancedSettingsState `json:"advanced_settings"`
