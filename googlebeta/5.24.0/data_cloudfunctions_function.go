...
import (
	...
	datacloudfunctionsfunction "github.com/golingon/terraproviders/googlebeta/5.24.0/datacloudfunctionsfunction"
)
...
func (cf dataCloudfunctionsFunctionAttributes) VersionId() terra.StringValue {
	return terra.ReferenceAsString(cf.ref.Append("version_id"))
}
