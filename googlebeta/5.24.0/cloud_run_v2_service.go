...
import (
	...
	cloudrunv2service "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudrunv2service"
	"io"
)
...
type CloudRunV2ServiceArgs struct {
	...
	// Scaling: optional
	Scaling *cloudrunv2service.Scaling `hcl:"scaling,block"`
	// Template: required
...
func (crvs cloudRunV2ServiceAttributes) CreateTime() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) Creator() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) CustomAudiences() terra.ListValue[terra.StringValue] {
...
func (crvs cloudRunV2ServiceAttributes) DeleteTime() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
...
func (crvs cloudRunV2ServiceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (crvs cloudRunV2ServiceAttributes) ExpireTime() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) LastModifier() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (crvs cloudRunV2ServiceAttributes) UpdateTime() terra.StringValue {
...
func (crvs cloudRunV2ServiceAttributes) Scaling() terra.ListValue[cloudrunv2service.ScalingAttributes] {
	return terra.ReferenceAsList[cloudrunv2service.ScalingAttributes](crvs.ref.Append("scaling"))
}
...
type cloudRunV2ServiceState struct {
	...
	Scaling               []cloudrunv2service.ScalingState             `json:"scaling"`
