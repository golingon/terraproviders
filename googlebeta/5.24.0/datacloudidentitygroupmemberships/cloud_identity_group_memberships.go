...
type Memberships struct {
	// MemberKey: min=0
	MemberKey []MemberKey `hcl:"member_key,block" validate:"min=0"`
...
type Roles struct {
	// ExpiryDetail: min=0
	ExpiryDetail []ExpiryDetail `hcl:"expiry_detail,block" validate:"min=0"`
}
...
func (m MembershipsAttributes) MemberKey() terra.ListValue[MemberKeyAttributes] {
	return terra.ReferenceAsList[MemberKeyAttributes](m.ref.Append("member_key"))
}
