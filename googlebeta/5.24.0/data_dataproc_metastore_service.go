...
import (
	...
	datadataprocmetastoreservice "github.com/golingon/terraproviders/googlebeta/5.24.0/datadataprocmetastoreservice"
)
...
type DataDataprocMetastoreServiceArgs struct {
	...
	// MetadataIntegration: min=0
	MetadataIntegration []datadataprocmetastoreservice.MetadataIntegration `hcl:"metadata_integration,block" validate:"min=0"`
	// NetworkConfig: min=0
	...
	// ScheduledBackup: min=0
	ScheduledBackup []datadataprocmetastoreservice.ScheduledBackup `hcl:"scheduled_backup,block" validate:"min=0"`
...
func (dms dataDataprocMetastoreServiceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dms.ref.Append("effective_labels"))
}
...
func (dms dataDataprocMetastoreServiceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dms.ref.Append("terraform_labels"))
}
...
func (dms dataDataprocMetastoreServiceAttributes) MetadataIntegration() terra.ListValue[datadataprocmetastoreservice.MetadataIntegrationAttributes] {
	return terra.ReferenceAsList[datadataprocmetastoreservice.MetadataIntegrationAttributes](dms.ref.Append("metadata_integration"))
}
...
func (dms dataDataprocMetastoreServiceAttributes) ScheduledBackup() terra.ListValue[datadataprocmetastoreservice.ScheduledBackupAttributes] {
	return terra.ReferenceAsList[datadataprocmetastoreservice.ScheduledBackupAttributes](dms.ref.Append("scheduled_backup"))
}
