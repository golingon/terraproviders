...
import (
	...
	databeyondcorpappgateway "github.com/golingon/terraproviders/googlebeta/5.24.0/databeyondcorpappgateway"
)
...
func (bag dataBeyondcorpAppGatewayAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bag.ref.Append("effective_labels"))
}
...
func (bag dataBeyondcorpAppGatewayAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](bag.ref.Append("terraform_labels"))
}
