...
import (
	...
	loggingorganizationbucketconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/loggingorganizationbucketconfig"
	"io"
)
...
type LoggingOrganizationBucketConfigArgs struct {
	...
	IndexConfigs []loggingorganizationbucketconfig.IndexConfigs `hcl:"index_configs,block" validate:"min=0,max=20"`
}
...
func (lobc loggingOrganizationBucketConfigAttributes) IndexConfigs() terra.SetValue[loggingorganizationbucketconfig.IndexConfigsAttributes] {
	return terra.ReferenceAsSet[loggingorganizationbucketconfig.IndexConfigsAttributes](lobc.ref.Append("index_configs"))
}
...
type loggingOrganizationBucketConfigState struct {
	...
	IndexConfigs   []loggingorganizationbucketconfig.IndexConfigsState `json:"index_configs"`
}
