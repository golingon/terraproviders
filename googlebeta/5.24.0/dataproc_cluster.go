...
import (
	...
	dataproccluster "github.com/golingon/terraproviders/googlebeta/5.24.0/dataproccluster"
	"io"
)
...
func (dc dataprocClusterAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dc.ref.Append("effective_labels"))
}
...
func (dc dataprocClusterAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dc.ref.Append("terraform_labels"))
}
