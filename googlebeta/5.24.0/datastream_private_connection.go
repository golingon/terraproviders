...
import (
	...
	datastreamprivateconnection "github.com/golingon/terraproviders/googlebeta/5.24.0/datastreamprivateconnection"
	"io"
)
...
func (dpc datastreamPrivateConnectionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dpc.ref.Append("effective_labels"))
}
...
func (dpc datastreamPrivateConnectionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dpc.ref.Append("terraform_labels"))
}
