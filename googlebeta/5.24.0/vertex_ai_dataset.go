...
import (
	...
	vertexaidataset "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaidataset"
	"io"
)
...
func (vad vertexAiDatasetAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vad.ref.Append("effective_labels"))
}
...
func (vad vertexAiDatasetAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vad.ref.Append("terraform_labels"))
}
