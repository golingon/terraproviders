...
import (
	...
	healthcaredicomstore "github.com/golingon/terraproviders/googlebeta/5.24.0/healthcaredicomstore"
	"io"
)
...
func (hds healthcareDicomStoreAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hds.ref.Append("effective_labels"))
}
...
func (hds healthcareDicomStoreAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](hds.ref.Append("terraform_labels"))
}
