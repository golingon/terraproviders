...
import (
	...
	bigqueryanalyticshublisting "github.com/golingon/terraproviders/googlebeta/5.24.0/bigqueryanalyticshublisting"
	"io"
)
...
type BigqueryAnalyticsHubListingArgs struct {
	...
	RestrictedExportConfig *bigqueryanalyticshublisting.RestrictedExportConfig `hcl:"restricted_export_config,block"`
	// Timeouts: optional
...
func (bahl bigqueryAnalyticsHubListingAttributes) RestrictedExportConfig() terra.ListValue[bigqueryanalyticshublisting.RestrictedExportConfigAttributes] {
	return terra.ReferenceAsList[bigqueryanalyticshublisting.RestrictedExportConfigAttributes](bahl.ref.Append("restricted_export_config"))
}
...
type bigqueryAnalyticsHubListingState struct {
	...
	RestrictedExportConfig []bigqueryanalyticshublisting.RestrictedExportConfigState `json:"restricted_export_config"`
