...
import (
	...
	vertexaiendpoint "github.com/golingon/terraproviders/googlebeta/5.24.0/vertexaiendpoint"
	"io"
)
...
func (vae vertexAiEndpointAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vae.ref.Append("effective_labels"))
}
...
func (vae vertexAiEndpointAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](vae.ref.Append("terraform_labels"))
}
