...
import (
	...
	computeperinstanceconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/computeperinstanceconfig"
	"io"
)
...
func (cpic computePerInstanceConfigAttributes) RemoveInstanceOnDestroy() terra.BoolValue {
	return terra.ReferenceAsBool(cpic.ref.Append("remove_instance_on_destroy"))
}
