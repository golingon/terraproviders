...
import (
	...
	dataprocjob "github.com/golingon/terraproviders/googlebeta/5.24.0/dataprocjob"
	"io"
)
...
func (dj dataprocJobAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (dj dataprocJobAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
