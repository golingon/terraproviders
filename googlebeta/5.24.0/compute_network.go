...
import (
	...
	computenetwork "github.com/golingon/terraproviders/googlebeta/5.24.0/computenetwork"
	"io"
)
...
func (cn computeNetworkAttributes) NumericId() terra.StringValue {
	return terra.ReferenceAsString(cn.ref.Append("numeric_id"))
}
