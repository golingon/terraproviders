...
import (
	...
	workstationsworkstationconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/workstationsworkstationconfig"
	"io"
)
...
type WorkstationsWorkstationConfigArgs struct {
	...
	EphemeralDirectories []workstationsworkstationconfig.EphemeralDirectories `hcl:"ephemeral_directories,block" validate:"min=0"`
	// Host: optional
	...
	ReadinessChecks []workstationsworkstationconfig.ReadinessChecks `hcl:"readiness_checks,block" validate:"min=0"`
	// Timeouts: optional
...
func (wwc workstationsWorkstationConfigAttributes) DisableTcpConnections() terra.BoolValue {
	return terra.ReferenceAsBool(wwc.ref.Append("disable_tcp_connections"))
}
...
func (wwc workstationsWorkstationConfigAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](wwc.ref.Append("effective_annotations"))
}

// EffectiveLabels returns a reference to field effective_labels of google_workstations_workstation_config.
func (wwc workstationsWorkstationConfigAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](wwc.ref.Append("effective_labels"))
}

// EnableAuditAgent returns a reference to field enable_audit_agent of google_workstations_workstation_config.
func (wwc workstationsWorkstationConfigAttributes) EnableAuditAgent() terra.BoolValue {
	return terra.ReferenceAsBool(wwc.ref.Append("enable_audit_agent"))
}
...
func (wwc workstationsWorkstationConfigAttributes) IdleTimeout() terra.StringValue {
	return terra.ReferenceAsString(wwc.ref.Append("idle_timeout"))
}
...
func (wwc workstationsWorkstationConfigAttributes) ReplicaZones() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](wwc.ref.Append("replica_zones"))
}

// RunningTimeout returns a reference to field running_timeout of google_workstations_workstation_config.
func (wwc workstationsWorkstationConfigAttributes) RunningTimeout() terra.StringValue {
	return terra.ReferenceAsString(wwc.ref.Append("running_timeout"))
}

// TerraformLabels returns a reference to field terraform_labels of google_workstations_workstation_config.
func (wwc workstationsWorkstationConfigAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](wwc.ref.Append("terraform_labels"))
}
...
func (wwc workstationsWorkstationConfigAttributes) EphemeralDirectories() terra.ListValue[workstationsworkstationconfig.EphemeralDirectoriesAttributes] {
	return terra.ReferenceAsList[workstationsworkstationconfig.EphemeralDirectoriesAttributes](wwc.ref.Append("ephemeral_directories"))
}
...
func (wwc workstationsWorkstationConfigAttributes) ReadinessChecks() terra.ListValue[workstationsworkstationconfig.ReadinessChecksAttributes] {
	return terra.ReferenceAsList[workstationsworkstationconfig.ReadinessChecksAttributes](wwc.ref.Append("readiness_checks"))
}
...
type workstationsWorkstationConfigState struct {
	...
	EphemeralDirectories  []workstationsworkstationconfig.EphemeralDirectoriesState  `json:"ephemeral_directories"`
	...
	ReadinessChecks       []workstationsworkstationconfig.ReadinessChecksState       `json:"readiness_checks"`
