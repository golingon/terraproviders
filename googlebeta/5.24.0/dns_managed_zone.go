...
import (
	...
	dnsmanagedzone "github.com/golingon/terraproviders/googlebeta/5.24.0/dnsmanagedzone"
	"io"
)
...
type DnsManagedZoneArgs struct {
	...
	ServiceDirectoryConfig *dnsmanagedzone.ServiceDirectoryConfig `hcl:"service_directory_config,block"`
	// Timeouts: optional
...
func (dmz dnsManagedZoneAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dmz.ref.Append("effective_labels"))
}
...
func (dmz dnsManagedZoneAttributes) ReverseLookup() terra.BoolValue {
	return terra.ReferenceAsBool(dmz.ref.Append("reverse_lookup"))
}

// TerraformLabels returns a reference to field terraform_labels of google_dns_managed_zone.
func (dmz dnsManagedZoneAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dmz.ref.Append("terraform_labels"))
}
...
func (dmz dnsManagedZoneAttributes) ServiceDirectoryConfig() terra.ListValue[dnsmanagedzone.ServiceDirectoryConfigAttributes] {
	return terra.ReferenceAsList[dnsmanagedzone.ServiceDirectoryConfigAttributes](dmz.ref.Append("service_directory_config"))
}
...
type dnsManagedZoneState struct {
	...
	ServiceDirectoryConfig  []dnsmanagedzone.ServiceDirectoryConfigState  `json:"service_directory_config"`
