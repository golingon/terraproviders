...
import (
	...
	computenodegroup "github.com/golingon/terraproviders/googlebeta/5.24.0/computenodegroup"
	"io"
)
...
func (cng computeNodeGroupAttributes) MaintenanceInterval() terra.StringValue {
	return terra.ReferenceAsString(cng.ref.Append("maintenance_interval"))
}
