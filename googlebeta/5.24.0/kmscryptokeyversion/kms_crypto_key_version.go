...
type Attestation struct {
	// CertChains: min=0
	CertChains []CertChains `hcl:"cert_chains,block" validate:"min=0"`
	// AttestationExternalProtectionLevelOptions: min=0
	ExternalProtectionLevelOptions []AttestationExternalProtectionLevelOptions `hcl:"external_protection_level_options,block" validate:"min=0"`
}

type CertChains struct{}

type AttestationExternalProtectionLevelOptions struct{}
...
func (cc CertChainsAttributes) CaviumCerts() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](cc.ref.Append("cavium_certs"))
}

func (cc CertChainsAttributes) GoogleCardCerts() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](cc.ref.Append("google_card_certs"))
}

func (cc CertChainsAttributes) GooglePartitionCerts() terra.ListValue[terra.StringValue] {
