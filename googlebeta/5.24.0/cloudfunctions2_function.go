...
import (
	...
	cloudfunctions2function "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudfunctions2function"
	"io"
)
...
func (cf cloudfunctions2FunctionAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cf cloudfunctions2FunctionAttributes) KmsKeyName() terra.StringValue {
...
func (cf cloudfunctions2FunctionAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (cf cloudfunctions2FunctionAttributes) Url() terra.StringValue {
