...
import (
	...
	bigqueryconnection "github.com/golingon/terraproviders/googlebeta/5.24.0/bigqueryconnection"
	"io"
)
...
type BigqueryConnectionArgs struct {
	...
	// Spark: optional
	Spark *bigqueryconnection.Spark `hcl:"spark,block"`
	// Timeouts: optional
...
func (bc bigqueryConnectionAttributes) Spark() terra.ListValue[bigqueryconnection.SparkAttributes] {
	return terra.ReferenceAsList[bigqueryconnection.SparkAttributes](bc.ref.Append("spark"))
}
...
type bigqueryConnectionState struct {
	...
	Spark         []bigqueryconnection.SparkState         `json:"spark"`
