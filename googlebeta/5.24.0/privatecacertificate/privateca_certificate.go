...
type CustomSans struct {
	// ObectId: min=0
	ObectId []ObectId `hcl:"obect_id,block" validate:"min=0"`
}
...
func (cs CustomSansAttributes) ObectId() terra.ListValue[ObectIdAttributes] {
	return terra.ReferenceAsList[ObectIdAttributes](cs.ref.Append("obect_id"))
}

type ObectIdAttributes struct {
	ref terra.Reference
}

func (oi ObectIdAttributes) InternalRef() (terra.Reference, error) {
	return oi.ref, nil
}

func (oi ObectIdAttributes) InternalWithRef(ref terra.Reference) ObectIdAttributes {
	return ObectIdAttributes{ref: ref}
}

func (oi ObectIdAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return oi.ref.InternalTokens()
}

func (oi ObectIdAttributes) ObjectIdPath() terra.ListValue[terra.NumberValue] {
...
type CustomSansState struct {
	...
	ObectId  []ObectIdState `json:"obect_id"`
}

type ObectIdState struct {
