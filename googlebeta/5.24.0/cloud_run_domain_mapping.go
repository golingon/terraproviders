...
import (
	...
	cloudrundomainmapping "github.com/golingon/terraproviders/googlebeta/5.24.0/cloudrundomainmapping"
	"io"
)
...
type CloudRunDomainMappingArgs struct {
	...
	// Metadata: optional
	Metadata *cloudrundomainmapping.Metadata `hcl:"metadata,block"`
	// Spec: required
