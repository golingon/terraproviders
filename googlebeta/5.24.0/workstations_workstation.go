...
import (
	...
	workstationsworkstation "github.com/golingon/terraproviders/googlebeta/5.24.0/workstationsworkstation"
	"io"
)
...
func (ww workstationsWorkstationAttributes) EffectiveAnnotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ww.ref.Append("effective_annotations"))
}

// EffectiveLabels returns a reference to field effective_labels of google_workstations_workstation.
func (ww workstationsWorkstationAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ww.ref.Append("effective_labels"))
}

// Env returns a reference to field env of google_workstations_workstation.
func (ww workstationsWorkstationAttributes) Env() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ww.ref.Append("env"))
}
...
func (ww workstationsWorkstationAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ww.ref.Append("terraform_labels"))
}
