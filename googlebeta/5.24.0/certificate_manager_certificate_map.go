...
import (
	...
	certificatemanagercertificatemap "github.com/golingon/terraproviders/googlebeta/5.24.0/certificatemanagercertificatemap"
	"io"
)
...
func (cmcm certificateManagerCertificateMapAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (cmcm certificateManagerCertificateMapAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
