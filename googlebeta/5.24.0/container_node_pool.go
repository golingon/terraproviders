...
import (
	...
	containernodepool "github.com/golingon/terraproviders/googlebeta/5.24.0/containernodepool"
	"io"
)
...
type ContainerNodePoolArgs struct {
	...
	QueuedProvisioning *containernodepool.QueuedProvisioning `hcl:"queued_provisioning,block"`
	// Timeouts: optional
...
func (cnp containerNodePoolAttributes) QueuedProvisioning() terra.ListValue[containernodepool.QueuedProvisioningAttributes] {
	return terra.ReferenceAsList[containernodepool.QueuedProvisioningAttributes](cnp.ref.Append("queued_provisioning"))
}
...
type containerNodePoolState struct {
	...
	QueuedProvisioning       []containernodepool.QueuedProvisioningState `json:"queued_provisioning"`
