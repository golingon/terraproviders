...
import (
	...
	certificatemanagercertificatemapentry "github.com/golingon/terraproviders/googlebeta/5.24.0/certificatemanagercertificatemapentry"
	"io"
)
...
func (cmcme certificateManagerCertificateMapEntryAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmcme.ref.Append("effective_labels"))
}
...
func (cmcme certificateManagerCertificateMapEntryAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](cmcme.ref.Append("terraform_labels"))
}
