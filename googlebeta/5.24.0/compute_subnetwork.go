...
import (
	...
	computesubnetwork "github.com/golingon/terraproviders/googlebeta/5.24.0/computesubnetwork"
	"io"
)
...
func (cs computeSubnetworkAttributes) AllowSubnetCidrRoutesOverlap() terra.BoolValue {
	return terra.ReferenceAsBool(cs.ref.Append("allow_subnet_cidr_routes_overlap"))
}
...
func (cs computeSubnetworkAttributes) InternalIpv6Prefix() terra.StringValue {
	return terra.ReferenceAsString(cs.ref.Append("internal_ipv6_prefix"))
}
