...
import (
	...
	dataplexzone "github.com/golingon/terraproviders/googlebeta/5.24.0/dataplexzone"
	"io"
)
...
func (dz dataplexZoneAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dz.ref.Append("effective_labels"))
}
...
func (dz dataplexZoneAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](dz.ref.Append("terraform_labels"))
}
