...
import (
	...
	identityplatformconfig "github.com/golingon/terraproviders/googlebeta/5.24.0/identityplatformconfig"
	"io"
)
...
type IdentityPlatformConfigArgs struct {
	...
	// Client: optional
	Client *identityplatformconfig.Client `hcl:"client,block"`
	// Mfa: optional
	Mfa *identityplatformconfig.Mfa `hcl:"mfa,block"`
	// Monitoring: optional
	Monitoring *identityplatformconfig.Monitoring `hcl:"monitoring,block"`
	// MultiTenant: optional
	MultiTenant *identityplatformconfig.MultiTenant `hcl:"multi_tenant,block"`
	// Quota: optional
	...
	SmsRegionConfig *identityplatformconfig.SmsRegionConfig `hcl:"sms_region_config,block"`
	// Timeouts: optional
...
func (ipc identityPlatformConfigAttributes) Client() terra.ListValue[identityplatformconfig.ClientAttributes] {
	return terra.ReferenceAsList[identityplatformconfig.ClientAttributes](ipc.ref.Append("client"))
}

func (ipc identityPlatformConfigAttributes) Mfa() terra.ListValue[identityplatformconfig.MfaAttributes] {
	return terra.ReferenceAsList[identityplatformconfig.MfaAttributes](ipc.ref.Append("mfa"))
}

func (ipc identityPlatformConfigAttributes) Monitoring() terra.ListValue[identityplatformconfig.MonitoringAttributes] {
	return terra.ReferenceAsList[identityplatformconfig.MonitoringAttributes](ipc.ref.Append("monitoring"))
}

func (ipc identityPlatformConfigAttributes) MultiTenant() terra.ListValue[identityplatformconfig.MultiTenantAttributes] {
	return terra.ReferenceAsList[identityplatformconfig.MultiTenantAttributes](ipc.ref.Append("multi_tenant"))
}
...
func (ipc identityPlatformConfigAttributes) SmsRegionConfig() terra.ListValue[identityplatformconfig.SmsRegionConfigAttributes] {
	return terra.ReferenceAsList[identityplatformconfig.SmsRegionConfigAttributes](ipc.ref.Append("sms_region_config"))
}
...
type identityPlatformConfigState struct {
	...
	Client                   []identityplatformconfig.ClientState            `json:"client"`
	Mfa                      []identityplatformconfig.MfaState               `json:"mfa"`
	Monitoring               []identityplatformconfig.MonitoringState        `json:"monitoring"`
	MultiTenant              []identityplatformconfig.MultiTenantState       `json:"multi_tenant"`
	Quota                    []identityplatformconfig.QuotaState             `json:"quota"`
	SignIn                   []identityplatformconfig.SignInState            `json:"sign_in"`
	SmsRegionConfig          []identityplatformconfig.SmsRegionConfigState   `json:"sms_region_config"`
