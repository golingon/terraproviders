...
import (
	...
	workflowsworkflow "github.com/golingon/terraproviders/googlebeta/5.24.0/workflowsworkflow"
	"io"
)
...
func (ww workflowsWorkflowAttributes) CallLogLevel() terra.StringValue {
	return terra.ReferenceAsString(ww.ref.Append("call_log_level"))
}
...
func (ww workflowsWorkflowAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (ww workflowsWorkflowAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (ww workflowsWorkflowAttributes) UserEnvVars() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ww.ref.Append("user_env_vars"))
}
