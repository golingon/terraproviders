...
import (
	...
	bigqueryroutine "github.com/golingon/terraproviders/googlebeta/5.24.0/bigqueryroutine"
	"io"
)
...
type BigqueryRoutineArgs struct {
	...
	RemoteFunctionOptions *bigqueryroutine.RemoteFunctionOptions `hcl:"remote_function_options,block"`
	// SparkOptions: optional
	SparkOptions *bigqueryroutine.SparkOptions `hcl:"spark_options,block"`
	// Timeouts: optional
...
func (br bigqueryRoutineAttributes) DataGovernanceType() terra.StringValue {
	return terra.ReferenceAsString(br.ref.Append("data_governance_type"))
}
...
func (br bigqueryRoutineAttributes) RemoteFunctionOptions() terra.ListValue[bigqueryroutine.RemoteFunctionOptionsAttributes] {
	return terra.ReferenceAsList[bigqueryroutine.RemoteFunctionOptionsAttributes](br.ref.Append("remote_function_options"))
}

func (br bigqueryRoutineAttributes) SparkOptions() terra.ListValue[bigqueryroutine.SparkOptionsAttributes] {
	return terra.ReferenceAsList[bigqueryroutine.SparkOptionsAttributes](br.ref.Append("spark_options"))
}
...
type bigqueryRoutineState struct {
	...
	RemoteFunctionOptions []bigqueryroutine.RemoteFunctionOptionsState `json:"remote_function_options"`
	SparkOptions          []bigqueryroutine.SparkOptionsState          `json:"spark_options"`
