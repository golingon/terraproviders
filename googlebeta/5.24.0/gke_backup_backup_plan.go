...
import (
	...
	gkebackupbackupplan "github.com/golingon/terraproviders/googlebeta/5.24.0/gkebackupbackupplan"
	"io"
)
...
func (gbbp gkeBackupBackupPlanAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](gbbp.ref.Append("effective_labels"))
}
...
func (gbbp gkeBackupBackupPlanAttributes) State() terra.StringValue {
	return terra.ReferenceAsString(gbbp.ref.Append("state"))
}

// StateReason returns a reference to field state_reason of google_gke_backup_backup_plan.
func (gbbp gkeBackupBackupPlanAttributes) StateReason() terra.StringValue {
	return terra.ReferenceAsString(gbbp.ref.Append("state_reason"))
}

// TerraformLabels returns a reference to field terraform_labels of google_gke_backup_backup_plan.
func (gbbp gkeBackupBackupPlanAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](gbbp.ref.Append("terraform_labels"))
}
