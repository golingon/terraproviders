...
import (
	...
	dataprocmetastoreservice "github.com/golingon/terraproviders/googlebeta/5.24.0/dataprocmetastoreservice"
	"io"
)
...
type DataprocMetastoreServiceArgs struct {
	...
	ScalingConfig *dataprocmetastoreservice.ScalingConfig `hcl:"scaling_config,block"`
	// ScheduledBackup: optional
	ScheduledBackup *dataprocmetastoreservice.ScheduledBackup `hcl:"scheduled_backup,block"`
...
func (dms dataprocMetastoreServiceAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
...
func (dms dataprocMetastoreServiceAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
...
func (dms dataprocMetastoreServiceAttributes) ScalingConfig() terra.ListValue[dataprocmetastoreservice.ScalingConfigAttributes] {
	return terra.ReferenceAsList[dataprocmetastoreservice.ScalingConfigAttributes](dms.ref.Append("scaling_config"))
}

func (dms dataprocMetastoreServiceAttributes) ScheduledBackup() terra.ListValue[dataprocmetastoreservice.ScheduledBackupAttributes] {
	return terra.ReferenceAsList[dataprocmetastoreservice.ScheduledBackupAttributes](dms.ref.Append("scheduled_backup"))
}
...
type dataprocMetastoreServiceState struct {
	...
	ScalingConfig       []dataprocmetastoreservice.ScalingConfigState       `json:"scaling_config"`
	ScheduledBackup     []dataprocmetastoreservice.ScheduledBackupState     `json:"scheduled_backup"`
