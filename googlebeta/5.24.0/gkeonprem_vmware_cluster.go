...
import (
	...
	gkeonpremvmwarecluster "github.com/golingon/terraproviders/googlebeta/5.24.0/gkeonpremvmwarecluster"
	"io"
)
...
func (gvc gkeonpremVmwareClusterAttributes) DisableBundledIngress() terra.BoolValue {
	return terra.ReferenceAsBool(gvc.ref.Append("disable_bundled_ingress"))
}
