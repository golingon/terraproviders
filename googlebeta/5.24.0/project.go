...
import (
	...
	project "github.com/golingon/terraproviders/googlebeta/5.24.0/project"
	"io"
)
...
func (p projectAttributes) EffectiveLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](p.ref.Append("effective_labels"))
}
...
func (p projectAttributes) TerraformLabels() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](p.ref.Append("terraform_labels"))
}
