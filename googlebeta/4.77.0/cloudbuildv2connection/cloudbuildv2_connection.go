...
type GitlabConfig struct {
	...
	// ReadAuthorizerCredential: required
	ReadAuthorizerCredential *ReadAuthorizerCredential `hcl:"read_authorizer_credential,block" validate:"required"`
...
type ReadAuthorizerCredential struct {
	// UserTokenSecretVersion: string, required
	UserTokenSecretVersion terra.StringValue `hcl:"user_token_secret_version,attr" validate:"required"`
}
...
func (gc GitlabConfigAttributes) ReadAuthorizerCredential() terra.ListValue[ReadAuthorizerCredentialAttributes] {
	return terra.ReferenceAsList[ReadAuthorizerCredentialAttributes](gc.ref.Append("read_authorizer_credential"))
}
...
type ReadAuthorizerCredentialAttributes struct {
	ref terra.Reference
}

func (rac ReadAuthorizerCredentialAttributes) InternalRef() (terra.Reference, error) {
	return rac.ref, nil
}

func (rac ReadAuthorizerCredentialAttributes) InternalWithRef(ref terra.Reference) ReadAuthorizerCredentialAttributes {
	return ReadAuthorizerCredentialAttributes{ref: ref}
}

func (rac ReadAuthorizerCredentialAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return rac.ref.InternalTokens()
}

func (rac ReadAuthorizerCredentialAttributes) UserTokenSecretVersion() terra.StringValue {
	return terra.ReferenceAsString(rac.ref.Append("user_token_secret_version"))
}

func (rac ReadAuthorizerCredentialAttributes) Username() terra.StringValue {
...
type GitlabConfigState struct {
	...
	ReadAuthorizerCredential   []ReadAuthorizerCredentialState           `json:"read_authorizer_credential"`
...
type ReadAuthorizerCredentialState struct {
	UserTokenSecretVersion string `json:"user_token_secret_version"`
	Username               string `json:"username"`
}
