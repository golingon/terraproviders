...
import (
	"encoding/json"
	"fmt"
	spannerdatabase "github.com/golingon/terraproviders/googlebeta/4.84.0/spannerdatabase"
...
func (sd spannerDatabaseAttributes) EnableDropProtection() terra.BoolValue {
	return terra.ReferenceAsBool(sd.ref.Append("enable_drop_protection"))
}
