...
import (
	"encoding/json"
	"fmt"
	secretmanagersecretversion "github.com/golingon/terraproviders/googlebeta/4.84.0/secretmanagersecretversion"
...
func (smsv secretManagerSecretVersionAttributes) DeletionPolicy() terra.StringValue {
	return terra.ReferenceAsString(smsv.ref.Append("deletion_policy"))
}
...
func (smsv secretManagerSecretVersionAttributes) IsSecretDataBase64() terra.BoolValue {
	return terra.ReferenceAsBool(smsv.ref.Append("is_secret_data_base64"))
}
