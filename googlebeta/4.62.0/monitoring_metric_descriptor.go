...
import (
	"encoding/json"
	"fmt"
	monitoringmetricdescriptor "github.com/golingon/terraproviders/googlebeta/4.62.0/monitoringmetricdescriptor"
...
func (mmd monitoringMetricDescriptorAttributes) MonitoredResourceTypes() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](mmd.ref.Append("monitored_resource_types"))
}
