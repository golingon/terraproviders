...
type Attestation struct {
	...
	// ExternalProtectionLevelOptions: min=0
	ExternalProtectionLevelOptions []ExternalProtectionLevelOptions `hcl:"external_protection_level_options,block" validate:"min=0"`
}
