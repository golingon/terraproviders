...
package dataconnectuserhierarchygroup
...
func (hp HierarchyPathAttributes) InternalRef() terra.Reference {
	return hp.ref
}
...
func (hp HierarchyPathAttributes) LevelFive() terra.ListValue[LevelFiveAttributes] {
	return terra.ReferenceAsList[LevelFiveAttributes](hp.ref.Append("level_five"))
}

func (hp HierarchyPathAttributes) LevelFour() terra.ListValue[LevelFourAttributes] {
	return terra.ReferenceAsList[LevelFourAttributes](hp.ref.Append("level_four"))
}

func (hp HierarchyPathAttributes) LevelOne() terra.ListValue[LevelOneAttributes] {
	return terra.ReferenceAsList[LevelOneAttributes](hp.ref.Append("level_one"))
}

func (hp HierarchyPathAttributes) LevelThree() terra.ListValue[LevelThreeAttributes] {
	return terra.ReferenceAsList[LevelThreeAttributes](hp.ref.Append("level_three"))
}

func (hp HierarchyPathAttributes) LevelTwo() terra.ListValue[LevelTwoAttributes] {
	return terra.ReferenceAsList[LevelTwoAttributes](hp.ref.Append("level_two"))
}
