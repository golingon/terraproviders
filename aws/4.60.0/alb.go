...
import (
	"encoding/json"
	"fmt"
	alb "github.com/golingon/terraproviders/aws/4.60.0/alb"
...
type AlbArgs struct {
	...
	// DependsOn contains resources that Alb depends on
...
func (a albAttributes) NamePrefix() terra.StringValue {
	return terra.ReferenceString(a.ref.Append("name_prefix"))
}
...
func (a albAttributes) AccessLogs() terra.ListValue[alb.AccessLogsAttributes] {
	return terra.ReferenceList[alb.AccessLogsAttributes](a.ref.Append("access_logs"))
}

func (a albAttributes) SubnetMapping() terra.SetValue[alb.SubnetMappingAttributes] {
	return terra.ReferenceSet[alb.SubnetMappingAttributes](a.ref.Append("subnet_mapping"))
}

func (a albAttributes) Timeouts() alb.TimeoutsAttributes {
	return terra.ReferenceSingle[alb.TimeoutsAttributes](a.ref.Append("timeouts"))
}
