...
import (
	"encoding/json"
	"fmt"
	workspacesworkspace "github.com/golingon/terraproviders/aws/4.60.0/workspacesworkspace"
...
type WorkspacesWorkspaceArgs struct {
	...
	// DependsOn contains resources that WorkspacesWorkspace depends on
...
func (ww workspacesWorkspaceAttributes) TagsAll() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](ww.ref.Append("tags_all"))
}
...
func (ww workspacesWorkspaceAttributes) Timeouts() workspacesworkspace.TimeoutsAttributes {
	return terra.ReferenceSingle[workspacesworkspace.TimeoutsAttributes](ww.ref.Append("timeouts"))
}
...
func (ww workspacesWorkspaceAttributes) WorkspaceProperties() terra.ListValue[workspacesworkspace.WorkspacePropertiesAttributes] {
	return terra.ReferenceList[workspacesworkspace.WorkspacePropertiesAttributes](ww.ref.Append("workspace_properties"))
}
