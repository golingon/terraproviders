...
import (
	"encoding/json"
	"fmt"
	cloudformationtype "github.com/golingon/terraproviders/aws/4.60.0/cloudformationtype"
...
type CloudformationTypeArgs struct {
	...
	// DependsOn contains resources that CloudformationType depends on
...
func (ct cloudformationTypeAttributes) SchemaHandlerPackage() terra.StringValue {
	return terra.ReferenceString(ct.ref.Append("schema_handler_package"))
}
...
func (ct cloudformationTypeAttributes) LoggingConfig() terra.ListValue[cloudformationtype.LoggingConfigAttributes] {
	return terra.ReferenceList[cloudformationtype.LoggingConfigAttributes](ct.ref.Append("logging_config"))
}
