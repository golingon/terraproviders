...
import (
	"encoding/json"
	"fmt"
	mqbroker "github.com/golingon/terraproviders/aws/4.60.0/mqbroker"
...
type MqBrokerArgs struct {
	...
	// DependsOn contains resources that MqBroker depends on
...
func (mb mqBrokerAttributes) ApplyImmediately() terra.BoolValue {
	return terra.ReferenceBool(mb.ref.Append("apply_immediately"))
}
...
func (mb mqBrokerAttributes) TagsAll() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](mb.ref.Append("tags_all"))
}

func (mb mqBrokerAttributes) Instances() terra.ListValue[mqbroker.InstancesAttributes] {
	return terra.ReferenceList[mqbroker.InstancesAttributes](mb.ref.Append("instances"))
}

func (mb mqBrokerAttributes) Configuration() terra.ListValue[mqbroker.ConfigurationAttributes] {
	return terra.ReferenceList[mqbroker.ConfigurationAttributes](mb.ref.Append("configuration"))
}

func (mb mqBrokerAttributes) EncryptionOptions() terra.ListValue[mqbroker.EncryptionOptionsAttributes] {
	return terra.ReferenceList[mqbroker.EncryptionOptionsAttributes](mb.ref.Append("encryption_options"))
}

func (mb mqBrokerAttributes) LdapServerMetadata() terra.ListValue[mqbroker.LdapServerMetadataAttributes] {
	return terra.ReferenceList[mqbroker.LdapServerMetadataAttributes](mb.ref.Append("ldap_server_metadata"))
}

func (mb mqBrokerAttributes) Logs() terra.ListValue[mqbroker.LogsAttributes] {
	return terra.ReferenceList[mqbroker.LogsAttributes](mb.ref.Append("logs"))
}

func (mb mqBrokerAttributes) MaintenanceWindowStartTime() terra.ListValue[mqbroker.MaintenanceWindowStartTimeAttributes] {
	return terra.ReferenceList[mqbroker.MaintenanceWindowStartTimeAttributes](mb.ref.Append("maintenance_window_start_time"))
}

func (mb mqBrokerAttributes) Timeouts() mqbroker.TimeoutsAttributes {
	return terra.ReferenceSingle[mqbroker.TimeoutsAttributes](mb.ref.Append("timeouts"))
}

func (mb mqBrokerAttributes) User() terra.SetValue[mqbroker.UserAttributes] {
	return terra.ReferenceSet[mqbroker.UserAttributes](mb.ref.Append("user"))
}
