...
func (ctdp CreateTableDefaultPermissionAttributes) InternalRef() terra.Reference {
	return ctdp.ref
}
...
func (p PrincipalAttributes) InternalRef() terra.Reference {
	return p.ref
}
...
func (td TargetDatabaseAttributes) InternalRef() terra.Reference {
	return td.ref
}
