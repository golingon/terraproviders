...
import (
	"encoding/json"
	"fmt"
	opsworksecsclusterlayer "github.com/golingon/terraproviders/aws/4.60.0/opsworksecsclusterlayer"
...
type OpsworksEcsClusterLayerArgs struct {
	...
	// DependsOn contains resources that OpsworksEcsClusterLayer depends on
...
func (oecl opsworksEcsClusterLayerAttributes) CloudwatchConfiguration() terra.ListValue[opsworksecsclusterlayer.CloudwatchConfigurationAttributes] {
	return terra.ReferenceList[opsworksecsclusterlayer.CloudwatchConfigurationAttributes](oecl.ref.Append("cloudwatch_configuration"))
}

func (oecl opsworksEcsClusterLayerAttributes) EbsVolume() terra.SetValue[opsworksecsclusterlayer.EbsVolumeAttributes] {
	return terra.ReferenceSet[opsworksecsclusterlayer.EbsVolumeAttributes](oecl.ref.Append("ebs_volume"))
}
...
func (oecl opsworksEcsClusterLayerAttributes) LoadBasedAutoScaling() terra.ListValue[opsworksecsclusterlayer.LoadBasedAutoScalingAttributes] {
	return terra.ReferenceList[opsworksecsclusterlayer.LoadBasedAutoScalingAttributes](oecl.ref.Append("load_based_auto_scaling"))
}
