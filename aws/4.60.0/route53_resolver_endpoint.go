...
import (
	"encoding/json"
	"fmt"
	route53resolverendpoint "github.com/golingon/terraproviders/aws/4.60.0/route53resolverendpoint"
...
type Route53ResolverEndpointArgs struct {
	...
	// DependsOn contains resources that Route53ResolverEndpoint depends on
...
func (rre route53ResolverEndpointAttributes) HostVpcId() terra.StringValue {
	return terra.ReferenceString(rre.ref.Append("host_vpc_id"))
}
...
func (rre route53ResolverEndpointAttributes) SecurityGroupIds() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](rre.ref.Append("security_group_ids"))
}

func (rre route53ResolverEndpointAttributes) Tags() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](rre.ref.Append("tags"))
}

func (rre route53ResolverEndpointAttributes) TagsAll() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](rre.ref.Append("tags_all"))
}

func (rre route53ResolverEndpointAttributes) IpAddress() terra.SetValue[route53resolverendpoint.IpAddressAttributes] {
	return terra.ReferenceSet[route53resolverendpoint.IpAddressAttributes](rre.ref.Append("ip_address"))
}

func (rre route53ResolverEndpointAttributes) Timeouts() route53resolverendpoint.TimeoutsAttributes {
	return terra.ReferenceSingle[route53resolverendpoint.TimeoutsAttributes](rre.ref.Append("timeouts"))
}
