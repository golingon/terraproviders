...
import (
	"encoding/json"
	"fmt"
	wafxssmatchset "github.com/golingon/terraproviders/aws/4.60.0/wafxssmatchset"
...
type WafXssMatchSetArgs struct {
	...
	// DependsOn contains resources that WafXssMatchSet depends on
...
func (wxms wafXssMatchSetAttributes) Arn() terra.StringValue {
	return terra.ReferenceString(wxms.ref.Append("arn"))
}
...
func (wxms wafXssMatchSetAttributes) XssMatchTuples() terra.SetValue[wafxssmatchset.XssMatchTuplesAttributes] {
	return terra.ReferenceSet[wafxssmatchset.XssMatchTuplesAttributes](wxms.ref.Append("xss_match_tuples"))
}
