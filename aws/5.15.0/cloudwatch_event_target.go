...
import (
	"encoding/json"
	"fmt"
	cloudwatcheventtarget "github.com/golingon/terraproviders/aws/5.15.0/cloudwatcheventtarget"
...
type CloudwatchEventTargetArgs struct {
	...
	SagemakerPipelineTarget *cloudwatcheventtarget.SagemakerPipelineTarget `hcl:"sagemaker_pipeline_target,block"`
	// SqsTarget: optional
...
func (cet cloudwatchEventTargetAttributes) SagemakerPipelineTarget() terra.ListValue[cloudwatcheventtarget.SagemakerPipelineTargetAttributes] {
	return terra.ReferenceAsList[cloudwatcheventtarget.SagemakerPipelineTargetAttributes](cet.ref.Append("sagemaker_pipeline_target"))
}
...
type cloudwatchEventTargetState struct {
	...
	SagemakerPipelineTarget []cloudwatcheventtarget.SagemakerPipelineTargetState `json:"sagemaker_pipeline_target"`
