...
import (
	"encoding/json"
	"fmt"
	rdsclusterinstance "github.com/golingon/terraproviders/aws/5.15.0/rdsclusterinstance"
...
func (rci rdsClusterInstanceAttributes) CustomIamInstanceProfile() terra.StringValue {
	return terra.ReferenceAsString(rci.ref.Append("custom_iam_instance_profile"))
}
