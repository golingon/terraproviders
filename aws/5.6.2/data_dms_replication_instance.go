...
func (dri dataDmsReplicationInstanceAttributes) AllowMajorVersionUpgrade() terra.BoolValue {
...
func (dri dataDmsReplicationInstanceAttributes) ApplyImmediately() terra.BoolValue {
