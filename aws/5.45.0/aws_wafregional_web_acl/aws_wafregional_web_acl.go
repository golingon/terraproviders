...
// Resource represents the Terraform resource aws_wafregional_web_acl.
type Resource struct {
	Name      string
	Args      Args
	state     *awsWafregionalWebAclState
...
func (awwa *Resource) Attributes() awsWafregionalWebAclAttributes {
	return awsWafregionalWebAclAttributes{ref: terra.ReferenceResource(awwa)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (awwa *Resource) ImportState(state io.Reader) error {
	awwa.state = &awsWafregionalWebAclState{}
...
func (awwa *Resource) State() (*awsWafregionalWebAclState, bool) {
	return awwa.state, awwa.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (awwa *Resource) StateMust() *awsWafregionalWebAclState {
	if awwa.state == nil {
...
// Args contains the configurations for aws_wafregional_web_acl.
type Args struct {
	// Id: string, optional
...
func (awwa awsWafregionalWebAclAttributes) MetricName() terra.StringValue {
...
func (awwa awsWafregionalWebAclAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(awwa.ref.Append("name"))
}

// Tags returns a reference to field tags of aws_wafregional_web_acl.
func (awwa awsWafregionalWebAclAttributes) Tags() terra.MapValue[terra.StringValue] {
...
func (awwa awsWafregionalWebAclAttributes) TagsAll() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](awwa.ref.Append("tags_all"))
}

func (awwa awsWafregionalWebAclAttributes) DefaultAction() terra.ListValue[DefaultActionAttributes] {
	return terra.ReferenceAsList[DefaultActionAttributes](awwa.ref.Append("default_action"))
}

func (awwa awsWafregionalWebAclAttributes) LoggingConfiguration() terra.ListValue[LoggingConfigurationAttributes] {
	return terra.ReferenceAsList[LoggingConfigurationAttributes](awwa.ref.Append("logging_configuration"))
}

func (awwa awsWafregionalWebAclAttributes) Rule() terra.SetValue[RuleAttributes] {
	return terra.ReferenceAsSet[RuleAttributes](awwa.ref.Append("rule"))
}

type awsWafregionalWebAclState struct {
	Arn                  string                      `json:"arn"`
	Id                   string                      `json:"id"`
