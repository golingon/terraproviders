...
func (grp GeoproximityRoutingPolicyAttributes) Coordinates() terra.SetValue[GeoproximityRoutingPolicyCoordinatesAttributes] {
	return terra.ReferenceAsSet[GeoproximityRoutingPolicyCoordinatesAttributes](grp.ref.Append("coordinates"))
}
...
func (c GeoproximityRoutingPolicyCoordinatesAttributes) InternalRef() (terra.Reference, error) {
	return c.ref, nil
}

func (c GeoproximityRoutingPolicyCoordinatesAttributes) InternalWithRef(ref terra.Reference) GeoproximityRoutingPolicyCoordinatesAttributes {
	return GeoproximityRoutingPolicyCoordinatesAttributes{ref: ref}
}

func (c GeoproximityRoutingPolicyCoordinatesAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return c.ref.InternalTokens()
}

func (c GeoproximityRoutingPolicyCoordinatesAttributes) Latitude() terra.StringValue {
	return terra.ReferenceAsString(c.ref.Append("latitude"))
}

func (c GeoproximityRoutingPolicyCoordinatesAttributes) Longitude() terra.StringValue {
