...
type Filters struct {
	// MessageTypes: set of string, optional
	MessageTypes terra.SetValue[terra.StringValue] `hcl:"message_types,attr"`
	// Severities: set of string, optional
	Severities terra.SetValue[terra.StringValue] `hcl:"severities,attr"`
}
...
func (f FiltersAttributes) MessageTypes() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](f.ref.Append("message_types"))
}

func (f FiltersAttributes) Severities() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](f.ref.Append("severities"))
}
