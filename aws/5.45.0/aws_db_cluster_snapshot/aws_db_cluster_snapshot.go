...
// Resource represents the Terraform resource aws_db_cluster_snapshot.
type Resource struct {
	Name      string
	Args      Args
	state     *awsDbClusterSnapshotState
...
func (adcs *Resource) Attributes() awsDbClusterSnapshotAttributes {
	return awsDbClusterSnapshotAttributes{ref: terra.ReferenceResource(adcs)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (adcs *Resource) ImportState(state io.Reader) error {
	adcs.state = &awsDbClusterSnapshotState{}
...
func (adcs *Resource) State() (*awsDbClusterSnapshotState, bool) {
	return adcs.state, adcs.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (adcs *Resource) StateMust() *awsDbClusterSnapshotState {
	if adcs.state == nil {
...
// Args contains the configurations for aws_db_cluster_snapshot.
type Args struct {
...
type awsDbClusterSnapshotAttributes struct {
	ref terra.Reference
}

// AllocatedStorage returns a reference to field allocated_storage of aws_db_cluster_snapshot.
func (adcs awsDbClusterSnapshotAttributes) AllocatedStorage() terra.NumberValue {
...
func (adcs awsDbClusterSnapshotAttributes) AvailabilityZones() terra.ListValue[terra.StringValue] {
...
func (adcs awsDbClusterSnapshotAttributes) DbClusterIdentifier() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) DbClusterSnapshotArn() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) DbClusterSnapshotIdentifier() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) Engine() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) EngineVersion() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) Id() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) KmsKeyId() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) LicenseModel() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) Port() terra.NumberValue {
...
func (adcs awsDbClusterSnapshotAttributes) SnapshotType() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) SourceDbClusterSnapshotArn() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) Status() terra.StringValue {
...
func (adcs awsDbClusterSnapshotAttributes) StorageEncrypted() terra.BoolValue {
...
func (adcs awsDbClusterSnapshotAttributes) Tags() terra.MapValue[terra.StringValue] {
...
func (adcs awsDbClusterSnapshotAttributes) TagsAll() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](adcs.ref.Append("tags_all"))
}

// VpcId returns a reference to field vpc_id of aws_db_cluster_snapshot.
func (adcs awsDbClusterSnapshotAttributes) VpcId() terra.StringValue {
	return terra.ReferenceAsString(adcs.ref.Append("vpc_id"))
}

func (adcs awsDbClusterSnapshotAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](adcs.ref.Append("timeouts"))
}

type awsDbClusterSnapshotState struct {
