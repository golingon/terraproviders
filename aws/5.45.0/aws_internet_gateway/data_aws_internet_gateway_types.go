...
type DataAttachmentsAttributes struct {
	ref terra.Reference
}

func (a DataAttachmentsAttributes) InternalRef() (terra.Reference, error) {
	return a.ref, nil
}

func (a DataAttachmentsAttributes) InternalWithRef(ref terra.Reference) DataAttachmentsAttributes {
	return DataAttachmentsAttributes{ref: ref}
}

func (a DataAttachmentsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return a.ref.InternalTokens()
}

func (a DataAttachmentsAttributes) State() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("state"))
}

func (a DataAttachmentsAttributes) VpcId() terra.StringValue {
...
type DataAttachmentsState struct {
