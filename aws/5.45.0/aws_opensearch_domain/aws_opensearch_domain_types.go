...
type AdvancedSecurityOptions struct {
	// AnonymousAuthEnabled: bool, optional
...
type AutoTuneOptions struct {
	...
	// UseOffPeakWindow: bool, optional
	UseOffPeakWindow terra.BoolValue `hcl:"use_off_peak_window,attr"`
...
type ClusterConfig struct {
	...
	// MultiAzWithStandbyEnabled: bool, optional
	MultiAzWithStandbyEnabled terra.BoolValue `hcl:"multi_az_with_standby_enabled,attr"`
...
type OffPeakWindowOptions struct {
	// Enabled: bool, optional
	Enabled terra.BoolValue `hcl:"enabled,attr"`
	// OffPeakWindowOptionsOffPeakWindow: optional
	OffPeakWindow *OffPeakWindowOptionsOffPeakWindow `hcl:"off_peak_window,block"`
}

type OffPeakWindowOptionsOffPeakWindow struct {
	// OffPeakWindowOptionsOffPeakWindowWindowStartTime: optional
	WindowStartTime *OffPeakWindowOptionsOffPeakWindowWindowStartTime `hcl:"window_start_time,block"`
}

type OffPeakWindowOptionsOffPeakWindowWindowStartTime struct {
...
type SoftwareUpdateOptions struct {
	// AutoSoftwareUpdateEnabled: bool, optional
	AutoSoftwareUpdateEnabled terra.BoolValue `hcl:"auto_software_update_enabled,attr"`
}
...
func (ato AutoTuneOptionsAttributes) UseOffPeakWindow() terra.BoolValue {
...
func (opwo OffPeakWindowOptionsAttributes) InternalWithRef(ref terra.Reference) OffPeakWindowOptionsAttributes {
	return OffPeakWindowOptionsAttributes{ref: ref}
}
...
func (opwo OffPeakWindowOptionsAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(opwo.ref.Append("enabled"))
}

func (opwo OffPeakWindowOptionsAttributes) OffPeakWindow() terra.ListValue[OffPeakWindowOptionsOffPeakWindowAttributes] {
	return terra.ReferenceAsList[OffPeakWindowOptionsOffPeakWindowAttributes](opwo.ref.Append("off_peak_window"))
}

type OffPeakWindowOptionsOffPeakWindowAttributes struct {
	ref terra.Reference
}

func (opw OffPeakWindowOptionsOffPeakWindowAttributes) InternalRef() (terra.Reference, error) {
	return opw.ref, nil
}

func (opw OffPeakWindowOptionsOffPeakWindowAttributes) InternalWithRef(ref terra.Reference) OffPeakWindowOptionsOffPeakWindowAttributes {
	return OffPeakWindowOptionsOffPeakWindowAttributes{ref: ref}
}

func (opw OffPeakWindowOptionsOffPeakWindowAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return opw.ref.InternalTokens()
}

func (opw OffPeakWindowOptionsOffPeakWindowAttributes) WindowStartTime() terra.ListValue[OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes] {
	return terra.ReferenceAsList[OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes](opw.ref.Append("window_start_time"))
}

type OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes struct {
	ref terra.Reference
}

func (wst OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes) InternalRef() (terra.Reference, error) {
	return wst.ref, nil
}

func (wst OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes) InternalWithRef(ref terra.Reference) OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes {
	return OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes{ref: ref}
}

func (wst OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return wst.ref.InternalTokens()
}

func (wst OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes) Hours() terra.NumberValue {
	return terra.ReferenceAsNumber(wst.ref.Append("hours"))
}

func (wst OffPeakWindowOptionsOffPeakWindowWindowStartTimeAttributes) Minutes() terra.NumberValue {
...
func (suo SoftwareUpdateOptionsAttributes) InternalRef() (terra.Reference, error) {
	return suo.ref, nil
}

func (suo SoftwareUpdateOptionsAttributes) InternalWithRef(ref terra.Reference) SoftwareUpdateOptionsAttributes {
	return SoftwareUpdateOptionsAttributes{ref: ref}
}
...
type OffPeakWindowOptionsState struct {
	Enabled       bool                                     `json:"enabled"`
	OffPeakWindow []OffPeakWindowOptionsOffPeakWindowState `json:"off_peak_window"`
}

type OffPeakWindowOptionsOffPeakWindowState struct {
	WindowStartTime []OffPeakWindowOptionsOffPeakWindowWindowStartTimeState `json:"window_start_time"`
}

type OffPeakWindowOptionsOffPeakWindowWindowStartTimeState struct {
