...
func (cp ConnectionPropertiesAttributes) CrossClusterSearch() terra.ListValue[ConnectionPropertiesCrossClusterSearchAttributes] {
	return terra.ReferenceAsList[ConnectionPropertiesCrossClusterSearchAttributes](cp.ref.Append("cross_cluster_search"))
}
...
func (ccs ConnectionPropertiesCrossClusterSearchAttributes) InternalRef() (terra.Reference, error) {
	return ccs.ref, nil
}

func (ccs ConnectionPropertiesCrossClusterSearchAttributes) InternalWithRef(ref terra.Reference) ConnectionPropertiesCrossClusterSearchAttributes {
	return ConnectionPropertiesCrossClusterSearchAttributes{ref: ref}
}

func (ccs ConnectionPropertiesCrossClusterSearchAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ccs.ref.InternalTokens()
}

func (ccs ConnectionPropertiesCrossClusterSearchAttributes) SkipUnavailable() terra.StringValue {
