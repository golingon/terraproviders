...
type ComputeResources struct {
	...
	// ComputeResourcesEc2Configuration: min=0,max=2
...
type UpdatePolicy struct {
	// JobExecutionTimeoutMinutes: number, required
	JobExecutionTimeoutMinutes terra.NumberValue `hcl:"job_execution_timeout_minutes,attr" validate:"required"`
	// TerminateJobsOnUpdate: bool, required
	TerminateJobsOnUpdate terra.BoolValue `hcl:"terminate_jobs_on_update,attr" validate:"required"`
}
...
func (cr ComputeResourcesAttributes) PlacementGroup() terra.StringValue {
	return terra.ReferenceAsString(cr.ref.Append("placement_group"))
}
