...
type AccountRecoverySetting struct {
	// AccountRecoverySettingRecoveryMechanism: min=0,max=2
...
type AdminCreateUserConfig struct {
	...
	// AdminCreateUserConfigInviteMessageTemplate: optional
...
type LambdaConfig struct {
	...
	// LambdaConfigCustomEmailSender: optional
	CustomEmailSender *LambdaConfigCustomEmailSender `hcl:"custom_email_sender,block"`
	// LambdaConfigCustomSmsSender: optional
	CustomSmsSender *LambdaConfigCustomSmsSender `hcl:"custom_sms_sender,block"`
	// LambdaConfigPreTokenGenerationConfig: optional
	PreTokenGenerationConfig *LambdaConfigPreTokenGenerationConfig `hcl:"pre_token_generation_config,block"`
}
...
type LambdaConfigPreTokenGenerationConfig struct {
	// LambdaArn: string, required
	LambdaArn terra.StringValue `hcl:"lambda_arn,attr" validate:"required"`
	// LambdaVersion: string, required
	LambdaVersion terra.StringValue `hcl:"lambda_version,attr" validate:"required"`
...
func (lc LambdaConfigAttributes) PreTokenGenerationConfig() terra.ListValue[LambdaConfigPreTokenGenerationConfigAttributes] {
	return terra.ReferenceAsList[LambdaConfigPreTokenGenerationConfigAttributes](lc.ref.Append("pre_token_generation_config"))
}
...
type LambdaConfigPreTokenGenerationConfigAttributes struct {
	ref terra.Reference
}

func (ptgc LambdaConfigPreTokenGenerationConfigAttributes) InternalRef() (terra.Reference, error) {
	return ptgc.ref, nil
}

func (ptgc LambdaConfigPreTokenGenerationConfigAttributes) InternalWithRef(ref terra.Reference) LambdaConfigPreTokenGenerationConfigAttributes {
	return LambdaConfigPreTokenGenerationConfigAttributes{ref: ref}
}

func (ptgc LambdaConfigPreTokenGenerationConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ptgc.ref.InternalTokens()
}

func (ptgc LambdaConfigPreTokenGenerationConfigAttributes) LambdaArn() terra.StringValue {
	return terra.ReferenceAsString(ptgc.ref.Append("lambda_arn"))
}

func (ptgc LambdaConfigPreTokenGenerationConfigAttributes) LambdaVersion() terra.StringValue {
	return terra.ReferenceAsString(ptgc.ref.Append("lambda_version"))
}
...
type LambdaConfigState struct {
	...
	PreTokenGenerationConfig    []LambdaConfigPreTokenGenerationConfigState `json:"pre_token_generation_config"`
}
...
type LambdaConfigPreTokenGenerationConfigState struct {
	LambdaArn     string `json:"lambda_arn"`
	LambdaVersion string `json:"lambda_version"`
}
