...
import (
	"encoding/json"
	"fmt"
	chimesdkmediapipelinesmediainsightspipelineconfiguration "github.com/golingon/terraproviders/aws/5.7.0/chimesdkmediapipelinesmediainsightspipelineconfiguration"
