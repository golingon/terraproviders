...
import (
	"encoding/json"
	"fmt"
	networkmanagercorenetwork "github.com/golingon/terraproviders/aws/5.22.0/networkmanagercorenetwork"
...
func (ncn networkmanagerCoreNetworkAttributes) BasePolicyDocument() terra.StringValue {
	return terra.ReferenceAsString(ncn.ref.Append("base_policy_document"))
}
