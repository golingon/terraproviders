...
import (
	"encoding/json"
	"fmt"
	dmss3endpoint "github.com/golingon/terraproviders/aws/5.22.0/dmss3endpoint"
...
func (dse dmsS3EndpointAttributes) GlueCatalogGeneration() terra.BoolValue {
	return terra.ReferenceAsBool(dse.ref.Append("glue_catalog_generation"))
}
