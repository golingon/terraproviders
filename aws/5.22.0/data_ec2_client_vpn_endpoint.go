...
import (
	dataec2clientvpnendpoint "github.com/golingon/terraproviders/aws/5.22.0/dataec2clientvpnendpoint"
...
func (ecve dataEc2ClientVpnEndpointAttributes) SelfServicePortalUrl() terra.StringValue {
	return terra.ReferenceAsString(ecve.ref.Append("self_service_portal_url"))
}
