...
import (
	"encoding/json"
	"fmt"
	cloudfrontdistribution "github.com/golingon/terraproviders/aws/5.22.0/cloudfrontdistribution"
...
func (cd cloudfrontDistributionAttributes) ContinuousDeploymentPolicyId() terra.StringValue {
	return terra.ReferenceAsString(cd.ref.Append("continuous_deployment_policy_id"))
}
...
func (cd cloudfrontDistributionAttributes) Staging() terra.BoolValue {
	return terra.ReferenceAsBool(cd.ref.Append("staging"))
}
