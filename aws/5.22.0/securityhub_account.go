...
func (sa securityhubAccountAttributes) Arn() terra.StringValue {
...
func (sa securityhubAccountAttributes) AutoEnableControls() terra.BoolValue {
	return terra.ReferenceAsBool(sa.ref.Append("auto_enable_controls"))
}

// ControlFindingGenerator returns a reference to field control_finding_generator of aws_securityhub_account.
func (sa securityhubAccountAttributes) ControlFindingGenerator() terra.StringValue {
	return terra.ReferenceAsString(sa.ref.Append("control_finding_generator"))
}
