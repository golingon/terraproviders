...
import (
	"encoding/json"
	"fmt"
	redshiftserverlessworkgroup "github.com/golingon/terraproviders/aws/4.63.0/redshiftserverlessworkgroup"
...
func (rw redshiftserverlessWorkgroupAttributes) ConfigParameter() terra.ListValue[redshiftserverlessworkgroup.ConfigParameterAttributes] {
	return terra.ReferenceAsList[redshiftserverlessworkgroup.ConfigParameterAttributes](rw.ref.Append("config_parameter"))
}
