...
import (
	"encoding/json"
	"fmt"
	s3controlobjectlambdaaccesspoint "github.com/golingon/terraproviders/aws/5.20.0/s3controlobjectlambdaaccesspoint"
...
func (solap s3ControlObjectLambdaAccessPointAttributes) Alias() terra.StringValue {
	return terra.ReferenceAsString(solap.ref.Append("alias"))
}
