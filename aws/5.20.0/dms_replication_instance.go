...
import (
	"encoding/json"
	"fmt"
	dmsreplicationinstance "github.com/golingon/terraproviders/aws/5.20.0/dmsreplicationinstance"
...
func (dri dmsReplicationInstanceAttributes) NetworkType() terra.StringValue {
