...
import (
	dataramresourceshare "github.com/golingon/terraproviders/aws/5.20.0/dataramresourceshare"
...
func (rrs dataRamResourceShareAttributes) ResourceArns() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](rrs.ref.Append("resource_arns"))
}
