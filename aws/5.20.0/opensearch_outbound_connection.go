...
import (
	"encoding/json"
	"fmt"
	opensearchoutboundconnection "github.com/golingon/terraproviders/aws/5.20.0/opensearchoutboundconnection"
...
type OpensearchOutboundConnectionArgs struct {
	...
	ConnectionProperties *opensearchoutboundconnection.ConnectionProperties `hcl:"connection_properties,block"`
...
func (ooc opensearchOutboundConnectionAttributes) AcceptConnection() terra.BoolValue {
	return terra.ReferenceAsBool(ooc.ref.Append("accept_connection"))
}
...
func (ooc opensearchOutboundConnectionAttributes) ConnectionMode() terra.StringValue {
	return terra.ReferenceAsString(ooc.ref.Append("connection_mode"))
}
...
func (ooc opensearchOutboundConnectionAttributes) ConnectionProperties() terra.ListValue[opensearchoutboundconnection.ConnectionPropertiesAttributes] {
	return terra.ReferenceAsList[opensearchoutboundconnection.ConnectionPropertiesAttributes](ooc.ref.Append("connection_properties"))
}
...
type opensearchOutboundConnectionState struct {
	...
	Id                   string                                                   `json:"id"`
	ConnectionProperties []opensearchoutboundconnection.ConnectionPropertiesState `json:"connection_properties"`
