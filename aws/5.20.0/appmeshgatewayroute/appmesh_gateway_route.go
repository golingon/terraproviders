...
type Http2RouteActionRewrite struct {
	...
	// Http2RouteActionRewritePath: optional
	Path *Http2RouteActionRewritePath `hcl:"path,block"`
...
type HttpRouteActionRewrite struct {
	...
	// HttpRouteActionRewritePath: optional
	Path *HttpRouteActionRewritePath `hcl:"path,block"`
