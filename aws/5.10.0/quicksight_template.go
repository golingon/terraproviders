...
import (
	"encoding/json"
	"fmt"
	quicksighttemplate "github.com/golingon/terraproviders/aws/5.10.0/quicksighttemplate"
...
func (qt quicksightTemplateAttributes) Permissions() terra.ListValue[quicksighttemplate.PermissionsAttributes] {
	return terra.ReferenceAsList[quicksighttemplate.PermissionsAttributes](qt.ref.Append("permissions"))
}
