...
import (
	"encoding/json"
	"fmt"
	fsxwindowsfilesystem "github.com/golingon/terraproviders/aws/5.21.0/fsxwindowsfilesystem"
...
type FsxWindowsFileSystemArgs struct {
	...
	DiskIopsConfiguration *fsxwindowsfilesystem.DiskIopsConfiguration `hcl:"disk_iops_configuration,block"`
...
func (fwfs fsxWindowsFileSystemAttributes) DiskIopsConfiguration() terra.ListValue[fsxwindowsfilesystem.DiskIopsConfigurationAttributes] {
	return terra.ReferenceAsList[fsxwindowsfilesystem.DiskIopsConfigurationAttributes](fwfs.ref.Append("disk_iops_configuration"))
}
...
type fsxWindowsFileSystemState struct {
	...
	DiskIopsConfiguration         []fsxwindowsfilesystem.DiskIopsConfigurationState      `json:"disk_iops_configuration"`
