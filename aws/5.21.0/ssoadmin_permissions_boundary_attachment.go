...
import (
	"encoding/json"
	"fmt"
	ssoadminpermissionsboundaryattachment "github.com/golingon/terraproviders/aws/5.21.0/ssoadminpermissionsboundaryattachment"
...
type SsoadminPermissionsBoundaryAttachmentArgs struct {
	...
	// Timeouts: optional
	Timeouts *ssoadminpermissionsboundaryattachment.Timeouts `hcl:"timeouts,block"`
}
...
func (spba ssoadminPermissionsBoundaryAttachmentAttributes) Timeouts() ssoadminpermissionsboundaryattachment.TimeoutsAttributes {
	return terra.ReferenceAsSingle[ssoadminpermissionsboundaryattachment.TimeoutsAttributes](spba.ref.Append("timeouts"))
}
...
type ssoadminPermissionsBoundaryAttachmentState struct {
	...
	Timeouts            *ssoadminpermissionsboundaryattachment.TimeoutsState             `json:"timeouts"`
}
