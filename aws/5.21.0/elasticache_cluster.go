...
import (
	"encoding/json"
	"fmt"
	elasticachecluster "github.com/golingon/terraproviders/aws/5.21.0/elasticachecluster"
...
func (ec elasticacheClusterAttributes) TransitEncryptionEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(ec.ref.Append("transit_encryption_enabled"))
}
