...
import (
	"encoding/json"
	"fmt"
	kinesisfirehosedeliverystream "github.com/golingon/terraproviders/aws/5.21.0/kinesisfirehosedeliverystream"
...
type KinesisFirehoseDeliveryStreamArgs struct {
	...
	MskSourceConfiguration *kinesisfirehosedeliverystream.MskSourceConfiguration `hcl:"msk_source_configuration,block"`
	...
	OpensearchserverlessConfiguration *kinesisfirehosedeliverystream.OpensearchserverlessConfiguration `hcl:"opensearchserverless_configuration,block"`
...
func (kfds kinesisFirehoseDeliveryStreamAttributes) MskSourceConfiguration() terra.ListValue[kinesisfirehosedeliverystream.MskSourceConfigurationAttributes] {
	return terra.ReferenceAsList[kinesisfirehosedeliverystream.MskSourceConfigurationAttributes](kfds.ref.Append("msk_source_configuration"))
}
...
func (kfds kinesisFirehoseDeliveryStreamAttributes) OpensearchserverlessConfiguration() terra.ListValue[kinesisfirehosedeliverystream.OpensearchserverlessConfigurationAttributes] {
	return terra.ReferenceAsList[kinesisfirehosedeliverystream.OpensearchserverlessConfigurationAttributes](kfds.ref.Append("opensearchserverless_configuration"))
}
...
type kinesisFirehoseDeliveryStreamState struct {
	...
	MskSourceConfiguration            []kinesisfirehosedeliverystream.MskSourceConfigurationState            `json:"msk_source_configuration"`
	OpensearchConfiguration           []kinesisfirehosedeliverystream.OpensearchConfigurationState           `json:"opensearch_configuration"`
	OpensearchserverlessConfiguration []kinesisfirehosedeliverystream.OpensearchserverlessConfigurationState `json:"opensearchserverless_configuration"`
