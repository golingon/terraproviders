...
import (
	"encoding/json"
	"fmt"
	fsxontapvolume "github.com/golingon/terraproviders/aws/5.21.0/fsxontapvolume"
...
type FsxOntapVolumeArgs struct {
	...
	SnaplockConfiguration *fsxontapvolume.SnaplockConfiguration `hcl:"snaplock_configuration,block"`
...
func (fov fsxOntapVolumeAttributes) BypassSnaplockEnterpriseRetention() terra.BoolValue {
	return terra.ReferenceAsBool(fov.ref.Append("bypass_snaplock_enterprise_retention"))
}

// CopyTagsToBackups returns a reference to field copy_tags_to_backups of aws_fsx_ontap_volume.
func (fov fsxOntapVolumeAttributes) CopyTagsToBackups() terra.BoolValue {
	return terra.ReferenceAsBool(fov.ref.Append("copy_tags_to_backups"))
}
...
func (fov fsxOntapVolumeAttributes) SkipFinalBackup() terra.BoolValue {
	return terra.ReferenceAsBool(fov.ref.Append("skip_final_backup"))
}

// SnapshotPolicy returns a reference to field snapshot_policy of aws_fsx_ontap_volume.
func (fov fsxOntapVolumeAttributes) SnapshotPolicy() terra.StringValue {
	return terra.ReferenceAsString(fov.ref.Append("snapshot_policy"))
}
...
func (fov fsxOntapVolumeAttributes) SnaplockConfiguration() terra.ListValue[fsxontapvolume.SnaplockConfigurationAttributes] {
	return terra.ReferenceAsList[fsxontapvolume.SnaplockConfigurationAttributes](fov.ref.Append("snaplock_configuration"))
}
...
type fsxOntapVolumeState struct {
	...
	SnaplockConfiguration             []fsxontapvolume.SnaplockConfigurationState `json:"snaplock_configuration"`
