...
func (p OpensearchserverlessConfigurationProcessingConfigurationProcessorsAttributes) Parameters() terra.ListValue[OpensearchserverlessConfigurationProcessingConfigurationProcessorsParametersAttributes] {
	return terra.ReferenceAsList[OpensearchserverlessConfigurationProcessingConfigurationProcessorsParametersAttributes](p.ref.Append("parameters"))
}
