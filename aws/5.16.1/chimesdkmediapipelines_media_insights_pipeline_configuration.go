...
import (
	"encoding/json"
	"fmt"
	chimesdkmediapipelinesmediainsightspipelineconfiguration "github.com/golingon/terraproviders/aws/5.16.1/chimesdkmediapipelinesmediainsightspipelineconfiguration"
