...
import (
	"encoding/json"
	"fmt"
	quicksightdashboard "github.com/golingon/terraproviders/aws/5.16.1/quicksightdashboard"
...
func (qd quicksightDashboardAttributes) Permissions() terra.SetValue[quicksightdashboard.PermissionsAttributes] {
	return terra.ReferenceAsSet[quicksightdashboard.PermissionsAttributes](qd.ref.Append("permissions"))
}
