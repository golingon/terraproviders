...
import (
	"encoding/json"
	"fmt"
	ec2clientvpnnetworkassociation "github.com/golingon/terraproviders/aws/4.66.1/ec2clientvpnnetworkassociation"
...
// SecurityGroups returns a reference to field security_groups of aws_ec2_client_vpn_network_association.
func (ecvna ec2ClientVpnNetworkAssociationAttributes) SecurityGroups() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](ecvna.ref.Append("security_groups"))
}

// Status returns a reference to field status of aws_ec2_client_vpn_network_association.
func (ecvna ec2ClientVpnNetworkAssociationAttributes) Status() terra.StringValue {
	return terra.ReferenceAsString(ecvna.ref.Append("status"))
}
