...
import (
	dataredshiftcluster "github.com/golingon/terraproviders/aws/4.66.1/dataredshiftcluster"
...
func (rc dataRedshiftClusterAttributes) ClusterSecurityGroups() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](rc.ref.Append("cluster_security_groups"))
}
