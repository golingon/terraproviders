...
import (
	"encoding/json"
	"fmt"
	lambdaeventsourcemapping "github.com/golingon/terraproviders/aws/4.66.1/lambdaeventsourcemapping"
...
func (lesm lambdaEventSourceMappingAttributes) Queues() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](lesm.ref.Append("queues"))
}
