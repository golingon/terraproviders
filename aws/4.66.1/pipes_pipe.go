...
import (
	"encoding/json"
	"fmt"
	pipespipe "github.com/golingon/terraproviders/aws/4.66.1/pipespipe"
...
type PipesPipeArgs struct {
	...
	SourceParameters *pipespipe.SourceParameters `hcl:"source_parameters,block" validate:"required"`
	// TargetParameters: required
	TargetParameters *pipespipe.TargetParameters `hcl:"target_parameters,block" validate:"required"`
	// Timeouts: optional
