...
import (
	"encoding/json"
	"fmt"
	iamrole "github.com/golingon/terraproviders/aws/4.66.1/iamrole"
...
type IamRoleArgs struct {
	...
	// RoleLastUsed: min=0
	RoleLastUsed []iamrole.RoleLastUsed `hcl:"role_last_used,block" validate:"min=0"`
	// InlinePolicy: min=0
...
func (ir iamRoleAttributes) RoleLastUsed() terra.ListValue[iamrole.RoleLastUsedAttributes] {
	return terra.ReferenceAsList[iamrole.RoleLastUsedAttributes](ir.ref.Append("role_last_used"))
}
...
type iamRoleState struct {
	...
	RoleLastUsed        []iamrole.RoleLastUsedState `json:"role_last_used"`
