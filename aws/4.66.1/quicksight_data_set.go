...
import (
	"encoding/json"
	"fmt"
	quicksightdataset "github.com/golingon/terraproviders/aws/4.66.1/quicksightdataset"
...
type QuicksightDataSetArgs struct {
	...
	// PhysicalTableMap: min=1,max=32
	PhysicalTableMap []quicksightdataset.PhysicalTableMap `hcl:"physical_table_map,block" validate:"min=1,max=32"`
