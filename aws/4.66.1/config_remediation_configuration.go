...
import (
	"encoding/json"
	"fmt"
	configremediationconfiguration "github.com/golingon/terraproviders/aws/4.66.1/configremediationconfiguration"
...
func (crc configRemediationConfigurationAttributes) Parameter() terra.SetValue[configremediationconfiguration.ParameterAttributes] {
	return terra.ReferenceAsSet[configremediationconfiguration.ParameterAttributes](crc.ref.Append("parameter"))
}
