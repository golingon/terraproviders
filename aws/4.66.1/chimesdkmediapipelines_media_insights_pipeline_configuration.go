...
import (
	"encoding/json"
	"fmt"
	chimesdkmediapipelinesmediainsightspipelineconfiguration "github.com/golingon/terraproviders/aws/4.66.1/chimesdkmediapipelinesmediainsightspipelineconfiguration"
