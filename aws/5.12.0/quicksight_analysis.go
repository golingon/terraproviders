...
import (
	"encoding/json"
	"fmt"
	quicksightanalysis "github.com/golingon/terraproviders/aws/5.12.0/quicksightanalysis"
...
func (qa quicksightAnalysisAttributes) Permissions() terra.ListValue[quicksightanalysis.PermissionsAttributes] {
	return terra.ReferenceAsList[quicksightanalysis.PermissionsAttributes](qa.ref.Append("permissions"))
}
