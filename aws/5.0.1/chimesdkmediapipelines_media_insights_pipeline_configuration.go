...
import (
	"encoding/json"
	"fmt"
	chimesdkmediapipelinesmediainsightspipelineconfiguration "github.com/golingon/terraproviders/aws/5.0.1/chimesdkmediapipelinesmediainsightspipelineconfiguration"
