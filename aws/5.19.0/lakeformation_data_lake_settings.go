...
import (
	"encoding/json"
	"fmt"
	lakeformationdatalakesettings "github.com/golingon/terraproviders/aws/5.19.0/lakeformationdatalakesettings"
...
func (ldls lakeformationDataLakeSettingsAttributes) ReadOnlyAdmins() terra.SetValue[terra.StringValue] {
