...
import (
	"encoding/json"
	"fmt"
	gluecatalogtable "github.com/golingon/terraproviders/aws/5.19.0/gluecatalogtable"
...
type GlueCatalogTableArgs struct {
	...
	OpenTableFormatInput *gluecatalogtable.OpenTableFormatInput `hcl:"open_table_format_input,block"`
...
func (gct glueCatalogTableAttributes) OpenTableFormatInput() terra.ListValue[gluecatalogtable.OpenTableFormatInputAttributes] {
	return terra.ReferenceAsList[gluecatalogtable.OpenTableFormatInputAttributes](gct.ref.Append("open_table_format_input"))
}
...
type glueCatalogTableState struct {
	...
	OpenTableFormatInput []gluecatalogtable.OpenTableFormatInputState `json:"open_table_format_input"`
