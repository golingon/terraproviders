...
import (
	dataeksnodegroup "github.com/golingon/terraproviders/aws/5.17.0/dataeksnodegroup"
...
type DataEksNodeGroupArgs struct {
	...
	LaunchTemplate []dataeksnodegroup.LaunchTemplate `hcl:"launch_template,block" validate:"min=0"`
	// RemoteAccess: min=0
...
func (eng dataEksNodeGroupAttributes) LaunchTemplate() terra.ListValue[dataeksnodegroup.LaunchTemplateAttributes] {
	return terra.ReferenceAsList[dataeksnodegroup.LaunchTemplateAttributes](eng.ref.Append("launch_template"))
}
