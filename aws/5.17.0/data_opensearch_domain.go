...
import (
	dataopensearchdomain "github.com/golingon/terraproviders/aws/5.17.0/dataopensearchdomain"
...
type DataOpensearchDomainArgs struct {
	...
	// SoftwareUpdateOptions: min=0
	SoftwareUpdateOptions []dataopensearchdomain.SoftwareUpdateOptions `hcl:"software_update_options,block" validate:"min=0"`
	// VpcOptions: min=0
...
func (od dataOpensearchDomainAttributes) SoftwareUpdateOptions() terra.ListValue[dataopensearchdomain.SoftwareUpdateOptionsAttributes] {
	return terra.ReferenceAsList[dataopensearchdomain.SoftwareUpdateOptionsAttributes](od.ref.Append("software_update_options"))
}
