...
import (
	"encoding/json"
	"fmt"
	ec2transitgatewayconnectpeer "github.com/golingon/terraproviders/aws/5.17.0/ec2transitgatewayconnectpeer"
...
func (etgcp ec2TransitGatewayConnectPeerAttributes) BgpPeerAddress() terra.StringValue {
...
func (etgcp ec2TransitGatewayConnectPeerAttributes) BgpTransitGatewayAddresses() terra.SetValue[terra.StringValue] {
