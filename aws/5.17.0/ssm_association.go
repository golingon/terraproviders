...
import (
	"encoding/json"
	"fmt"
	ssmassociation "github.com/golingon/terraproviders/aws/5.17.0/ssmassociation"
...
func (sa ssmAssociationAttributes) SyncCompliance() terra.StringValue {
	return terra.ReferenceAsString(sa.ref.Append("sync_compliance"))
}
