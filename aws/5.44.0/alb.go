...
import (
	...
	alb "github.com/golingon/terraproviders/aws/5.44.0/alb"
	"io"
)
...
type AlbArgs struct {
	...
	ConnectionLogs *alb.ConnectionLogs `hcl:"connection_logs,block"`
	// SubnetMapping: min=0
...
func (a albAttributes) DnsRecordClientRoutingPolicy() terra.StringValue {
...
func (a albAttributes) EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic() terra.StringValue {
...
func (a albAttributes) ConnectionLogs() terra.ListValue[alb.ConnectionLogsAttributes] {
	return terra.ReferenceAsList[alb.ConnectionLogsAttributes](a.ref.Append("connection_logs"))
}
...
type albState struct {
	...
	ConnectionLogs                                       []alb.ConnectionLogsState `json:"connection_logs"`
