...
import (
	...
	datassmpatchbaseline "github.com/golingon/terraproviders/aws/5.44.0/datassmpatchbaseline"
)
...
func (spb dataSsmPatchBaselineAttributes) Json() terra.StringValue {
	return terra.ReferenceAsString(spb.ref.Append("json"))
}
