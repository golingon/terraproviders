...
import (
	...
	albtargetgroup "github.com/golingon/terraproviders/aws/5.44.0/albtargetgroup"
	"io"
)
...
type AlbTargetGroupArgs struct {
	...
	TargetHealthState []albtargetgroup.TargetHealthState `hcl:"target_health_state,block" validate:"min=0"`
}
...
func (atg albTargetGroupAttributes) LoadBalancerArns() terra.SetValue[terra.StringValue] {
...
func (atg albTargetGroupAttributes) LoadBalancingAnomalyMitigation() terra.StringValue {
...
func (atg albTargetGroupAttributes) TargetHealthState() terra.ListValue[albtargetgroup.TargetHealthStateAttributes] {
	return terra.ReferenceAsList[albtargetgroup.TargetHealthStateAttributes](atg.ref.Append("target_health_state"))
}
...
type albTargetGroupState struct {
	...
	TargetHealthState              []albtargetgroup.TargetHealthStateState `json:"target_health_state"`
}
