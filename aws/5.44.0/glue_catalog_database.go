...
import (
	...
	gluecatalogdatabase "github.com/golingon/terraproviders/aws/5.44.0/gluecatalogdatabase"
	"io"
)
...
type GlueCatalogDatabaseArgs struct {
	...
	FederatedDatabase *gluecatalogdatabase.FederatedDatabase `hcl:"federated_database,block"`
...
func (gcd glueCatalogDatabaseAttributes) FederatedDatabase() terra.ListValue[gluecatalogdatabase.FederatedDatabaseAttributes] {
	return terra.ReferenceAsList[gluecatalogdatabase.FederatedDatabaseAttributes](gcd.ref.Append("federated_database"))
}
...
type glueCatalogDatabaseState struct {
	...
	FederatedDatabase            []gluecatalogdatabase.FederatedDatabaseState            `json:"federated_database"`
