...
import (
	...
	neptuneclusterinstance "github.com/golingon/terraproviders/aws/5.44.0/neptuneclusterinstance"
	"io"
)
...
func (nci neptuneClusterInstanceAttributes) SkipFinalSnapshot() terra.BoolValue {
	return terra.ReferenceAsBool(nci.ref.Append("skip_final_snapshot"))
}
...
func (nci neptuneClusterInstanceAttributes) StorageType() terra.StringValue {
	return terra.ReferenceAsString(nci.ref.Append("storage_type"))
}
