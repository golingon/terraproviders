...
import (
	...
	datalbtargetgroup "github.com/golingon/terraproviders/aws/5.44.0/datalbtargetgroup"
)
...
func (ltg dataLbTargetGroupAttributes) DeregistrationDelay() terra.StringValue {
...
func (ltg dataLbTargetGroupAttributes) LoadBalancerArns() terra.SetValue[terra.StringValue] {
...
func (ltg dataLbTargetGroupAttributes) LoadBalancingAnomalyMitigation() terra.StringValue {
