...
import (
	...
	configconfigrule "github.com/golingon/terraproviders/aws/5.44.0/configconfigrule"
	"io"
)
...
type ConfigConfigRuleArgs struct {
	...
	EvaluationMode []configconfigrule.EvaluationMode `hcl:"evaluation_mode,block" validate:"min=0"`
	// Scope: optional
...
func (ccr configConfigRuleAttributes) EvaluationMode() terra.SetValue[configconfigrule.EvaluationModeAttributes] {
	return terra.ReferenceAsSet[configconfigrule.EvaluationModeAttributes](ccr.ref.Append("evaluation_mode"))
}
...
type configConfigRuleState struct {
	...
	EvaluationMode            []configconfigrule.EvaluationModeState `json:"evaluation_mode"`
