...
type LambdaConfig struct {
	...
	// PreTokenGenerationConfig: optional
	PreTokenGenerationConfig *PreTokenGenerationConfig `hcl:"pre_token_generation_config,block"`
}
...
func (lc LambdaConfigAttributes) PreTokenGenerationConfig() terra.ListValue[PreTokenGenerationConfigAttributes] {
	return terra.ReferenceAsList[PreTokenGenerationConfigAttributes](lc.ref.Append("pre_token_generation_config"))
}
...
type PreTokenGenerationConfigAttributes struct {
	ref terra.Reference
}

func (ptgc PreTokenGenerationConfigAttributes) InternalRef() (terra.Reference, error) {
	return ptgc.ref, nil
}

func (ptgc PreTokenGenerationConfigAttributes) InternalWithRef(ref terra.Reference) PreTokenGenerationConfigAttributes {
	return PreTokenGenerationConfigAttributes{ref: ref}
}

func (ptgc PreTokenGenerationConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ptgc.ref.InternalTokens()
}

func (ptgc PreTokenGenerationConfigAttributes) LambdaArn() terra.StringValue {
	return terra.ReferenceAsString(ptgc.ref.Append("lambda_arn"))
}

func (ptgc PreTokenGenerationConfigAttributes) LambdaVersion() terra.StringValue {
...
type LambdaConfigState struct {
	...
	PreTokenGenerationConfig    []PreTokenGenerationConfigState `json:"pre_token_generation_config"`
}
...
type PreTokenGenerationConfigState struct {
	LambdaArn     string `json:"lambda_arn"`
	LambdaVersion string `json:"lambda_version"`
}
