...
import (
	...
	sagemakerdomain "github.com/golingon/terraproviders/aws/5.44.0/sagemakerdomain"
	"io"
)
...
func (sd sagemakerDomainAttributes) SingleSignOnApplicationArn() terra.StringValue {
	return terra.ReferenceAsString(sd.ref.Append("single_sign_on_application_arn"))
}
