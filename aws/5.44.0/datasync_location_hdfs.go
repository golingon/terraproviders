...
import (
	...
	datasynclocationhdfs "github.com/golingon/terraproviders/aws/5.44.0/datasynclocationhdfs"
	"io"
)
...
func (dlh datasyncLocationHdfsAttributes) KerberosKeytabBase64() terra.StringValue {
	return terra.ReferenceAsString(dlh.ref.Append("kerberos_keytab_base64"))
}
...
func (dlh datasyncLocationHdfsAttributes) KerberosKrb5ConfBase64() terra.StringValue {
	return terra.ReferenceAsString(dlh.ref.Append("kerberos_krb5_conf_base64"))
}
