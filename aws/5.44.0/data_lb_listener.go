...
import (
	...
	datalblistener "github.com/golingon/terraproviders/aws/5.44.0/datalblistener"
)
...
type DataLbListenerArgs struct {
	...
	MutualAuthentication []datalblistener.MutualAuthentication `hcl:"mutual_authentication,block" validate:"min=0"`
	// Timeouts: optional
...
func (ll dataLbListenerAttributes) MutualAuthentication() terra.ListValue[datalblistener.MutualAuthenticationAttributes] {
	return terra.ReferenceAsList[datalblistener.MutualAuthenticationAttributes](ll.ref.Append("mutual_authentication"))
}
