...
import (
	...
	dataekscluster "github.com/golingon/terraproviders/aws/5.44.0/dataekscluster"
)
...
type DataEksClusterArgs struct {
	...
	// AccessConfig: min=0
	AccessConfig []dataekscluster.AccessConfig `hcl:"access_config,block" validate:"min=0"`
...
func (ec dataEksClusterAttributes) AccessConfig() terra.ListValue[dataekscluster.AccessConfigAttributes] {
	return terra.ReferenceAsList[dataekscluster.AccessConfigAttributes](ec.ref.Append("access_config"))
}
