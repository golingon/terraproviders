...
func (lr lakeformationResourceAttributes) HybridAccessEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lr.ref.Append("hybrid_access_enabled"))
}
...
func (lr lakeformationResourceAttributes) UseServiceLinkedRole() terra.BoolValue {
	return terra.ReferenceAsBool(lr.ref.Append("use_service_linked_role"))
}

// WithFederation returns a reference to field with_federation of aws_lakeformation_resource.
func (lr lakeformationResourceAttributes) WithFederation() terra.BoolValue {
	return terra.ReferenceAsBool(lr.ref.Append("with_federation"))
}
