...
type SagemakerPipelineTarget struct {
	// PipelineParameterList: min=0,max=200
	PipelineParameterList []PipelineParameterList `hcl:"pipeline_parameter_list,block" validate:"min=0,max=200"`
}

type PipelineParameterList struct {
...
func (et EcsTargetAttributes) OrderedPlacementStrategy() terra.ListValue[OrderedPlacementStrategyAttributes] {
	return terra.ReferenceAsList[OrderedPlacementStrategyAttributes](et.ref.Append("ordered_placement_strategy"))
}
...
func (spt SagemakerPipelineTargetAttributes) PipelineParameterList() terra.SetValue[PipelineParameterListAttributes] {
	return terra.ReferenceAsSet[PipelineParameterListAttributes](spt.ref.Append("pipeline_parameter_list"))
}

type PipelineParameterListAttributes struct {
	ref terra.Reference
}

func (ppl PipelineParameterListAttributes) InternalRef() (terra.Reference, error) {
	return ppl.ref, nil
}

func (ppl PipelineParameterListAttributes) InternalWithRef(ref terra.Reference) PipelineParameterListAttributes {
	return PipelineParameterListAttributes{ref: ref}
}

func (ppl PipelineParameterListAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ppl.ref.InternalTokens()
}

func (ppl PipelineParameterListAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(ppl.ref.Append("name"))
}

func (ppl PipelineParameterListAttributes) Value() terra.StringValue {
...
type SagemakerPipelineTargetState struct {
	PipelineParameterList []PipelineParameterListState `json:"pipeline_parameter_list"`
}

type PipelineParameterListState struct {
