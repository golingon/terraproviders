...
import (
	...
	datalb "github.com/golingon/terraproviders/aws/5.44.0/datalb"
)
...
type DataLbArgs struct {
	...
	// ConnectionLogs: min=0
	ConnectionLogs []datalb.ConnectionLogs `hcl:"connection_logs,block" validate:"min=0"`
	// SubnetMapping: min=0
...
func (l dataLbAttributes) DnsRecordClientRoutingPolicy() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("dns_record_client_routing_policy"))
}
...
func (l dataLbAttributes) EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("enforce_security_group_inbound_rules_on_private_link_traffic"))
}
...
func (l dataLbAttributes) ConnectionLogs() terra.ListValue[datalb.ConnectionLogsAttributes] {
	return terra.ReferenceAsList[datalb.ConnectionLogsAttributes](l.ref.Append("connection_logs"))
}
