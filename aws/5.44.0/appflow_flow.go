...
import (
	...
	appflowflow "github.com/golingon/terraproviders/aws/5.44.0/appflowflow"
	"io"
)
...
func (af appflowFlowAttributes) FlowStatus() terra.StringValue {
	return terra.ReferenceAsString(af.ref.Append("flow_status"))
}
...
func (af appflowFlowAttributes) DestinationFlowConfig() terra.ListValue[appflowflow.DestinationFlowConfigAttributes] {
	return terra.ReferenceAsList[appflowflow.DestinationFlowConfigAttributes](af.ref.Append("destination_flow_config"))
}
