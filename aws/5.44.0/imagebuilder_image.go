...
import (
	...
	imagebuilderimage "github.com/golingon/terraproviders/aws/5.44.0/imagebuilderimage"
	"io"
)
...
type ImagebuilderImageArgs struct {
	...
	ImageScanningConfiguration *imagebuilderimage.ImageScanningConfiguration `hcl:"image_scanning_configuration,block"`
...
func (ii imagebuilderImageAttributes) ImageScanningConfiguration() terra.ListValue[imagebuilderimage.ImageScanningConfigurationAttributes] {
	return terra.ReferenceAsList[imagebuilderimage.ImageScanningConfigurationAttributes](ii.ref.Append("image_scanning_configuration"))
}
...
type imagebuilderImageState struct {
	...
	ImageScanningConfiguration     []imagebuilderimage.ImageScanningConfigurationState `json:"image_scanning_configuration"`
