...
import (
	...
	ekscluster "github.com/golingon/terraproviders/aws/5.44.0/ekscluster"
	"io"
)
...
type EksClusterArgs struct {
	...
	AccessConfig *ekscluster.AccessConfig `hcl:"access_config,block"`
...
func (ec eksClusterAttributes) AccessConfig() terra.ListValue[ekscluster.AccessConfigAttributes] {
	return terra.ReferenceAsList[ekscluster.AccessConfigAttributes](ec.ref.Append("access_config"))
}
...
type eksClusterState struct {
	...
	AccessConfig            []ekscluster.AccessConfigState            `json:"access_config"`
