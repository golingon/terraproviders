...
import (
	...
	s3bucketlifecycleconfiguration "github.com/golingon/terraproviders/aws/5.44.0/s3bucketlifecycleconfiguration"
	"io"
)
...
type S3BucketLifecycleConfigurationArgs struct {
	...
	// Timeouts: optional
	Timeouts *s3bucketlifecycleconfiguration.Timeouts `hcl:"timeouts,block"`
}
...
func (sblc s3BucketLifecycleConfigurationAttributes) Timeouts() s3bucketlifecycleconfiguration.TimeoutsAttributes {
	return terra.ReferenceAsSingle[s3bucketlifecycleconfiguration.TimeoutsAttributes](sblc.ref.Append("timeouts"))
}
...
type s3BucketLifecycleConfigurationState struct {
	...
	Timeouts            *s3bucketlifecycleconfiguration.TimeoutsState `json:"timeouts"`
}
