...
import (
	...
	s3object "github.com/golingon/terraproviders/aws/5.44.0/s3object"
	"io"
)
...
type S3ObjectArgs struct {
	...
	OverrideProvider *s3object.OverrideProvider `hcl:"override_provider,block"`
}
...
func (so s3ObjectAttributes) Arn() terra.StringValue {
...
func (so s3ObjectAttributes) ChecksumAlgorithm() terra.StringValue {
	return terra.ReferenceAsString(so.ref.Append("checksum_algorithm"))
}

// ChecksumCrc32 returns a reference to field checksum_crc32 of aws_s3_object.
func (so s3ObjectAttributes) ChecksumCrc32() terra.StringValue {
...
func (so s3ObjectAttributes) ChecksumCrc32C() terra.StringValue {
...
func (so s3ObjectAttributes) ChecksumSha1() terra.StringValue {
...
func (so s3ObjectAttributes) ChecksumSha256() terra.StringValue {
...
func (so s3ObjectAttributes) OverrideProvider() terra.ListValue[s3object.OverrideProviderAttributes] {
	return terra.ReferenceAsList[s3object.OverrideProviderAttributes](so.ref.Append("override_provider"))
}
...
type s3ObjectState struct {
	...
	OverrideProvider          []s3object.OverrideProviderState `json:"override_provider"`
}
