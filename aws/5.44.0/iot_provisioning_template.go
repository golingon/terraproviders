...
import (
	...
	iotprovisioningtemplate "github.com/golingon/terraproviders/aws/5.44.0/iotprovisioningtemplate"
	"io"
)
...
func (ipt iotProvisioningTemplateAttributes) Type() terra.StringValue {
	return terra.ReferenceAsString(ipt.ref.Append("type"))
}
