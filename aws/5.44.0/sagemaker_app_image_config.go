...
import (
	...
	sagemakerappimageconfig "github.com/golingon/terraproviders/aws/5.44.0/sagemakerappimageconfig"
	"io"
)
...
type SagemakerAppImageConfigArgs struct {
	...
	JupyterLabImageConfig *sagemakerappimageconfig.JupyterLabImageConfig `hcl:"jupyter_lab_image_config,block"`
...
func (saic sagemakerAppImageConfigAttributes) JupyterLabImageConfig() terra.ListValue[sagemakerappimageconfig.JupyterLabImageConfigAttributes] {
	return terra.ReferenceAsList[sagemakerappimageconfig.JupyterLabImageConfigAttributes](saic.ref.Append("jupyter_lab_image_config"))
}
...
type sagemakerAppImageConfigState struct {
	...
	JupyterLabImageConfig    []sagemakerappimageconfig.JupyterLabImageConfigState    `json:"jupyter_lab_image_config"`
