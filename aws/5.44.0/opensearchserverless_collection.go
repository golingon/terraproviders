...
import (
	...
	opensearchserverlesscollection "github.com/golingon/terraproviders/aws/5.44.0/opensearchserverlesscollection"
	"io"
)
...
func (oc opensearchserverlessCollectionAttributes) StandbyReplicas() terra.StringValue {
	return terra.ReferenceAsString(oc.ref.Append("standby_replicas"))
}
