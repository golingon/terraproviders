...
import (
	...
	vpcipam "github.com/golingon/terraproviders/aws/5.44.0/vpcipam"
	"io"
)
...
func (vi vpcIpamAttributes) Tier() terra.StringValue {
	return terra.ReferenceAsString(vi.ref.Append("tier"))
}
