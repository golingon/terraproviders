...
import (
	...
	dataalblistener "github.com/golingon/terraproviders/aws/5.44.0/dataalblistener"
)
...
type DataAlbListenerArgs struct {
	...
	// MutualAuthentication: min=0
	MutualAuthentication []dataalblistener.MutualAuthentication `hcl:"mutual_authentication,block" validate:"min=0"`
	// Timeouts: optional
...
func (al dataAlbListenerAttributes) MutualAuthentication() terra.ListValue[dataalblistener.MutualAuthenticationAttributes] {
	return terra.ReferenceAsList[dataalblistener.MutualAuthenticationAttributes](al.ref.Append("mutual_authentication"))
}
