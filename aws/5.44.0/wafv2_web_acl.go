...
import (
	...
	wafv2webacl "github.com/golingon/terraproviders/aws/5.44.0/wafv2webacl"
	"io"
)
...
type Wafv2WebAclArgs struct {
	...
	ChallengeConfig *wafv2webacl.ChallengeConfig `hcl:"challenge_config,block"`
...
func (wwa wafv2WebAclAttributes) ApplicationIntegrationUrl() terra.StringValue {
	return terra.ReferenceAsString(wwa.ref.Append("application_integration_url"))
}
...
func (wwa wafv2WebAclAttributes) ChallengeConfig() terra.ListValue[wafv2webacl.ChallengeConfigAttributes] {
	return terra.ReferenceAsList[wafv2webacl.ChallengeConfigAttributes](wwa.ref.Append("challenge_config"))
}
...
type wafv2WebAclState struct {
	...
	ChallengeConfig           []wafv2webacl.ChallengeConfigState    `json:"challenge_config"`
