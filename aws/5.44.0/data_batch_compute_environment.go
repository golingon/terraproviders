...
import (
	...
	databatchcomputeenvironment "github.com/golingon/terraproviders/aws/5.44.0/databatchcomputeenvironment"
)
...
type DataBatchComputeEnvironmentArgs struct {
	...
	// UpdatePolicy: min=0
	UpdatePolicy []databatchcomputeenvironment.UpdatePolicy `hcl:"update_policy,block" validate:"min=0"`
}
...
func (bce dataBatchComputeEnvironmentAttributes) UpdatePolicy() terra.ListValue[databatchcomputeenvironment.UpdatePolicyAttributes] {
	return terra.ReferenceAsList[databatchcomputeenvironment.UpdatePolicyAttributes](bce.ref.Append("update_policy"))
}
