...
import (
	...
	dataappconfigconfigurationprofile "github.com/golingon/terraproviders/aws/5.44.0/dataappconfigconfigurationprofile"
)
...
func (acp dataAppconfigConfigurationProfileAttributes) KmsKeyIdentifier() terra.StringValue {
	return terra.ReferenceAsString(acp.ref.Append("kms_key_identifier"))
}
