...
import (
	...
	datadmsendpoint "github.com/golingon/terraproviders/aws/5.44.0/datadmsendpoint"
)
...
type DataDmsEndpointArgs struct {
	...
	// PostgresSettings: min=0
	PostgresSettings []datadmsendpoint.PostgresSettings `hcl:"postgres_settings,block" validate:"min=0"`
	// RedisSettings: min=0
...
func (de dataDmsEndpointAttributes) PostgresSettings() terra.ListValue[datadmsendpoint.PostgresSettingsAttributes] {
	return terra.ReferenceAsList[datadmsendpoint.PostgresSettingsAttributes](de.ref.Append("postgres_settings"))
}
