...
type Tls struct {
	...
	// IssuerCertAuthority: required
	IssuerCertAuthority *IssuerCertAuthority `hcl:"issuer_cert_authority,block" validate:"required"`
}

type IssuerCertAuthority struct {
...
func (s ServiceAttributes) Timeout() terra.ListValue[TimeoutAttributes] {
	return terra.ReferenceAsList[TimeoutAttributes](s.ref.Append("timeout"))
}

func (s ServiceAttributes) Tls() terra.ListValue[TlsAttributes] {
	return terra.ReferenceAsList[TlsAttributes](s.ref.Append("tls"))
}
...
func (t TimeoutAttributes) IdleTimeoutSeconds() terra.NumberValue {
	return terra.ReferenceAsNumber(t.ref.Append("idle_timeout_seconds"))
}

func (t TimeoutAttributes) PerRequestTimeoutSeconds() terra.NumberValue {
...
func (t TlsAttributes) KmsKey() terra.StringValue {
	return terra.ReferenceAsString(t.ref.Append("kms_key"))
}

func (t TlsAttributes) RoleArn() terra.StringValue {
	return terra.ReferenceAsString(t.ref.Append("role_arn"))
}

func (t TlsAttributes) IssuerCertAuthority() terra.ListValue[IssuerCertAuthorityAttributes] {
	return terra.ReferenceAsList[IssuerCertAuthorityAttributes](t.ref.Append("issuer_cert_authority"))
}

type IssuerCertAuthorityAttributes struct {
	ref terra.Reference
}

func (ica IssuerCertAuthorityAttributes) InternalRef() (terra.Reference, error) {
	return ica.ref, nil
}

func (ica IssuerCertAuthorityAttributes) InternalWithRef(ref terra.Reference) IssuerCertAuthorityAttributes {
	return IssuerCertAuthorityAttributes{ref: ref}
}

func (ica IssuerCertAuthorityAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ica.ref.InternalTokens()
}

func (ica IssuerCertAuthorityAttributes) AwsPcaAuthorityArn() terra.StringValue {
...
type TlsState struct {
	...
	IssuerCertAuthority []IssuerCertAuthorityState `json:"issuer_cert_authority"`
}

type IssuerCertAuthorityState struct {
