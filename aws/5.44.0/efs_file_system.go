...
import (
	...
	efsfilesystem "github.com/golingon/terraproviders/aws/5.44.0/efsfilesystem"
	"io"
)
...
type EfsFileSystemArgs struct {
	...
	LifecyclePolicy []efsfilesystem.LifecyclePolicy `hcl:"lifecycle_policy,block" validate:"min=0,max=3"`
	// Protection: optional
	Protection *efsfilesystem.Protection `hcl:"protection,block"`
}
...
func (efs efsFileSystemAttributes) Protection() terra.ListValue[efsfilesystem.ProtectionAttributes] {
	return terra.ReferenceAsList[efsfilesystem.ProtectionAttributes](efs.ref.Append("protection"))
}
...
type efsFileSystemState struct {
	...
	Protection                   []efsfilesystem.ProtectionState      `json:"protection"`
}
