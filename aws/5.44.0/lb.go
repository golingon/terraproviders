...
import (
	...
	lb "github.com/golingon/terraproviders/aws/5.44.0/lb"
	"io"
)
...
type LbArgs struct {
	...
	ConnectionLogs *lb.ConnectionLogs `hcl:"connection_logs,block"`
	// SubnetMapping: min=0
...
func (l lbAttributes) DnsRecordClientRoutingPolicy() terra.StringValue {
...
func (l lbAttributes) EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic() terra.StringValue {
...
func (l lbAttributes) ConnectionLogs() terra.ListValue[lb.ConnectionLogsAttributes] {
	return terra.ReferenceAsList[lb.ConnectionLogsAttributes](l.ref.Append("connection_logs"))
}
...
type lbState struct {
	...
	ConnectionLogs                                       []lb.ConnectionLogsState `json:"connection_logs"`
