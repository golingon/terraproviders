...
import (
	...
	neptunecluster "github.com/golingon/terraproviders/aws/5.44.0/neptunecluster"
	"io"
)
...
func (nc neptuneClusterAttributes) StorageType() terra.StringValue {
	return terra.ReferenceAsString(nc.ref.Append("storage_type"))
}
