...
import (
	...
	dataec2instancetype "github.com/golingon/terraproviders/aws/5.44.0/dataec2instancetype"
)
...
func (eit dataEc2InstanceTypeAttributes) MaximumNetworkCards() terra.NumberValue {
	return terra.ReferenceAsNumber(eit.ref.Append("maximum_network_cards"))
}
