...
type MskSourceConfiguration struct {
	...
	AuthenticationConfiguration *AuthenticationConfiguration `hcl:"authentication_configuration,block" validate:"required"`
}
...
type OpensearchConfiguration struct {
	...
	// DocumentIdOptions: optional
	DocumentIdOptions *DocumentIdOptions `hcl:"document_id_options,block"`
...
func (msc MskSourceConfigurationAttributes) AuthenticationConfiguration() terra.ListValue[AuthenticationConfigurationAttributes] {
	return terra.ReferenceAsList[AuthenticationConfigurationAttributes](msc.ref.Append("authentication_configuration"))
}
...
func (ac AuthenticationConfigurationAttributes) Connectivity() terra.StringValue {
	return terra.ReferenceAsString(ac.ref.Append("connectivity"))
}

func (ac AuthenticationConfigurationAttributes) RoleArn() terra.StringValue {
...
func (oc OpensearchConfigurationAttributes) DocumentIdOptions() terra.ListValue[DocumentIdOptionsAttributes] {
	return terra.ReferenceAsList[DocumentIdOptionsAttributes](oc.ref.Append("document_id_options"))
}
...
type DocumentIdOptionsAttributes struct {
	ref terra.Reference
}

func (dio DocumentIdOptionsAttributes) InternalRef() (terra.Reference, error) {
	return dio.ref, nil
}

func (dio DocumentIdOptionsAttributes) InternalWithRef(ref terra.Reference) DocumentIdOptionsAttributes {
	return DocumentIdOptionsAttributes{ref: ref}
}

func (dio DocumentIdOptionsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return dio.ref.InternalTokens()
}

func (dio DocumentIdOptionsAttributes) DefaultDocumentIdFormat() terra.StringValue {
...
type OpensearchConfigurationState struct {
	...
	DocumentIdOptions        []DocumentIdOptionsState                               `json:"document_id_options"`
...
type DocumentIdOptionsState struct {
