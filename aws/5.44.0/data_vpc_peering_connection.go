...
import (
	...
	datavpcpeeringconnection "github.com/golingon/terraproviders/aws/5.44.0/datavpcpeeringconnection"
)
...
type DataVpcPeeringConnectionArgs struct {
	...
	// Ipv6CidrBlockSet: min=0
	Ipv6CidrBlockSet []datavpcpeeringconnection.Ipv6CidrBlockSet `hcl:"ipv6_cidr_block_set,block" validate:"min=0"`
	...
	// PeerIpv6CidrBlockSet: min=0
	PeerIpv6CidrBlockSet []datavpcpeeringconnection.PeerIpv6CidrBlockSet `hcl:"peer_ipv6_cidr_block_set,block" validate:"min=0"`
	// Filter: min=0
...
func (vpc dataVpcPeeringConnectionAttributes) Ipv6CidrBlockSet() terra.ListValue[datavpcpeeringconnection.Ipv6CidrBlockSetAttributes] {
	return terra.ReferenceAsList[datavpcpeeringconnection.Ipv6CidrBlockSetAttributes](vpc.ref.Append("ipv6_cidr_block_set"))
}
...
func (vpc dataVpcPeeringConnectionAttributes) PeerIpv6CidrBlockSet() terra.ListValue[datavpcpeeringconnection.PeerIpv6CidrBlockSetAttributes] {
	return terra.ReferenceAsList[datavpcpeeringconnection.PeerIpv6CidrBlockSetAttributes](vpc.ref.Append("peer_ipv6_cidr_block_set"))
}
