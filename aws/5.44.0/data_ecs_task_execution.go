...
import (
	...
	dataecstaskexecution "github.com/golingon/terraproviders/aws/5.44.0/dataecstaskexecution"
)
...
func (ete dataEcsTaskExecutionAttributes) ClientToken() terra.StringValue {
	return terra.ReferenceAsString(ete.ref.Append("client_token"))
}
