...
import (
	...
	lakeformationpermissions "github.com/golingon/terraproviders/aws/5.44.0/lakeformationpermissions"
	"io"
)
...
type LakeformationPermissionsArgs struct {
	...
	DataCellsFilter *lakeformationpermissions.DataCellsFilter `hcl:"data_cells_filter,block"`
...
func (lp lakeformationPermissionsAttributes) DataCellsFilter() terra.ListValue[lakeformationpermissions.DataCellsFilterAttributes] {
	return terra.ReferenceAsList[lakeformationpermissions.DataCellsFilterAttributes](lp.ref.Append("data_cells_filter"))
}
...
type lakeformationPermissionsState struct {
	...
	DataCellsFilter            []lakeformationpermissions.DataCellsFilterState  `json:"data_cells_filter"`
