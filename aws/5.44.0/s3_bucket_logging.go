...
import (
	...
	s3bucketlogging "github.com/golingon/terraproviders/aws/5.44.0/s3bucketlogging"
	"io"
)
...
type S3BucketLoggingArgs struct {
	...
	TargetObjectKeyFormat *s3bucketlogging.TargetObjectKeyFormat `hcl:"target_object_key_format,block"`
}
...
func (sbl s3BucketLoggingAttributes) TargetObjectKeyFormat() terra.ListValue[s3bucketlogging.TargetObjectKeyFormatAttributes] {
	return terra.ReferenceAsList[s3bucketlogging.TargetObjectKeyFormatAttributes](sbl.ref.Append("target_object_key_format"))
}
...
type s3BucketLoggingState struct {
	...
	TargetObjectKeyFormat []s3bucketlogging.TargetObjectKeyFormatState `json:"target_object_key_format"`
}
