...
import (
	...
	batchjobqueue "github.com/golingon/terraproviders/aws/5.44.0/batchjobqueue"
	"io"
)
...
type BatchJobQueueArgs struct {
	...
	ComputeEnvironmentOrder []batchjobqueue.ComputeEnvironmentOrder `hcl:"compute_environment_order,block" validate:"min=0"`
	// Timeouts: optional
...
func (bjq batchJobQueueAttributes) ComputeEnvironmentOrder() terra.ListValue[batchjobqueue.ComputeEnvironmentOrderAttributes] {
	return terra.ReferenceAsList[batchjobqueue.ComputeEnvironmentOrderAttributes](bjq.ref.Append("compute_environment_order"))
}
...
type batchJobQueueState struct {
	...
	ComputeEnvironmentOrder []batchjobqueue.ComputeEnvironmentOrderState `json:"compute_environment_order"`
