...
import (
	...
	s3objectcopy "github.com/golingon/terraproviders/aws/5.44.0/s3objectcopy"
	"io"
)
...
func (soc s3ObjectCopyAttributes) Arn() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("arn"))
}
...
func (soc s3ObjectCopyAttributes) ChecksumAlgorithm() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("checksum_algorithm"))
}

// ChecksumCrc32 returns a reference to field checksum_crc32 of aws_s3_object_copy.
func (soc s3ObjectCopyAttributes) ChecksumCrc32() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("checksum_crc32"))
}

// ChecksumCrc32C returns a reference to field checksum_crc32c of aws_s3_object_copy.
func (soc s3ObjectCopyAttributes) ChecksumCrc32C() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("checksum_crc32c"))
}

// ChecksumSha1 returns a reference to field checksum_sha1 of aws_s3_object_copy.
func (soc s3ObjectCopyAttributes) ChecksumSha1() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("checksum_sha1"))
}

// ChecksumSha256 returns a reference to field checksum_sha256 of aws_s3_object_copy.
func (soc s3ObjectCopyAttributes) ChecksumSha256() terra.StringValue {
	return terra.ReferenceAsString(soc.ref.Append("checksum_sha256"))
}
