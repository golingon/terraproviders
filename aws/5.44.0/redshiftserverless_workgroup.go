...
import (
	...
	redshiftserverlessworkgroup "github.com/golingon/terraproviders/aws/5.44.0/redshiftserverlessworkgroup"
	"io"
)
...
func (rw redshiftserverlessWorkgroupAttributes) MaxCapacity() terra.NumberValue {
	return terra.ReferenceAsNumber(rw.ref.Append("max_capacity"))
}
...
func (rw redshiftserverlessWorkgroupAttributes) Port() terra.NumberValue {
	return terra.ReferenceAsNumber(rw.ref.Append("port"))
}
