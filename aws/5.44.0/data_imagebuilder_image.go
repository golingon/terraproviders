...
import (
	...
	dataimagebuilderimage "github.com/golingon/terraproviders/aws/5.44.0/dataimagebuilderimage"
)
...
type DataImagebuilderImageArgs struct {
	...
	ImageScanningConfiguration []dataimagebuilderimage.ImageScanningConfiguration `hcl:"image_scanning_configuration,block" validate:"min=0"`
...
func (ii dataImagebuilderImageAttributes) ImageScanningConfiguration() terra.ListValue[dataimagebuilderimage.ImageScanningConfigurationAttributes] {
	return terra.ReferenceAsList[dataimagebuilderimage.ImageScanningConfigurationAttributes](ii.ref.Append("image_scanning_configuration"))
}
