...
import (
	...
	lambdafunction "github.com/golingon/terraproviders/aws/5.44.0/lambdafunction"
	"io"
)
...
type LambdaFunctionArgs struct {
	...
	LoggingConfig *lambdafunction.LoggingConfig `hcl:"logging_config,block"`
	// SnapStart: optional
...
func (lf lambdaFunctionAttributes) LoggingConfig() terra.ListValue[lambdafunction.LoggingConfigAttributes] {
	return terra.ReferenceAsList[lambdafunction.LoggingConfigAttributes](lf.ref.Append("logging_config"))
}
...
type lambdaFunctionState struct {
	...
	LoggingConfig                  []lambdafunction.LoggingConfigState    `json:"logging_config"`
