...
func (es ElasticsearchSettingsAttributes) UseNewMappingType() terra.BoolValue {
	return terra.ReferenceAsBool(es.ref.Append("use_new_mapping_type"))
}
...
func (ps PostgresSettingsAttributes) InternalWithRef(ref terra.Reference) PostgresSettingsAttributes {
	return PostgresSettingsAttributes{ref: ref}
}
...
func (ps PostgresSettingsAttributes) PluginName() terra.StringValue {
	return terra.ReferenceAsString(ps.ref.Append("plugin_name"))
}

func (ps PostgresSettingsAttributes) SlotName() terra.StringValue {
