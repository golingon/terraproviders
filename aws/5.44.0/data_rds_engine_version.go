...
import (
	...
	datardsengineversion "github.com/golingon/terraproviders/aws/5.44.0/datardsengineversion"
)
...
func (rev dataRdsEngineVersionAttributes) HasMajorTarget() terra.BoolValue {
	return terra.ReferenceAsBool(rev.ref.Append("has_major_target"))
}

// HasMinorTarget returns a reference to field has_minor_target of aws_rds_engine_version.
func (rev dataRdsEngineVersionAttributes) HasMinorTarget() terra.BoolValue {
	return terra.ReferenceAsBool(rev.ref.Append("has_minor_target"))
}
...
func (rev dataRdsEngineVersionAttributes) Latest() terra.BoolValue {
	return terra.ReferenceAsBool(rev.ref.Append("latest"))
}
...
func (rev dataRdsEngineVersionAttributes) PreferredMajorTargets() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](rev.ref.Append("preferred_major_targets"))
}

// PreferredUpgradeTargets returns a reference to field preferred_upgrade_targets of aws_rds_engine_version.
func (rev dataRdsEngineVersionAttributes) PreferredUpgradeTargets() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](rev.ref.Append("preferred_upgrade_targets"))
}
...
func (rev dataRdsEngineVersionAttributes) ValidMajorTargets() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](rev.ref.Append("valid_major_targets"))
}

// ValidMinorTargets returns a reference to field valid_minor_targets of aws_rds_engine_version.
func (rev dataRdsEngineVersionAttributes) ValidMinorTargets() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](rev.ref.Append("valid_minor_targets"))
}
...
func (rev dataRdsEngineVersionAttributes) VersionActual() terra.StringValue {
	return terra.ReferenceAsString(rev.ref.Append("version_actual"))
}
