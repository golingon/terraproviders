...
type OffPeakWindowOptions struct {
	...
	OffPeakWindow *OffPeakWindow `hcl:"off_peak_window,block"`
}

type OffPeakWindow struct {
	// WindowStartTime: optional
	WindowStartTime *WindowStartTime `hcl:"window_start_time,block"`
}
...
func (opwo OffPeakWindowOptionsAttributes) OffPeakWindow() terra.ListValue[OffPeakWindowAttributes] {
	return terra.ReferenceAsList[OffPeakWindowAttributes](opwo.ref.Append("off_peak_window"))
}
...
func (opw OffPeakWindowAttributes) InternalWithRef(ref terra.Reference) OffPeakWindowAttributes {
	return OffPeakWindowAttributes{ref: ref}
}
...
func (opw OffPeakWindowAttributes) WindowStartTime() terra.ListValue[WindowStartTimeAttributes] {
	return terra.ReferenceAsList[WindowStartTimeAttributes](opw.ref.Append("window_start_time"))
}
...
func (wst WindowStartTimeAttributes) InternalWithRef(ref terra.Reference) WindowStartTimeAttributes {
	return WindowStartTimeAttributes{ref: ref}
}
...
func (wst WindowStartTimeAttributes) Hours() terra.NumberValue {
	return terra.ReferenceAsNumber(wst.ref.Append("hours"))
}

func (wst WindowStartTimeAttributes) Minutes() terra.NumberValue {
