...
func (s ConnectorProfileCredentialsSalesforceAttributes) JwtToken() terra.StringValue {
	return terra.ReferenceAsString(s.ref.Append("jwt_token"))
}

func (s ConnectorProfileCredentialsSalesforceAttributes) Oauth2GrantType() terra.StringValue {
