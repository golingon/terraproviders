...
func (aascv apprunnerAutoScalingConfigurationVersionAttributes) HasAssociatedService() terra.BoolValue {
	return terra.ReferenceAsBool(aascv.ref.Append("has_associated_service"))
}
...
func (aascv apprunnerAutoScalingConfigurationVersionAttributes) IsDefault() terra.BoolValue {
	return terra.ReferenceAsBool(aascv.ref.Append("is_default"))
}
