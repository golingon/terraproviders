...
import (
	...
	configconfigurationrecorder "github.com/golingon/terraproviders/aws/5.44.0/configconfigurationrecorder"
	"io"
)
...
type ConfigConfigurationRecorderArgs struct {
	...
	RecordingMode *configconfigurationrecorder.RecordingMode `hcl:"recording_mode,block"`
}
...
func (ccr configConfigurationRecorderAttributes) RecordingMode() terra.ListValue[configconfigurationrecorder.RecordingModeAttributes] {
	return terra.ReferenceAsList[configconfigurationrecorder.RecordingModeAttributes](ccr.ref.Append("recording_mode"))
}
...
type configConfigurationRecorderState struct {
	...
	RecordingMode  []configconfigurationrecorder.RecordingModeState  `json:"recording_mode"`
}
