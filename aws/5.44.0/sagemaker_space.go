...
import (
	...
	sagemakerspace "github.com/golingon/terraproviders/aws/5.44.0/sagemakerspace"
	"io"
)
...
type SagemakerSpaceArgs struct {
	...
	OwnershipSettings *sagemakerspace.OwnershipSettings `hcl:"ownership_settings,block"`
	// SpaceSettings: optional
	SpaceSettings *sagemakerspace.SpaceSettings `hcl:"space_settings,block"`
	// SpaceSharingSettings: optional
	SpaceSharingSettings *sagemakerspace.SpaceSharingSettings `hcl:"space_sharing_settings,block"`
}
...
func (ss sagemakerSpaceAttributes) SpaceDisplayName() terra.StringValue {
	return terra.ReferenceAsString(ss.ref.Append("space_display_name"))
}
...
func (ss sagemakerSpaceAttributes) Url() terra.StringValue {
	return terra.ReferenceAsString(ss.ref.Append("url"))
}

func (ss sagemakerSpaceAttributes) OwnershipSettings() terra.ListValue[sagemakerspace.OwnershipSettingsAttributes] {
	return terra.ReferenceAsList[sagemakerspace.OwnershipSettingsAttributes](ss.ref.Append("ownership_settings"))
}
...
func (ss sagemakerSpaceAttributes) SpaceSharingSettings() terra.ListValue[sagemakerspace.SpaceSharingSettingsAttributes] {
	return terra.ReferenceAsList[sagemakerspace.SpaceSharingSettingsAttributes](ss.ref.Append("space_sharing_settings"))
}
...
type sagemakerSpaceState struct {
	...
	Url                  string                                     `json:"url"`
	OwnershipSettings    []sagemakerspace.OwnershipSettingsState    `json:"ownership_settings"`
	SpaceSettings        []sagemakerspace.SpaceSettingsState        `json:"space_settings"`
	SpaceSharingSettings []sagemakerspace.SpaceSharingSettingsState `json:"space_sharing_settings"`
}
