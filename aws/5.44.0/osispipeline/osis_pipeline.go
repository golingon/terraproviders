...
type LogPublishingOptions struct {
	...
	// CloudwatchLogDestination: min=0
	CloudwatchLogDestination []CloudwatchLogDestination `hcl:"cloudwatch_log_destination,block" validate:"min=0"`
}
...
func (lpo LogPublishingOptionsAttributes) CloudwatchLogDestination() terra.ListValue[CloudwatchLogDestinationAttributes] {
	return terra.ReferenceAsList[CloudwatchLogDestinationAttributes](lpo.ref.Append("cloudwatch_log_destination"))
}
...
func (cld CloudwatchLogDestinationAttributes) InternalRef() (terra.Reference, error) {
	return cld.ref, nil
}

func (cld CloudwatchLogDestinationAttributes) InternalWithRef(ref terra.Reference) CloudwatchLogDestinationAttributes {
	return CloudwatchLogDestinationAttributes{ref: ref}
}

func (cld CloudwatchLogDestinationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return cld.ref.InternalTokens()
}

func (cld CloudwatchLogDestinationAttributes) LogGroup() terra.StringValue {
...
type LogPublishingOptionsState struct {
	...
	CloudwatchLogDestination []CloudwatchLogDestinationState `json:"cloudwatch_log_destination"`
}
