...
import (
	...
	batchcomputeenvironment "github.com/golingon/terraproviders/aws/5.44.0/batchcomputeenvironment"
	"io"
)
...
type BatchComputeEnvironmentArgs struct {
	...
	UpdatePolicy *batchcomputeenvironment.UpdatePolicy `hcl:"update_policy,block"`
}
...
func (bce batchComputeEnvironmentAttributes) UpdatePolicy() terra.ListValue[batchcomputeenvironment.UpdatePolicyAttributes] {
	return terra.ReferenceAsList[batchcomputeenvironment.UpdatePolicyAttributes](bce.ref.Append("update_policy"))
}
...
type batchComputeEnvironmentState struct {
	...
	UpdatePolicy                 []batchcomputeenvironment.UpdatePolicyState     `json:"update_policy"`
}
