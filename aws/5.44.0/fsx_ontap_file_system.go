...
import (
	...
	fsxontapfilesystem "github.com/golingon/terraproviders/aws/5.44.0/fsxontapfilesystem"
	"io"
)
...
func (fofs fsxOntapFileSystemAttributes) HaPairs() terra.NumberValue {
...
func (fofs fsxOntapFileSystemAttributes) ThroughputCapacityPerHaPair() terra.NumberValue {
