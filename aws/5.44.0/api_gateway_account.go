...
import (
	...
	apigatewayaccount "github.com/golingon/terraproviders/aws/5.44.0/apigatewayaccount"
	"io"
)
...
func (aga apiGatewayAccountAttributes) ApiKeyVersion() terra.StringValue {
	return terra.ReferenceAsString(aga.ref.Append("api_key_version"))
}
...
func (aga apiGatewayAccountAttributes) Features() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](aga.ref.Append("features"))
}
