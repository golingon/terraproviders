...
import (
	...
	redshiftserverlessendpointaccess "github.com/golingon/terraproviders/aws/5.44.0/redshiftserverlessendpointaccess"
	"io"
)
...
func (rea redshiftserverlessEndpointAccessAttributes) OwnerAccount() terra.StringValue {
	return terra.ReferenceAsString(rea.ref.Append("owner_account"))
}
