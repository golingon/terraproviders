...
import (
	...
	alblistener "github.com/golingon/terraproviders/aws/5.44.0/alblistener"
	"io"
)
...
type AlbListenerArgs struct {
	...
	MutualAuthentication *alblistener.MutualAuthentication `hcl:"mutual_authentication,block"`
	// Timeouts: optional
...
func (al albListenerAttributes) MutualAuthentication() terra.ListValue[alblistener.MutualAuthenticationAttributes] {
	return terra.ReferenceAsList[alblistener.MutualAuthenticationAttributes](al.ref.Append("mutual_authentication"))
}
...
type albListenerState struct {
	...
	MutualAuthentication []alblistener.MutualAuthenticationState `json:"mutual_authentication"`
