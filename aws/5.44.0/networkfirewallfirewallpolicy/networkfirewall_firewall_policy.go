...
type FirewallPolicy struct {
	...
	// PolicyVariables: optional
	PolicyVariables *PolicyVariables `hcl:"policy_variables,block"`
...
type PolicyVariables struct {
	// RuleVariables: min=0
	RuleVariables []RuleVariables `hcl:"rule_variables,block" validate:"min=0"`
}
...
func (fp FirewallPolicyAttributes) PolicyVariables() terra.ListValue[PolicyVariablesAttributes] {
	return terra.ReferenceAsList[PolicyVariablesAttributes](fp.ref.Append("policy_variables"))
}
...
type PolicyVariablesAttributes struct {
	ref terra.Reference
}

func (pv PolicyVariablesAttributes) InternalRef() (terra.Reference, error) {
	return pv.ref, nil
}

func (pv PolicyVariablesAttributes) InternalWithRef(ref terra.Reference) PolicyVariablesAttributes {
	return PolicyVariablesAttributes{ref: ref}
}

func (pv PolicyVariablesAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return pv.ref.InternalTokens()
}

func (pv PolicyVariablesAttributes) RuleVariables() terra.SetValue[RuleVariablesAttributes] {
	return terra.ReferenceAsSet[RuleVariablesAttributes](pv.ref.Append("rule_variables"))
}
...
func (rv RuleVariablesAttributes) Key() terra.StringValue {
	return terra.ReferenceAsString(rv.ref.Append("key"))
}

func (rv RuleVariablesAttributes) IpSet() terra.ListValue[IpSetAttributes] {
	return terra.ReferenceAsList[IpSetAttributes](rv.ref.Append("ip_set"))
}
...
type FirewallPolicyState struct {
	...
	PolicyVariables                 []PolicyVariablesState             `json:"policy_variables"`
...
type PolicyVariablesState struct {
