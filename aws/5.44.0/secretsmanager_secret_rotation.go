...
import (
	...
	secretsmanagersecretrotation "github.com/golingon/terraproviders/aws/5.44.0/secretsmanagersecretrotation"
	"io"
)
...
func (ssr secretsmanagerSecretRotationAttributes) RotateImmediately() terra.BoolValue {
	return terra.ReferenceAsBool(ssr.ref.Append("rotate_immediately"))
}
