...
import (
	...
	accessanalyzeranalyzer "github.com/golingon/terraproviders/aws/5.44.0/accessanalyzeranalyzer"
	"io"
)
...
type AccessanalyzerAnalyzerArgs struct {
	...
	Configuration *accessanalyzeranalyzer.Configuration `hcl:"configuration,block"`
}
...
func (aa accessanalyzerAnalyzerAttributes) Configuration() terra.ListValue[accessanalyzeranalyzer.ConfigurationAttributes] {
	return terra.ReferenceAsList[accessanalyzeranalyzer.ConfigurationAttributes](aa.ref.Append("configuration"))
}
...
type accessanalyzerAnalyzerState struct {
	...
	Configuration []accessanalyzeranalyzer.ConfigurationState `json:"configuration"`
}
