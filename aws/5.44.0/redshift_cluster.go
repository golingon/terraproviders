...
import (
	...
	redshiftcluster "github.com/golingon/terraproviders/aws/5.44.0/redshiftcluster"
	"io"
)
...
func (rc redshiftClusterAttributes) ManageMasterPassword() terra.BoolValue {
	return terra.ReferenceAsBool(rc.ref.Append("manage_master_password"))
}
...
func (rc redshiftClusterAttributes) MasterPasswordSecretArn() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("master_password_secret_arn"))
}

// MasterPasswordSecretKmsKeyId returns a reference to field master_password_secret_kms_key_id of aws_redshift_cluster.
func (rc redshiftClusterAttributes) MasterPasswordSecretKmsKeyId() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("master_password_secret_kms_key_id"))
}
...
func (rc redshiftClusterAttributes) MultiAz() terra.BoolValue {
...
func (rc redshiftClusterAttributes) SnapshotArn() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("snapshot_arn"))
}
