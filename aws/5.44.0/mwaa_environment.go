...
import (
	...
	mwaaenvironment "github.com/golingon/terraproviders/aws/5.44.0/mwaaenvironment"
	"io"
)
...
func (me mwaaEnvironmentAttributes) EndpointManagement() terra.StringValue {
	return terra.ReferenceAsString(me.ref.Append("endpoint_management"))
}
