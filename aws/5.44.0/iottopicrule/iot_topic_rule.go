...
type ErrorActionKafka struct {
	...
	// ErrorActionKafkaHeader: min=0
	Header []ErrorActionKafkaHeader `hcl:"header,block" validate:"min=0"`
}

type ErrorActionKafkaHeader struct {
	// Key: string, required
	Key terra.StringValue `hcl:"key,attr" validate:"required"`
	// Value: string, required
	Value terra.StringValue `hcl:"value,attr" validate:"required"`
...
type Kafka struct {
	...
	Topic terra.StringValue `hcl:"topic,attr" validate:"required"`
	// KafkaHeader: min=0
	Header []KafkaHeader `hcl:"header,block" validate:"min=0"`
}
...
func (k ErrorActionKafkaAttributes) Header() terra.ListValue[ErrorActionKafkaHeaderAttributes] {
	return terra.ReferenceAsList[ErrorActionKafkaHeaderAttributes](k.ref.Append("header"))
}

type ErrorActionKafkaHeaderAttributes struct {
	ref terra.Reference
}

func (h ErrorActionKafkaHeaderAttributes) InternalRef() (terra.Reference, error) {
	return h.ref, nil
}

func (h ErrorActionKafkaHeaderAttributes) InternalWithRef(ref terra.Reference) ErrorActionKafkaHeaderAttributes {
	return ErrorActionKafkaHeaderAttributes{ref: ref}
}

func (h ErrorActionKafkaHeaderAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return h.ref.InternalTokens()
}

func (h ErrorActionKafkaHeaderAttributes) Key() terra.StringValue {
	return terra.ReferenceAsString(h.ref.Append("key"))
}

func (h ErrorActionKafkaHeaderAttributes) Value() terra.StringValue {
...
func (k KafkaAttributes) Header() terra.ListValue[KafkaHeaderAttributes] {
	return terra.ReferenceAsList[KafkaHeaderAttributes](k.ref.Append("header"))
}

type KafkaHeaderAttributes struct {
	ref terra.Reference
}

func (h KafkaHeaderAttributes) InternalRef() (terra.Reference, error) {
	return h.ref, nil
}

func (h KafkaHeaderAttributes) InternalWithRef(ref terra.Reference) KafkaHeaderAttributes {
	return KafkaHeaderAttributes{ref: ref}
}

func (h KafkaHeaderAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return h.ref.InternalTokens()
}

func (h KafkaHeaderAttributes) Key() terra.StringValue {
	return terra.ReferenceAsString(h.ref.Append("key"))
}

func (h KafkaHeaderAttributes) Value() terra.StringValue {
	return terra.ReferenceAsString(h.ref.Append("value"))
}
...
type ErrorActionKafkaState struct {
	...
	Header           []ErrorActionKafkaHeaderState `json:"header"`
}

type ErrorActionKafkaHeaderState struct {
	Key   string `json:"key"`
	Value string `json:"value"`
}
...
type KafkaState struct {
	...
	Partition        string             `json:"partition"`
	Topic            string             `json:"topic"`
	Header           []KafkaHeaderState `json:"header"`
}

type KafkaHeaderState struct {
	Key   string `json:"key"`
	Value string `json:"value"`
}
