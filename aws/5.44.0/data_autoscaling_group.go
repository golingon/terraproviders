...
import (
	...
	dataautoscalinggroup "github.com/golingon/terraproviders/aws/5.44.0/dataautoscalinggroup"
)
...
type DataAutoscalingGroupArgs struct {
	...
	// InstanceMaintenancePolicy: min=0
	InstanceMaintenancePolicy []dataautoscalinggroup.InstanceMaintenancePolicy `hcl:"instance_maintenance_policy,block" validate:"min=0"`
...
func (ag dataAutoscalingGroupAttributes) InstanceMaintenancePolicy() terra.ListValue[dataautoscalinggroup.InstanceMaintenancePolicyAttributes] {
	return terra.ReferenceAsList[dataautoscalinggroup.InstanceMaintenancePolicyAttributes](ag.ref.Append("instance_maintenance_policy"))
}
