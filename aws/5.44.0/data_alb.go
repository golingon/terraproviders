...
import (
	...
	dataalb "github.com/golingon/terraproviders/aws/5.44.0/dataalb"
)
...
type DataAlbArgs struct {
	...
	ConnectionLogs []dataalb.ConnectionLogs `hcl:"connection_logs,block" validate:"min=0"`
	// SubnetMapping: min=0
...
func (a dataAlbAttributes) DnsRecordClientRoutingPolicy() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("dns_record_client_routing_policy"))
}
...
func (a dataAlbAttributes) EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("enforce_security_group_inbound_rules_on_private_link_traffic"))
}
...
func (a dataAlbAttributes) ConnectionLogs() terra.ListValue[dataalb.ConnectionLogsAttributes] {
	return terra.ReferenceAsList[dataalb.ConnectionLogsAttributes](a.ref.Append("connection_logs"))
}
