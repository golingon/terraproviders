...
import (
	...
	datasynctask "github.com/golingon/terraproviders/aws/5.44.0/datasynctask"
	"io"
)
...
type DatasyncTaskArgs struct {
	...
	TaskReportConfig *datasynctask.TaskReportConfig `hcl:"task_report_config,block"`
	// Timeouts: optional
...
func (dt datasyncTaskAttributes) TaskReportConfig() terra.ListValue[datasynctask.TaskReportConfigAttributes] {
	return terra.ReferenceAsList[datasynctask.TaskReportConfigAttributes](dt.ref.Append("task_report_config"))
}
...
type datasyncTaskState struct {
	...
	TaskReportConfig       []datasynctask.TaskReportConfigState `json:"task_report_config"`
