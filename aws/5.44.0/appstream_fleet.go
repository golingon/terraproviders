...
import (
	...
	appstreamfleet "github.com/golingon/terraproviders/aws/5.44.0/appstreamfleet"
	"io"
)
...
func (af appstreamFleetAttributes) MaxSessionsPerInstance() terra.NumberValue {
	return terra.ReferenceAsNumber(af.ref.Append("max_sessions_per_instance"))
}
