...
func (twc TableWithColumnsAttributes) ColumnWildcard() terra.ListValue[ColumnWildcardAttributes] {
	return terra.ReferenceAsList[ColumnWildcardAttributes](twc.ref.Append("column_wildcard"))
}
...
func (cw ColumnWildcardAttributes) ExcludedColumnNames() terra.SetValue[terra.StringValue] {
