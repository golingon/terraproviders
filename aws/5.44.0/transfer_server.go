...
import (
	...
	transferserver "github.com/golingon/terraproviders/aws/5.44.0/transferserver"
	"io"
)
...
type TransferServerArgs struct {
	...
	S3StorageOptions *transferserver.S3StorageOptions `hcl:"s3_storage_options,block"`
...
func (ts transferServerAttributes) S3StorageOptions() terra.ListValue[transferserver.S3StorageOptionsAttributes] {
	return terra.ReferenceAsList[transferserver.S3StorageOptionsAttributes](ts.ref.Append("s3_storage_options"))
}
...
type transferServerState struct {
	...
	S3StorageOptions              []transferserver.S3StorageOptionsState `json:"s3_storage_options"`
