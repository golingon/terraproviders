...
import (
	...
	dbproxy "github.com/golingon/terraproviders/aws/5.44.0/dbproxy"
	"io"
)
...
func (dp dbProxyAttributes) Auth() terra.SetValue[dbproxy.AuthAttributes] {
	return terra.ReferenceAsSet[dbproxy.AuthAttributes](dp.ref.Append("auth"))
}
