...
import (
	...
	docdbcluster "github.com/golingon/terraproviders/aws/5.44.0/docdbcluster"
	"io"
)
...
func (dc docdbClusterAttributes) AllowMajorVersionUpgrade() terra.BoolValue {
	return terra.ReferenceAsBool(dc.ref.Append("allow_major_version_upgrade"))
}
...
func (dc docdbClusterAttributes) StorageType() terra.StringValue {
	return terra.ReferenceAsString(dc.ref.Append("storage_type"))
}
