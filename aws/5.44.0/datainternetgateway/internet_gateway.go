...
type AttachmentsAttributes struct {
	ref terra.Reference
}

func (a AttachmentsAttributes) InternalRef() (terra.Reference, error) {
	return a.ref, nil
}

func (a AttachmentsAttributes) InternalWithRef(ref terra.Reference) AttachmentsAttributes {
	return AttachmentsAttributes{ref: ref}
}

func (a AttachmentsAttributes) InternalTokens() (hclwrite.Tokens, error) {
