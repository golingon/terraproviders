...
import (
	...
	batchjobdefinition "github.com/golingon/terraproviders/aws/5.44.0/batchjobdefinition"
	"io"
)
...
type BatchJobDefinitionArgs struct {
	...
	EksProperties *batchjobdefinition.EksProperties `hcl:"eks_properties,block"`
...
func (bjd batchJobDefinitionAttributes) ArnPrefix() terra.StringValue {
...
func (bjd batchJobDefinitionAttributes) DeregisterOnNewRevision() terra.BoolValue {
	return terra.ReferenceAsBool(bjd.ref.Append("deregister_on_new_revision"))
}
...
func (bjd batchJobDefinitionAttributes) NodeProperties() terra.StringValue {
	return terra.ReferenceAsString(bjd.ref.Append("node_properties"))
}
...
func (bjd batchJobDefinitionAttributes) SchedulingPriority() terra.NumberValue {
...
func (bjd batchJobDefinitionAttributes) EksProperties() terra.ListValue[batchjobdefinition.EksPropertiesAttributes] {
	return terra.ReferenceAsList[batchjobdefinition.EksPropertiesAttributes](bjd.ref.Append("eks_properties"))
}
...
type batchJobDefinitionState struct {
	...
	EksProperties           []batchjobdefinition.EksPropertiesState `json:"eks_properties"`
