...
import (
	...
	networkmanagerconnectpeer "github.com/golingon/terraproviders/aws/5.44.0/networkmanagerconnectpeer"
	"io"
)
...
func (ncp networkmanagerConnectPeerAttributes) SubnetArn() terra.StringValue {
	return terra.ReferenceAsString(ncp.ref.Append("subnet_arn"))
}
