...
import (
	...
	ec2host "github.com/golingon/terraproviders/aws/5.44.0/ec2host"
	"io"
)
...
type Ec2HostArgs struct {
	...
	// Timeouts: optional
	Timeouts *ec2host.Timeouts `hcl:"timeouts,block"`
}
...
func (eh ec2HostAttributes) AssetId() terra.StringValue {
...
func (eh ec2HostAttributes) Timeouts() ec2host.TimeoutsAttributes {
	return terra.ReferenceAsSingle[ec2host.TimeoutsAttributes](eh.ref.Append("timeouts"))
}
...
type ec2HostState struct {
	...
	Timeouts         *ec2host.TimeoutsState `json:"timeouts"`
}
