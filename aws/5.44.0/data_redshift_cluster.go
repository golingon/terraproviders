...
import (
	...
	dataredshiftcluster "github.com/golingon/terraproviders/aws/5.44.0/dataredshiftcluster"
)
...
func (rc dataRedshiftClusterAttributes) MultiAz() terra.BoolValue {
	return terra.ReferenceAsBool(rc.ref.Append("multi_az"))
}
