...
import (
	...
	dbinstance "github.com/golingon/terraproviders/aws/5.44.0/dbinstance"
	"io"
)
...
func (di dbInstanceAttributes) DomainAuthSecretArn() terra.StringValue {
	return terra.ReferenceAsString(di.ref.Append("domain_auth_secret_arn"))
}

// DomainDnsIps returns a reference to field domain_dns_ips of aws_db_instance.
func (di dbInstanceAttributes) DomainDnsIps() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](di.ref.Append("domain_dns_ips"))
}

// DomainFqdn returns a reference to field domain_fqdn of aws_db_instance.
func (di dbInstanceAttributes) DomainFqdn() terra.StringValue {
	return terra.ReferenceAsString(di.ref.Append("domain_fqdn"))
}
...
func (di dbInstanceAttributes) DomainOu() terra.StringValue {
	return terra.ReferenceAsString(di.ref.Append("domain_ou"))
}
