...
import (
	...
	ecstaskdefinition "github.com/golingon/terraproviders/aws/5.44.0/ecstaskdefinition"
	"io"
)
...
func (etd ecsTaskDefinitionAttributes) TrackLatest() terra.BoolValue {
	return terra.ReferenceAsBool(etd.ref.Append("track_latest"))
}
