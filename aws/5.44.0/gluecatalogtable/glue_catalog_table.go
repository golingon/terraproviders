...
type OpenTableFormatInput struct {
	// IcebergInput: required
	IcebergInput *IcebergInput `hcl:"iceberg_input,block" validate:"required"`
}
...
func (otfi OpenTableFormatInputAttributes) IcebergInput() terra.ListValue[IcebergInputAttributes] {
	return terra.ReferenceAsList[IcebergInputAttributes](otfi.ref.Append("iceberg_input"))
}
...
func (ii IcebergInputAttributes) InternalWithRef(ref terra.Reference) IcebergInputAttributes {
	return IcebergInputAttributes{ref: ref}
}
