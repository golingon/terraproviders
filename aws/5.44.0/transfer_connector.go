...
import (
	...
	transferconnector "github.com/golingon/terraproviders/aws/5.44.0/transferconnector"
	"io"
)
...
type TransferConnectorArgs struct {
	...
	// As2Config: optional
	As2Config *transferconnector.As2Config `hcl:"as2_config,block"`
	// SftpConfig: optional
	SftpConfig *transferconnector.SftpConfig `hcl:"sftp_config,block"`
}
...
func (tc transferConnectorAttributes) Arn() terra.StringValue {
	return terra.ReferenceAsString(tc.ref.Append("arn"))
}
...
func (tc transferConnectorAttributes) SftpConfig() terra.ListValue[transferconnector.SftpConfigAttributes] {
	return terra.ReferenceAsList[transferconnector.SftpConfigAttributes](tc.ref.Append("sftp_config"))
}
...
type transferConnectorState struct {
	...
	SftpConfig  []transferconnector.SftpConfigState `json:"sftp_config"`
}
