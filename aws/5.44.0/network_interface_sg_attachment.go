...
import (
	...
	networkinterfacesgattachment "github.com/golingon/terraproviders/aws/5.44.0/networkinterfacesgattachment"
	"io"
)
...
type NetworkInterfaceSgAttachmentArgs struct {
	...
	// Timeouts: optional
	Timeouts *networkinterfacesgattachment.Timeouts `hcl:"timeouts,block"`
}
...
func (nisa networkInterfaceSgAttachmentAttributes) Timeouts() networkinterfacesgattachment.TimeoutsAttributes {
	return terra.ReferenceAsSingle[networkinterfacesgattachment.TimeoutsAttributes](nisa.ref.Append("timeouts"))
}
...
type networkInterfaceSgAttachmentState struct {
	...
	Timeouts           *networkinterfacesgattachment.TimeoutsState `json:"timeouts"`
}
