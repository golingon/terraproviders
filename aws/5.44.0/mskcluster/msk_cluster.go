...
type ConnectivityInfo struct {
	...
	// VpcConnectivity: optional
	VpcConnectivity *VpcConnectivity `hcl:"vpc_connectivity,block"`
}
...
type VpcConnectivity struct {
	// VpcConnectivityClientAuthentication: optional
	ClientAuthentication *VpcConnectivityClientAuthentication `hcl:"client_authentication,block"`
}

type VpcConnectivityClientAuthentication struct {
	// Tls: bool, optional
	Tls terra.BoolValue `hcl:"tls,attr"`
	// VpcConnectivityClientAuthenticationSasl: optional
	Sasl *VpcConnectivityClientAuthenticationSasl `hcl:"sasl,block"`
}

type VpcConnectivityClientAuthenticationSasl struct {
	// Iam: bool, optional
...
func (ci ConnectivityInfoAttributes) VpcConnectivity() terra.ListValue[VpcConnectivityAttributes] {
	return terra.ReferenceAsList[VpcConnectivityAttributes](ci.ref.Append("vpc_connectivity"))
}
...
type VpcConnectivityAttributes struct {
	ref terra.Reference
}

func (vc VpcConnectivityAttributes) InternalRef() (terra.Reference, error) {
	return vc.ref, nil
}

func (vc VpcConnectivityAttributes) InternalWithRef(ref terra.Reference) VpcConnectivityAttributes {
	return VpcConnectivityAttributes{ref: ref}
}

func (vc VpcConnectivityAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return vc.ref.InternalTokens()
}

func (vc VpcConnectivityAttributes) ClientAuthentication() terra.ListValue[VpcConnectivityClientAuthenticationAttributes] {
	return terra.ReferenceAsList[VpcConnectivityClientAuthenticationAttributes](vc.ref.Append("client_authentication"))
}

type VpcConnectivityClientAuthenticationAttributes struct {
	ref terra.Reference
}

func (ca VpcConnectivityClientAuthenticationAttributes) InternalRef() (terra.Reference, error) {
	return ca.ref, nil
}

func (ca VpcConnectivityClientAuthenticationAttributes) InternalWithRef(ref terra.Reference) VpcConnectivityClientAuthenticationAttributes {
	return VpcConnectivityClientAuthenticationAttributes{ref: ref}
}

func (ca VpcConnectivityClientAuthenticationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ca.ref.InternalTokens()
}

func (ca VpcConnectivityClientAuthenticationAttributes) Tls() terra.BoolValue {
	return terra.ReferenceAsBool(ca.ref.Append("tls"))
}

func (ca VpcConnectivityClientAuthenticationAttributes) Sasl() terra.ListValue[VpcConnectivityClientAuthenticationSaslAttributes] {
	return terra.ReferenceAsList[VpcConnectivityClientAuthenticationSaslAttributes](ca.ref.Append("sasl"))
}

type VpcConnectivityClientAuthenticationSaslAttributes struct {
	ref terra.Reference
}

func (s VpcConnectivityClientAuthenticationSaslAttributes) InternalRef() (terra.Reference, error) {
	return s.ref, nil
}

func (s VpcConnectivityClientAuthenticationSaslAttributes) InternalWithRef(ref terra.Reference) VpcConnectivityClientAuthenticationSaslAttributes {
	return VpcConnectivityClientAuthenticationSaslAttributes{ref: ref}
}

func (s VpcConnectivityClientAuthenticationSaslAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return s.ref.InternalTokens()
}

func (s VpcConnectivityClientAuthenticationSaslAttributes) Iam() terra.BoolValue {
	return terra.ReferenceAsBool(s.ref.Append("iam"))
}

func (s VpcConnectivityClientAuthenticationSaslAttributes) Scram() terra.BoolValue {
...
type ConnectivityInfoState struct {
	...
	VpcConnectivity []VpcConnectivityState `json:"vpc_connectivity"`
}
...
type VpcConnectivityState struct {
	ClientAuthentication []VpcConnectivityClientAuthenticationState `json:"client_authentication"`
}

type VpcConnectivityClientAuthenticationState struct {
	Tls  bool                                           `json:"tls"`
	Sasl []VpcConnectivityClientAuthenticationSaslState `json:"sasl"`
}

type VpcConnectivityClientAuthenticationSaslState struct {
	Iam   bool `json:"iam"`
