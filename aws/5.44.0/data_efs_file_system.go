...
import (
	...
	dataefsfilesystem "github.com/golingon/terraproviders/aws/5.44.0/dataefsfilesystem"
)
...
type DataEfsFileSystemArgs struct {
	...
	// Protection: min=0
	Protection []dataefsfilesystem.Protection `hcl:"protection,block" validate:"min=0"`
}
...
func (efs dataEfsFileSystemAttributes) Name() terra.StringValue {
...
func (efs dataEfsFileSystemAttributes) Protection() terra.ListValue[dataefsfilesystem.ProtectionAttributes] {
	return terra.ReferenceAsList[dataefsfilesystem.ProtectionAttributes](efs.ref.Append("protection"))
}
