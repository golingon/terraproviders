...
import (
	...
	elasticachereplicationgroup "github.com/golingon/terraproviders/aws/5.44.0/elasticachereplicationgroup"
	"io"
)
...
func (erg elasticacheReplicationGroupAttributes) AuthTokenUpdateStrategy() terra.StringValue {
	return terra.ReferenceAsString(erg.ref.Append("auth_token_update_strategy"))
}
...
func (erg elasticacheReplicationGroupAttributes) IpDiscovery() terra.StringValue {
	return terra.ReferenceAsString(erg.ref.Append("ip_discovery"))
}
...
func (erg elasticacheReplicationGroupAttributes) NetworkType() terra.StringValue {
	return terra.ReferenceAsString(erg.ref.Append("network_type"))
}
