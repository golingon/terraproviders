...
import (
	...
	autoscalinggroup "github.com/golingon/terraproviders/aws/5.44.0/autoscalinggroup"
	"io"
)
...
type AutoscalingGroupArgs struct {
	...
	InstanceMaintenancePolicy *autoscalinggroup.InstanceMaintenancePolicy `hcl:"instance_maintenance_policy,block"`
...
func (ag autoscalingGroupAttributes) IgnoreFailedScalingActivities() terra.BoolValue {
	return terra.ReferenceAsBool(ag.ref.Append("ignore_failed_scaling_activities"))
}
...
func (ag autoscalingGroupAttributes) InstanceMaintenancePolicy() terra.ListValue[autoscalinggroup.InstanceMaintenancePolicyAttributes] {
	return terra.ReferenceAsList[autoscalinggroup.InstanceMaintenancePolicyAttributes](ag.ref.Append("instance_maintenance_policy"))
}
...
type autoscalingGroupState struct {
	...
	InstanceMaintenancePolicy     []autoscalinggroup.InstanceMaintenancePolicyState `json:"instance_maintenance_policy"`
