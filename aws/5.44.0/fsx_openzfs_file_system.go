...
import (
	...
	fsxopenzfsfilesystem "github.com/golingon/terraproviders/aws/5.44.0/fsxopenzfsfilesystem"
	"io"
)
...
func (fofs fsxOpenzfsFileSystemAttributes) EndpointIpAddressRange() terra.StringValue {
...
func (fofs fsxOpenzfsFileSystemAttributes) PreferredSubnetId() terra.StringValue {
...
func (fofs fsxOpenzfsFileSystemAttributes) RouteTableIds() terra.SetValue[terra.StringValue] {
...
func (fofs fsxOpenzfsFileSystemAttributes) SkipFinalBackup() terra.BoolValue {
	return terra.ReferenceAsBool(fofs.ref.Append("skip_final_backup"))
}
