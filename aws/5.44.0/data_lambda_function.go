...
import (
	...
	datalambdafunction "github.com/golingon/terraproviders/aws/5.44.0/datalambdafunction"
)
...
type DataLambdaFunctionArgs struct {
	...
	// LoggingConfig: min=0
	LoggingConfig []datalambdafunction.LoggingConfig `hcl:"logging_config,block" validate:"min=0"`
	// TracingConfig: min=0
...
func (lf dataLambdaFunctionAttributes) LoggingConfig() terra.ListValue[datalambdafunction.LoggingConfigAttributes] {
	return terra.ReferenceAsList[datalambdafunction.LoggingConfigAttributes](lf.ref.Append("logging_config"))
}
