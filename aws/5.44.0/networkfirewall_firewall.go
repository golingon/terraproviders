...
import (
	...
	networkfirewallfirewall "github.com/golingon/terraproviders/aws/5.44.0/networkfirewallfirewall"
	"io"
)
...
type NetworkfirewallFirewallArgs struct {
	...
	// Timeouts: optional
	Timeouts *networkfirewallfirewall.Timeouts `hcl:"timeouts,block"`
}
...
func (nf networkfirewallFirewallAttributes) Timeouts() networkfirewallfirewall.TimeoutsAttributes {
	return terra.ReferenceAsSingle[networkfirewallfirewall.TimeoutsAttributes](nf.ref.Append("timeouts"))
}
...
type networkfirewallFirewallState struct {
	...
	Timeouts                       *networkfirewallfirewall.TimeoutsState                 `json:"timeouts"`
}
