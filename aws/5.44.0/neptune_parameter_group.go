...
import (
	...
	neptuneparametergroup "github.com/golingon/terraproviders/aws/5.44.0/neptuneparametergroup"
	"io"
)
...
func (npg neptuneParameterGroupAttributes) NamePrefix() terra.StringValue {
	return terra.ReferenceAsString(npg.ref.Append("name_prefix"))
}
