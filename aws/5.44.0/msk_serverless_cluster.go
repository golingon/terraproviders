...
import (
	...
	mskserverlesscluster "github.com/golingon/terraproviders/aws/5.44.0/mskserverlesscluster"
	"io"
)
...
func (msc mskServerlessClusterAttributes) ClusterUuid() terra.StringValue {
	return terra.ReferenceAsString(msc.ref.Append("cluster_uuid"))
}
