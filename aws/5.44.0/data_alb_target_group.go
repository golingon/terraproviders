...
import (
	...
	dataalbtargetgroup "github.com/golingon/terraproviders/aws/5.44.0/dataalbtargetgroup"
)
...
func (atg dataAlbTargetGroupAttributes) DeregistrationDelay() terra.StringValue {
...
func (atg dataAlbTargetGroupAttributes) LoadBalancerArns() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](atg.ref.Append("load_balancer_arns"))
}
...
func (atg dataAlbTargetGroupAttributes) LoadBalancingAnomalyMitigation() terra.StringValue {
	return terra.ReferenceAsString(atg.ref.Append("load_balancing_anomaly_mitigation"))
}
