...
import (
	...
	route53resolverendpoint "github.com/golingon/terraproviders/aws/5.44.0/route53resolverendpoint"
	"io"
)
...
func (rre route53ResolverEndpointAttributes) Protocols() terra.SetValue[terra.StringValue] {
...
func (rre route53ResolverEndpointAttributes) ResolverEndpointType() terra.StringValue {
