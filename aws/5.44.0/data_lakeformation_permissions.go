...
import (
	...
	datalakeformationpermissions "github.com/golingon/terraproviders/aws/5.44.0/datalakeformationpermissions"
)
...
type DataLakeformationPermissionsArgs struct {
	...
	DataCellsFilter *datalakeformationpermissions.DataCellsFilter `hcl:"data_cells_filter,block"`
...
func (lp dataLakeformationPermissionsAttributes) DataCellsFilter() terra.ListValue[datalakeformationpermissions.DataCellsFilterAttributes] {
	return terra.ReferenceAsList[datalakeformationpermissions.DataCellsFilterAttributes](lp.ref.Append("data_cells_filter"))
}
