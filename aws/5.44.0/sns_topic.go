...
func (st snsTopicAttributes) ArchivePolicy() terra.StringValue {
	return terra.ReferenceAsString(st.ref.Append("archive_policy"))
}
...
func (st snsTopicAttributes) BeginningArchiveTime() terra.StringValue {
	return terra.ReferenceAsString(st.ref.Append("beginning_archive_time"))
}
