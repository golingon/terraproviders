...
import (
	"encoding/json"
	"fmt"
	lbprobe "github.com/golingon/terraproviders/azurestack/1.0.0/lbprobe"
...
// LbProbe represents the Terraform resource azurestack_lb_probe.
type LbProbe struct {
	Name      string
	Args      LbProbeArgs
	state     *lbProbeState
...
// LbProbeArgs contains the configurations for azurestack_lb_probe.
...
func (lp lbProbeAttributes) ResourceGroupName() terra.StringValue {
	return terra.ReferenceAsString(lp.ref.Append("resource_group_name"))
}
