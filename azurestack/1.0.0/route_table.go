...
import (
	"encoding/json"
	"fmt"
	routetable "github.com/golingon/terraproviders/azurestack/1.0.0/routetable"
...
// RouteTable represents the Terraform resource azurestack_route_table.
...
// RouteTableArgs contains the configurations for azurestack_route_table.
...
func (rt routeTableAttributes) Route() terra.ListValue[routetable.RouteAttributes] {
	return terra.ReferenceAsList[routetable.RouteAttributes](rt.ref.Append("route"))
}
