...
import (
	datalb "github.com/golingon/terraproviders/azurestack/1.0.0/datalb"
...
// DataLb represents the Terraform data resource azurestack_lb.
type DataLb struct {
	Name string
	Args DataLbArgs
}
...
// DataLbArgs contains the configurations for azurestack_lb.
