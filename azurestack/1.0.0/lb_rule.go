...
import (
	...
	lbrule "github.com/golingon/terraproviders/azurestack/1.0.0/lbrule"
	"io"
)
...
// LbRule represents the Terraform resource azurestack_lb_rule.
type LbRule struct {
	Name      string
	Args      LbRuleArgs
	state     *lbRuleState
...
// LbRuleArgs contains the configurations for azurestack_lb_rule.
...
func (lr lbRuleAttributes) BackendAddressPoolId() terra.StringValue {
...
func (lr lbRuleAttributes) ResourceGroupName() terra.StringValue {
	return terra.ReferenceAsString(lr.ref.Append("resource_group_name"))
}
