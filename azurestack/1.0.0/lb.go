...
import (
	...
	lb "github.com/golingon/terraproviders/azurestack/1.0.0/lb"
	"io"
)
...
// Lb represents the Terraform resource azurestack_lb.
type Lb struct {
	Name      string
	Args      LbArgs
	state     *lbState
...
// LbArgs contains the configurations for azurestack_lb.
type LbArgs struct {
	// Id: string, optional
