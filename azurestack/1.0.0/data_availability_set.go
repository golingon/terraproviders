...
import (
	dataavailabilityset "github.com/golingon/terraproviders/azurestack/1.0.0/dataavailabilityset"
...
// DataAvailabilitySet represents the Terraform data resource azurestack_availability_set.
...
// DataAvailabilitySetArgs contains the configurations for azurestack_availability_set.
...
func (as dataAvailabilitySetAttributes) PlatformFaultDomainCount() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("platform_fault_domain_count"))
}

// PlatformUpdateDomainCount returns a reference to field platform_update_domain_count of azurestack_availability_set.
func (as dataAvailabilitySetAttributes) PlatformUpdateDomainCount() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("platform_update_domain_count"))
}
