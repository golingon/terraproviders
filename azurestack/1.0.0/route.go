...
import (
	...
	route "github.com/golingon/terraproviders/azurestack/1.0.0/route"
	"io"
)
...
// Route represents the Terraform resource azurestack_route.
type Route struct {
	Name      string
	Args      RouteArgs
	state     *routeState
...
// RouteArgs contains the configurations for azurestack_route.
