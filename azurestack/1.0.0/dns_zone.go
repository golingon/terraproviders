...
import (
	...
	dnszone "github.com/golingon/terraproviders/azurestack/1.0.0/dnszone"
	"io"
)
...
// DnsZone represents the Terraform resource azurestack_dns_zone.
type DnsZone struct {
	Name      string
	Args      DnsZoneArgs
	state     *dnsZoneState
...
// DnsZoneArgs contains the configurations for azurestack_dns_zone.
