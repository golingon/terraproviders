...
type Kubernetes struct {
	...
	// KubernetesExec: optional
	Exec *KubernetesExec `hcl:"exec,block"`
}
...
func (k KubernetesAttributes) Exec() terra.ListValue[KubernetesExecAttributes] {
	return terra.ReferenceAsList[KubernetesExecAttributes](k.ref.Append("exec"))
}

type KubernetesExecAttributes struct {
	ref terra.Reference
}

func (e KubernetesExecAttributes) InternalRef() (terra.Reference, error) {
	return e.ref, nil
}

func (e KubernetesExecAttributes) InternalWithRef(ref terra.Reference) KubernetesExecAttributes {
	return KubernetesExecAttributes{ref: ref}
}

func (e KubernetesExecAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return e.ref.InternalTokens()
}

func (e KubernetesExecAttributes) ApiVersion() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("api_version"))
}

func (e KubernetesExecAttributes) Args() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](e.ref.Append("args"))
}

func (e KubernetesExecAttributes) Command() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("command"))
}

func (e KubernetesExecAttributes) Env() terra.MapValue[terra.StringValue] {
...
type KubernetesState struct {
	...
	Exec                  []KubernetesExecState `json:"exec"`
}

type KubernetesExecState struct {
