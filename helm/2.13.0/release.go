...
import (
	...
	release "github.com/golingon/terraproviders/helm/2.13.0/release"
	"io"
)
...
type ReleaseArgs struct {
	...
	// SetList: min=0
	SetList []release.SetList `hcl:"set_list,block" validate:"min=0"`
	// SetSensitive: min=0
...
func (r releaseAttributes) SetList() terra.ListValue[release.SetListAttributes] {
	return terra.ReferenceAsList[release.SetListAttributes](r.ref.Append("set_list"))
}
...
type releaseState struct {
	...
	SetList                  []release.SetListState      `json:"set_list"`
