...
import (
	"encoding/json"
	"fmt"
	networkservicesedgecacheorigin "github.com/golingon/terraproviders/google/4.59.0/networkservicesedgecacheorigin"
...
type NetworkServicesEdgeCacheOriginArgs struct {
	...
	// DependsOn contains resources that NetworkServicesEdgeCacheOrigin depends on
...
func (nseco networkServicesEdgeCacheOriginAttributes) AwsV4Authentication() terra.ListValue[networkservicesedgecacheorigin.AwsV4AuthenticationAttributes] {
	return terra.ReferenceList[networkservicesedgecacheorigin.AwsV4AuthenticationAttributes](nseco.ref.Append("aws_v4_authentication"))
}
...
func (nseco networkServicesEdgeCacheOriginAttributes) OriginOverrideAction() terra.ListValue[networkservicesedgecacheorigin.OriginOverrideActionAttributes] {
	return terra.ReferenceList[networkservicesedgecacheorigin.OriginOverrideActionAttributes](nseco.ref.Append("origin_override_action"))
}
...
func (nseco networkServicesEdgeCacheOriginAttributes) OriginRedirect() terra.ListValue[networkservicesedgecacheorigin.OriginRedirectAttributes] {
	return terra.ReferenceList[networkservicesedgecacheorigin.OriginRedirectAttributes](nseco.ref.Append("origin_redirect"))
}
...
func (nseco networkServicesEdgeCacheOriginAttributes) Timeout() terra.ListValue[networkservicesedgecacheorigin.TimeoutAttributes] {
	return terra.ReferenceList[networkservicesedgecacheorigin.TimeoutAttributes](nseco.ref.Append("timeout"))
}

func (nseco networkServicesEdgeCacheOriginAttributes) Timeouts() networkservicesedgecacheorigin.TimeoutsAttributes {
	return terra.ReferenceSingle[networkservicesedgecacheorigin.TimeoutsAttributes](nseco.ref.Append("timeouts"))
}
