...
import (
	"encoding/json"
	"fmt"
	organizationpolicy "github.com/golingon/terraproviders/google/4.59.0/organizationpolicy"
...
type OrganizationPolicyArgs struct {
	...
	// DependsOn contains resources that OrganizationPolicy depends on
...
func (op organizationPolicyAttributes) Constraint() terra.StringValue {
	return terra.ReferenceString(op.ref.Append("constraint"))
}

func (op organizationPolicyAttributes) Etag() terra.StringValue {
	return terra.ReferenceString(op.ref.Append("etag"))
}
