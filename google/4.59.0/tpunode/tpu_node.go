...
func (ne NetworkEndpointsAttributes) InternalRef() terra.Reference {
	return ne.ref
}
...
func (ne NetworkEndpointsAttributes) InternalTokens() hclwrite.Tokens {
	return ne.ref.InternalTokens()
}

func (ne NetworkEndpointsAttributes) IpAddress() terra.StringValue {
	return terra.ReferenceString(ne.ref.Append("ip_address"))
}

func (ne NetworkEndpointsAttributes) Port() terra.NumberValue {
	return terra.ReferenceNumber(ne.ref.Append("port"))
}
...
func (sc SchedulingConfigAttributes) InternalRef() terra.Reference {
	return sc.ref
}
...
func (sc SchedulingConfigAttributes) InternalTokens() hclwrite.Tokens {
	return sc.ref.InternalTokens()
}

func (sc SchedulingConfigAttributes) Preemptible() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("preemptible"))
}
