...
func (tp TrainingPhrasesAttributes) InternalRef() terra.Reference {
	return tp.ref
}
...
func (tp TrainingPhrasesAttributes) InternalTokens() hclwrite.Tokens {
	return tp.ref.InternalTokens()
}

func (tp TrainingPhrasesAttributes) Id() terra.StringValue {
	return terra.ReferenceString(tp.ref.Append("id"))
}

func (tp TrainingPhrasesAttributes) RepeatCount() terra.NumberValue {
	return terra.ReferenceNumber(tp.ref.Append("repeat_count"))
}

func (tp TrainingPhrasesAttributes) Parts() terra.ListValue[PartsAttributes] {
	return terra.ReferenceList[PartsAttributes](tp.ref.Append("parts"))
}
...
func (p PartsAttributes) InternalRef() terra.Reference {
	return p.ref
}
...
func (p PartsAttributes) InternalTokens() hclwrite.Tokens {
	return p.ref.InternalTokens()
}

func (p PartsAttributes) ParameterId() terra.StringValue {
	return terra.ReferenceString(p.ref.Append("parameter_id"))
}

func (p PartsAttributes) Text() terra.StringValue {
	return terra.ReferenceString(p.ref.Append("text"))
}
