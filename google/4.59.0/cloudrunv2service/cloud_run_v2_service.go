...
func (ts TrafficStatusesAttributes) InternalRef() terra.Reference {
	return ts.ref
}
...
func (ts TrafficStatusesAttributes) InternalTokens() hclwrite.Tokens {
...
func (ts TrafficStatusesAttributes) Revision() terra.StringValue {
	return terra.ReferenceString(ts.ref.Append("revision"))
}

func (ts TrafficStatusesAttributes) Tag() terra.StringValue {
	return terra.ReferenceString(ts.ref.Append("tag"))
}

func (ts TrafficStatusesAttributes) Type() terra.StringValue {
	return terra.ReferenceString(ts.ref.Append("type"))
}

func (ts TrafficStatusesAttributes) Uri() terra.StringValue {
	return terra.ReferenceString(ts.ref.Append("uri"))
}
...
func (t TemplateAttributes) Annotations() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](t.ref.Append("annotations"))
}
...
func (t TemplateAttributes) MaxInstanceRequestConcurrency() terra.NumberValue {
	return terra.ReferenceNumber(t.ref.Append("max_instance_request_concurrency"))
}

func (t TemplateAttributes) Revision() terra.StringValue {
	return terra.ReferenceString(t.ref.Append("revision"))
}
...
func (t TemplateAttributes) Scaling() terra.ListValue[ScalingAttributes] {
	return terra.ReferenceList[ScalingAttributes](t.ref.Append("scaling"))
}
...
func (lp LivenessProbeAttributes) Grpc() terra.ListValue[LivenessProbeGrpcAttributes] {
	return terra.ReferenceList[LivenessProbeGrpcAttributes](lp.ref.Append("grpc"))
}
...
func (g LivenessProbeGrpcAttributes) InternalRef() terra.Reference {
	return g.ref
}
...
func (g LivenessProbeGrpcAttributes) InternalTokens() hclwrite.Tokens {
	return g.ref.InternalTokens()
}

func (g LivenessProbeGrpcAttributes) Port() terra.NumberValue {
	return terra.ReferenceNumber(g.ref.Append("port"))
}
...
func (r ResourcesAttributes) CpuIdle() terra.BoolValue {
	return terra.ReferenceBool(r.ref.Append("cpu_idle"))
}
...
func (sp StartupProbeAttributes) Grpc() terra.ListValue[StartupProbeGrpcAttributes] {
	return terra.ReferenceList[StartupProbeGrpcAttributes](sp.ref.Append("grpc"))
}
...
func (g StartupProbeGrpcAttributes) InternalRef() terra.Reference {
	return g.ref
}
...
func (g StartupProbeGrpcAttributes) InternalTokens() hclwrite.Tokens {
	return g.ref.InternalTokens()
}
...
func (s ScalingAttributes) MaxInstanceCount() terra.NumberValue {
	return terra.ReferenceNumber(s.ref.Append("max_instance_count"))
}

func (s ScalingAttributes) MinInstanceCount() terra.NumberValue {
	return terra.ReferenceNumber(s.ref.Append("min_instance_count"))
}
