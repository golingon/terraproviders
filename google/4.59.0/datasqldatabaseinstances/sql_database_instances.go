...
package datasqldatabaseinstances
...
type Instances struct {
	// Clone: min=0
	Clone []Clone `hcl:"clone,block" validate:"min=0"`
	// IpAddress: min=0
	IpAddress []IpAddress `hcl:"ip_address,block" validate:"min=0"`
	// ReplicaConfiguration: min=0
	ReplicaConfiguration []ReplicaConfiguration `hcl:"replica_configuration,block" validate:"min=0"`
	// RestoreBackupContext: min=0
	RestoreBackupContext []RestoreBackupContext `hcl:"restore_backup_context,block" validate:"min=0"`
	// ServerCaCert: min=0
	ServerCaCert []ServerCaCert `hcl:"server_ca_cert,block" validate:"min=0"`
	// Settings: min=0
...
func (i InstancesAttributes) AvailableMaintenanceVersions() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](i.ref.Append("available_maintenance_versions"))
}

func (i InstancesAttributes) ConnectionName() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("connection_name"))
}

func (i InstancesAttributes) DatabaseVersion() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("database_version"))
}

func (i InstancesAttributes) DeletionProtection() terra.BoolValue {
	return terra.ReferenceBool(i.ref.Append("deletion_protection"))
}

func (i InstancesAttributes) EncryptionKeyName() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("encryption_key_name"))
}

func (i InstancesAttributes) FirstIpAddress() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("first_ip_address"))
}

func (i InstancesAttributes) InstanceType() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("instance_type"))
}

func (i InstancesAttributes) MaintenanceVersion() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("maintenance_version"))
}

func (i InstancesAttributes) MasterInstanceName() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("master_instance_name"))
}
...
func (i InstancesAttributes) PrivateIpAddress() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("private_ip_address"))
}

func (i InstancesAttributes) Project() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("project"))
}

func (i InstancesAttributes) PublicIpAddress() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("public_ip_address"))
}

func (i InstancesAttributes) Region() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("region"))
}

func (i InstancesAttributes) RootPassword() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("root_password"))
}

func (i InstancesAttributes) SelfLink() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("self_link"))
}

func (i InstancesAttributes) ServiceAccountEmailAddress() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("service_account_email_address"))
}

func (i InstancesAttributes) Clone() terra.ListValue[CloneAttributes] {
	return terra.ReferenceList[CloneAttributes](i.ref.Append("clone"))
}

func (i InstancesAttributes) IpAddress() terra.ListValue[IpAddressAttributes] {
	return terra.ReferenceList[IpAddressAttributes](i.ref.Append("ip_address"))
}

func (i InstancesAttributes) ReplicaConfiguration() terra.ListValue[ReplicaConfigurationAttributes] {
	return terra.ReferenceList[ReplicaConfigurationAttributes](i.ref.Append("replica_configuration"))
}

func (i InstancesAttributes) RestoreBackupContext() terra.ListValue[RestoreBackupContextAttributes] {
	return terra.ReferenceList[RestoreBackupContextAttributes](i.ref.Append("restore_backup_context"))
}

func (i InstancesAttributes) ServerCaCert() terra.ListValue[ServerCaCertAttributes] {
	return terra.ReferenceList[ServerCaCertAttributes](i.ref.Append("server_ca_cert"))
}

func (i InstancesAttributes) Settings() terra.ListValue[SettingsAttributes] {
	return terra.ReferenceList[SettingsAttributes](i.ref.Append("settings"))
}
