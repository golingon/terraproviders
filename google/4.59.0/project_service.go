...
import (
	"encoding/json"
	"fmt"
	projectservice "github.com/golingon/terraproviders/google/4.59.0/projectservice"
...
type ProjectServiceArgs struct {
	...
	// DependsOn contains resources that ProjectService depends on
...
func (ps projectServiceAttributes) Timeouts() projectservice.TimeoutsAttributes {
	return terra.ReferenceSingle[projectservice.TimeoutsAttributes](ps.ref.Append("timeouts"))
}
