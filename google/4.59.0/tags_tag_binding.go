...
import (
	"encoding/json"
	"fmt"
	tagstagbinding "github.com/golingon/terraproviders/google/4.59.0/tagstagbinding"
...
type TagsTagBindingArgs struct {
	...
	// DependsOn contains resources that TagsTagBinding depends on
...
func (ttb tagsTagBindingAttributes) Id() terra.StringValue {
	return terra.ReferenceString(ttb.ref.Append("id"))
}

func (ttb tagsTagBindingAttributes) Name() terra.StringValue {
	return terra.ReferenceString(ttb.ref.Append("name"))
}

func (ttb tagsTagBindingAttributes) Parent() terra.StringValue {
	return terra.ReferenceString(ttb.ref.Append("parent"))
}

func (ttb tagsTagBindingAttributes) TagValue() terra.StringValue {
	return terra.ReferenceString(ttb.ref.Append("tag_value"))
}

func (ttb tagsTagBindingAttributes) Timeouts() tagstagbinding.TimeoutsAttributes {
	return terra.ReferenceSingle[tagstagbinding.TimeoutsAttributes](ttb.ref.Append("timeouts"))
}
