...
import (
	"encoding/json"
	"fmt"
	cloudassetprojectfeed "github.com/golingon/terraproviders/google/4.59.0/cloudassetprojectfeed"
...
type CloudAssetProjectFeedArgs struct {
	...
	// DependsOn contains resources that CloudAssetProjectFeed depends on
...
func (capf cloudAssetProjectFeedAttributes) FeedOutputConfig() terra.ListValue[cloudassetprojectfeed.FeedOutputConfigAttributes] {
	return terra.ReferenceList[cloudassetprojectfeed.FeedOutputConfigAttributes](capf.ref.Append("feed_output_config"))
}

func (capf cloudAssetProjectFeedAttributes) Timeouts() cloudassetprojectfeed.TimeoutsAttributes {
	return terra.ReferenceSingle[cloudassetprojectfeed.TimeoutsAttributes](capf.ref.Append("timeouts"))
}
