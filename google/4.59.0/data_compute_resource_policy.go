...
import (
	datacomputeresourcepolicy "github.com/golingon/terraproviders/google/4.59.0/datacomputeresourcepolicy"
...
func (crp dataComputeResourcePolicyAttributes) GroupPlacementPolicy() terra.ListValue[datacomputeresourcepolicy.GroupPlacementPolicyAttributes] {
	return terra.ReferenceList[datacomputeresourcepolicy.GroupPlacementPolicyAttributes](crp.ref.Append("group_placement_policy"))
}
...
func (crp dataComputeResourcePolicyAttributes) InstanceSchedulePolicy() terra.ListValue[datacomputeresourcepolicy.InstanceSchedulePolicyAttributes] {
	return terra.ReferenceList[datacomputeresourcepolicy.InstanceSchedulePolicyAttributes](crp.ref.Append("instance_schedule_policy"))
}
...
func (crp dataComputeResourcePolicyAttributes) SnapshotSchedulePolicy() terra.ListValue[datacomputeresourcepolicy.SnapshotSchedulePolicyAttributes] {
	return terra.ReferenceList[datacomputeresourcepolicy.SnapshotSchedulePolicyAttributes](crp.ref.Append("snapshot_schedule_policy"))
}
