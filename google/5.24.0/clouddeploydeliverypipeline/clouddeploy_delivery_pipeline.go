...
func (cr CloudRunAttributes) CanaryRevisionTags() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](cr.ref.Append("canary_revision_tags"))
}

func (cr CloudRunAttributes) PriorRevisionTags() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](cr.ref.Append("prior_revision_tags"))
}

func (cr CloudRunAttributes) StableRevisionTags() terra.ListValue[terra.StringValue] {
...
func (gsm GatewayServiceMeshAttributes) StableCutbackDuration() terra.StringValue {
