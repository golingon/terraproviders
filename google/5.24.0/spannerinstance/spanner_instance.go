...
type AutoscalingConfig struct {
	// AutoscalingLimits: optional
	AutoscalingLimits *AutoscalingLimits `hcl:"autoscaling_limits,block"`
	// AutoscalingTargets: optional
	AutoscalingTargets *AutoscalingTargets `hcl:"autoscaling_targets,block"`
}
