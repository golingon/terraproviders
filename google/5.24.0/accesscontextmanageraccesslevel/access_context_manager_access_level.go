...
func (c ConditionsAttributes) VpcNetworkSources() terra.ListValue[VpcNetworkSourcesAttributes] {
	return terra.ReferenceAsList[VpcNetworkSourcesAttributes](c.ref.Append("vpc_network_sources"))
}
...
func (oc OsConstraintsAttributes) RequireVerifiedChromeOs() terra.BoolValue {
