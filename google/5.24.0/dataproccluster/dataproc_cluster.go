...
type ClusterConfig struct {
	...
	// AuxiliaryNodeGroups: min=0
	AuxiliaryNodeGroups []AuxiliaryNodeGroups `hcl:"auxiliary_node_groups,block" validate:"min=0"`
...
type NodeGroupConfig struct {
	...
	// NodeGroupConfigAccelerators: min=0
	Accelerators []NodeGroupConfigAccelerators `hcl:"accelerators,block" validate:"min=0"`
	// NodeGroupConfigDiskConfig: optional
	DiskConfig *NodeGroupConfigDiskConfig `hcl:"disk_config,block"`
}

type NodeGroupConfigAccelerators struct {
...
type NodeGroupConfigDiskConfig struct {
...
type PreemptibleWorkerConfig struct {
	...
	// InstanceFlexibilityPolicy: optional
	InstanceFlexibilityPolicy *InstanceFlexibilityPolicy `hcl:"instance_flexibility_policy,block"`
}
...
type InstanceFlexibilityPolicy struct {
	// InstanceSelectionResults: min=0
	InstanceSelectionResults []InstanceSelectionResults `hcl:"instance_selection_results,block" validate:"min=0"`
	// InstanceSelectionList: min=0
	InstanceSelectionList []InstanceSelectionList `hcl:"instance_selection_list,block" validate:"min=0"`
}

type InstanceSelectionResults struct{}

type InstanceSelectionList struct {
...
func (cc ClusterConfigAttributes) AuxiliaryNodeGroups() terra.ListValue[AuxiliaryNodeGroupsAttributes] {
	return terra.ReferenceAsList[AuxiliaryNodeGroupsAttributes](cc.ref.Append("auxiliary_node_groups"))
}
...
type AuxiliaryNodeGroupsAttributes struct {
	ref terra.Reference
}

func (ang AuxiliaryNodeGroupsAttributes) InternalRef() (terra.Reference, error) {
	return ang.ref, nil
}

func (ang AuxiliaryNodeGroupsAttributes) InternalWithRef(ref terra.Reference) AuxiliaryNodeGroupsAttributes {
	return AuxiliaryNodeGroupsAttributes{ref: ref}
}

func (ang AuxiliaryNodeGroupsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ang.ref.InternalTokens()
}

func (ang AuxiliaryNodeGroupsAttributes) NodeGroupId() terra.StringValue {
	return terra.ReferenceAsString(ang.ref.Append("node_group_id"))
}

func (ang AuxiliaryNodeGroupsAttributes) NodeGroup() terra.ListValue[NodeGroupAttributes] {
	return terra.ReferenceAsList[NodeGroupAttributes](ang.ref.Append("node_group"))
}
...
func (ng NodeGroupAttributes) InternalRef() (terra.Reference, error) {
	return ng.ref, nil
}

func (ng NodeGroupAttributes) InternalWithRef(ref terra.Reference) NodeGroupAttributes {
	return NodeGroupAttributes{ref: ref}
}

func (ng NodeGroupAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ng.ref.InternalTokens()
}

func (ng NodeGroupAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(ng.ref.Append("name"))
}

func (ng NodeGroupAttributes) Roles() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](ng.ref.Append("roles"))
}

func (ng NodeGroupAttributes) NodeGroupConfig() terra.ListValue[NodeGroupConfigAttributes] {
	return terra.ReferenceAsList[NodeGroupConfigAttributes](ng.ref.Append("node_group_config"))
}

type NodeGroupConfigAttributes struct {
	ref terra.Reference
}

func (ngc NodeGroupConfigAttributes) InternalRef() (terra.Reference, error) {
	return ngc.ref, nil
}

func (ngc NodeGroupConfigAttributes) InternalWithRef(ref terra.Reference) NodeGroupConfigAttributes {
	return NodeGroupConfigAttributes{ref: ref}
}

func (ngc NodeGroupConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ngc.ref.InternalTokens()
}

func (ngc NodeGroupConfigAttributes) InstanceNames() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](ngc.ref.Append("instance_names"))
}

func (ngc NodeGroupConfigAttributes) MachineType() terra.StringValue {
	return terra.ReferenceAsString(ngc.ref.Append("machine_type"))
}

func (ngc NodeGroupConfigAttributes) MinCpuPlatform() terra.StringValue {
	return terra.ReferenceAsString(ngc.ref.Append("min_cpu_platform"))
}

func (ngc NodeGroupConfigAttributes) NumInstances() terra.NumberValue {
	return terra.ReferenceAsNumber(ngc.ref.Append("num_instances"))
}

func (ngc NodeGroupConfigAttributes) Accelerators() terra.SetValue[NodeGroupConfigAcceleratorsAttributes] {
	return terra.ReferenceAsSet[NodeGroupConfigAcceleratorsAttributes](ngc.ref.Append("accelerators"))
}

func (ngc NodeGroupConfigAttributes) DiskConfig() terra.ListValue[NodeGroupConfigDiskConfigAttributes] {
	return terra.ReferenceAsList[NodeGroupConfigDiskConfigAttributes](ngc.ref.Append("disk_config"))
}

type NodeGroupConfigAcceleratorsAttributes struct {
	ref terra.Reference
}

func (a NodeGroupConfigAcceleratorsAttributes) InternalRef() (terra.Reference, error) {
	return a.ref, nil
}

func (a NodeGroupConfigAcceleratorsAttributes) InternalWithRef(ref terra.Reference) NodeGroupConfigAcceleratorsAttributes {
	return NodeGroupConfigAcceleratorsAttributes{ref: ref}
}

func (a NodeGroupConfigAcceleratorsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return a.ref.InternalTokens()
}

func (a NodeGroupConfigAcceleratorsAttributes) AcceleratorCount() terra.NumberValue {
	return terra.ReferenceAsNumber(a.ref.Append("accelerator_count"))
}

func (a NodeGroupConfigAcceleratorsAttributes) AcceleratorType() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("accelerator_type"))
}

type NodeGroupConfigDiskConfigAttributes struct {
	ref terra.Reference
}

func (dc NodeGroupConfigDiskConfigAttributes) InternalRef() (terra.Reference, error) {
	return dc.ref, nil
}

func (dc NodeGroupConfigDiskConfigAttributes) InternalWithRef(ref terra.Reference) NodeGroupConfigDiskConfigAttributes {
	return NodeGroupConfigDiskConfigAttributes{ref: ref}
}

func (dc NodeGroupConfigDiskConfigAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return dc.ref.InternalTokens()
}

func (dc NodeGroupConfigDiskConfigAttributes) BootDiskSizeGb() terra.NumberValue {
	return terra.ReferenceAsNumber(dc.ref.Append("boot_disk_size_gb"))
}

func (dc NodeGroupConfigDiskConfigAttributes) BootDiskType() terra.StringValue {
	return terra.ReferenceAsString(dc.ref.Append("boot_disk_type"))
}

func (dc NodeGroupConfigDiskConfigAttributes) NumLocalSsds() terra.NumberValue {
...
func (pwc PreemptibleWorkerConfigAttributes) InstanceFlexibilityPolicy() terra.ListValue[InstanceFlexibilityPolicyAttributes] {
	return terra.ReferenceAsList[InstanceFlexibilityPolicyAttributes](pwc.ref.Append("instance_flexibility_policy"))
}
...
type InstanceFlexibilityPolicyAttributes struct {
	ref terra.Reference
}

func (ifp InstanceFlexibilityPolicyAttributes) InternalRef() (terra.Reference, error) {
	return ifp.ref, nil
}

func (ifp InstanceFlexibilityPolicyAttributes) InternalWithRef(ref terra.Reference) InstanceFlexibilityPolicyAttributes {
	return InstanceFlexibilityPolicyAttributes{ref: ref}
}

func (ifp InstanceFlexibilityPolicyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ifp.ref.InternalTokens()
}

func (ifp InstanceFlexibilityPolicyAttributes) InstanceSelectionResults() terra.ListValue[InstanceSelectionResultsAttributes] {
	return terra.ReferenceAsList[InstanceSelectionResultsAttributes](ifp.ref.Append("instance_selection_results"))
}

func (ifp InstanceFlexibilityPolicyAttributes) InstanceSelectionList() terra.ListValue[InstanceSelectionListAttributes] {
	return terra.ReferenceAsList[InstanceSelectionListAttributes](ifp.ref.Append("instance_selection_list"))
}

type InstanceSelectionResultsAttributes struct {
	ref terra.Reference
}

func (isr InstanceSelectionResultsAttributes) InternalRef() (terra.Reference, error) {
	return isr.ref, nil
}

func (isr InstanceSelectionResultsAttributes) InternalWithRef(ref terra.Reference) InstanceSelectionResultsAttributes {
	return InstanceSelectionResultsAttributes{ref: ref}
}

func (isr InstanceSelectionResultsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return isr.ref.InternalTokens()
}

func (isr InstanceSelectionResultsAttributes) MachineType() terra.StringValue {
	return terra.ReferenceAsString(isr.ref.Append("machine_type"))
}

func (isr InstanceSelectionResultsAttributes) VmCount() terra.NumberValue {
	return terra.ReferenceAsNumber(isr.ref.Append("vm_count"))
}

type InstanceSelectionListAttributes struct {
	ref terra.Reference
}

func (isl InstanceSelectionListAttributes) InternalRef() (terra.Reference, error) {
	return isl.ref, nil
}

func (isl InstanceSelectionListAttributes) InternalWithRef(ref terra.Reference) InstanceSelectionListAttributes {
	return InstanceSelectionListAttributes{ref: ref}
}

func (isl InstanceSelectionListAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return isl.ref.InternalTokens()
}

func (isl InstanceSelectionListAttributes) MachineTypes() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](isl.ref.Append("machine_types"))
}

func (isl InstanceSelectionListAttributes) Rank() terra.NumberValue {
...
func (wc WorkerConfigAttributes) MinNumInstances() terra.NumberValue {
...
type ClusterConfigState struct {
	...
	AuxiliaryNodeGroups     []AuxiliaryNodeGroupsState          `json:"auxiliary_node_groups"`
...
type AuxiliaryNodeGroupsState struct {
	NodeGroupId string           `json:"node_group_id"`
	NodeGroup   []NodeGroupState `json:"node_group"`
}

type NodeGroupState struct {
	Name            string                 `json:"name"`
	Roles           []string               `json:"roles"`
	NodeGroupConfig []NodeGroupConfigState `json:"node_group_config"`
}

type NodeGroupConfigState struct {
	InstanceNames  []string                           `json:"instance_names"`
	MachineType    string                             `json:"machine_type"`
	MinCpuPlatform string                             `json:"min_cpu_platform"`
	NumInstances   float64                            `json:"num_instances"`
	Accelerators   []NodeGroupConfigAcceleratorsState `json:"accelerators"`
	DiskConfig     []NodeGroupConfigDiskConfigState   `json:"disk_config"`
}

type NodeGroupConfigAcceleratorsState struct {
	AcceleratorCount float64 `json:"accelerator_count"`
	AcceleratorType  string  `json:"accelerator_type"`
}

type NodeGroupConfigDiskConfigState struct {
...
type PreemptibleWorkerConfigState struct {
	...
	InstanceFlexibilityPolicy []InstanceFlexibilityPolicyState         `json:"instance_flexibility_policy"`
}
...
type InstanceFlexibilityPolicyState struct {
	InstanceSelectionResults []InstanceSelectionResultsState `json:"instance_selection_results"`
	InstanceSelectionList    []InstanceSelectionListState    `json:"instance_selection_list"`
}

type InstanceSelectionResultsState struct {
	MachineType string  `json:"machine_type"`
	VmCount     float64 `json:"vm_count"`
}

type InstanceSelectionListState struct {
