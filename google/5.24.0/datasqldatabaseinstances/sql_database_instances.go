...
type Settings struct {
	...
	AdvancedMachineFeatures []AdvancedMachineFeatures `hcl:"advanced_machine_features,block" validate:"min=0"`
	// BackupConfiguration: min=0
	BackupConfiguration []BackupConfiguration `hcl:"backup_configuration,block" validate:"min=0"`
	// DataCacheConfig: min=0
	DataCacheConfig []DataCacheConfig `hcl:"data_cache_config,block" validate:"min=0"`
	// DatabaseFlags: min=0
...
func (i InstancesAttributes) DnsName() terra.StringValue {
...
func (i InstancesAttributes) PscServiceAttachmentLink() terra.StringValue {
...
func (i InstancesAttributes) Clone() terra.ListValue[CloneAttributes] {
	return terra.ReferenceAsList[CloneAttributes](i.ref.Append("clone"))
}

func (i InstancesAttributes) IpAddress() terra.ListValue[IpAddressAttributes] {
	return terra.ReferenceAsList[IpAddressAttributes](i.ref.Append("ip_address"))
}

func (i InstancesAttributes) ReplicaConfiguration() terra.ListValue[ReplicaConfigurationAttributes] {
	return terra.ReferenceAsList[ReplicaConfigurationAttributes](i.ref.Append("replica_configuration"))
}

func (i InstancesAttributes) RestoreBackupContext() terra.ListValue[RestoreBackupContextAttributes] {
	return terra.ReferenceAsList[RestoreBackupContextAttributes](i.ref.Append("restore_backup_context"))
}

func (i InstancesAttributes) ServerCaCert() terra.ListValue[ServerCaCertAttributes] {
	return terra.ReferenceAsList[ServerCaCertAttributes](i.ref.Append("server_ca_cert"))
}

func (i InstancesAttributes) Settings() terra.ListValue[SettingsAttributes] {
	return terra.ReferenceAsList[SettingsAttributes](i.ref.Append("settings"))
}
...
func (s SettingsAttributes) DatabaseFlags() terra.SetValue[DatabaseFlagsAttributes] {
	return terra.ReferenceAsSet[DatabaseFlagsAttributes](s.ref.Append("database_flags"))
}
...
func (ic IpConfigurationAttributes) SslMode() terra.StringValue {
