...
func (ccc ClientConnectionConfigAttributes) SslConfig() terra.ListValue[SslConfigAttributes] {
	return terra.ReferenceAsList[SslConfigAttributes](ccc.ref.Append("ssl_config"))
}
...
func (sc SslConfigAttributes) SslMode() terra.StringValue {
