...
package google_compute_http_health_check
...
// Resource represents the Terraform resource google_compute_http_health_check.
type Resource struct {
	Name      string
	Args      Args
	state     *googleComputeHttpHealthCheckState
...
func (gchhc *Resource) Attributes() googleComputeHttpHealthCheckAttributes {
	return googleComputeHttpHealthCheckAttributes{ref: terra.ReferenceResource(gchhc)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (gchhc *Resource) ImportState(state io.Reader) error {
	gchhc.state = &googleComputeHttpHealthCheckState{}
...
func (gchhc *Resource) State() (*googleComputeHttpHealthCheckState, bool) {
	return gchhc.state, gchhc.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (gchhc *Resource) StateMust() *googleComputeHttpHealthCheckState {
	if gchhc.state == nil {
...
// Args contains the configurations for google_compute_http_health_check.
type Args struct {
...
type googleComputeHttpHealthCheckAttributes struct {
	ref terra.Reference
}

// CheckIntervalSec returns a reference to field check_interval_sec of google_compute_http_health_check.
func (gchhc googleComputeHttpHealthCheckAttributes) CheckIntervalSec() terra.NumberValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) CreationTimestamp() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Description() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) HealthyThreshold() terra.NumberValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Host() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Id() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Name() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Port() terra.NumberValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) Project() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) RequestPath() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) SelfLink() terra.StringValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) TimeoutSec() terra.NumberValue {
...
func (gchhc googleComputeHttpHealthCheckAttributes) UnhealthyThreshold() terra.NumberValue {
	return terra.ReferenceAsNumber(gchhc.ref.Append("unhealthy_threshold"))
}

func (gchhc googleComputeHttpHealthCheckAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](gchhc.ref.Append("timeouts"))
}

type googleComputeHttpHealthCheckState struct {
