...
type Endpoint struct {
	// EndpointGkeCluster: optional
	GkeCluster *EndpointGkeCluster `hcl:"gke_cluster,block"`
}

type EndpointGkeCluster struct {
...
func (e EndpointAttributes) GkeCluster() terra.ListValue[EndpointGkeClusterAttributes] {
	return terra.ReferenceAsList[EndpointGkeClusterAttributes](e.ref.Append("gke_cluster"))
}
...
func (gc EndpointGkeClusterAttributes) InternalWithRef(ref terra.Reference) EndpointGkeClusterAttributes {
	return EndpointGkeClusterAttributes{ref: ref}
}
