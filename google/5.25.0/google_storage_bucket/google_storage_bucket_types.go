...
func (lr LifecycleRuleAttributes) Action() terra.SetValue[LifecycleRuleActionAttributes] {
	return terra.ReferenceAsSet[LifecycleRuleActionAttributes](lr.ref.Append("action"))
}

func (lr LifecycleRuleAttributes) Condition() terra.SetValue[LifecycleRuleConditionAttributes] {
	return terra.ReferenceAsSet[LifecycleRuleConditionAttributes](lr.ref.Append("condition"))
}
...
func (a LifecycleRuleActionAttributes) InternalRef() (terra.Reference, error) {
	return a.ref, nil
}

func (a LifecycleRuleActionAttributes) InternalWithRef(ref terra.Reference) LifecycleRuleActionAttributes {
	return LifecycleRuleActionAttributes{ref: ref}
}
...
func (a LifecycleRuleActionAttributes) StorageClass() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("storage_class"))
}

func (a LifecycleRuleActionAttributes) Type() terra.StringValue {
...
func (c LifecycleRuleConditionAttributes) InternalRef() (terra.Reference, error) {
	return c.ref, nil
}

func (c LifecycleRuleConditionAttributes) InternalWithRef(ref terra.Reference) LifecycleRuleConditionAttributes {
	return LifecycleRuleConditionAttributes{ref: ref}
}
...
func (c LifecycleRuleConditionAttributes) Age() terra.NumberValue {
	return terra.ReferenceAsNumber(c.ref.Append("age"))
}

func (c LifecycleRuleConditionAttributes) CreatedBefore() terra.StringValue {
...
func (c LifecycleRuleConditionAttributes) MatchesPrefix() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](c.ref.Append("matches_prefix"))
}

func (c LifecycleRuleConditionAttributes) MatchesStorageClass() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](c.ref.Append("matches_storage_class"))
}

func (c LifecycleRuleConditionAttributes) MatchesSuffix() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](c.ref.Append("matches_suffix"))
}

func (c LifecycleRuleConditionAttributes) NoAge() terra.BoolValue {
...
func (c LifecycleRuleConditionAttributes) WithState() terra.StringValue {
