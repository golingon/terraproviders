...
type PartitionConfig struct {
	...
	// PartitionConfigCapacity: optional
	Capacity *PartitionConfigCapacity `hcl:"capacity,block"`
}

type PartitionConfigCapacity struct {
...
func (pc PartitionConfigAttributes) Capacity() terra.ListValue[PartitionConfigCapacityAttributes] {
	return terra.ReferenceAsList[PartitionConfigCapacityAttributes](pc.ref.Append("capacity"))
}

type PartitionConfigCapacityAttributes struct {
	ref terra.Reference
}

func (c PartitionConfigCapacityAttributes) InternalRef() (terra.Reference, error) {
	return c.ref, nil
}

func (c PartitionConfigCapacityAttributes) InternalWithRef(ref terra.Reference) PartitionConfigCapacityAttributes {
	return PartitionConfigCapacityAttributes{ref: ref}
}

func (c PartitionConfigCapacityAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return c.ref.InternalTokens()
}

func (c PartitionConfigCapacityAttributes) PublishMibPerSec() terra.NumberValue {
	return terra.ReferenceAsNumber(c.ref.Append("publish_mib_per_sec"))
}

func (c PartitionConfigCapacityAttributes) SubscribeMibPerSec() terra.NumberValue {
...
type PartitionConfigState struct {
	...
	Capacity []PartitionConfigCapacityState `json:"capacity"`
}

type PartitionConfigCapacityState struct {
