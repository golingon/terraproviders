...
type PathMatcherDefaultRouteActionFaultInjectionPolicyDelay struct {
	// Percentage: number, optional
	Percentage terra.NumberValue `hcl:"percentage,attr"`
	// PathMatcherDefaultRouteActionFe3931D1: optional
	FixedDelay *PathMatcherDefaultRouteActionFe3931D1 `hcl:"fixed_delay,block"`
}

type PathMatcherDefaultRouteActionFe3931D1 struct {
	// Nanos: number, optional
	Nanos terra.NumberValue `hcl:"nanos,attr"`
	// Seconds: string, optional
	Seconds terra.StringValue `hcl:"seconds,attr"`
...
type PathMatcherDefaultRouteActionWeightedBackendServicesHeaderAction struct {
	...
	// ResponseHeadersToRemove: list of string, optional
	ResponseHeadersToRemove terra.ListValue[terra.StringValue] `hcl:"response_headers_to_remove,attr"`
	// PathMatcherDefaultRouteAction346Ded4F: min=0
	RequestHeadersToAdd []PathMatcherDefaultRouteAction346Ded4F `hcl:"request_headers_to_add,block" validate:"min=0"`
	// PathMatcherDefaultRouteAction3368A15A: min=0
	ResponseHeadersToAdd []PathMatcherDefaultRouteAction3368A15A `hcl:"response_headers_to_add,block" validate:"min=0"`
}

type PathMatcherDefaultRouteAction346Ded4F struct {
	// HeaderName: string, optional
	HeaderName terra.StringValue `hcl:"header_name,attr"`
	// HeaderValue: string, optional
	HeaderValue terra.StringValue `hcl:"header_value,attr"`
...
type PathMatcherDefaultRouteAction3368A15A struct {
	// HeaderName: string, optional
	HeaderName terra.StringValue `hcl:"header_name,attr"`
	// HeaderValue: string, optional
	HeaderValue terra.StringValue `hcl:"header_value,attr"`
...
func (d PathMatcherDefaultRouteActionFaultInjectionPolicyDelayAttributes) FixedDelay() terra.ListValue[PathMatcherDefaultRouteActionFe3931D1Attributes] {
	return terra.ReferenceAsList[PathMatcherDefaultRouteActionFe3931D1Attributes](d.ref.Append("fixed_delay"))
}

type PathMatcherDefaultRouteActionFe3931D1Attributes struct {
	ref terra.Reference
}

func (fd PathMatcherDefaultRouteActionFe3931D1Attributes) InternalRef() (terra.Reference, error) {
	return fd.ref, nil
}

func (fd PathMatcherDefaultRouteActionFe3931D1Attributes) InternalWithRef(ref terra.Reference) PathMatcherDefaultRouteActionFe3931D1Attributes {
	return PathMatcherDefaultRouteActionFe3931D1Attributes{ref: ref}
}

func (fd PathMatcherDefaultRouteActionFe3931D1Attributes) InternalTokens() (hclwrite.Tokens, error) {
	return fd.ref.InternalTokens()
}

func (fd PathMatcherDefaultRouteActionFe3931D1Attributes) Nanos() terra.NumberValue {
	return terra.ReferenceAsNumber(fd.ref.Append("nanos"))
}

func (fd PathMatcherDefaultRouteActionFe3931D1Attributes) Seconds() terra.StringValue {
	return terra.ReferenceAsString(fd.ref.Append("seconds"))
}
...
func (ha PathMatcherDefaultRouteActionWeightedBackendServicesHeaderActionAttributes) RequestHeadersToAdd() terra.ListValue[PathMatcherDefaultRouteAction346Ded4FAttributes] {
	return terra.ReferenceAsList[PathMatcherDefaultRouteAction346Ded4FAttributes](ha.ref.Append("request_headers_to_add"))
}

func (ha PathMatcherDefaultRouteActionWeightedBackendServicesHeaderActionAttributes) ResponseHeadersToAdd() terra.ListValue[PathMatcherDefaultRouteAction3368A15AAttributes] {
	return terra.ReferenceAsList[PathMatcherDefaultRouteAction3368A15AAttributes](ha.ref.Append("response_headers_to_add"))
}

type PathMatcherDefaultRouteAction346Ded4FAttributes struct {
	ref terra.Reference
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) InternalRef() (terra.Reference, error) {
	return rhta.ref, nil
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) InternalWithRef(ref terra.Reference) PathMatcherDefaultRouteAction346Ded4FAttributes {
	return PathMatcherDefaultRouteAction346Ded4FAttributes{ref: ref}
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return rhta.ref.InternalTokens()
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) HeaderName() terra.StringValue {
	return terra.ReferenceAsString(rhta.ref.Append("header_name"))
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) HeaderValue() terra.StringValue {
	return terra.ReferenceAsString(rhta.ref.Append("header_value"))
}

func (rhta PathMatcherDefaultRouteAction346Ded4FAttributes) Replace() terra.BoolValue {
	return terra.ReferenceAsBool(rhta.ref.Append("replace"))
}

type PathMatcherDefaultRouteAction3368A15AAttributes struct {
	ref terra.Reference
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) InternalRef() (terra.Reference, error) {
	return rhta.ref, nil
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) InternalWithRef(ref terra.Reference) PathMatcherDefaultRouteAction3368A15AAttributes {
	return PathMatcherDefaultRouteAction3368A15AAttributes{ref: ref}
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return rhta.ref.InternalTokens()
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) HeaderName() terra.StringValue {
	return terra.ReferenceAsString(rhta.ref.Append("header_name"))
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) HeaderValue() terra.StringValue {
	return terra.ReferenceAsString(rhta.ref.Append("header_value"))
}

func (rhta PathMatcherDefaultRouteAction3368A15AAttributes) Replace() terra.BoolValue {
	return terra.ReferenceAsBool(rhta.ref.Append("replace"))
}
...
type PathMatcherDefaultRouteActionFaultInjectionPolicyDelayState struct {
	Percentage float64                                      `json:"percentage"`
	FixedDelay []PathMatcherDefaultRouteActionFe3931D1State `json:"fixed_delay"`
}

type PathMatcherDefaultRouteActionFe3931D1State struct {
	Nanos   float64 `json:"nanos"`
	Seconds string  `json:"seconds"`
}
...
type PathMatcherDefaultRouteActionWeightedBackendServicesHeaderActionState struct {
	RequestHeadersToRemove  []string                                     `json:"request_headers_to_remove"`
	ResponseHeadersToRemove []string                                     `json:"response_headers_to_remove"`
	RequestHeadersToAdd     []PathMatcherDefaultRouteAction346Ded4FState `json:"request_headers_to_add"`
	ResponseHeadersToAdd    []PathMatcherDefaultRouteAction3368A15AState `json:"response_headers_to_add"`
}

type PathMatcherDefaultRouteAction346Ded4FState struct {
	HeaderName  string `json:"header_name"`
	HeaderValue string `json:"header_value"`
	Replace     bool   `json:"replace"`
}

type PathMatcherDefaultRouteAction3368A15AState struct {
	HeaderName  string `json:"header_name"`
	HeaderValue string `json:"header_value"`
	Replace     bool   `json:"replace"`
}
