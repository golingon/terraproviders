...
type MaintenancePolicy struct {
	...
	// MaintenancePolicyWeeklyMaintenanceWindow: min=1
	WeeklyMaintenanceWindow []MaintenancePolicyWeeklyMaintenanceWindow `hcl:"weekly_maintenance_window,block" validate:"min=1"`
}
