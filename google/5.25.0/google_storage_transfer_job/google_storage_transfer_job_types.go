...
type TransferSpecAzureBlobStorageDataSource struct {
	...
	// TransferSpecAzureBlobStorageDataSourceAzureCredentials: required
	AzureCredentials *TransferSpecAzureBlobStorageDataSourceAzureCredentials `hcl:"azure_credentials,block" validate:"required"`
}
