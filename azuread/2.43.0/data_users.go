...
import (
	datausers "github.com/golingon/terraproviders/azuread/2.43.0/datausers"
...
func (u dataUsersAttributes) EmployeeIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](u.ref.Append("employee_ids"))
}
