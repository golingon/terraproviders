...
func (a ApiAttributes) Oauth2PermissionScope() terra.SetValue[Oauth2PermissionScopeAttributes] {
	return terra.ReferenceAsSet[Oauth2PermissionScopeAttributes](a.ref.Append("oauth2_permission_scope"))
}
...
func (ops Oauth2PermissionScopeAttributes) InternalRef() (terra.Reference, error) {
	return ops.ref, nil
}

func (ops Oauth2PermissionScopeAttributes) InternalWithRef(ref terra.Reference) Oauth2PermissionScopeAttributes {
	return Oauth2PermissionScopeAttributes{ref: ref}
}
...
func (ops Oauth2PermissionScopeAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(ops.ref.Append("enabled"))
}

func (ops Oauth2PermissionScopeAttributes) Id() terra.StringValue {
	return terra.ReferenceAsString(ops.ref.Append("id"))
}

func (ops Oauth2PermissionScopeAttributes) Type() terra.StringValue {
...
func (ops Oauth2PermissionScopeAttributes) Value() terra.StringValue {
