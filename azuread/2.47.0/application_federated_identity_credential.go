...
import (
	...
	applicationfederatedidentitycredential "github.com/golingon/terraproviders/azuread/2.47.0/applicationfederatedidentitycredential"
	"io"
)
...
func (afic applicationFederatedIdentityCredentialAttributes) ApplicationId() terra.StringValue {
	return terra.ReferenceAsString(afic.ref.Append("application_id"))
}
