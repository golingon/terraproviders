...
import (
	...
	applicationpreauthorized "github.com/golingon/terraproviders/azuread/2.47.0/applicationpreauthorized"
	"io"
)
...
func (apa applicationPreAuthorizedAttributes) ApplicationId() terra.StringValue {
...
func (apa applicationPreAuthorizedAttributes) AuthorizedClientId() terra.StringValue {
	return terra.ReferenceAsString(apa.ref.Append("authorized_client_id"))
}
