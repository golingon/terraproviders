...
import (
	dataserviceprincipals "github.com/golingon/terraproviders/azuread/2.44.0/dataserviceprincipals"
...
func (sp dataServicePrincipalsAttributes) ClientIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](sp.ref.Append("client_ids"))
}
