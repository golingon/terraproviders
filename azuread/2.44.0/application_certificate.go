...
import (
	"encoding/json"
	"fmt"
	applicationcertificate "github.com/golingon/terraproviders/azuread/2.44.0/applicationcertificate"
...
func (ac applicationCertificateAttributes) ApplicationId() terra.StringValue {
