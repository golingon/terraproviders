...
import (
	"encoding/json"
	"fmt"
	networkinterfaceapplicationsecuritygroupassociation "github.com/golingon/terraproviders/azurerm/3.55.0/networkinterfaceapplicationsecuritygroupassociation"
