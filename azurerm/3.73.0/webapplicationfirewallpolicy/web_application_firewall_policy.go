...
type RuleGroupOverride struct {
	...
	// RuleGroupName: string, required
	RuleGroupName terra.StringValue `hcl:"rule_group_name,attr" validate:"required"`
	// RuleGroupOverrideRule: min=0
	Rule []RuleGroupOverrideRule `hcl:"rule,block" validate:"min=0"`
}

type RuleGroupOverrideRule struct {
...
type PolicySettings struct {
	...
	// LogScrubbing: optional
	LogScrubbing *LogScrubbing `hcl:"log_scrubbing,block"`
}

type LogScrubbing struct {
	// Enabled: bool, optional
	Enabled terra.BoolValue `hcl:"enabled,attr"`
	// LogScrubbingRule: min=0
	Rule []LogScrubbingRule `hcl:"rule,block" validate:"min=0"`
}

type LogScrubbingRule struct {
	// Enabled: bool, optional
	Enabled terra.BoolValue `hcl:"enabled,attr"`
	// MatchVariable: string, required
	MatchVariable terra.StringValue `hcl:"match_variable,attr" validate:"required"`
...
func (rgo RuleGroupOverrideAttributes) Rule() terra.ListValue[RuleGroupOverrideRuleAttributes] {
	return terra.ReferenceAsList[RuleGroupOverrideRuleAttributes](rgo.ref.Append("rule"))
}

type RuleGroupOverrideRuleAttributes struct {
	ref terra.Reference
}

func (r RuleGroupOverrideRuleAttributes) InternalRef() (terra.Reference, error) {
	return r.ref, nil
}

func (r RuleGroupOverrideRuleAttributes) InternalWithRef(ref terra.Reference) RuleGroupOverrideRuleAttributes {
	return RuleGroupOverrideRuleAttributes{ref: ref}
}

func (r RuleGroupOverrideRuleAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return r.ref.InternalTokens()
}

func (r RuleGroupOverrideRuleAttributes) Action() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("action"))
}

func (r RuleGroupOverrideRuleAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(r.ref.Append("enabled"))
}

func (r RuleGroupOverrideRuleAttributes) Id() terra.StringValue {
...
func (ps PolicySettingsAttributes) LogScrubbing() terra.ListValue[LogScrubbingAttributes] {
	return terra.ReferenceAsList[LogScrubbingAttributes](ps.ref.Append("log_scrubbing"))
}

type LogScrubbingAttributes struct {
	ref terra.Reference
}

func (ls LogScrubbingAttributes) InternalRef() (terra.Reference, error) {
	return ls.ref, nil
}

func (ls LogScrubbingAttributes) InternalWithRef(ref terra.Reference) LogScrubbingAttributes {
	return LogScrubbingAttributes{ref: ref}
}

func (ls LogScrubbingAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ls.ref.InternalTokens()
}

func (ls LogScrubbingAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(ls.ref.Append("enabled"))
}

func (ls LogScrubbingAttributes) Rule() terra.ListValue[LogScrubbingRuleAttributes] {
	return terra.ReferenceAsList[LogScrubbingRuleAttributes](ls.ref.Append("rule"))
}

type LogScrubbingRuleAttributes struct {
	ref terra.Reference
}

func (r LogScrubbingRuleAttributes) InternalRef() (terra.Reference, error) {
	return r.ref, nil
}

func (r LogScrubbingRuleAttributes) InternalWithRef(ref terra.Reference) LogScrubbingRuleAttributes {
	return LogScrubbingRuleAttributes{ref: ref}
}

func (r LogScrubbingRuleAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return r.ref.InternalTokens()
}

func (r LogScrubbingRuleAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(r.ref.Append("enabled"))
}

func (r LogScrubbingRuleAttributes) MatchVariable() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("match_variable"))
}

func (r LogScrubbingRuleAttributes) Selector() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("selector"))
}

func (r LogScrubbingRuleAttributes) SelectorMatchOperator() terra.StringValue {
...
type RuleGroupOverrideState struct {
	...
	RuleGroupName string                       `json:"rule_group_name"`
	Rule          []RuleGroupOverrideRuleState `json:"rule"`
}

type RuleGroupOverrideRuleState struct {
	Action  string `json:"action"`
	Enabled bool   `json:"enabled"`
	Id      string `json:"id"`
}
...
type PolicySettingsState struct {
	...
	LogScrubbing           []LogScrubbingState `json:"log_scrubbing"`
}

type LogScrubbingState struct {
	Enabled bool                    `json:"enabled"`
	Rule    []LogScrubbingRuleState `json:"rule"`
}

type LogScrubbingRuleState struct {
	Enabled               bool   `json:"enabled"`
	MatchVariable         string `json:"match_variable"`
	Selector              string `json:"selector"`
	SelectorMatchOperator string `json:"selector_match_operator"`
