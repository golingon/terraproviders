...
import (
	"encoding/json"
	"fmt"
	monitoraaddiagnosticsetting "github.com/golingon/terraproviders/azurerm/3.69.0/monitoraaddiagnosticsetting"
...
type MonitorAadDiagnosticSettingArgs struct {
	...
	// EnabledLog: min=0
	EnabledLog []monitoraaddiagnosticsetting.EnabledLog `hcl:"enabled_log,block" validate:"min=0"`
	// Log: min=0
	Log []monitoraaddiagnosticsetting.Log `hcl:"log,block" validate:"min=0"`
	// Timeouts: optional
...
func (mads monitorAadDiagnosticSettingAttributes) EnabledLog() terra.SetValue[monitoraaddiagnosticsetting.EnabledLogAttributes] {
	return terra.ReferenceAsSet[monitoraaddiagnosticsetting.EnabledLogAttributes](mads.ref.Append("enabled_log"))
}
...
type monitorAadDiagnosticSettingState struct {
	...
	EnabledLog                  []monitoraaddiagnosticsetting.EnabledLogState `json:"enabled_log"`
