...
import (
	...
	springcloudcontainerdeployment "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudcontainerdeployment"
	"io"
)
...
func (sccd springCloudContainerDeploymentAttributes) ApplicationPerformanceMonitoringIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](sccd.ref.Append("application_performance_monitoring_ids"))
}
