...
import (
	...
	datalinuxfunctionapp "github.com/golingon/terraproviders/azurerm/3.98.0/datalinuxfunctionapp"
)
...
func (lfa dataLinuxFunctionAppAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lfa.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (lfa dataLinuxFunctionAppAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lfa.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
