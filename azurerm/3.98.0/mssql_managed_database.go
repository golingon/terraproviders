...
import (
	...
	mssqlmanageddatabase "github.com/golingon/terraproviders/azurerm/3.98.0/mssqlmanageddatabase"
	"io"
)
...
type MssqlManagedDatabaseArgs struct {
	...
	PointInTimeRestore *mssqlmanageddatabase.PointInTimeRestore `hcl:"point_in_time_restore,block"`
	// Timeouts: optional
...
func (mmd mssqlManagedDatabaseAttributes) PointInTimeRestore() terra.ListValue[mssqlmanageddatabase.PointInTimeRestoreAttributes] {
	return terra.ReferenceAsList[mssqlmanageddatabase.PointInTimeRestoreAttributes](mmd.ref.Append("point_in_time_restore"))
}
...
type mssqlManagedDatabaseState struct {
	...
	PointInTimeRestore      []mssqlmanageddatabase.PointInTimeRestoreState      `json:"point_in_time_restore"`
