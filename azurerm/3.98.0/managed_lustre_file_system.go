...
import (
	...
	managedlustrefilesystem "github.com/golingon/terraproviders/azurerm/3.98.0/managedlustrefilesystem"
	"io"
)
...
func (mlfs managedLustreFileSystemAttributes) MgsAddress() terra.StringValue {
	return terra.ReferenceAsString(mlfs.ref.Append("mgs_address"))
}
