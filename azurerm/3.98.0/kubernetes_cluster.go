...
import (
	...
	kubernetescluster "github.com/golingon/terraproviders/azurerm/3.98.0/kubernetescluster"
	"io"
)
...
func (kc kubernetesClusterAttributes) CurrentKubernetesVersion() terra.StringValue {
...
func (kc kubernetesClusterAttributes) SupportPlan() terra.StringValue {
	return terra.ReferenceAsString(kc.ref.Append("support_plan"))
}
