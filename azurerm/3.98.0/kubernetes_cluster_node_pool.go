...
import (
	...
	kubernetesclusternodepool "github.com/golingon/terraproviders/azurerm/3.98.0/kubernetesclusternodepool"
	"io"
)
...
func (kcnp kubernetesClusterNodePoolAttributes) GpuInstance() terra.StringValue {
	return terra.ReferenceAsString(kcnp.ref.Append("gpu_instance"))
}
