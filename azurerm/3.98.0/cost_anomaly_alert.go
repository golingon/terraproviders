...
import (
	...
	costanomalyalert "github.com/golingon/terraproviders/azurerm/3.98.0/costanomalyalert"
	"io"
)
...
func (caa costAnomalyAlertAttributes) SubscriptionId() terra.StringValue {
	return terra.ReferenceAsString(caa.ref.Append("subscription_id"))
}
