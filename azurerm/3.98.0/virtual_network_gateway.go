...
import (
	...
	virtualnetworkgateway "github.com/golingon/terraproviders/azurerm/3.98.0/virtualnetworkgateway"
	"io"
)
...
type VirtualNetworkGatewayArgs struct {
	...
	// PolicyGroup: min=0
	PolicyGroup []virtualnetworkgateway.PolicyGroup `hcl:"policy_group,block" validate:"min=0"`
	// Timeouts: optional
...
func (vng virtualNetworkGatewayAttributes) BgpRouteTranslationForNatEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(vng.ref.Append("bgp_route_translation_for_nat_enabled"))
}
...
func (vng virtualNetworkGatewayAttributes) DnsForwardingEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(vng.ref.Append("dns_forwarding_enabled"))
}
...
func (vng virtualNetworkGatewayAttributes) IpSecReplayProtectionEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(vng.ref.Append("ip_sec_replay_protection_enabled"))
}
...
func (vng virtualNetworkGatewayAttributes) RemoteVnetTrafficEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(vng.ref.Append("remote_vnet_traffic_enabled"))
}
...
func (vng virtualNetworkGatewayAttributes) VirtualWanTrafficEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(vng.ref.Append("virtual_wan_traffic_enabled"))
}
...
func (vng virtualNetworkGatewayAttributes) PolicyGroup() terra.ListValue[virtualnetworkgateway.PolicyGroupAttributes] {
	return terra.ReferenceAsList[virtualnetworkgateway.PolicyGroupAttributes](vng.ref.Append("policy_group"))
}
...
type virtualNetworkGatewayState struct {
	...
	PolicyGroup                      []virtualnetworkgateway.PolicyGroupState            `json:"policy_group"`
