...
import (
	...
	springcloudconfigurationservice "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudconfigurationservice"
	"io"
)
...
func (sccs springCloudConfigurationServiceAttributes) RefreshIntervalInSeconds() terra.NumberValue {
	return terra.ReferenceAsNumber(sccs.ref.Append("refresh_interval_in_seconds"))
}
