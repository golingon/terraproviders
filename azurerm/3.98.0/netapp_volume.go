...
import (
	...
	netappvolume "github.com/golingon/terraproviders/azurerm/3.98.0/netappvolume"
	"io"
)
...
func (nv netappVolumeAttributes) EncryptionKeySource() terra.StringValue {
	return terra.ReferenceAsString(nv.ref.Append("encryption_key_source"))
}
...
func (nv netappVolumeAttributes) KeyVaultPrivateEndpointId() terra.StringValue {
	return terra.ReferenceAsString(nv.ref.Append("key_vault_private_endpoint_id"))
}
...
func (nv netappVolumeAttributes) SmbAccessBasedEnumerationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(nv.ref.Append("smb_access_based_enumeration_enabled"))
}
...
func (nv netappVolumeAttributes) SmbContinuousAvailabilityEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(nv.ref.Append("smb_continuous_availability_enabled"))
}

// SmbNonBrowsableEnabled returns a reference to field smb_non_browsable_enabled of azurerm_netapp_volume.
func (nv netappVolumeAttributes) SmbNonBrowsableEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(nv.ref.Append("smb_non_browsable_enabled"))
}
