...
import (
	...
	cdnfrontdoorfirewallpolicy "github.com/golingon/terraproviders/azurerm/3.98.0/cdnfrontdoorfirewallpolicy"
	"io"
)
...
func (cffp cdnFrontdoorFirewallPolicyAttributes) RequestBodyCheckEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(cffp.ref.Append("request_body_check_enabled"))
}
