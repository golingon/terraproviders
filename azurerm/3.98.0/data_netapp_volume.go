...
import (
	...
	datanetappvolume "github.com/golingon/terraproviders/azurerm/3.98.0/datanetappvolume"
)
...
func (nv dataNetappVolumeAttributes) EncryptionKeySource() terra.StringValue {
...
func (nv dataNetappVolumeAttributes) KeyVaultPrivateEndpointId() terra.StringValue {
...
func (nv dataNetappVolumeAttributes) SmbAccessBasedEnumerationEnabled() terra.BoolValue {
...
func (nv dataNetappVolumeAttributes) SmbNonBrowsableEnabled() terra.BoolValue {
