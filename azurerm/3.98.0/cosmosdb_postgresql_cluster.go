...
import (
	...
	cosmosdbpostgresqlcluster "github.com/golingon/terraproviders/azurerm/3.98.0/cosmosdbpostgresqlcluster"
	"io"
)
...
type CosmosdbPostgresqlClusterArgs struct {
	...
	// Servers: min=0
	Servers []cosmosdbpostgresqlcluster.Servers `hcl:"servers,block" validate:"min=0"`
...
func (cpc cosmosdbPostgresqlClusterAttributes) Servers() terra.ListValue[cosmosdbpostgresqlcluster.ServersAttributes] {
	return terra.ReferenceAsList[cosmosdbpostgresqlcluster.ServersAttributes](cpc.ref.Append("servers"))
}
...
type cosmosdbPostgresqlClusterState struct {
	...
	Servers                          []cosmosdbpostgresqlcluster.ServersState           `json:"servers"`
