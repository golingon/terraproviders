...
import (
	...
	windowsvirtualmachine "github.com/golingon/terraproviders/azurerm/3.98.0/windowsvirtualmachine"
	"io"
)
...
type WindowsVirtualMachineArgs struct {
	...
	OsImageNotification *windowsvirtualmachine.OsImageNotification `hcl:"os_image_notification,block"`
	// Plan: optional
...
func (wvm windowsVirtualMachineAttributes) BypassPlatformSafetyChecksOnUserScheduleEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wvm.ref.Append("bypass_platform_safety_checks_on_user_schedule_enabled"))
}
...
func (wvm windowsVirtualMachineAttributes) DiskControllerType() terra.StringValue {
	return terra.ReferenceAsString(wvm.ref.Append("disk_controller_type"))
}
...
func (wvm windowsVirtualMachineAttributes) RebootSetting() terra.StringValue {
	return terra.ReferenceAsString(wvm.ref.Append("reboot_setting"))
}
...
func (wvm windowsVirtualMachineAttributes) VmAgentPlatformUpdatesEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wvm.ref.Append("vm_agent_platform_updates_enabled"))
}
...
func (wvm windowsVirtualMachineAttributes) OsImageNotification() terra.ListValue[windowsvirtualmachine.OsImageNotificationAttributes] {
	return terra.ReferenceAsList[windowsvirtualmachine.OsImageNotificationAttributes](wvm.ref.Append("os_image_notification"))
}
...
type windowsVirtualMachineState struct {
	...
	OsImageNotification                             []windowsvirtualmachine.OsImageNotificationState       `json:"os_image_notification"`
