...
import (
	...
	linuxfunctionappslot "github.com/golingon/terraproviders/azurerm/3.98.0/linuxfunctionappslot"
	"io"
)
...
func (lfas linuxFunctionAppSlotAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lfas.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (lfas linuxFunctionAppSlotAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lfas.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
