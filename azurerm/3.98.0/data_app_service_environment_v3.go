...
import (
	...
	dataappserviceenvironmentv3 "github.com/golingon/terraproviders/azurerm/3.98.0/dataappserviceenvironmentv3"
)
...
func (asev dataAppServiceEnvironmentV3Attributes) RemoteDebuggingEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(asev.ref.Append("remote_debugging_enabled"))
}
