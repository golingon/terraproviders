...
import (
	...
	springcloudservice "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudservice"
	"io"
)
...
func (scs springCloudServiceAttributes) ManagedEnvironmentId() terra.StringValue {
	return terra.ReferenceAsString(scs.ref.Append("managed_environment_id"))
}
...
func (scs springCloudServiceAttributes) SkuTier() terra.StringValue {
	return terra.ReferenceAsString(scs.ref.Append("sku_tier"))
}
