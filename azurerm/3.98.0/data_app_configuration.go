...
import (
	...
	dataappconfiguration "github.com/golingon/terraproviders/azurerm/3.98.0/dataappconfiguration"
)
...
type DataAppConfigurationArgs struct {
	...
	// Replica: min=0
	Replica []dataappconfiguration.Replica `hcl:"replica,block" validate:"min=0"`
...
func (ac dataAppConfigurationAttributes) Replica() terra.ListValue[dataappconfiguration.ReplicaAttributes] {
	return terra.ReferenceAsList[dataappconfiguration.ReplicaAttributes](ac.ref.Append("replica"))
}
