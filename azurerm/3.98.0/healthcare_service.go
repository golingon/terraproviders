...
import (
	...
	healthcareservice "github.com/golingon/terraproviders/azurerm/3.98.0/healthcareservice"
	"io"
)
...
type HealthcareServiceArgs struct {
	...
	// Identity: optional
	Identity *healthcareservice.Identity `hcl:"identity,block"`
	// Timeouts: optional
...
func (hs healthcareServiceAttributes) ConfigurationExportStorageAccountName() terra.StringValue {
	return terra.ReferenceAsString(hs.ref.Append("configuration_export_storage_account_name"))
}
...
func (hs healthcareServiceAttributes) Identity() terra.ListValue[healthcareservice.IdentityAttributes] {
	return terra.ReferenceAsList[healthcareservice.IdentityAttributes](hs.ref.Append("identity"))
}
...
type healthcareServiceState struct {
	...
	Identity                              []healthcareservice.IdentityState                    `json:"identity"`
