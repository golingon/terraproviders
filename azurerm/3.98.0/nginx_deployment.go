...
import (
	...
	nginxdeployment "github.com/golingon/terraproviders/azurerm/3.98.0/nginxdeployment"
	"io"
)
...
type NginxDeploymentArgs struct {
	...
	AutoScaleProfile []nginxdeployment.AutoScaleProfile `hcl:"auto_scale_profile,block" validate:"min=0"`
	// Configuration: optional
	Configuration *nginxdeployment.Configuration `hcl:"configuration,block"`
...
func (nd nginxDeploymentAttributes) AutomaticUpgradeChannel() terra.StringValue {
...
func (nd nginxDeploymentAttributes) AutoScaleProfile() terra.ListValue[nginxdeployment.AutoScaleProfileAttributes] {
	return terra.ReferenceAsList[nginxdeployment.AutoScaleProfileAttributes](nd.ref.Append("auto_scale_profile"))
}

func (nd nginxDeploymentAttributes) Configuration() terra.ListValue[nginxdeployment.ConfigurationAttributes] {
	return terra.ReferenceAsList[nginxdeployment.ConfigurationAttributes](nd.ref.Append("configuration"))
}
...
type nginxDeploymentState struct {
	...
	AutoScaleProfile        []nginxdeployment.AutoScaleProfileState      `json:"auto_scale_profile"`
	Configuration           []nginxdeployment.ConfigurationState         `json:"configuration"`
