...
import (
	...
	cosmosdbcassandradatacenter "github.com/golingon/terraproviders/azurerm/3.98.0/cosmosdbcassandradatacenter"
	"io"
)
...
func (ccd cosmosdbCassandraDatacenterAttributes) SeedNodeIpAddresses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](ccd.ref.Append("seed_node_ip_addresses"))
}
