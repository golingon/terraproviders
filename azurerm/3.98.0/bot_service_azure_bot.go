...
import (
	...
	botserviceazurebot "github.com/golingon/terraproviders/azurerm/3.98.0/botserviceazurebot"
	"io"
)
...
func (bsab botServiceAzureBotAttributes) CmkKeyVaultKeyUrl() terra.StringValue {
	return terra.ReferenceAsString(bsab.ref.Append("cmk_key_vault_key_url"))
}
...
func (bsab botServiceAzureBotAttributes) IconUrl() terra.StringValue {
	return terra.ReferenceAsString(bsab.ref.Append("icon_url"))
}
...
func (bsab botServiceAzureBotAttributes) LocalAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(bsab.ref.Append("local_authentication_enabled"))
}
...
func (bsab botServiceAzureBotAttributes) PublicNetworkAccessEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(bsab.ref.Append("public_network_access_enabled"))
}
