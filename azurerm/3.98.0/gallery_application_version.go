...
import (
	...
	galleryapplicationversion "github.com/golingon/terraproviders/azurerm/3.98.0/galleryapplicationversion"
	"io"
)
...
func (gav galleryApplicationVersionAttributes) ConfigFile() terra.StringValue {
	return terra.ReferenceAsString(gav.ref.Append("config_file"))
}
...
func (gav galleryApplicationVersionAttributes) PackageFile() terra.StringValue {
	return terra.ReferenceAsString(gav.ref.Append("package_file"))
}
