...
import (
	...
	servicebusnamespace "github.com/golingon/terraproviders/azurerm/3.98.0/servicebusnamespace"
	"io"
)
...
type ServicebusNamespaceArgs struct {
	...
	NetworkRuleSet *servicebusnamespace.NetworkRuleSet `hcl:"network_rule_set,block"`
	// Timeouts: optional
...
func (sn servicebusNamespaceAttributes) PremiumMessagingPartitions() terra.NumberValue {
...
func (sn servicebusNamespaceAttributes) NetworkRuleSet() terra.ListValue[servicebusnamespace.NetworkRuleSetAttributes] {
	return terra.ReferenceAsList[servicebusnamespace.NetworkRuleSetAttributes](sn.ref.Append("network_rule_set"))
}
...
type servicebusNamespaceState struct {
	...
	NetworkRuleSet                   []servicebusnamespace.NetworkRuleSetState     `json:"network_rule_set"`
