...
import (
	...
	pointtositevpngateway "github.com/golingon/terraproviders/azurerm/3.98.0/pointtositevpngateway"
	"io"
)
...
type PointToSiteVpnGatewayArgs struct {
	...
	ConnectionConfiguration []pointtositevpngateway.ConnectionConfiguration `hcl:"connection_configuration,block" validate:"min=1"`
	// Timeouts: optional
