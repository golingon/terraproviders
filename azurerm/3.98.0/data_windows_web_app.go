...
import (
	...
	datawindowswebapp "github.com/golingon/terraproviders/azurerm/3.98.0/datawindowswebapp"
)
...
func (wwa dataWindowsWebAppAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wwa.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (wwa dataWindowsWebAppAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wwa.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
