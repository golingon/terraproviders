...
import (
	...
	springcloudapiportal "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudapiportal"
	"io"
)
...
func (scap springCloudApiPortalAttributes) ApiTryOutEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(scap.ref.Append("api_try_out_enabled"))
}
