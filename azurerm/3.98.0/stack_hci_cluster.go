...
import (
	...
	stackhcicluster "github.com/golingon/terraproviders/azurerm/3.98.0/stackhcicluster"
	"io"
)
...
type StackHciClusterArgs struct {
	...
	// Identity: optional
	Identity *stackhcicluster.Identity `hcl:"identity,block"`
	// Timeouts: optional
...
func (shc stackHciClusterAttributes) AutomanageConfigurationId() terra.StringValue {
...
func (shc stackHciClusterAttributes) CloudId() terra.StringValue {
...
func (shc stackHciClusterAttributes) ResourceProviderObjectId() terra.StringValue {
...
func (shc stackHciClusterAttributes) ServiceEndpoint() terra.StringValue {
...
func (shc stackHciClusterAttributes) Identity() terra.ListValue[stackhcicluster.IdentityAttributes] {
	return terra.ReferenceAsList[stackhcicluster.IdentityAttributes](shc.ref.Append("identity"))
}
...
type stackHciClusterState struct {
	...
	Identity                  []stackhcicluster.IdentityState `json:"identity"`
