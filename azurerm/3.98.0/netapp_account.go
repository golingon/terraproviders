...
import (
	...
	netappaccount "github.com/golingon/terraproviders/azurerm/3.98.0/netappaccount"
	"io"
)
...
type NetappAccountArgs struct {
	...
	// Identity: optional
	Identity *netappaccount.Identity `hcl:"identity,block"`
	// Timeouts: optional
...
func (na netappAccountAttributes) Identity() terra.ListValue[netappaccount.IdentityAttributes] {
	return terra.ReferenceAsList[netappaccount.IdentityAttributes](na.ref.Append("identity"))
}
...
type netappAccountState struct {
	...
	Identity          []netappaccount.IdentityState        `json:"identity"`
