...
import (
	...
	dataeventgriddomain "github.com/golingon/terraproviders/azurerm/3.98.0/dataeventgriddomain"
)
...
type DataEventgridDomainArgs struct {
	...
	// Identity: min=0
	Identity []dataeventgriddomain.Identity `hcl:"identity,block" validate:"min=0"`
	// InboundIpRule: min=0
...
func (ed dataEventgridDomainAttributes) Identity() terra.ListValue[dataeventgriddomain.IdentityAttributes] {
	return terra.ReferenceAsList[dataeventgriddomain.IdentityAttributes](ed.ref.Append("identity"))
}
