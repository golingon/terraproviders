...
import (
	...
	storagetableentity "github.com/golingon/terraproviders/azurerm/3.98.0/storagetableentity"
	"io"
)
...
func (ste storageTableEntityAttributes) StorageTableId() terra.StringValue {
	return terra.ReferenceAsString(ste.ref.Append("storage_table_id"))
}
