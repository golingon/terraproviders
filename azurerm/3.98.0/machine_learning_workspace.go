...
import (
	...
	machinelearningworkspace "github.com/golingon/terraproviders/azurerm/3.98.0/machinelearningworkspace"
	"io"
)
...
type MachineLearningWorkspaceArgs struct {
	...
	FeatureStore *machinelearningworkspace.FeatureStore `hcl:"feature_store,block"`
	// Identity: required
	Identity *machinelearningworkspace.Identity `hcl:"identity,block" validate:"required"`
	// ManagedNetwork: optional
	ManagedNetwork *machinelearningworkspace.ManagedNetwork `hcl:"managed_network,block"`
	// Timeouts: optional
...
func (mlw machineLearningWorkspaceAttributes) Kind() terra.StringValue {
	return terra.ReferenceAsString(mlw.ref.Append("kind"))
}
...
func (mlw machineLearningWorkspaceAttributes) FeatureStore() terra.ListValue[machinelearningworkspace.FeatureStoreAttributes] {
	return terra.ReferenceAsList[machinelearningworkspace.FeatureStoreAttributes](mlw.ref.Append("feature_store"))
}
...
func (mlw machineLearningWorkspaceAttributes) ManagedNetwork() terra.ListValue[machinelearningworkspace.ManagedNetworkAttributes] {
	return terra.ReferenceAsList[machinelearningworkspace.ManagedNetworkAttributes](mlw.ref.Append("managed_network"))
}
...
type machineLearningWorkspaceState struct {
	...
	FeatureStore                            []machinelearningworkspace.FeatureStoreState   `json:"feature_store"`
	Identity                                []machinelearningworkspace.IdentityState       `json:"identity"`
	ManagedNetwork                          []machinelearningworkspace.ManagedNetworkState `json:"managed_network"`
