...
import (
	...
	datasharedimagegallery "github.com/golingon/terraproviders/azurerm/3.98.0/datasharedimagegallery"
)
...
func (sig dataSharedImageGalleryAttributes) ImageNames() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](sig.ref.Append("image_names"))
}
