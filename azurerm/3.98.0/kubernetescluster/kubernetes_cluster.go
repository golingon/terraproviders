...
type NodeNetworkProfile struct {
	...
	// AllowedHostPorts: min=0
	AllowedHostPorts []AllowedHostPorts `hcl:"allowed_host_ports,block" validate:"min=0"`
}

type AllowedHostPorts struct {
...
type WebAppRouting struct {
	...
	// WebAppRoutingIdentity: min=0
	WebAppRoutingIdentity []WebAppRoutingIdentity `hcl:"web_app_routing_identity,block" validate:"min=0"`
}

type WebAppRoutingIdentity struct{}
...
func (nnp NodeNetworkProfileAttributes) AllowedHostPorts() terra.ListValue[AllowedHostPortsAttributes] {
	return terra.ReferenceAsList[AllowedHostPortsAttributes](nnp.ref.Append("allowed_host_ports"))
}

type AllowedHostPortsAttributes struct {
	ref terra.Reference
}

func (ahp AllowedHostPortsAttributes) InternalRef() (terra.Reference, error) {
	return ahp.ref, nil
}

func (ahp AllowedHostPortsAttributes) InternalWithRef(ref terra.Reference) AllowedHostPortsAttributes {
	return AllowedHostPortsAttributes{ref: ref}
}

func (ahp AllowedHostPortsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ahp.ref.InternalTokens()
}

func (ahp AllowedHostPortsAttributes) PortEnd() terra.NumberValue {
	return terra.ReferenceAsNumber(ahp.ref.Append("port_end"))
}

func (ahp AllowedHostPortsAttributes) PortStart() terra.NumberValue {
	return terra.ReferenceAsNumber(ahp.ref.Append("port_start"))
}

func (ahp AllowedHostPortsAttributes) Protocol() terra.StringValue {
...
func (war WebAppRoutingAttributes) WebAppRoutingIdentity() terra.ListValue[WebAppRoutingIdentityAttributes] {
	return terra.ReferenceAsList[WebAppRoutingIdentityAttributes](war.ref.Append("web_app_routing_identity"))
}

type WebAppRoutingIdentityAttributes struct {
	ref terra.Reference
}

func (wari WebAppRoutingIdentityAttributes) InternalRef() (terra.Reference, error) {
	return wari.ref, nil
}

func (wari WebAppRoutingIdentityAttributes) InternalWithRef(ref terra.Reference) WebAppRoutingIdentityAttributes {
	return WebAppRoutingIdentityAttributes{ref: ref}
}

func (wari WebAppRoutingIdentityAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return wari.ref.InternalTokens()
}

func (wari WebAppRoutingIdentityAttributes) ClientId() terra.StringValue {
	return terra.ReferenceAsString(wari.ref.Append("client_id"))
}

func (wari WebAppRoutingIdentityAttributes) ObjectId() terra.StringValue {
	return terra.ReferenceAsString(wari.ref.Append("object_id"))
}

func (wari WebAppRoutingIdentityAttributes) UserAssignedIdentityId() terra.StringValue {
...
type NodeNetworkProfileState struct {
	...
	AllowedHostPorts            []AllowedHostPortsState `json:"allowed_host_ports"`
}

type AllowedHostPortsState struct {
...
type WebAppRoutingState struct {
	...
	WebAppRoutingIdentity []WebAppRoutingIdentityState `json:"web_app_routing_identity"`
}

type WebAppRoutingIdentityState struct {
	ClientId               string `json:"client_id"`
	ObjectId               string `json:"object_id"`
	UserAssignedIdentityId string `json:"user_assigned_identity_id"`
}
