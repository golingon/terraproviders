...
import (
	...
	databricksworkspace "github.com/golingon/terraproviders/azurerm/3.98.0/databricksworkspace"
	"io"
)
...
func (dw databricksWorkspaceAttributes) ManagedDiskCmkKeyVaultId() terra.StringValue {
	return terra.ReferenceAsString(dw.ref.Append("managed_disk_cmk_key_vault_id"))
}
...
func (dw databricksWorkspaceAttributes) ManagedServicesCmkKeyVaultId() terra.StringValue {
	return terra.ReferenceAsString(dw.ref.Append("managed_services_cmk_key_vault_id"))
}
