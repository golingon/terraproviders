...
import (
	...
	datafactoryintegrationruntimeselfhosted "github.com/golingon/terraproviders/azurerm/3.98.0/datafactoryintegrationruntimeselfhosted"
	"io"
)
...
func (dfirsh dataFactoryIntegrationRuntimeSelfHostedAttributes) SelfContainedInteractiveAuthoringEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(dfirsh.ref.Append("self_contained_interactive_authoring_enabled"))
}
