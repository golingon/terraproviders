...
import (
	...
	datalinuxwebapp "github.com/golingon/terraproviders/azurerm/3.98.0/datalinuxwebapp"
)
...
func (lwa dataLinuxWebAppAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lwa.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (lwa dataLinuxWebAppAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lwa.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
