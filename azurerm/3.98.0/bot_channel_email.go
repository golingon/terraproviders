...
import (
	...
	botchannelemail "github.com/golingon/terraproviders/azurerm/3.98.0/botchannelemail"
	"io"
)
...
func (bce botChannelEmailAttributes) MagicCode() terra.StringValue {
	return terra.ReferenceAsString(bce.ref.Append("magic_code"))
}
