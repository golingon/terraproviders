...
import (
	...
	datafactoryintegrationruntimeazuressis "github.com/golingon/terraproviders/azurerm/3.98.0/datafactoryintegrationruntimeazuressis"
	"io"
)
...
type DataFactoryIntegrationRuntimeAzureSsisArgs struct {
	...
	CopyComputeScale *datafactoryintegrationruntimeazuressis.CopyComputeScale `hcl:"copy_compute_scale,block"`
	...
	PipelineExternalComputeScale *datafactoryintegrationruntimeazuressis.PipelineExternalComputeScale `hcl:"pipeline_external_compute_scale,block"`
	// Proxy: optional
...
func (dfiras dataFactoryIntegrationRuntimeAzureSsisAttributes) CredentialName() terra.StringValue {
	return terra.ReferenceAsString(dfiras.ref.Append("credential_name"))
}
...
func (dfiras dataFactoryIntegrationRuntimeAzureSsisAttributes) CopyComputeScale() terra.ListValue[datafactoryintegrationruntimeazuressis.CopyComputeScaleAttributes] {
	return terra.ReferenceAsList[datafactoryintegrationruntimeazuressis.CopyComputeScaleAttributes](dfiras.ref.Append("copy_compute_scale"))
}
...
func (dfiras dataFactoryIntegrationRuntimeAzureSsisAttributes) PipelineExternalComputeScale() terra.ListValue[datafactoryintegrationruntimeazuressis.PipelineExternalComputeScaleAttributes] {
	return terra.ReferenceAsList[datafactoryintegrationruntimeazuressis.PipelineExternalComputeScaleAttributes](dfiras.ref.Append("pipeline_external_compute_scale"))
}
...
type dataFactoryIntegrationRuntimeAzureSsisState struct {
	...
	CopyComputeScale             []datafactoryintegrationruntimeazuressis.CopyComputeScaleState             `json:"copy_compute_scale"`
	...
	PipelineExternalComputeScale []datafactoryintegrationruntimeazuressis.PipelineExternalComputeScaleState `json:"pipeline_external_compute_scale"`
