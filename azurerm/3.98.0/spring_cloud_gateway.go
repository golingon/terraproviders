...
import (
	...
	springcloudgateway "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudgateway"
	"io"
)
...
type SpringCloudGatewayArgs struct {
	...
	LocalResponseCachePerInstance *springcloudgateway.LocalResponseCachePerInstance `hcl:"local_response_cache_per_instance,block"`
	// LocalResponseCachePerRoute: optional
	LocalResponseCachePerRoute *springcloudgateway.LocalResponseCachePerRoute `hcl:"local_response_cache_per_route,block"`
	// Quota: optional
...
func (scg springCloudGatewayAttributes) ApplicationPerformanceMonitoringIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](scg.ref.Append("application_performance_monitoring_ids"))
}
...
func (scg springCloudGatewayAttributes) LocalResponseCachePerInstance() terra.ListValue[springcloudgateway.LocalResponseCachePerInstanceAttributes] {
	return terra.ReferenceAsList[springcloudgateway.LocalResponseCachePerInstanceAttributes](scg.ref.Append("local_response_cache_per_instance"))
}

func (scg springCloudGatewayAttributes) LocalResponseCachePerRoute() terra.ListValue[springcloudgateway.LocalResponseCachePerRouteAttributes] {
	return terra.ReferenceAsList[springcloudgateway.LocalResponseCachePerRouteAttributes](scg.ref.Append("local_response_cache_per_route"))
}
...
type springCloudGatewayState struct {
	...
	LocalResponseCachePerInstance         []springcloudgateway.LocalResponseCachePerInstanceState `json:"local_response_cache_per_instance"`
	LocalResponseCachePerRoute            []springcloudgateway.LocalResponseCachePerRouteState    `json:"local_response_cache_per_route"`
