...
import (
	...
	synapseworkspace "github.com/golingon/terraproviders/azurerm/3.98.0/synapseworkspace"
	"io"
)
...
func (sw synapseWorkspaceAttributes) AzureadAuthenticationOnly() terra.BoolValue {
	return terra.ReferenceAsBool(sw.ref.Append("azuread_authentication_only"))
}
