...
import (
	...
	appservicecertificate "github.com/golingon/terraproviders/azurerm/3.98.0/appservicecertificate"
	"io"
)
...
func (asc appServiceCertificateAttributes) KeyVaultId() terra.StringValue {
	return terra.ReferenceAsString(asc.ref.Append("key_vault_id"))
}
