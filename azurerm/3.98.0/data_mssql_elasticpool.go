...
import (
	...
	datamssqlelasticpool "github.com/golingon/terraproviders/azurerm/3.98.0/datamssqlelasticpool"
)
...
func (me dataMssqlElasticpoolAttributes) EnclaveType() terra.StringValue {
	return terra.ReferenceAsString(me.ref.Append("enclave_type"))
}
