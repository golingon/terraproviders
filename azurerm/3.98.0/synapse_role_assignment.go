...
import (
	...
	synapseroleassignment "github.com/golingon/terraproviders/azurerm/3.98.0/synapseroleassignment"
	"io"
)
...
func (sra synapseRoleAssignmentAttributes) PrincipalType() terra.StringValue {
	return terra.ReferenceAsString(sra.ref.Append("principal_type"))
}
