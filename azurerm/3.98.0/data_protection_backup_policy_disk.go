...
import (
	...
	dataprotectionbackuppolicydisk "github.com/golingon/terraproviders/azurerm/3.98.0/dataprotectionbackuppolicydisk"
	"io"
)
...
func (dpbpd dataProtectionBackupPolicyDiskAttributes) TimeZone() terra.StringValue {
	return terra.ReferenceAsString(dpbpd.ref.Append("time_zone"))
}
