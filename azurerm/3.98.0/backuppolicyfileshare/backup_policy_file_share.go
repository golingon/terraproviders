...
type Backup struct {
	...
	// Hourly: optional
	Hourly *Hourly `hcl:"hourly,block"`
}
...
func (b BackupAttributes) Hourly() terra.ListValue[HourlyAttributes] {
	return terra.ReferenceAsList[HourlyAttributes](b.ref.Append("hourly"))
}

type HourlyAttributes struct {
	ref terra.Reference
}

func (h HourlyAttributes) InternalRef() (terra.Reference, error) {
	return h.ref, nil
}

func (h HourlyAttributes) InternalWithRef(ref terra.Reference) HourlyAttributes {
	return HourlyAttributes{ref: ref}
}

func (h HourlyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return h.ref.InternalTokens()
}

func (h HourlyAttributes) Interval() terra.NumberValue {
	return terra.ReferenceAsNumber(h.ref.Append("interval"))
}

func (h HourlyAttributes) StartTime() terra.StringValue {
	return terra.ReferenceAsString(h.ref.Append("start_time"))
}

func (h HourlyAttributes) WindowDuration() terra.NumberValue {
...
type BackupState struct {
	...
	Hourly    []HourlyState `json:"hourly"`
}
