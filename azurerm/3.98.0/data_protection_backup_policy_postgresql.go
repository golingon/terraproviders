...
import (
	...
	dataprotectionbackuppolicypostgresql "github.com/golingon/terraproviders/azurerm/3.98.0/dataprotectionbackuppolicypostgresql"
	"io"
)
...
func (dpbpp dataProtectionBackupPolicyPostgresqlAttributes) TimeZone() terra.StringValue {
	return terra.ReferenceAsString(dpbpp.ref.Append("time_zone"))
}
