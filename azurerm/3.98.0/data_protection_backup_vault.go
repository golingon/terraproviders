...
import (
	...
	dataprotectionbackupvault "github.com/golingon/terraproviders/azurerm/3.98.0/dataprotectionbackupvault"
	"io"
)
...
func (dpbv dataProtectionBackupVaultAttributes) RetentionDurationInDays() terra.NumberValue {
	return terra.ReferenceAsNumber(dpbv.ref.Append("retention_duration_in_days"))
}

// SoftDelete returns a reference to field soft_delete of azurerm_data_protection_backup_vault.
func (dpbv dataProtectionBackupVaultAttributes) SoftDelete() terra.StringValue {
	return terra.ReferenceAsString(dpbv.ref.Append("soft_delete"))
}
