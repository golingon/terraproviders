...
import (
	...
	datacontainerapp "github.com/golingon/terraproviders/azurerm/3.98.0/datacontainerapp"
)
...
func (ca dataContainerAppAttributes) WorkloadProfileName() terra.StringValue {
	return terra.ReferenceAsString(ca.ref.Append("workload_profile_name"))
}
...
func (ca dataContainerAppAttributes) Secret() terra.SetValue[datacontainerapp.SecretAttributes] {
	return terra.ReferenceAsSet[datacontainerapp.SecretAttributes](ca.ref.Append("secret"))
}
