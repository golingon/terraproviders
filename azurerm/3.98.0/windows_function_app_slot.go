...
import (
	...
	windowsfunctionappslot "github.com/golingon/terraproviders/azurerm/3.98.0/windowsfunctionappslot"
	"io"
)
...
func (wfas windowsFunctionAppSlotAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wfas.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (wfas windowsFunctionAppSlotAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wfas.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
