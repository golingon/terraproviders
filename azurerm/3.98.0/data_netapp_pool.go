...
import (
	...
	datanetapppool "github.com/golingon/terraproviders/azurerm/3.98.0/datanetapppool"
)
...
func (np dataNetappPoolAttributes) EncryptionType() terra.StringValue {
	return terra.ReferenceAsString(np.ref.Append("encryption_type"))
}
