...
import (
	...
	postgresqlflexibleserver "github.com/golingon/terraproviders/azurerm/3.98.0/postgresqlflexibleserver"
	"io"
)
...
func (pfs postgresqlFlexibleServerAttributes) StorageTier() terra.StringValue {
	return terra.ReferenceAsString(pfs.ref.Append("storage_tier"))
}
