...
import (
	...
	datafirewall "github.com/golingon/terraproviders/azurerm/3.98.0/datafirewall"
)
...
func (f dataFirewallAttributes) DnsProxyEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(f.ref.Append("dns_proxy_enabled"))
}
