...
type Codec struct {
	...
	// JpgImage: optional
	JpgImage *JpgImage `hcl:"jpg_image,block"`
	// PngImage: optional
	PngImage *PngImage `hcl:"png_image,block"`
}
...
type JpgImage struct {
	...
	SyncMode terra.StringValue `hcl:"sync_mode,attr"`
	// JpgImageLayer: min=0
	Layer []JpgImageLayer `hcl:"layer,block" validate:"min=0"`
}

type JpgImageLayer struct {
	// Height: string, optional
	Height terra.StringValue `hcl:"height,attr"`
	// Label: string, optional
	Label terra.StringValue `hcl:"label,attr"`
...
type PngImage struct {
	...
	SyncMode terra.StringValue `hcl:"sync_mode,attr"`
	// PngImageLayer: min=0
	Layer []PngImageLayer `hcl:"layer,block" validate:"min=0"`
}

type PngImageLayer struct {
	// Height: string, optional
	Height terra.StringValue `hcl:"height,attr"`
	// Label: string, optional
	Label terra.StringValue `hcl:"label,attr"`
...
type Format struct {
	// Jpg: optional
	Jpg *Jpg `hcl:"jpg,block"`
	// Mp4: optional
	Mp4 *Mp4 `hcl:"mp4,block"`
	// Png: optional
	Png *Png `hcl:"png,block"`
...
func (cp CustomPresetAttributes) ExperimentalOptions() terra.MapValue[terra.StringValue] {
...
func (c CodecAttributes) JpgImage() terra.ListValue[JpgImageAttributes] {
	return terra.ReferenceAsList[JpgImageAttributes](c.ref.Append("jpg_image"))
}

func (c CodecAttributes) PngImage() terra.ListValue[PngImageAttributes] {
	return terra.ReferenceAsList[PngImageAttributes](c.ref.Append("png_image"))
}
...
type JpgImageAttributes struct {
	ref terra.Reference
}

func (ji JpgImageAttributes) InternalRef() (terra.Reference, error) {
	return ji.ref, nil
}

func (ji JpgImageAttributes) InternalWithRef(ref terra.Reference) JpgImageAttributes {
	return JpgImageAttributes{ref: ref}
}

func (ji JpgImageAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ji.ref.InternalTokens()
}

func (ji JpgImageAttributes) KeyFrameInterval() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("key_frame_interval"))
}

func (ji JpgImageAttributes) Label() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("label"))
}

func (ji JpgImageAttributes) Range() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("range"))
}

func (ji JpgImageAttributes) SpriteColumn() terra.NumberValue {
	return terra.ReferenceAsNumber(ji.ref.Append("sprite_column"))
}

func (ji JpgImageAttributes) Start() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("start"))
}

func (ji JpgImageAttributes) Step() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("step"))
}

func (ji JpgImageAttributes) StretchMode() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("stretch_mode"))
}

func (ji JpgImageAttributes) SyncMode() terra.StringValue {
	return terra.ReferenceAsString(ji.ref.Append("sync_mode"))
}

func (ji JpgImageAttributes) Layer() terra.ListValue[JpgImageLayerAttributes] {
	return terra.ReferenceAsList[JpgImageLayerAttributes](ji.ref.Append("layer"))
}

type JpgImageLayerAttributes struct {
	ref terra.Reference
}

func (l JpgImageLayerAttributes) InternalRef() (terra.Reference, error) {
	return l.ref, nil
}

func (l JpgImageLayerAttributes) InternalWithRef(ref terra.Reference) JpgImageLayerAttributes {
	return JpgImageLayerAttributes{ref: ref}
}

func (l JpgImageLayerAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return l.ref.InternalTokens()
}

func (l JpgImageLayerAttributes) Height() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("height"))
}

func (l JpgImageLayerAttributes) Label() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("label"))
}

func (l JpgImageLayerAttributes) Quality() terra.NumberValue {
	return terra.ReferenceAsNumber(l.ref.Append("quality"))
}

func (l JpgImageLayerAttributes) Width() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("width"))
}

type PngImageAttributes struct {
	ref terra.Reference
}

func (pi PngImageAttributes) InternalRef() (terra.Reference, error) {
	return pi.ref, nil
}

func (pi PngImageAttributes) InternalWithRef(ref terra.Reference) PngImageAttributes {
	return PngImageAttributes{ref: ref}
}

func (pi PngImageAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return pi.ref.InternalTokens()
}

func (pi PngImageAttributes) KeyFrameInterval() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("key_frame_interval"))
}

func (pi PngImageAttributes) Label() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("label"))
}

func (pi PngImageAttributes) Range() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("range"))
}

func (pi PngImageAttributes) Start() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("start"))
}

func (pi PngImageAttributes) Step() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("step"))
}

func (pi PngImageAttributes) StretchMode() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("stretch_mode"))
}

func (pi PngImageAttributes) SyncMode() terra.StringValue {
	return terra.ReferenceAsString(pi.ref.Append("sync_mode"))
}

func (pi PngImageAttributes) Layer() terra.ListValue[PngImageLayerAttributes] {
	return terra.ReferenceAsList[PngImageLayerAttributes](pi.ref.Append("layer"))
}

type PngImageLayerAttributes struct {
	ref terra.Reference
}

func (l PngImageLayerAttributes) InternalRef() (terra.Reference, error) {
	return l.ref, nil
}

func (l PngImageLayerAttributes) InternalWithRef(ref terra.Reference) PngImageLayerAttributes {
	return PngImageLayerAttributes{ref: ref}
}

func (l PngImageLayerAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return l.ref.InternalTokens()
}

func (l PngImageLayerAttributes) Height() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("height"))
}

func (l PngImageLayerAttributes) Label() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("label"))
}

func (l PngImageLayerAttributes) Width() terra.StringValue {
	return terra.ReferenceAsString(l.ref.Append("width"))
}
...
func (f FormatAttributes) Jpg() terra.ListValue[JpgAttributes] {
	return terra.ReferenceAsList[JpgAttributes](f.ref.Append("jpg"))
}
...
func (f FormatAttributes) Png() terra.ListValue[PngAttributes] {
	return terra.ReferenceAsList[PngAttributes](f.ref.Append("png"))
}
...
type JpgAttributes struct {
	ref terra.Reference
}

func (j JpgAttributes) InternalRef() (terra.Reference, error) {
	return j.ref, nil
}

func (j JpgAttributes) InternalWithRef(ref terra.Reference) JpgAttributes {
	return JpgAttributes{ref: ref}
}

func (j JpgAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return j.ref.InternalTokens()
}

func (j JpgAttributes) FilenamePattern() terra.StringValue {
...
type PngAttributes struct {
	ref terra.Reference
}

func (p PngAttributes) InternalRef() (terra.Reference, error) {
	return p.ref, nil
}

func (p PngAttributes) InternalWithRef(ref terra.Reference) PngAttributes {
	return PngAttributes{ref: ref}
}

func (p PngAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return p.ref.InternalTokens()
}

func (p PngAttributes) FilenamePattern() terra.StringValue {
...
type CodecState struct {
	...
	JpgImage  []JpgImageState  `json:"jpg_image"`
	PngImage  []PngImageState  `json:"png_image"`
}
...
type JpgImageState struct {
	...
	StretchMode      string               `json:"stretch_mode"`
	SyncMode         string               `json:"sync_mode"`
	Layer            []JpgImageLayerState `json:"layer"`
}

type JpgImageLayerState struct {
	Height  string  `json:"height"`
	Label   string  `json:"label"`
...
type PngImageState struct {
	...
	StretchMode      string               `json:"stretch_mode"`
	SyncMode         string               `json:"sync_mode"`
	Layer            []PngImageLayerState `json:"layer"`
}

type PngImageLayerState struct {
	Height string `json:"height"`
	Label  string `json:"label"`
	Width  string `json:"width"`
}
