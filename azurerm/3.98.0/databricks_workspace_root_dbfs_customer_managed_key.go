...
import (
	...
	databricksworkspacerootdbfscustomermanagedkey "github.com/golingon/terraproviders/azurerm/3.98.0/databricksworkspacerootdbfscustomermanagedkey"
	"io"
)
...
func (dwrdcmk databricksWorkspaceRootDbfsCustomerManagedKeyAttributes) KeyVaultId() terra.StringValue {
	return terra.ReferenceAsString(dwrdcmk.ref.Append("key_vault_id"))
}
