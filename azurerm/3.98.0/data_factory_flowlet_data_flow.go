...
import (
	...
	datafactoryflowletdataflow "github.com/golingon/terraproviders/azurerm/3.98.0/datafactoryflowletdataflow"
	"io"
)
...
type DataFactoryFlowletDataFlowArgs struct {
	...
	// Sink: min=0
	Sink []datafactoryflowletdataflow.Sink `hcl:"sink,block" validate:"min=0"`
	// Source: min=0
	Source []datafactoryflowletdataflow.Source `hcl:"source,block" validate:"min=0"`
	// Timeouts: optional
