...
import (
	...
	linuxvirtualmachine "github.com/golingon/terraproviders/azurerm/3.98.0/linuxvirtualmachine"
	"io"
)
...
type LinuxVirtualMachineArgs struct {
	...
	OsImageNotification *linuxvirtualmachine.OsImageNotification `hcl:"os_image_notification,block"`
	// Plan: optional
...
func (lvm linuxVirtualMachineAttributes) BypassPlatformSafetyChecksOnUserScheduleEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lvm.ref.Append("bypass_platform_safety_checks_on_user_schedule_enabled"))
}
...
func (lvm linuxVirtualMachineAttributes) DiskControllerType() terra.StringValue {
	return terra.ReferenceAsString(lvm.ref.Append("disk_controller_type"))
}
...
func (lvm linuxVirtualMachineAttributes) RebootSetting() terra.StringValue {
	return terra.ReferenceAsString(lvm.ref.Append("reboot_setting"))
}
...
func (lvm linuxVirtualMachineAttributes) VmAgentPlatformUpdatesEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lvm.ref.Append("vm_agent_platform_updates_enabled"))
}
...
func (lvm linuxVirtualMachineAttributes) OsImageNotification() terra.ListValue[linuxvirtualmachine.OsImageNotificationAttributes] {
	return terra.ReferenceAsList[linuxvirtualmachine.OsImageNotificationAttributes](lvm.ref.Append("os_image_notification"))
}
...
type linuxVirtualMachineState struct {
	...
	OsImageNotification                             []linuxvirtualmachine.OsImageNotificationState     `json:"os_image_notification"`
