...
func (o ObjectAttributes) InternalRef() (terra.Reference, error) {
	return o.ref, nil
}

func (o ObjectAttributes) InternalWithRef(ref terra.Reference) ObjectAttributes {
	return ObjectAttributes{ref: ref}
}

func (o ObjectAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return o.ref.InternalTokens()
}

func (o ObjectAttributes) Description() terra.StringValue {
	return terra.ReferenceAsString(o.ref.Append("description"))
}

func (o ObjectAttributes) Encrypted() terra.BoolValue {
	return terra.ReferenceAsBool(o.ref.Append("encrypted"))
}

func (o ObjectAttributes) Id() terra.StringValue {
	return terra.ReferenceAsString(o.ref.Append("id"))
}

func (o ObjectAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(o.ref.Append("name"))
}

func (o ObjectAttributes) Value() terra.StringValue {
