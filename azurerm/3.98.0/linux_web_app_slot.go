...
import (
	...
	linuxwebappslot "github.com/golingon/terraproviders/azurerm/3.98.0/linuxwebappslot"
	"io"
)
...
func (lwas linuxWebAppSlotAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lwas.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (lwas linuxWebAppSlotAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(lwas.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
