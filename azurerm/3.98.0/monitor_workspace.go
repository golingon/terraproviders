...
import (
	...
	monitorworkspace "github.com/golingon/terraproviders/azurerm/3.98.0/monitorworkspace"
	"io"
)
...
func (mw monitorWorkspaceAttributes) DefaultDataCollectionEndpointId() terra.StringValue {
...
func (mw monitorWorkspaceAttributes) DefaultDataCollectionRuleId() terra.StringValue {
...
func (mw monitorWorkspaceAttributes) QueryEndpoint() terra.StringValue {
