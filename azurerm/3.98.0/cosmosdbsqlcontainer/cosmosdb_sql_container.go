...
func (ip IndexingPolicyAttributes) ExcludedPath() terra.ListValue[ExcludedPathAttributes] {
	return terra.ReferenceAsList[ExcludedPathAttributes](ip.ref.Append("excluded_path"))
}

func (ip IndexingPolicyAttributes) IncludedPath() terra.ListValue[IncludedPathAttributes] {
	return terra.ReferenceAsList[IncludedPathAttributes](ip.ref.Append("included_path"))
}
...
func (ep ExcludedPathAttributes) InternalRef() (terra.Reference, error) {
	return ep.ref, nil
}
...
func (ep ExcludedPathAttributes) InternalTokens() (hclwrite.Tokens, error) {
...
func (ip IncludedPathAttributes) InternalRef() (terra.Reference, error) {
	return ip.ref, nil
}
...
func (ip IncludedPathAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ip.ref.InternalTokens()
}
