...
import (
	...
	dashboardgrafana "github.com/golingon/terraproviders/azurerm/3.98.0/dashboardgrafana"
	"io"
)
...
type DashboardGrafanaArgs struct {
	...
	// Smtp: optional
	Smtp *dashboardgrafana.Smtp `hcl:"smtp,block"`
	// Timeouts: optional
...
func (dg dashboardGrafanaAttributes) GrafanaMajorVersion() terra.StringValue {
...
func (dg dashboardGrafanaAttributes) Smtp() terra.ListValue[dashboardgrafana.SmtpAttributes] {
	return terra.ReferenceAsList[dashboardgrafana.SmtpAttributes](dg.ref.Append("smtp"))
}
...
type dashboardGrafanaState struct {
	...
	Smtp                              []dashboardgrafana.SmtpState                              `json:"smtp"`
