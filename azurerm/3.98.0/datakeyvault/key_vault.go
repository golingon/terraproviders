...
func (na NetworkAclsAttributes) IpRules() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](na.ref.Append("ip_rules"))
}

func (na NetworkAclsAttributes) VirtualNetworkSubnetIds() terra.ListValue[terra.StringValue] {
