...
import (
	...
	trafficmanagerazureendpoint "github.com/golingon/terraproviders/azurerm/3.98.0/trafficmanagerazureendpoint"
	"io"
)
...
func (tmae trafficManagerAzureEndpointAttributes) AlwaysServeEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(tmae.ref.Append("always_serve_enabled"))
}
