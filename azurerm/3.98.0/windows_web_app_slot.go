...
import (
	...
	windowswebappslot "github.com/golingon/terraproviders/azurerm/3.98.0/windowswebappslot"
	"io"
)
...
func (wwas windowsWebAppSlotAttributes) FtpPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wwas.ref.Append("ftp_publish_basic_authentication_enabled"))
}
...
func (wwas windowsWebAppSlotAttributes) WebdeployPublishBasicAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(wwas.ref.Append("webdeploy_publish_basic_authentication_enabled"))
}
