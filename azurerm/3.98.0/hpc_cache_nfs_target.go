...
import (
	...
	hpccachenfstarget "github.com/golingon/terraproviders/azurerm/3.98.0/hpccachenfstarget"
	"io"
)
...
func (hcnt hpcCacheNfsTargetAttributes) VerificationTimerInSeconds() terra.NumberValue {
	return terra.ReferenceAsNumber(hcnt.ref.Append("verification_timer_in_seconds"))
}

// WriteBackTimerInSeconds returns a reference to field write_back_timer_in_seconds of azurerm_hpc_cache_nfs_target.
func (hcnt hpcCacheNfsTargetAttributes) WriteBackTimerInSeconds() terra.NumberValue {
	return terra.ReferenceAsNumber(hcnt.ref.Append("write_back_timer_in_seconds"))
}
