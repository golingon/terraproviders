...
import (
	...
	labservicelab "github.com/golingon/terraproviders/azurerm/3.98.0/labservicelab"
	"io"
)
...
type LabServiceLabArgs struct {
	...
	ConnectionSetting *labservicelab.ConnectionSetting `hcl:"connection_setting,block" validate:"required"`
	// Network: optional
