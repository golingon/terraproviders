...
import (
	...
	datafactoryintegrationruntimemanaged "github.com/golingon/terraproviders/azurerm/3.98.0/datafactoryintegrationruntimemanaged"
	"io"
)
...
func (dfirm dataFactoryIntegrationRuntimeManagedAttributes) CredentialName() terra.StringValue {
	return terra.ReferenceAsString(dfirm.ref.Append("credential_name"))
}
