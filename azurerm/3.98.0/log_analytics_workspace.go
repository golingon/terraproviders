...
import (
	...
	loganalyticsworkspace "github.com/golingon/terraproviders/azurerm/3.98.0/loganalyticsworkspace"
	"io"
)
...
type LogAnalyticsWorkspaceArgs struct {
	...
	// Identity: optional
	Identity *loganalyticsworkspace.Identity `hcl:"identity,block"`
	// Timeouts: optional
...
func (law logAnalyticsWorkspaceAttributes) DataCollectionRuleId() terra.StringValue {
	return terra.ReferenceAsString(law.ref.Append("data_collection_rule_id"))
}
...
func (law logAnalyticsWorkspaceAttributes) ImmediateDataPurgeOn30DaysEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(law.ref.Append("immediate_data_purge_on_30_days_enabled"))
}
...
func (law logAnalyticsWorkspaceAttributes) Identity() terra.ListValue[loganalyticsworkspace.IdentityAttributes] {
	return terra.ReferenceAsList[loganalyticsworkspace.IdentityAttributes](law.ref.Append("identity"))
}
...
type logAnalyticsWorkspaceState struct {
	...
	Identity                          []loganalyticsworkspace.IdentityState `json:"identity"`
