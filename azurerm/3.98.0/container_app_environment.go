...
import (
	...
	containerappenvironment "github.com/golingon/terraproviders/azurerm/3.98.0/containerappenvironment"
	"io"
)
...
type ContainerAppEnvironmentArgs struct {
	...
	WorkloadProfile []containerappenvironment.WorkloadProfile `hcl:"workload_profile,block" validate:"min=0"`
}
...
func (cae containerAppEnvironmentAttributes) DaprApplicationInsightsConnectionString() terra.StringValue {
	return terra.ReferenceAsString(cae.ref.Append("dapr_application_insights_connection_string"))
}
...
func (cae containerAppEnvironmentAttributes) InfrastructureResourceGroupName() terra.StringValue {
	return terra.ReferenceAsString(cae.ref.Append("infrastructure_resource_group_name"))
}
...
func (cae containerAppEnvironmentAttributes) ZoneRedundancyEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(cae.ref.Append("zone_redundancy_enabled"))
}
...
func (cae containerAppEnvironmentAttributes) WorkloadProfile() terra.SetValue[containerappenvironment.WorkloadProfileAttributes] {
	return terra.ReferenceAsSet[containerappenvironment.WorkloadProfileAttributes](cae.ref.Append("workload_profile"))
}
...
type containerAppEnvironmentState struct {
	...
	WorkloadProfile                         []containerappenvironment.WorkloadProfileState `json:"workload_profile"`
}
