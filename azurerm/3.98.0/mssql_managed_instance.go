...
import (
	...
	mssqlmanagedinstance "github.com/golingon/terraproviders/azurerm/3.98.0/mssqlmanagedinstance"
	"io"
)
...
func (mmi mssqlManagedInstanceAttributes) DnsZone() terra.StringValue {
	return terra.ReferenceAsString(mmi.ref.Append("dns_zone"))
}
...
func (mmi mssqlManagedInstanceAttributes) ZoneRedundantEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(mmi.ref.Append("zone_redundant_enabled"))
}
