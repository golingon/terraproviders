...
import (
	...
	sharedimage "github.com/golingon/terraproviders/azurerm/3.98.0/sharedimage"
	"io"
)
...
func (si sharedImageAttributes) TrustedLaunchSupported() terra.BoolValue {
	return terra.ReferenceAsBool(si.ref.Append("trusted_launch_supported"))
}
