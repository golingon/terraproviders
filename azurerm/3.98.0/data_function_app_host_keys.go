...
import (
	...
	datafunctionapphostkeys "github.com/golingon/terraproviders/azurerm/3.98.0/datafunctionapphostkeys"
)
...
func (fahk dataFunctionAppHostKeysAttributes) EventGridExtensionKey() terra.StringValue {
	return terra.ReferenceAsString(fahk.ref.Append("event_grid_extension_key"))
}
