...
import (
	...
	datastreamanalyticsjob "github.com/golingon/terraproviders/azurerm/3.98.0/datastreamanalyticsjob"
)
...
func (saj dataStreamAnalyticsJobAttributes) SkuName() terra.StringValue {
	return terra.ReferenceAsString(saj.ref.Append("sku_name"))
}
