...
import (
	...
	springcloudbuilddeployment "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudbuilddeployment"
	"io"
)
...
func (scbd springCloudBuildDeploymentAttributes) ApplicationPerformanceMonitoringIds() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](scbd.ref.Append("application_performance_monitoring_ids"))
}
