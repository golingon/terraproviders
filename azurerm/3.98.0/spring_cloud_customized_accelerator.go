...
import (
	...
	springcloudcustomizedaccelerator "github.com/golingon/terraproviders/azurerm/3.98.0/springcloudcustomizedaccelerator"
	"io"
)
...
func (scca springCloudCustomizedAcceleratorAttributes) AcceleratorType() terra.StringValue {
	return terra.ReferenceAsString(scca.ref.Append("accelerator_type"))
}
