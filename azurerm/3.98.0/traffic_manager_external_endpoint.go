...
import (
	...
	trafficmanagerexternalendpoint "github.com/golingon/terraproviders/azurerm/3.98.0/trafficmanagerexternalendpoint"
	"io"
)
...
func (tmee trafficManagerExternalEndpointAttributes) AlwaysServeEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(tmee.ref.Append("always_serve_enabled"))
}
