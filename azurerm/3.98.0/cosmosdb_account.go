...
import (
	...
	cosmosdbaccount "github.com/golingon/terraproviders/azurerm/3.98.0/cosmosdbaccount"
	"io"
)
...
func (ca cosmosdbAccountAttributes) MinimalTlsVersion() terra.StringValue {
	return terra.ReferenceAsString(ca.ref.Append("minimal_tls_version"))
}
...
func (ca cosmosdbAccountAttributes) PartitionMergeEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(ca.ref.Append("partition_merge_enabled"))
}
