...
import (
	...
	searchservice "github.com/golingon/terraproviders/azurerm/3.98.0/searchservice"
	"io"
)
...
func (ss searchServiceAttributes) SemanticSearchSku() terra.StringValue {
	return terra.ReferenceAsString(ss.ref.Append("semantic_search_sku"))
}
