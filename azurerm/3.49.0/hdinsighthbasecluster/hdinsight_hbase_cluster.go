...
type ComponentVersion struct {
	...
	Hbase terra.StringValue `hcl:"hbase,attr" validate:"required"`
}
...
func (cv ComponentVersionAttributes) Hbase() terra.StringValue {
	return terra.ReferenceString(cv.ref.Append("hbase"))
}
