...
func (cr CustomRulesAttributes) InternalRef() terra.Reference {
	return cr.ref
}
...
func (cr CustomRulesAttributes) InternalTokens() hclwrite.Tokens {
...
func (cr CustomRulesAttributes) RuleType() terra.StringValue {
	return terra.ReferenceString(cr.ref.Append("rule_type"))
}

func (cr CustomRulesAttributes) MatchConditions() terra.ListValue[MatchConditionsAttributes] {
	return terra.ReferenceList[MatchConditionsAttributes](cr.ref.Append("match_conditions"))
}
...
func (mc MatchConditionsAttributes) InternalRef() terra.Reference {
	return mc.ref
}
...
func (mc MatchConditionsAttributes) InternalTokens() hclwrite.Tokens {
...
func (mc MatchConditionsAttributes) Transforms() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](mc.ref.Append("transforms"))
}

func (mc MatchConditionsAttributes) MatchVariables() terra.ListValue[MatchVariablesAttributes] {
	return terra.ReferenceList[MatchVariablesAttributes](mc.ref.Append("match_variables"))
}
...
func (mv MatchVariablesAttributes) InternalRef() terra.Reference {
	return mv.ref
}
...
func (mv MatchVariablesAttributes) InternalTokens() hclwrite.Tokens {
	return mv.ref.InternalTokens()
}

func (mv MatchVariablesAttributes) Selector() terra.StringValue {
	return terra.ReferenceString(mv.ref.Append("selector"))
}

func (mv MatchVariablesAttributes) VariableName() terra.StringValue {
	return terra.ReferenceString(mv.ref.Append("variable_name"))
}
...
func (mr ManagedRulesAttributes) InternalRef() terra.Reference {
	return mr.ref
}
...
func (mr ManagedRulesAttributes) InternalTokens() hclwrite.Tokens {
	return mr.ref.InternalTokens()
}

func (mr ManagedRulesAttributes) Exclusion() terra.ListValue[ExclusionAttributes] {
	return terra.ReferenceList[ExclusionAttributes](mr.ref.Append("exclusion"))
}

func (mr ManagedRulesAttributes) ManagedRuleSet() terra.ListValue[ManagedRuleSetAttributes] {
	return terra.ReferenceList[ManagedRuleSetAttributes](mr.ref.Append("managed_rule_set"))
}
...
func (e ExclusionAttributes) ExcludedRuleSet() terra.ListValue[ExcludedRuleSetAttributes] {
	return terra.ReferenceList[ExcludedRuleSetAttributes](e.ref.Append("excluded_rule_set"))
}
...
func (ers ExcludedRuleSetAttributes) InternalRef() terra.Reference {
	return ers.ref
}
...
func (ers ExcludedRuleSetAttributes) InternalTokens() hclwrite.Tokens {
	return ers.ref.InternalTokens()
}

func (ers ExcludedRuleSetAttributes) Type() terra.StringValue {
	return terra.ReferenceString(ers.ref.Append("type"))
}

func (ers ExcludedRuleSetAttributes) Version() terra.StringValue {
	return terra.ReferenceString(ers.ref.Append("version"))
}

func (ers ExcludedRuleSetAttributes) RuleGroup() terra.ListValue[RuleGroupAttributes] {
	return terra.ReferenceList[RuleGroupAttributes](ers.ref.Append("rule_group"))
}
...
func (rg RuleGroupAttributes) ExcludedRules() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](rg.ref.Append("excluded_rules"))
}

func (rg RuleGroupAttributes) RuleGroupName() terra.StringValue {
	return terra.ReferenceString(rg.ref.Append("rule_group_name"))
}
...
func (mrs ManagedRuleSetAttributes) InternalRef() terra.Reference {
	return mrs.ref
}
...
func (mrs ManagedRuleSetAttributes) InternalTokens() hclwrite.Tokens {
	return mrs.ref.InternalTokens()
}

func (mrs ManagedRuleSetAttributes) Type() terra.StringValue {
	return terra.ReferenceString(mrs.ref.Append("type"))
}

func (mrs ManagedRuleSetAttributes) Version() terra.StringValue {
	return terra.ReferenceString(mrs.ref.Append("version"))
}

func (mrs ManagedRuleSetAttributes) RuleGroupOverride() terra.ListValue[RuleGroupOverrideAttributes] {
	return terra.ReferenceList[RuleGroupOverrideAttributes](mrs.ref.Append("rule_group_override"))
}
...
func (rgo RuleGroupOverrideAttributes) InternalRef() terra.Reference {
	return rgo.ref
}
...
func (rgo RuleGroupOverrideAttributes) InternalTokens() hclwrite.Tokens {
	return rgo.ref.InternalTokens()
}

func (rgo RuleGroupOverrideAttributes) DisabledRules() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](rgo.ref.Append("disabled_rules"))
}

func (rgo RuleGroupOverrideAttributes) RuleGroupName() terra.StringValue {
	return terra.ReferenceString(rgo.ref.Append("rule_group_name"))
}

func (rgo RuleGroupOverrideAttributes) Rule() terra.ListValue[RuleAttributes] {
	return terra.ReferenceList[RuleAttributes](rgo.ref.Append("rule"))
}
...
func (ps PolicySettingsAttributes) InternalRef() terra.Reference {
	return ps.ref
}
...
func (ps PolicySettingsAttributes) InternalTokens() hclwrite.Tokens {
	return ps.ref.InternalTokens()
}

func (ps PolicySettingsAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceBool(ps.ref.Append("enabled"))
}

func (ps PolicySettingsAttributes) FileUploadLimitInMb() terra.NumberValue {
	return terra.ReferenceNumber(ps.ref.Append("file_upload_limit_in_mb"))
}

func (ps PolicySettingsAttributes) MaxRequestBodySizeInKb() terra.NumberValue {
	return terra.ReferenceNumber(ps.ref.Append("max_request_body_size_in_kb"))
}

func (ps PolicySettingsAttributes) Mode() terra.StringValue {
	return terra.ReferenceString(ps.ref.Append("mode"))
}

func (ps PolicySettingsAttributes) RequestBodyCheck() terra.BoolValue {
	return terra.ReferenceBool(ps.ref.Append("request_body_check"))
}
