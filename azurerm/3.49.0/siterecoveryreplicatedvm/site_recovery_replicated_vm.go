...
func (md ManagedDiskAttributes) DiskId() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("disk_id"))
}

func (md ManagedDiskAttributes) StagingStorageAccountId() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("staging_storage_account_id"))
}

func (md ManagedDiskAttributes) TargetDiskEncryptionSetId() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("target_disk_encryption_set_id"))
}

func (md ManagedDiskAttributes) TargetDiskType() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("target_disk_type"))
}

func (md ManagedDiskAttributes) TargetReplicaDiskType() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("target_replica_disk_type"))
}

func (md ManagedDiskAttributes) TargetResourceGroupId() terra.StringValue {
	return terra.ReferenceString(md.ref.Append("target_resource_group_id"))
}

func (md ManagedDiskAttributes) TargetDiskEncryption() terra.ListValue[TargetDiskEncryptionAttributes] {
	return terra.ReferenceList[TargetDiskEncryptionAttributes](md.ref.Append("target_disk_encryption"))
}
...
func (tde TargetDiskEncryptionAttributes) InternalRef() terra.Reference {
	return tde.ref
}
...
func (tde TargetDiskEncryptionAttributes) InternalTokens() hclwrite.Tokens {
...
func (tde TargetDiskEncryptionAttributes) DiskEncryptionKey() terra.ListValue[DiskEncryptionKeyAttributes] {
	return terra.ReferenceList[DiskEncryptionKeyAttributes](tde.ref.Append("disk_encryption_key"))
}

func (tde TargetDiskEncryptionAttributes) KeyEncryptionKey() terra.ListValue[KeyEncryptionKeyAttributes] {
	return terra.ReferenceList[KeyEncryptionKeyAttributes](tde.ref.Append("key_encryption_key"))
}
...
func (dek DiskEncryptionKeyAttributes) VaultId() terra.StringValue {
	return terra.ReferenceString(dek.ref.Append("vault_id"))
}
...
func (kek KeyEncryptionKeyAttributes) VaultId() terra.StringValue {
	return terra.ReferenceString(kek.ref.Append("vault_id"))
}
...
func (ni NetworkInterfaceAttributes) FailoverTestPublicIpAddressId() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("failover_test_public_ip_address_id"))
}

func (ni NetworkInterfaceAttributes) FailoverTestStaticIp() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("failover_test_static_ip"))
}

func (ni NetworkInterfaceAttributes) FailoverTestSubnetName() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("failover_test_subnet_name"))
}

func (ni NetworkInterfaceAttributes) IsPrimary() terra.BoolValue {
	return terra.ReferenceBool(ni.ref.Append("is_primary"))
}

func (ni NetworkInterfaceAttributes) RecoveryPublicIpAddressId() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("recovery_public_ip_address_id"))
}

func (ni NetworkInterfaceAttributes) SourceNetworkInterfaceId() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("source_network_interface_id"))
}

func (ni NetworkInterfaceAttributes) TargetStaticIp() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("target_static_ip"))
}

func (ni NetworkInterfaceAttributes) TargetSubnetName() terra.StringValue {
	return terra.ReferenceString(ni.ref.Append("target_subnet_name"))
}
...
func (ud UnmanagedDiskAttributes) InternalRef() terra.Reference {
	return ud.ref
}
...
func (ud UnmanagedDiskAttributes) InternalTokens() hclwrite.Tokens {
	return ud.ref.InternalTokens()
}

func (ud UnmanagedDiskAttributes) DiskUri() terra.StringValue {
	return terra.ReferenceString(ud.ref.Append("disk_uri"))
}

func (ud UnmanagedDiskAttributes) StagingStorageAccountId() terra.StringValue {
	return terra.ReferenceString(ud.ref.Append("staging_storage_account_id"))
}

func (ud UnmanagedDiskAttributes) TargetStorageAccountId() terra.StringValue {
	return terra.ReferenceString(ud.ref.Append("target_storage_account_id"))
}
