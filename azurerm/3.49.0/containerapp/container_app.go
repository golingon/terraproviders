...
func (d DaprAttributes) InternalRef() terra.Reference {
	return d.ref
}
...
func (d DaprAttributes) InternalTokens() hclwrite.Tokens {
	return d.ref.InternalTokens()
}

func (d DaprAttributes) AppId() terra.StringValue {
	return terra.ReferenceString(d.ref.Append("app_id"))
}

func (d DaprAttributes) AppPort() terra.NumberValue {
	return terra.ReferenceNumber(d.ref.Append("app_port"))
}

func (d DaprAttributes) AppProtocol() terra.StringValue {
	return terra.ReferenceString(d.ref.Append("app_protocol"))
}
...
func (i IngressAttributes) AllowInsecureConnections() terra.BoolValue {
	return terra.ReferenceBool(i.ref.Append("allow_insecure_connections"))
}

func (i IngressAttributes) ExternalEnabled() terra.BoolValue {
	return terra.ReferenceBool(i.ref.Append("external_enabled"))
}

func (i IngressAttributes) Fqdn() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("fqdn"))
}

func (i IngressAttributes) TargetPort() terra.NumberValue {
	return terra.ReferenceNumber(i.ref.Append("target_port"))
}

func (i IngressAttributes) Transport() terra.StringValue {
	return terra.ReferenceString(i.ref.Append("transport"))
}

func (i IngressAttributes) CustomDomain() terra.ListValue[CustomDomainAttributes] {
	return terra.ReferenceList[CustomDomainAttributes](i.ref.Append("custom_domain"))
}

func (i IngressAttributes) TrafficWeight() terra.ListValue[TrafficWeightAttributes] {
	return terra.ReferenceList[TrafficWeightAttributes](i.ref.Append("traffic_weight"))
}
...
func (cd CustomDomainAttributes) CertificateBindingType() terra.StringValue {
	return terra.ReferenceString(cd.ref.Append("certificate_binding_type"))
}

func (cd CustomDomainAttributes) CertificateId() terra.StringValue {
	return terra.ReferenceString(cd.ref.Append("certificate_id"))
}
...
func (tw TrafficWeightAttributes) InternalRef() terra.Reference {
	return tw.ref
}
...
func (tw TrafficWeightAttributes) InternalTokens() hclwrite.Tokens {
	return tw.ref.InternalTokens()
}

func (tw TrafficWeightAttributes) Label() terra.StringValue {
	return terra.ReferenceString(tw.ref.Append("label"))
}

func (tw TrafficWeightAttributes) LatestRevision() terra.BoolValue {
	return terra.ReferenceBool(tw.ref.Append("latest_revision"))
}

func (tw TrafficWeightAttributes) Percentage() terra.NumberValue {
	return terra.ReferenceNumber(tw.ref.Append("percentage"))
}

func (tw TrafficWeightAttributes) RevisionSuffix() terra.StringValue {
	return terra.ReferenceString(tw.ref.Append("revision_suffix"))
}
...
func (r RegistryAttributes) Identity() terra.StringValue {
	return terra.ReferenceString(r.ref.Append("identity"))
}

func (r RegistryAttributes) PasswordSecretName() terra.StringValue {
	return terra.ReferenceString(r.ref.Append("password_secret_name"))
}

func (r RegistryAttributes) Server() terra.StringValue {
	return terra.ReferenceString(r.ref.Append("server"))
}
...
func (t TemplateAttributes) MaxReplicas() terra.NumberValue {
	return terra.ReferenceNumber(t.ref.Append("max_replicas"))
}

func (t TemplateAttributes) MinReplicas() terra.NumberValue {
	return terra.ReferenceNumber(t.ref.Append("min_replicas"))
}

func (t TemplateAttributes) RevisionSuffix() terra.StringValue {
	return terra.ReferenceString(t.ref.Append("revision_suffix"))
}

func (t TemplateAttributes) Container() terra.ListValue[ContainerAttributes] {
	return terra.ReferenceList[ContainerAttributes](t.ref.Append("container"))
}

func (t TemplateAttributes) Volume() terra.ListValue[VolumeAttributes] {
	return terra.ReferenceList[VolumeAttributes](t.ref.Append("volume"))
}
...
func (c ContainerAttributes) EphemeralStorage() terra.StringValue {
	return terra.ReferenceString(c.ref.Append("ephemeral_storage"))
}
...
func (c ContainerAttributes) Memory() terra.StringValue {
	return terra.ReferenceString(c.ref.Append("memory"))
}
...
func (e EnvAttributes) SecretName() terra.StringValue {
	return terra.ReferenceString(e.ref.Append("secret_name"))
}
...
func (lp LivenessProbeAttributes) FailureCountThreshold() terra.NumberValue {
	return terra.ReferenceNumber(lp.ref.Append("failure_count_threshold"))
}

func (lp LivenessProbeAttributes) Host() terra.StringValue {
	return terra.ReferenceString(lp.ref.Append("host"))
}

func (lp LivenessProbeAttributes) InitialDelay() terra.NumberValue {
	return terra.ReferenceNumber(lp.ref.Append("initial_delay"))
}

func (lp LivenessProbeAttributes) IntervalSeconds() terra.NumberValue {
	return terra.ReferenceNumber(lp.ref.Append("interval_seconds"))
}

func (lp LivenessProbeAttributes) Path() terra.StringValue {
	return terra.ReferenceString(lp.ref.Append("path"))
}
...
func (lp LivenessProbeAttributes) TerminationGracePeriodSeconds() terra.NumberValue {
	return terra.ReferenceNumber(lp.ref.Append("termination_grace_period_seconds"))
}

func (lp LivenessProbeAttributes) Timeout() terra.NumberValue {
	return terra.ReferenceNumber(lp.ref.Append("timeout"))
}

func (lp LivenessProbeAttributes) Transport() terra.StringValue {
	return terra.ReferenceString(lp.ref.Append("transport"))
}

func (lp LivenessProbeAttributes) Header() terra.ListValue[LivenessProbeHeaderAttributes] {
	return terra.ReferenceList[LivenessProbeHeaderAttributes](lp.ref.Append("header"))
}
...
func (h LivenessProbeHeaderAttributes) InternalRef() terra.Reference {
	return h.ref
}
...
func (h LivenessProbeHeaderAttributes) InternalTokens() hclwrite.Tokens {
...
func (rp ReadinessProbeAttributes) FailureCountThreshold() terra.NumberValue {
	return terra.ReferenceNumber(rp.ref.Append("failure_count_threshold"))
}

func (rp ReadinessProbeAttributes) Host() terra.StringValue {
	return terra.ReferenceString(rp.ref.Append("host"))
}

func (rp ReadinessProbeAttributes) IntervalSeconds() terra.NumberValue {
	return terra.ReferenceNumber(rp.ref.Append("interval_seconds"))
}

func (rp ReadinessProbeAttributes) Path() terra.StringValue {
	return terra.ReferenceString(rp.ref.Append("path"))
}

func (rp ReadinessProbeAttributes) Port() terra.NumberValue {
	return terra.ReferenceNumber(rp.ref.Append("port"))
}

func (rp ReadinessProbeAttributes) SuccessCountThreshold() terra.NumberValue {
	return terra.ReferenceNumber(rp.ref.Append("success_count_threshold"))
}

func (rp ReadinessProbeAttributes) Timeout() terra.NumberValue {
	return terra.ReferenceNumber(rp.ref.Append("timeout"))
}

func (rp ReadinessProbeAttributes) Transport() terra.StringValue {
	return terra.ReferenceString(rp.ref.Append("transport"))
}

func (rp ReadinessProbeAttributes) Header() terra.ListValue[ReadinessProbeHeaderAttributes] {
	return terra.ReferenceList[ReadinessProbeHeaderAttributes](rp.ref.Append("header"))
}
...
func (h ReadinessProbeHeaderAttributes) InternalRef() terra.Reference {
	return h.ref
}
...
func (h ReadinessProbeHeaderAttributes) InternalTokens() hclwrite.Tokens {
	return h.ref.InternalTokens()
}
...
func (sp StartupProbeAttributes) FailureCountThreshold() terra.NumberValue {
	return terra.ReferenceNumber(sp.ref.Append("failure_count_threshold"))
}

func (sp StartupProbeAttributes) Host() terra.StringValue {
	return terra.ReferenceString(sp.ref.Append("host"))
}

func (sp StartupProbeAttributes) IntervalSeconds() terra.NumberValue {
	return terra.ReferenceNumber(sp.ref.Append("interval_seconds"))
}

func (sp StartupProbeAttributes) Path() terra.StringValue {
	return terra.ReferenceString(sp.ref.Append("path"))
}

func (sp StartupProbeAttributes) Port() terra.NumberValue {
	return terra.ReferenceNumber(sp.ref.Append("port"))
}

func (sp StartupProbeAttributes) TerminationGracePeriodSeconds() terra.NumberValue {
	return terra.ReferenceNumber(sp.ref.Append("termination_grace_period_seconds"))
}

func (sp StartupProbeAttributes) Timeout() terra.NumberValue {
	return terra.ReferenceNumber(sp.ref.Append("timeout"))
}

func (sp StartupProbeAttributes) Transport() terra.StringValue {
	return terra.ReferenceString(sp.ref.Append("transport"))
}

func (sp StartupProbeAttributes) Header() terra.ListValue[StartupProbeHeaderAttributes] {
	return terra.ReferenceList[StartupProbeHeaderAttributes](sp.ref.Append("header"))
}
...
func (h StartupProbeHeaderAttributes) InternalRef() terra.Reference {
	return h.ref
}
...
func (h StartupProbeHeaderAttributes) InternalTokens() hclwrite.Tokens {
	return h.ref.InternalTokens()
}
...
func (vm VolumeMountsAttributes) Path() terra.StringValue {
	return terra.ReferenceString(vm.ref.Append("path"))
}
...
func (v VolumeAttributes) StorageName() terra.StringValue {
	return terra.ReferenceString(v.ref.Append("storage_name"))
}

func (v VolumeAttributes) StorageType() terra.StringValue {
	return terra.ReferenceString(v.ref.Append("storage_type"))
}
