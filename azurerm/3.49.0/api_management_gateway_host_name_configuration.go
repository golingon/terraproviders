...
import (
	"encoding/json"
	"fmt"
	apimanagementgatewayhostnameconfiguration "github.com/golingon/terraproviders/azurerm/3.49.0/apimanagementgatewayhostnameconfiguration"
...
type ApiManagementGatewayHostNameConfigurationArgs struct {
	...
	// DependsOn contains resources that ApiManagementGatewayHostNameConfiguration depends on
...
func (amghnc apiManagementGatewayHostNameConfigurationAttributes) Timeouts() apimanagementgatewayhostnameconfiguration.TimeoutsAttributes {
	return terra.ReferenceSingle[apimanagementgatewayhostnameconfiguration.TimeoutsAttributes](amghnc.ref.Append("timeouts"))
}
