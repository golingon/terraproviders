...
func (i IncidentAttributes) InternalRef() terra.Reference {
	return i.ref
}
...
func (i IncidentAttributes) InternalTokens() hclwrite.Tokens {
	return i.ref.InternalTokens()
}

func (i IncidentAttributes) CreateIncidentEnabled() terra.BoolValue {
	return terra.ReferenceBool(i.ref.Append("create_incident_enabled"))
}

func (i IncidentAttributes) Grouping() terra.ListValue[GroupingAttributes] {
	return terra.ReferenceList[GroupingAttributes](i.ref.Append("grouping"))
}
...
func (g GroupingAttributes) ByAlertDetails() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](g.ref.Append("by_alert_details"))
}

func (g GroupingAttributes) ByCustomDetails() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](g.ref.Append("by_custom_details"))
}

func (g GroupingAttributes) ByEntities() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](g.ref.Append("by_entities"))
}
