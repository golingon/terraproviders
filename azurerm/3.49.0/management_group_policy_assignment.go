...
import (
	"encoding/json"
	"fmt"
	managementgrouppolicyassignment "github.com/golingon/terraproviders/azurerm/3.49.0/managementgrouppolicyassignment"
...
type ManagementGroupPolicyAssignmentArgs struct {
	...
	// DependsOn contains resources that ManagementGroupPolicyAssignment depends on
...
func (mgpa managementGroupPolicyAssignmentAttributes) Identity() terra.ListValue[managementgrouppolicyassignment.IdentityAttributes] {
	return terra.ReferenceList[managementgrouppolicyassignment.IdentityAttributes](mgpa.ref.Append("identity"))
}
...
func (mgpa managementGroupPolicyAssignmentAttributes) NonComplianceMessage() terra.ListValue[managementgrouppolicyassignment.NonComplianceMessageAttributes] {
	return terra.ReferenceList[managementgrouppolicyassignment.NonComplianceMessageAttributes](mgpa.ref.Append("non_compliance_message"))
}
...
func (mgpa managementGroupPolicyAssignmentAttributes) Overrides() terra.ListValue[managementgrouppolicyassignment.OverridesAttributes] {
	return terra.ReferenceList[managementgrouppolicyassignment.OverridesAttributes](mgpa.ref.Append("overrides"))
}
...
func (mgpa managementGroupPolicyAssignmentAttributes) ResourceSelectors() terra.ListValue[managementgrouppolicyassignment.ResourceSelectorsAttributes] {
	return terra.ReferenceList[managementgrouppolicyassignment.ResourceSelectorsAttributes](mgpa.ref.Append("resource_selectors"))
}

func (mgpa managementGroupPolicyAssignmentAttributes) Timeouts() managementgrouppolicyassignment.TimeoutsAttributes {
	return terra.ReferenceSingle[managementgrouppolicyassignment.TimeoutsAttributes](mgpa.ref.Append("timeouts"))
}
