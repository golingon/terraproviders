...
import (
	"encoding/json"
	"fmt"
	networkmanager "github.com/golingon/terraproviders/azurerm/3.49.0/networkmanager"
...
type NetworkManagerArgs struct {
	...
	// DependsOn contains resources that NetworkManager depends on
...
func (nm networkManagerAttributes) Description() terra.StringValue {
	return terra.ReferenceString(nm.ref.Append("description"))
}

func (nm networkManagerAttributes) Id() terra.StringValue {
	return terra.ReferenceString(nm.ref.Append("id"))
}

func (nm networkManagerAttributes) Location() terra.StringValue {
	return terra.ReferenceString(nm.ref.Append("location"))
}

func (nm networkManagerAttributes) Name() terra.StringValue {
	return terra.ReferenceString(nm.ref.Append("name"))
}

func (nm networkManagerAttributes) ResourceGroupName() terra.StringValue {
	return terra.ReferenceString(nm.ref.Append("resource_group_name"))
}

func (nm networkManagerAttributes) ScopeAccesses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](nm.ref.Append("scope_accesses"))
}

func (nm networkManagerAttributes) Tags() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](nm.ref.Append("tags"))
}

func (nm networkManagerAttributes) CrossTenantScopes() terra.ListValue[networkmanager.CrossTenantScopesAttributes] {
	return terra.ReferenceList[networkmanager.CrossTenantScopesAttributes](nm.ref.Append("cross_tenant_scopes"))
}

func (nm networkManagerAttributes) Scope() terra.ListValue[networkmanager.ScopeAttributes] {
	return terra.ReferenceList[networkmanager.ScopeAttributes](nm.ref.Append("scope"))
}

func (nm networkManagerAttributes) Timeouts() networkmanager.TimeoutsAttributes {
	return terra.ReferenceSingle[networkmanager.TimeoutsAttributes](nm.ref.Append("timeouts"))
}
