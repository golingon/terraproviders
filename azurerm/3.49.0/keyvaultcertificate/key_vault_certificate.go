...
func (ca CertificateAttributeAttributes) InternalRef() terra.Reference {
	return ca.ref
}
...
func (ca CertificateAttributeAttributes) InternalTokens() hclwrite.Tokens {
	return ca.ref.InternalTokens()
}

func (ca CertificateAttributeAttributes) Created() terra.StringValue {
	return terra.ReferenceString(ca.ref.Append("created"))
}
...
func (ca CertificateAttributeAttributes) Expires() terra.StringValue {
	return terra.ReferenceString(ca.ref.Append("expires"))
}

func (ca CertificateAttributeAttributes) NotBefore() terra.StringValue {
	return terra.ReferenceString(ca.ref.Append("not_before"))
}

func (ca CertificateAttributeAttributes) RecoveryLevel() terra.StringValue {
	return terra.ReferenceString(ca.ref.Append("recovery_level"))
}

func (ca CertificateAttributeAttributes) Updated() terra.StringValue {
	return terra.ReferenceString(ca.ref.Append("updated"))
}
...
func (c CertificateAttributes) Contents() terra.StringValue {
	return terra.ReferenceString(c.ref.Append("contents"))
}
...
func (xcp X509CertificatePropertiesAttributes) KeyUsage() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](xcp.ref.Append("key_usage"))
}
...
func (san SubjectAlternativeNamesAttributes) DnsNames() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](san.ref.Append("dns_names"))
}

func (san SubjectAlternativeNamesAttributes) Emails() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](san.ref.Append("emails"))
}

func (san SubjectAlternativeNamesAttributes) Upns() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](san.ref.Append("upns"))
}
