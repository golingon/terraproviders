...
import (
	"encoding/json"
	"fmt"
	mssqlservertransparentdataencryption "github.com/golingon/terraproviders/azurerm/3.49.0/mssqlservertransparentdataencryption"
...
type MssqlServerTransparentDataEncryptionArgs struct {
	...
	// DependsOn contains resources that MssqlServerTransparentDataEncryption depends on
...
func (mstde mssqlServerTransparentDataEncryptionAttributes) Timeouts() mssqlservertransparentdataencryption.TimeoutsAttributes {
	return terra.ReferenceSingle[mssqlservertransparentdataencryption.TimeoutsAttributes](mstde.ref.Append("timeouts"))
}
