...
func (bs BgpSettingsAttributes) PeeringAddresses() terra.ListValue[PeeringAddressesAttributes] {
	return terra.ReferenceList[PeeringAddressesAttributes](bs.ref.Append("peering_addresses"))
}
...
func (pa PeeringAddressesAttributes) InternalRef() terra.Reference {
	return pa.ref
}
...
func (pa PeeringAddressesAttributes) InternalTokens() hclwrite.Tokens {
	return pa.ref.InternalTokens()
}

func (pa PeeringAddressesAttributes) ApipaAddresses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](pa.ref.Append("apipa_addresses"))
}

func (pa PeeringAddressesAttributes) DefaultAddresses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](pa.ref.Append("default_addresses"))
}

func (pa PeeringAddressesAttributes) IpConfigurationName() terra.StringValue {
	return terra.ReferenceString(pa.ref.Append("ip_configuration_name"))
}

func (pa PeeringAddressesAttributes) TunnelIpAddresses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceList[terra.StringValue](pa.ref.Append("tunnel_ip_addresses"))
}
...
func (vcc VpnClientConfigurationAttributes) VpnAuthTypes() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](vcc.ref.Append("vpn_auth_types"))
}
...
func (vcc VpnClientConfigurationAttributes) RevokedCertificate() terra.SetValue[RevokedCertificateAttributes] {
	return terra.ReferenceSet[RevokedCertificateAttributes](vcc.ref.Append("revoked_certificate"))
}

func (vcc VpnClientConfigurationAttributes) RootCertificate() terra.SetValue[RootCertificateAttributes] {
	return terra.ReferenceSet[RootCertificateAttributes](vcc.ref.Append("root_certificate"))
}
