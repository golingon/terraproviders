...
type PowerbiEmbeddedArgs struct {
	...
	// DependsOn contains resources that PowerbiEmbedded depends on
...
func (pe powerbiEmbeddedAttributes) Administrators() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](pe.ref.Append("administrators"))
}
...
func (pe powerbiEmbeddedAttributes) Mode() terra.StringValue {
	return terra.ReferenceString(pe.ref.Append("mode"))
}
...
func (pe powerbiEmbeddedAttributes) SkuName() terra.StringValue {
	return terra.ReferenceString(pe.ref.Append("sku_name"))
}
...
func (pe powerbiEmbeddedAttributes) Timeouts() powerbiembedded.TimeoutsAttributes {
	return terra.ReferenceSingle[powerbiembedded.TimeoutsAttributes](pe.ref.Append("timeouts"))
}
