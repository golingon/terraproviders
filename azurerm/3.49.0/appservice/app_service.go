...
func (sc SiteCredentialAttributes) Username() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("username"))
}
...
func (as AuthSettingsAttributes) AdditionalLoginParams() terra.MapValue[terra.StringValue] {
	return terra.ReferenceMap[terra.StringValue](as.ref.Append("additional_login_params"))
}
...
func (s ScheduleAttributes) RetentionPeriodInDays() terra.NumberValue {
	return terra.ReferenceNumber(s.ref.Append("retention_period_in_days"))
}
...
func (l LogsAttributes) DetailedErrorMessagesEnabled() terra.BoolValue {
	return terra.ReferenceBool(l.ref.Append("detailed_error_messages_enabled"))
}

func (l LogsAttributes) FailedRequestTracingEnabled() terra.BoolValue {
	return terra.ReferenceBool(l.ref.Append("failed_request_tracing_enabled"))
}
...
func (sc SiteConfigAttributes) AcrUseManagedIdentityCredentials() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("acr_use_managed_identity_credentials"))
}

func (sc SiteConfigAttributes) AcrUserManagedIdentityClientId() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("acr_user_managed_identity_client_id"))
}
...
func (sc SiteConfigAttributes) DotnetFrameworkVersion() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("dotnet_framework_version"))
}
...
func (sc SiteConfigAttributes) JavaContainer() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("java_container"))
}

func (sc SiteConfigAttributes) JavaContainerVersion() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("java_container_version"))
}

func (sc SiteConfigAttributes) JavaVersion() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("java_version"))
}
...
func (sc SiteConfigAttributes) MinTlsVersion() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("min_tls_version"))
}

func (sc SiteConfigAttributes) NumberOfWorkers() terra.NumberValue {
	return terra.ReferenceNumber(sc.ref.Append("number_of_workers"))
}

func (sc SiteConfigAttributes) PhpVersion() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("php_version"))
}
...
func (sc SiteConfigAttributes) Use32BitWorkerProcess() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("use_32_bit_worker_process"))
}
...
func (h IpRestrictionHeadersAttributes) XAzureFdid() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](h.ref.Append("x_azure_fdid"))
}

func (h IpRestrictionHeadersAttributes) XFdHealthProbe() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](h.ref.Append("x_fd_health_probe"))
}

func (h IpRestrictionHeadersAttributes) XForwardedFor() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](h.ref.Append("x_forwarded_for"))
}

func (h IpRestrictionHeadersAttributes) XForwardedHost() terra.SetValue[terra.StringValue] {
	return terra.ReferenceSet[terra.StringValue](h.ref.Append("x_forwarded_host"))
}
...
func (sc SourceControlAttributes) InternalRef() terra.Reference {
	return sc.ref
}
...
func (sc SourceControlAttributes) InternalTokens() hclwrite.Tokens {
	return sc.ref.InternalTokens()
}

func (sc SourceControlAttributes) Branch() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("branch"))
}

func (sc SourceControlAttributes) ManualIntegration() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("manual_integration"))
}

func (sc SourceControlAttributes) RepoUrl() terra.StringValue {
	return terra.ReferenceString(sc.ref.Append("repo_url"))
}

func (sc SourceControlAttributes) RollbackEnabled() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("rollback_enabled"))
}

func (sc SourceControlAttributes) UseMercurial() terra.BoolValue {
	return terra.ReferenceBool(sc.ref.Append("use_mercurial"))
}
