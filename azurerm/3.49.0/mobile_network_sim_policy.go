...
import (
	"encoding/json"
	"fmt"
	mobilenetworksimpolicy "github.com/golingon/terraproviders/azurerm/3.49.0/mobilenetworksimpolicy"
...
type MobileNetworkSimPolicyArgs struct {
	...
	// DependsOn contains resources that MobileNetworkSimPolicy depends on
...
func (mnsp mobileNetworkSimPolicyAttributes) Slice() terra.ListValue[mobilenetworksimpolicy.SliceAttributes] {
	return terra.ReferenceList[mobilenetworksimpolicy.SliceAttributes](mnsp.ref.Append("slice"))
}

func (mnsp mobileNetworkSimPolicyAttributes) Timeouts() mobilenetworksimpolicy.TimeoutsAttributes {
	return terra.ReferenceSingle[mobilenetworksimpolicy.TimeoutsAttributes](mnsp.ref.Append("timeouts"))
}
...
func (mnsp mobileNetworkSimPolicyAttributes) UserEquipmentAggregateMaximumBitRate() terra.ListValue[mobilenetworksimpolicy.UserEquipmentAggregateMaximumBitRateAttributes] {
	return terra.ReferenceList[mobilenetworksimpolicy.UserEquipmentAggregateMaximumBitRateAttributes](mnsp.ref.Append("user_equipment_aggregate_maximum_bit_rate"))
}
