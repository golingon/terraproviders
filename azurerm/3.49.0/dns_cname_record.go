...
import (
	"encoding/json"
	"fmt"
	dnscnamerecord "github.com/golingon/terraproviders/azurerm/3.49.0/dnscnamerecord"
...
type DnsCnameRecordArgs struct {
	...
	// DependsOn contains resources that DnsCnameRecord depends on
...
func (dcr dnsCnameRecordAttributes) Timeouts() dnscnamerecord.TimeoutsAttributes {
	return terra.ReferenceSingle[dnscnamerecord.TimeoutsAttributes](dcr.ref.Append("timeouts"))
}
