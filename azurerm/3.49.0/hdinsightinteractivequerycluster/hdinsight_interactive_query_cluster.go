...
type ComponentVersion struct {
	// InteractiveHive: string, required
	InteractiveHive terra.StringValue `hcl:"interactive_hive,attr" validate:"required"`
}
...
func (cv ComponentVersionAttributes) InteractiveHive() terra.StringValue {
	return terra.ReferenceString(cv.ref.Append("interactive_hive"))
}
