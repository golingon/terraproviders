...
import (
	"encoding/json"
	"fmt"
	virtualnetwork "github.com/golingon/terraproviders/azurerm/3.70.0/virtualnetwork"
...
type VirtualNetworkArgs struct {
	...
	// Encryption: optional
	Encryption *virtualnetwork.Encryption `hcl:"encryption,block"`
	// Timeouts: optional
...
func (vn virtualNetworkAttributes) Encryption() terra.ListValue[virtualnetwork.EncryptionAttributes] {
	return terra.ReferenceAsList[virtualnetwork.EncryptionAttributes](vn.ref.Append("encryption"))
}
...
type virtualNetworkState struct {
	...
	Encryption           []virtualnetwork.EncryptionState         `json:"encryption"`
