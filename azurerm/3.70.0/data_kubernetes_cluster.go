...
import (
	datakubernetescluster "github.com/golingon/terraproviders/azurerm/3.70.0/datakubernetescluster"
...
func (kc dataKubernetesClusterAttributes) CurrentKubernetesVersion() terra.StringValue {
	return terra.ReferenceAsString(kc.ref.Append("current_kubernetes_version"))
}
