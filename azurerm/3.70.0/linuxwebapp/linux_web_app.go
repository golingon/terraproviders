...
type StatusCode struct {
	...
	// Win32Status: number, optional
	Win32Status terra.NumberValue `hcl:"win32_status,attr"`
}
...
func (as ApplicationStackAttributes) DockerImage() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("docker_image"))
}

func (as ApplicationStackAttributes) DockerImageName() terra.StringValue {
...
func (as ApplicationStackAttributes) DockerImageTag() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("docker_image_tag"))
}

func (as ApplicationStackAttributes) DockerRegistryPassword() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("docker_registry_password"))
}

func (as ApplicationStackAttributes) DockerRegistryUrl() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("docker_registry_url"))
}

func (as ApplicationStackAttributes) DockerRegistryUsername() terra.StringValue {
...
func (as ApplicationStackAttributes) GoVersion() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("go_version"))
}

func (as ApplicationStackAttributes) JavaServer() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("java_server"))
}

func (as ApplicationStackAttributes) JavaServerVersion() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("java_server_version"))
}
...
func (as ApplicationStackAttributes) RubyVersion() terra.StringValue {
	return terra.ReferenceAsString(as.ref.Append("ruby_version"))
}
...
func (sc StatusCodeAttributes) Win32Status() terra.NumberValue {
	return terra.ReferenceAsNumber(sc.ref.Append("win32_status"))
}
...
type StatusCodeState struct {
	...
	Win32Status     float64 `json:"win32_status"`
}
