...
import (
	"encoding/json"
	"fmt"
	securitycentersubscriptionpricing "github.com/golingon/terraproviders/azurerm/3.76.0/securitycentersubscriptionpricing"
...
type SecurityCenterSubscriptionPricingArgs struct {
	...
	// Extension: min=0
	Extension []securitycentersubscriptionpricing.Extension `hcl:"extension,block" validate:"min=0"`
	// Timeouts: optional
...
func (scsp securityCenterSubscriptionPricingAttributes) Extension() terra.SetValue[securitycentersubscriptionpricing.ExtensionAttributes] {
	return terra.ReferenceAsSet[securitycentersubscriptionpricing.ExtensionAttributes](scsp.ref.Append("extension"))
}
...
type securityCenterSubscriptionPricingState struct {
	...
	Extension    []securitycentersubscriptionpricing.ExtensionState `json:"extension"`
