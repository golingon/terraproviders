...
import (
	"encoding/json"
	"fmt"
	botchanneldirectlinespeech "github.com/golingon/terraproviders/azurerm/3.76.0/botchanneldirectlinespeech"
...
func (bcdls botChannelDirectLineSpeechAttributes) CognitiveAccountId() terra.StringValue {
	return terra.ReferenceAsString(bcdls.ref.Append("cognitive_account_id"))
}
