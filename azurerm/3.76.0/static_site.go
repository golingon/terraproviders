...
import (
	"encoding/json"
	"fmt"
	staticsite "github.com/golingon/terraproviders/azurerm/3.76.0/staticsite"
...
func (ss staticSiteAttributes) AppSettings() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](ss.ref.Append("app_settings"))
}
