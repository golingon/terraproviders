...
import (
	"encoding/json"
	"fmt"
	paloaltolocalrulestackoutboundtrustcertificateassociation "github.com/golingon/terraproviders/azurerm/3.76.0/paloaltolocalrulestackoutboundtrustcertificateassociation"
