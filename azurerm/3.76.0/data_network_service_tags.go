...
import (
	datanetworkservicetags "github.com/golingon/terraproviders/azurerm/3.76.0/datanetworkservicetags"
...
func (nst dataNetworkServiceTagsAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(nst.ref.Append("name"))
}
