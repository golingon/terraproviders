...
import (
	"encoding/json"
	"fmt"
	paloaltolocalrulestackoutboundtrustcertificateassociation "github.com/golingon/terraproviders/azurerm/3.71.0/paloaltolocalrulestackoutboundtrustcertificateassociation"
