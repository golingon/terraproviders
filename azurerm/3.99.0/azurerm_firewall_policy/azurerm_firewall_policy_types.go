...
type Insights struct {
	...
	// InsightsLogAnalyticsWorkspace: min=0
	LogAnalyticsWorkspace []InsightsLogAnalyticsWorkspace `hcl:"log_analytics_workspace,block" validate:"min=0"`
}

type InsightsLogAnalyticsWorkspace struct {
...
type IntrusionDetection struct {
	...
	// IntrusionDetectionSignatureOverrides: min=0
	SignatureOverrides []IntrusionDetectionSignatureOverrides `hcl:"signature_overrides,block" validate:"min=0"`
	// IntrusionDetectionTrafficBypass: min=0
	TrafficBypass []IntrusionDetectionTrafficBypass `hcl:"traffic_bypass,block" validate:"min=0"`
}

type IntrusionDetectionSignatureOverrides struct {
	// Id: string, optional
...
type IntrusionDetectionTrafficBypass struct {
...
func (i InsightsAttributes) LogAnalyticsWorkspace() terra.ListValue[InsightsLogAnalyticsWorkspaceAttributes] {
	return terra.ReferenceAsList[InsightsLogAnalyticsWorkspaceAttributes](i.ref.Append("log_analytics_workspace"))
}

type InsightsLogAnalyticsWorkspaceAttributes struct {
	ref terra.Reference
}

func (law InsightsLogAnalyticsWorkspaceAttributes) InternalRef() (terra.Reference, error) {
	return law.ref, nil
}

func (law InsightsLogAnalyticsWorkspaceAttributes) InternalWithRef(ref terra.Reference) InsightsLogAnalyticsWorkspaceAttributes {
	return InsightsLogAnalyticsWorkspaceAttributes{ref: ref}
}

func (law InsightsLogAnalyticsWorkspaceAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return law.ref.InternalTokens()
}

func (law InsightsLogAnalyticsWorkspaceAttributes) FirewallLocation() terra.StringValue {
	return terra.ReferenceAsString(law.ref.Append("firewall_location"))
}

func (law InsightsLogAnalyticsWorkspaceAttributes) Id() terra.StringValue {
...
func (id IntrusionDetectionAttributes) SignatureOverrides() terra.ListValue[IntrusionDetectionSignatureOverridesAttributes] {
	return terra.ReferenceAsList[IntrusionDetectionSignatureOverridesAttributes](id.ref.Append("signature_overrides"))
}

func (id IntrusionDetectionAttributes) TrafficBypass() terra.ListValue[IntrusionDetectionTrafficBypassAttributes] {
	return terra.ReferenceAsList[IntrusionDetectionTrafficBypassAttributes](id.ref.Append("traffic_bypass"))
}

type IntrusionDetectionSignatureOverridesAttributes struct {
	ref terra.Reference
}

func (so IntrusionDetectionSignatureOverridesAttributes) InternalRef() (terra.Reference, error) {
	return so.ref, nil
}

func (so IntrusionDetectionSignatureOverridesAttributes) InternalWithRef(ref terra.Reference) IntrusionDetectionSignatureOverridesAttributes {
	return IntrusionDetectionSignatureOverridesAttributes{ref: ref}
}

func (so IntrusionDetectionSignatureOverridesAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return so.ref.InternalTokens()
}

func (so IntrusionDetectionSignatureOverridesAttributes) Id() terra.StringValue {
	return terra.ReferenceAsString(so.ref.Append("id"))
}

func (so IntrusionDetectionSignatureOverridesAttributes) State() terra.StringValue {
	return terra.ReferenceAsString(so.ref.Append("state"))
}

type IntrusionDetectionTrafficBypassAttributes struct {
	ref terra.Reference
}

func (tb IntrusionDetectionTrafficBypassAttributes) InternalRef() (terra.Reference, error) {
	return tb.ref, nil
}

func (tb IntrusionDetectionTrafficBypassAttributes) InternalWithRef(ref terra.Reference) IntrusionDetectionTrafficBypassAttributes {
	return IntrusionDetectionTrafficBypassAttributes{ref: ref}
}

func (tb IntrusionDetectionTrafficBypassAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return tb.ref.InternalTokens()
}

func (tb IntrusionDetectionTrafficBypassAttributes) Description() terra.StringValue {
	return terra.ReferenceAsString(tb.ref.Append("description"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) DestinationAddresses() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](tb.ref.Append("destination_addresses"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) DestinationIpGroups() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](tb.ref.Append("destination_ip_groups"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) DestinationPorts() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](tb.ref.Append("destination_ports"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(tb.ref.Append("name"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) Protocol() terra.StringValue {
	return terra.ReferenceAsString(tb.ref.Append("protocol"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) SourceAddresses() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](tb.ref.Append("source_addresses"))
}

func (tb IntrusionDetectionTrafficBypassAttributes) SourceIpGroups() terra.SetValue[terra.StringValue] {
...
type InsightsState struct {
	...
	LogAnalyticsWorkspace          []InsightsLogAnalyticsWorkspaceState `json:"log_analytics_workspace"`
}

type InsightsLogAnalyticsWorkspaceState struct {
...
type IntrusionDetectionState struct {
	...
	SignatureOverrides []IntrusionDetectionSignatureOverridesState `json:"signature_overrides"`
	TrafficBypass      []IntrusionDetectionTrafficBypassState      `json:"traffic_bypass"`
}

type IntrusionDetectionSignatureOverridesState struct {
	Id    string `json:"id"`
	State string `json:"state"`
}

type IntrusionDetectionTrafficBypassState struct {
