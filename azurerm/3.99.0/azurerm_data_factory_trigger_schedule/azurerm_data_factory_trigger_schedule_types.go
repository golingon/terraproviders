...
type Schedule struct {
	...
	// ScheduleMonthly: min=0
	Monthly []ScheduleMonthly `hcl:"monthly,block" validate:"min=0"`
}
...
func (s ScheduleAttributes) Monthly() terra.ListValue[ScheduleMonthlyAttributes] {
	return terra.ReferenceAsList[ScheduleMonthlyAttributes](s.ref.Append("monthly"))
}

type ScheduleMonthlyAttributes struct {
	ref terra.Reference
}

func (m ScheduleMonthlyAttributes) InternalRef() (terra.Reference, error) {
	return m.ref, nil
}

func (m ScheduleMonthlyAttributes) InternalWithRef(ref terra.Reference) ScheduleMonthlyAttributes {
	return ScheduleMonthlyAttributes{ref: ref}
}

func (m ScheduleMonthlyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return m.ref.InternalTokens()
}

func (m ScheduleMonthlyAttributes) Week() terra.NumberValue {
	return terra.ReferenceAsNumber(m.ref.Append("week"))
}

func (m ScheduleMonthlyAttributes) Weekday() terra.StringValue {
...
type ScheduleState struct {
	...
	Monthly     []ScheduleMonthlyState `json:"monthly"`
}

type ScheduleMonthlyState struct {
