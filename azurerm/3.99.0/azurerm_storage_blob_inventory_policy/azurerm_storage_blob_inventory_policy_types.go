...
type Rules struct {
	...
	// RulesFilter: optional
	Filter *RulesFilter `hcl:"filter,block"`
}
...
func (r RulesAttributes) Filter() terra.ListValue[RulesFilterAttributes] {
	return terra.ReferenceAsList[RulesFilterAttributes](r.ref.Append("filter"))
}

type RulesFilterAttributes struct {
	ref terra.Reference
}

func (f RulesFilterAttributes) InternalRef() (terra.Reference, error) {
	return f.ref, nil
}

func (f RulesFilterAttributes) InternalWithRef(ref terra.Reference) RulesFilterAttributes {
	return RulesFilterAttributes{ref: ref}
}

func (f RulesFilterAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return f.ref.InternalTokens()
}

func (f RulesFilterAttributes) BlobTypes() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](f.ref.Append("blob_types"))
}

func (f RulesFilterAttributes) ExcludePrefixes() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](f.ref.Append("exclude_prefixes"))
}

func (f RulesFilterAttributes) IncludeBlobVersions() terra.BoolValue {
	return terra.ReferenceAsBool(f.ref.Append("include_blob_versions"))
}

func (f RulesFilterAttributes) IncludeDeleted() terra.BoolValue {
	return terra.ReferenceAsBool(f.ref.Append("include_deleted"))
}

func (f RulesFilterAttributes) IncludeSnapshots() terra.BoolValue {
	return terra.ReferenceAsBool(f.ref.Append("include_snapshots"))
}

func (f RulesFilterAttributes) PrefixMatch() terra.SetValue[terra.StringValue] {
...
type RulesState struct {
	...
	Filter               []RulesFilterState `json:"filter"`
}
