...
type CloudToDevice struct {
	...
	// CloudToDeviceFeedback: min=0
	Feedback []CloudToDeviceFeedback `hcl:"feedback,block" validate:"min=0"`
}

type CloudToDeviceFeedback struct {
...
func (ctd CloudToDeviceAttributes) Feedback() terra.ListValue[CloudToDeviceFeedbackAttributes] {
	return terra.ReferenceAsList[CloudToDeviceFeedbackAttributes](ctd.ref.Append("feedback"))
}

type CloudToDeviceFeedbackAttributes struct {
	ref terra.Reference
}

func (f CloudToDeviceFeedbackAttributes) InternalRef() (terra.Reference, error) {
	return f.ref, nil
}

func (f CloudToDeviceFeedbackAttributes) InternalWithRef(ref terra.Reference) CloudToDeviceFeedbackAttributes {
	return CloudToDeviceFeedbackAttributes{ref: ref}
}

func (f CloudToDeviceFeedbackAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return f.ref.InternalTokens()
}

func (f CloudToDeviceFeedbackAttributes) LockDuration() terra.StringValue {
	return terra.ReferenceAsString(f.ref.Append("lock_duration"))
}

func (f CloudToDeviceFeedbackAttributes) MaxDeliveryCount() terra.NumberValue {
	return terra.ReferenceAsNumber(f.ref.Append("max_delivery_count"))
}

func (f CloudToDeviceFeedbackAttributes) TimeToLive() terra.StringValue {
...
func (nrs NetworkRuleSetAttributes) IpRule() terra.ListValue[NetworkRuleSetIpRuleAttributes] {
	return terra.ReferenceAsList[NetworkRuleSetIpRuleAttributes](nrs.ref.Append("ip_rule"))
}
...
func (ir NetworkRuleSetIpRuleAttributes) IpMask() terra.StringValue {
	return terra.ReferenceAsString(ir.ref.Append("ip_mask"))
}

func (ir NetworkRuleSetIpRuleAttributes) Name() terra.StringValue {
...
type CloudToDeviceState struct {
	...
	Feedback         []CloudToDeviceFeedbackState `json:"feedback"`
}

type CloudToDeviceFeedbackState struct {
