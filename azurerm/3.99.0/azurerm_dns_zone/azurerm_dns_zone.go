...
// Resource represents the Terraform resource azurerm_dns_zone.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermDnsZoneState
...
func (adz *Resource) Attributes() azurermDnsZoneAttributes {
	return azurermDnsZoneAttributes{ref: terra.ReferenceResource(adz)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (adz *Resource) ImportState(state io.Reader) error {
	adz.state = &azurermDnsZoneState{}
...
func (adz *Resource) State() (*azurermDnsZoneState, bool) {
	return adz.state, adz.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (adz *Resource) StateMust() *azurermDnsZoneState {
	if adz.state == nil {
...
// Args contains the configurations for azurerm_dns_zone.
type Args struct {
	// Id: string, optional
...
type azurermDnsZoneAttributes struct {
	ref terra.Reference
}

// Id returns a reference to field id of azurerm_dns_zone.
func (adz azurermDnsZoneAttributes) Id() terra.StringValue {
...
func (adz azurermDnsZoneAttributes) MaxNumberOfRecordSets() terra.NumberValue {
...
func (adz azurermDnsZoneAttributes) Name() terra.StringValue {
...
func (adz azurermDnsZoneAttributes) NameServers() terra.SetValue[terra.StringValue] {
...
func (adz azurermDnsZoneAttributes) NumberOfRecordSets() terra.NumberValue {
...
func (adz azurermDnsZoneAttributes) ResourceGroupName() terra.StringValue {
...
func (adz azurermDnsZoneAttributes) Tags() terra.MapValue[terra.StringValue] {
	return terra.ReferenceAsMap[terra.StringValue](adz.ref.Append("tags"))
}

func (adz azurermDnsZoneAttributes) SoaRecord() terra.ListValue[SoaRecordAttributes] {
	return terra.ReferenceAsList[SoaRecordAttributes](adz.ref.Append("soa_record"))
}

func (adz azurermDnsZoneAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](adz.ref.Append("timeouts"))
}

type azurermDnsZoneState struct {
	Id                    string            `json:"id"`
