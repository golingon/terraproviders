...
func (sr DataSecurityRuleAttributes) DestinationApplicationSecurityGroupIds() terra.SetValue[terra.StringValue] {
...
func (sr DataSecurityRuleAttributes) SourceApplicationSecurityGroupIds() terra.SetValue[terra.StringValue] {
