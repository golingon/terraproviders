...
type NetworkProfile struct {
	...
	// NetworkProfileVnetConfiguration: required
	VnetConfiguration *NetworkProfileVnetConfiguration `hcl:"vnet_configuration,block" validate:"required"`
}

type NetworkProfileVnetConfiguration struct {
...
func (np NetworkProfileAttributes) VnetConfiguration() terra.ListValue[NetworkProfileVnetConfigurationAttributes] {
	return terra.ReferenceAsList[NetworkProfileVnetConfigurationAttributes](np.ref.Append("vnet_configuration"))
}

type NetworkProfileVnetConfigurationAttributes struct {
	ref terra.Reference
}

func (vc NetworkProfileVnetConfigurationAttributes) InternalRef() (terra.Reference, error) {
	return vc.ref, nil
}

func (vc NetworkProfileVnetConfigurationAttributes) InternalWithRef(ref terra.Reference) NetworkProfileVnetConfigurationAttributes {
	return NetworkProfileVnetConfigurationAttributes{ref: ref}
}

func (vc NetworkProfileVnetConfigurationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return vc.ref.InternalTokens()
}

func (vc NetworkProfileVnetConfigurationAttributes) IpOfTrustForUserDefinedRoutes() terra.StringValue {
	return terra.ReferenceAsString(vc.ref.Append("ip_of_trust_for_user_defined_routes"))
}

func (vc NetworkProfileVnetConfigurationAttributes) TrustedSubnetId() terra.StringValue {
	return terra.ReferenceAsString(vc.ref.Append("trusted_subnet_id"))
}

func (vc NetworkProfileVnetConfigurationAttributes) UntrustedSubnetId() terra.StringValue {
	return terra.ReferenceAsString(vc.ref.Append("untrusted_subnet_id"))
}

func (vc NetworkProfileVnetConfigurationAttributes) VirtualNetworkId() terra.StringValue {
...
type NetworkProfileState struct {
	...
	VnetConfiguration     []NetworkProfileVnetConfigurationState `json:"vnet_configuration"`
}

type NetworkProfileVnetConfigurationState struct {
