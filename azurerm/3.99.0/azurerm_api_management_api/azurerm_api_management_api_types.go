...
type Import struct {
	...
	// ImportWsdlSelector: optional
	WsdlSelector *ImportWsdlSelector `hcl:"wsdl_selector,block"`
}

type ImportWsdlSelector struct {
...
func (i ImportAttributes) WsdlSelector() terra.ListValue[ImportWsdlSelectorAttributes] {
	return terra.ReferenceAsList[ImportWsdlSelectorAttributes](i.ref.Append("wsdl_selector"))
}

type ImportWsdlSelectorAttributes struct {
	ref terra.Reference
}

func (ws ImportWsdlSelectorAttributes) InternalRef() (terra.Reference, error) {
	return ws.ref, nil
}

func (ws ImportWsdlSelectorAttributes) InternalWithRef(ref terra.Reference) ImportWsdlSelectorAttributes {
	return ImportWsdlSelectorAttributes{ref: ref}
}

func (ws ImportWsdlSelectorAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ws.ref.InternalTokens()
}

func (ws ImportWsdlSelectorAttributes) EndpointName() terra.StringValue {
	return terra.ReferenceAsString(ws.ref.Append("endpoint_name"))
}

func (ws ImportWsdlSelectorAttributes) ServiceName() terra.StringValue {
...
type ImportState struct {
	...
	WsdlSelector  []ImportWsdlSelectorState `json:"wsdl_selector"`
}

type ImportWsdlSelectorState struct {
