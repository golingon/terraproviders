...
type DataPersistentDiskAttributes struct {
	ref terra.Reference
}

func (pd DataPersistentDiskAttributes) InternalRef() (terra.Reference, error) {
	return pd.ref, nil
}

func (pd DataPersistentDiskAttributes) InternalWithRef(ref terra.Reference) DataPersistentDiskAttributes {
	return DataPersistentDiskAttributes{ref: ref}
}

func (pd DataPersistentDiskAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return pd.ref.InternalTokens()
}

func (pd DataPersistentDiskAttributes) MountPath() terra.StringValue {
	return terra.ReferenceAsString(pd.ref.Append("mount_path"))
}

func (pd DataPersistentDiskAttributes) SizeInGb() terra.NumberValue {
...
type DataPersistentDiskState struct {
