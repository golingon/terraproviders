...
// Resource represents the Terraform resource azurerm_cdn_profile.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermCdnProfileState
...
func (acp *Resource) Attributes() azurermCdnProfileAttributes {
	return azurermCdnProfileAttributes{ref: terra.ReferenceResource(acp)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (acp *Resource) ImportState(state io.Reader) error {
	acp.state = &azurermCdnProfileState{}
...
func (acp *Resource) State() (*azurermCdnProfileState, bool) {
	return acp.state, acp.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (acp *Resource) StateMust() *azurermCdnProfileState {
	if acp.state == nil {
...
// Args contains the configurations for azurerm_cdn_profile.
type Args struct {
	// Id: string, optional
...
func (acp azurermCdnProfileAttributes) ResourceGroupName() terra.StringValue {
