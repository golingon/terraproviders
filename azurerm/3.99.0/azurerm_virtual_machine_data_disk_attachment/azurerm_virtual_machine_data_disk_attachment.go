...
package azurerm_virtual_machine_data_disk_attachment
...
// Resource represents the Terraform resource azurerm_virtual_machine_data_disk_attachment.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermVirtualMachineDataDiskAttachmentState
...
func (avmdda *Resource) Attributes() azurermVirtualMachineDataDiskAttachmentAttributes {
	return azurermVirtualMachineDataDiskAttachmentAttributes{ref: terra.ReferenceResource(avmdda)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (avmdda *Resource) ImportState(state io.Reader) error {
	avmdda.state = &azurermVirtualMachineDataDiskAttachmentState{}
...
func (avmdda *Resource) State() (*azurermVirtualMachineDataDiskAttachmentState, bool) {
	return avmdda.state, avmdda.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (avmdda *Resource) StateMust() *azurermVirtualMachineDataDiskAttachmentState {
	if avmdda.state == nil {
...
// Args contains the configurations for azurerm_virtual_machine_data_disk_attachment.
type Args struct {
...
type azurermVirtualMachineDataDiskAttachmentAttributes struct {
	ref terra.Reference
}

// Caching returns a reference to field caching of azurerm_virtual_machine_data_disk_attachment.
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) Caching() terra.StringValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) CreateOption() terra.StringValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) Id() terra.StringValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) Lun() terra.NumberValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) ManagedDiskId() terra.StringValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) VirtualMachineId() terra.StringValue {
...
func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) WriteAcceleratorEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(avmdda.ref.Append("write_accelerator_enabled"))
}

func (avmdda azurermVirtualMachineDataDiskAttachmentAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](avmdda.ref.Append("timeouts"))
}

type azurermVirtualMachineDataDiskAttachmentState struct {
