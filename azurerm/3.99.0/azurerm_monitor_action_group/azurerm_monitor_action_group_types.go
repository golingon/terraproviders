...
type WebhookReceiver struct {
	...
	// UseCommonAlertSchema: bool, optional
	UseCommonAlertSchema terra.BoolValue `hcl:"use_common_alert_schema,attr"`
	// WebhookReceiverAadAuth: optional
	AadAuth *WebhookReceiverAadAuth `hcl:"aad_auth,block"`
}

type WebhookReceiverAadAuth struct {
...
func (wr WebhookReceiverAttributes) AadAuth() terra.ListValue[WebhookReceiverAadAuthAttributes] {
	return terra.ReferenceAsList[WebhookReceiverAadAuthAttributes](wr.ref.Append("aad_auth"))
}

type WebhookReceiverAadAuthAttributes struct {
	ref terra.Reference
}

func (aa WebhookReceiverAadAuthAttributes) InternalRef() (terra.Reference, error) {
	return aa.ref, nil
}

func (aa WebhookReceiverAadAuthAttributes) InternalWithRef(ref terra.Reference) WebhookReceiverAadAuthAttributes {
	return WebhookReceiverAadAuthAttributes{ref: ref}
}

func (aa WebhookReceiverAadAuthAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return aa.ref.InternalTokens()
}

func (aa WebhookReceiverAadAuthAttributes) IdentifierUri() terra.StringValue {
	return terra.ReferenceAsString(aa.ref.Append("identifier_uri"))
}

func (aa WebhookReceiverAadAuthAttributes) ObjectId() terra.StringValue {
	return terra.ReferenceAsString(aa.ref.Append("object_id"))
}

func (aa WebhookReceiverAadAuthAttributes) TenantId() terra.StringValue {
...
type WebhookReceiverState struct {
	...
	ServiceUri           string                        `json:"service_uri"`
	UseCommonAlertSchema bool                          `json:"use_common_alert_schema"`
	AadAuth              []WebhookReceiverAadAuthState `json:"aad_auth"`
}

type WebhookReceiverAadAuthState struct {
