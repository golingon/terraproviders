...
// Resource represents the Terraform resource azurerm_mysql_server.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermMysqlServerState
...
func (ams *Resource) Attributes() azurermMysqlServerAttributes {
	return azurermMysqlServerAttributes{ref: terra.ReferenceResource(ams)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (ams *Resource) ImportState(state io.Reader) error {
	ams.state = &azurermMysqlServerState{}
...
func (ams *Resource) State() (*azurermMysqlServerState, bool) {
	return ams.state, ams.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (ams *Resource) StateMust() *azurermMysqlServerState {
	if ams.state == nil {
...
// Args contains the configurations for azurerm_mysql_server.
type Args struct {
...
type azurermMysqlServerAttributes struct {
	ref terra.Reference
}

// AdministratorLogin returns a reference to field administrator_login of azurerm_mysql_server.
func (ams azurermMysqlServerAttributes) AdministratorLogin() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) AdministratorLoginPassword() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) AutoGrowEnabled() terra.BoolValue {
...
func (ams azurermMysqlServerAttributes) BackupRetentionDays() terra.NumberValue {
...
func (ams azurermMysqlServerAttributes) CreateMode() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) CreationSourceServerId() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) Fqdn() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) GeoRedundantBackupEnabled() terra.BoolValue {
...
func (ams azurermMysqlServerAttributes) Id() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) InfrastructureEncryptionEnabled() terra.BoolValue {
...
func (ams azurermMysqlServerAttributes) Location() terra.StringValue {
	return terra.ReferenceAsString(ams.ref.Append("location"))
}

// Name returns a reference to field name of azurerm_mysql_server.
func (ams azurermMysqlServerAttributes) Name() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) PublicNetworkAccessEnabled() terra.BoolValue {
...
func (ams azurermMysqlServerAttributes) ResourceGroupName() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) RestorePointInTime() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) SkuName() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) SslEnforcementEnabled() terra.BoolValue {
...
func (ams azurermMysqlServerAttributes) SslMinimalTlsVersionEnforced() terra.StringValue {
...
func (ams azurermMysqlServerAttributes) StorageMb() terra.NumberValue {
	return terra.ReferenceAsNumber(ams.ref.Append("storage_mb"))
}

// Tags returns a reference to field tags of azurerm_mysql_server.
func (ams azurermMysqlServerAttributes) Tags() terra.MapValue[terra.StringValue] {
...
func (ams azurermMysqlServerAttributes) Version() terra.StringValue {
	return terra.ReferenceAsString(ams.ref.Append("version"))
}

func (ams azurermMysqlServerAttributes) Identity() terra.ListValue[IdentityAttributes] {
	return terra.ReferenceAsList[IdentityAttributes](ams.ref.Append("identity"))
}

func (ams azurermMysqlServerAttributes) ThreatDetectionPolicy() terra.ListValue[ThreatDetectionPolicyAttributes] {
	return terra.ReferenceAsList[ThreatDetectionPolicyAttributes](ams.ref.Append("threat_detection_policy"))
}

func (ams azurermMysqlServerAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](ams.ref.Append("timeouts"))
}

type azurermMysqlServerState struct {
