...
// Resource represents the Terraform resource azurerm_key_vault_access_policy.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermKeyVaultAccessPolicyState
...
func (akvap *Resource) Attributes() azurermKeyVaultAccessPolicyAttributes {
	return azurermKeyVaultAccessPolicyAttributes{ref: terra.ReferenceResource(akvap)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (akvap *Resource) ImportState(state io.Reader) error {
	akvap.state = &azurermKeyVaultAccessPolicyState{}
...
func (akvap *Resource) State() (*azurermKeyVaultAccessPolicyState, bool) {
	return akvap.state, akvap.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (akvap *Resource) StateMust() *azurermKeyVaultAccessPolicyState {
	if akvap.state == nil {
...
// Args contains the configurations for azurerm_key_vault_access_policy.
type Args struct {
...
type azurermKeyVaultAccessPolicyAttributes struct {
	ref terra.Reference
}

// ApplicationId returns a reference to field application_id of azurerm_key_vault_access_policy.
func (akvap azurermKeyVaultAccessPolicyAttributes) ApplicationId() terra.StringValue {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) CertificatePermissions() terra.ListValue[terra.StringValue] {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) Id() terra.StringValue {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) KeyPermissions() terra.ListValue[terra.StringValue] {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) KeyVaultId() terra.StringValue {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) ObjectId() terra.StringValue {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) SecretPermissions() terra.ListValue[terra.StringValue] {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) StoragePermissions() terra.ListValue[terra.StringValue] {
...
func (akvap azurermKeyVaultAccessPolicyAttributes) TenantId() terra.StringValue {
	return terra.ReferenceAsString(akvap.ref.Append("tenant_id"))
}

func (akvap azurermKeyVaultAccessPolicyAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](akvap.ref.Append("timeouts"))
}

type azurermKeyVaultAccessPolicyState struct {
