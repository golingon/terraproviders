...
type Rule struct {
	...
	// RuleProtocol: min=0
	Protocol []RuleProtocol `hcl:"protocol,block" validate:"min=0"`
}
...
func (r RuleAttributes) Protocol() terra.ListValue[RuleProtocolAttributes] {
	return terra.ReferenceAsList[RuleProtocolAttributes](r.ref.Append("protocol"))
}

type RuleProtocolAttributes struct {
	ref terra.Reference
}

func (p RuleProtocolAttributes) InternalRef() (terra.Reference, error) {
	return p.ref, nil
}

func (p RuleProtocolAttributes) InternalWithRef(ref terra.Reference) RuleProtocolAttributes {
	return RuleProtocolAttributes{ref: ref}
}

func (p RuleProtocolAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return p.ref.InternalTokens()
}

func (p RuleProtocolAttributes) Port() terra.NumberValue {
	return terra.ReferenceAsNumber(p.ref.Append("port"))
}

func (p RuleProtocolAttributes) Type() terra.StringValue {
...
type RuleState struct {
	...
	Protocol        []RuleProtocolState `json:"protocol"`
}

type RuleProtocolState struct {
