...
type PermissionScope struct {
	...
	// PermissionScopePermissions: required
	Permissions *PermissionScopePermissions `hcl:"permissions,block" validate:"required"`
}

type PermissionScopePermissions struct {
...
func (ps PermissionScopeAttributes) Permissions() terra.ListValue[PermissionScopePermissionsAttributes] {
	return terra.ReferenceAsList[PermissionScopePermissionsAttributes](ps.ref.Append("permissions"))
}

type PermissionScopePermissionsAttributes struct {
	ref terra.Reference
}

func (p PermissionScopePermissionsAttributes) InternalRef() (terra.Reference, error) {
	return p.ref, nil
}

func (p PermissionScopePermissionsAttributes) InternalWithRef(ref terra.Reference) PermissionScopePermissionsAttributes {
	return PermissionScopePermissionsAttributes{ref: ref}
}

func (p PermissionScopePermissionsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return p.ref.InternalTokens()
}

func (p PermissionScopePermissionsAttributes) Create() terra.BoolValue {
	return terra.ReferenceAsBool(p.ref.Append("create"))
}

func (p PermissionScopePermissionsAttributes) Delete() terra.BoolValue {
	return terra.ReferenceAsBool(p.ref.Append("delete"))
}

func (p PermissionScopePermissionsAttributes) List() terra.BoolValue {
	return terra.ReferenceAsBool(p.ref.Append("list"))
}

func (p PermissionScopePermissionsAttributes) Read() terra.BoolValue {
	return terra.ReferenceAsBool(p.ref.Append("read"))
}

func (p PermissionScopePermissionsAttributes) Write() terra.BoolValue {
...
type PermissionScopeState struct {
	...
	Permissions  []PermissionScopePermissionsState `json:"permissions"`
}

type PermissionScopePermissionsState struct {
