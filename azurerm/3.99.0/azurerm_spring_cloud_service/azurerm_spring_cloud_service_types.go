...
type ConfigServerGitSetting struct {
	...
	// ConfigServerGitSettingRepository: min=0
	Repository []ConfigServerGitSettingRepository `hcl:"repository,block" validate:"min=0"`
...
type ConfigServerGitSettingRepository struct {
	// Label: string, optional
	Label terra.StringValue `hcl:"label,attr"`
	...
	// Uri: string, required
	Uri terra.StringValue `hcl:"uri,attr" validate:"required"`
	// ConfigServerGitSettingRepositoryHttpBasicAuth: optional
	HttpBasicAuth *ConfigServerGitSettingRepositoryHttpBasicAuth `hcl:"http_basic_auth,block"`
	// ConfigServerGitSettingRepositorySshAuth: optional
	SshAuth *ConfigServerGitSettingRepositorySshAuth `hcl:"ssh_auth,block"`
}

type ConfigServerGitSettingRepositoryHttpBasicAuth struct {
	// Password: string, required
	Password terra.StringValue `hcl:"password,attr" validate:"required"`
	// Username: string, required
	Username terra.StringValue `hcl:"username,attr" validate:"required"`
...
type ConfigServerGitSettingRepositorySshAuth struct {
...
func (csgs ConfigServerGitSettingAttributes) Repository() terra.ListValue[ConfigServerGitSettingRepositoryAttributes] {
	return terra.ReferenceAsList[ConfigServerGitSettingRepositoryAttributes](csgs.ref.Append("repository"))
}
...
type ConfigServerGitSettingRepositoryAttributes struct {
	ref terra.Reference
}

func (r ConfigServerGitSettingRepositoryAttributes) InternalRef() (terra.Reference, error) {
	return r.ref, nil
}

func (r ConfigServerGitSettingRepositoryAttributes) InternalWithRef(ref terra.Reference) ConfigServerGitSettingRepositoryAttributes {
	return ConfigServerGitSettingRepositoryAttributes{ref: ref}
}

func (r ConfigServerGitSettingRepositoryAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return r.ref.InternalTokens()
}

func (r ConfigServerGitSettingRepositoryAttributes) Label() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("label"))
}

func (r ConfigServerGitSettingRepositoryAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("name"))
}

func (r ConfigServerGitSettingRepositoryAttributes) Pattern() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](r.ref.Append("pattern"))
}

func (r ConfigServerGitSettingRepositoryAttributes) SearchPaths() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](r.ref.Append("search_paths"))
}

func (r ConfigServerGitSettingRepositoryAttributes) Uri() terra.StringValue {
	return terra.ReferenceAsString(r.ref.Append("uri"))
}

func (r ConfigServerGitSettingRepositoryAttributes) HttpBasicAuth() terra.ListValue[ConfigServerGitSettingRepositoryHttpBasicAuthAttributes] {
	return terra.ReferenceAsList[ConfigServerGitSettingRepositoryHttpBasicAuthAttributes](r.ref.Append("http_basic_auth"))
}

func (r ConfigServerGitSettingRepositoryAttributes) SshAuth() terra.ListValue[ConfigServerGitSettingRepositorySshAuthAttributes] {
	return terra.ReferenceAsList[ConfigServerGitSettingRepositorySshAuthAttributes](r.ref.Append("ssh_auth"))
}

type ConfigServerGitSettingRepositoryHttpBasicAuthAttributes struct {
	ref terra.Reference
}

func (hba ConfigServerGitSettingRepositoryHttpBasicAuthAttributes) InternalRef() (terra.Reference, error) {
	return hba.ref, nil
}

func (hba ConfigServerGitSettingRepositoryHttpBasicAuthAttributes) InternalWithRef(ref terra.Reference) ConfigServerGitSettingRepositoryHttpBasicAuthAttributes {
	return ConfigServerGitSettingRepositoryHttpBasicAuthAttributes{ref: ref}
}

func (hba ConfigServerGitSettingRepositoryHttpBasicAuthAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return hba.ref.InternalTokens()
}

func (hba ConfigServerGitSettingRepositoryHttpBasicAuthAttributes) Password() terra.StringValue {
	return terra.ReferenceAsString(hba.ref.Append("password"))
}

func (hba ConfigServerGitSettingRepositoryHttpBasicAuthAttributes) Username() terra.StringValue {
	return terra.ReferenceAsString(hba.ref.Append("username"))
}

type ConfigServerGitSettingRepositorySshAuthAttributes struct {
	ref terra.Reference
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) InternalRef() (terra.Reference, error) {
	return sa.ref, nil
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) InternalWithRef(ref terra.Reference) ConfigServerGitSettingRepositorySshAuthAttributes {
	return ConfigServerGitSettingRepositorySshAuthAttributes{ref: ref}
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return sa.ref.InternalTokens()
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) HostKey() terra.StringValue {
	return terra.ReferenceAsString(sa.ref.Append("host_key"))
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) HostKeyAlgorithm() terra.StringValue {
	return terra.ReferenceAsString(sa.ref.Append("host_key_algorithm"))
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) PrivateKey() terra.StringValue {
	return terra.ReferenceAsString(sa.ref.Append("private_key"))
}

func (sa ConfigServerGitSettingRepositorySshAuthAttributes) StrictHostKeyCheckingEnabled() terra.BoolValue {
...
type ConfigServerGitSettingState struct {
	...
	Repository    []ConfigServerGitSettingRepositoryState    `json:"repository"`
...
type ConfigServerGitSettingRepositoryState struct {
	Label         string                                               `json:"label"`
	Name          string                                               `json:"name"`
	Pattern       []string                                             `json:"pattern"`
	SearchPaths   []string                                             `json:"search_paths"`
	Uri           string                                               `json:"uri"`
	HttpBasicAuth []ConfigServerGitSettingRepositoryHttpBasicAuthState `json:"http_basic_auth"`
	SshAuth       []ConfigServerGitSettingRepositorySshAuthState       `json:"ssh_auth"`
}

type ConfigServerGitSettingRepositoryHttpBasicAuthState struct {
	Password string `json:"password"`
	Username string `json:"username"`
}

type ConfigServerGitSettingRepositorySshAuthState struct {
