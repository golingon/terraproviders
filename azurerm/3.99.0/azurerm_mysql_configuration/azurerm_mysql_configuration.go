...
package azurerm_mysql_configuration
...
// Resource represents the Terraform resource azurerm_mysql_configuration.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermMysqlConfigurationState
...
func (amc *Resource) Attributes() azurermMysqlConfigurationAttributes {
	return azurermMysqlConfigurationAttributes{ref: terra.ReferenceResource(amc)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (amc *Resource) ImportState(state io.Reader) error {
	amc.state = &azurermMysqlConfigurationState{}
...
func (amc *Resource) State() (*azurermMysqlConfigurationState, bool) {
	return amc.state, amc.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (amc *Resource) StateMust() *azurermMysqlConfigurationState {
	if amc.state == nil {
...
// Args contains the configurations for azurerm_mysql_configuration.
type Args struct {
	// Id: string, optional
...
func (amc azurermMysqlConfigurationAttributes) ResourceGroupName() terra.StringValue {
...
func (amc azurermMysqlConfigurationAttributes) ServerName() terra.StringValue {
...
func (amc azurermMysqlConfigurationAttributes) Value() terra.StringValue {
	return terra.ReferenceAsString(amc.ref.Append("value"))
}

func (amc azurermMysqlConfigurationAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](amc.ref.Append("timeouts"))
}

type azurermMysqlConfigurationState struct {
	Id                string         `json:"id"`
