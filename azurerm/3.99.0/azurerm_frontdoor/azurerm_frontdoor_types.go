...
type BackendPool struct {
	...
	// BackendPoolBackend: min=1,max=500
	Backend []BackendPoolBackend `hcl:"backend,block" validate:"min=1,max=500"`
}

type BackendPoolBackend struct {
...
type RoutingRule struct {
	...
	// RoutingRuleForwardingConfiguration: optional
	ForwardingConfiguration *RoutingRuleForwardingConfiguration `hcl:"forwarding_configuration,block"`
	// RoutingRuleRedirectConfiguration: optional
	RedirectConfiguration *RoutingRuleRedirectConfiguration `hcl:"redirect_configuration,block"`
}

type RoutingRuleForwardingConfiguration struct {
...
type RoutingRuleRedirectConfiguration struct {
...
func (bp BackendPoolAttributes) Backend() terra.ListValue[BackendPoolBackendAttributes] {
	return terra.ReferenceAsList[BackendPoolBackendAttributes](bp.ref.Append("backend"))
}

type BackendPoolBackendAttributes struct {
	ref terra.Reference
}

func (b BackendPoolBackendAttributes) InternalRef() (terra.Reference, error) {
	return b.ref, nil
}

func (b BackendPoolBackendAttributes) InternalWithRef(ref terra.Reference) BackendPoolBackendAttributes {
	return BackendPoolBackendAttributes{ref: ref}
}

func (b BackendPoolBackendAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return b.ref.InternalTokens()
}

func (b BackendPoolBackendAttributes) Address() terra.StringValue {
	return terra.ReferenceAsString(b.ref.Append("address"))
}

func (b BackendPoolBackendAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(b.ref.Append("enabled"))
}

func (b BackendPoolBackendAttributes) HostHeader() terra.StringValue {
	return terra.ReferenceAsString(b.ref.Append("host_header"))
}

func (b BackendPoolBackendAttributes) HttpPort() terra.NumberValue {
	return terra.ReferenceAsNumber(b.ref.Append("http_port"))
}

func (b BackendPoolBackendAttributes) HttpsPort() terra.NumberValue {
	return terra.ReferenceAsNumber(b.ref.Append("https_port"))
}

func (b BackendPoolBackendAttributes) Priority() terra.NumberValue {
	return terra.ReferenceAsNumber(b.ref.Append("priority"))
}

func (b BackendPoolBackendAttributes) Weight() terra.NumberValue {
...
func (rr RoutingRuleAttributes) ForwardingConfiguration() terra.ListValue[RoutingRuleForwardingConfigurationAttributes] {
	return terra.ReferenceAsList[RoutingRuleForwardingConfigurationAttributes](rr.ref.Append("forwarding_configuration"))
}

func (rr RoutingRuleAttributes) RedirectConfiguration() terra.ListValue[RoutingRuleRedirectConfigurationAttributes] {
	return terra.ReferenceAsList[RoutingRuleRedirectConfigurationAttributes](rr.ref.Append("redirect_configuration"))
}

type RoutingRuleForwardingConfigurationAttributes struct {
	ref terra.Reference
}

func (fc RoutingRuleForwardingConfigurationAttributes) InternalRef() (terra.Reference, error) {
	return fc.ref, nil
}

func (fc RoutingRuleForwardingConfigurationAttributes) InternalWithRef(ref terra.Reference) RoutingRuleForwardingConfigurationAttributes {
	return RoutingRuleForwardingConfigurationAttributes{ref: ref}
}

func (fc RoutingRuleForwardingConfigurationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return fc.ref.InternalTokens()
}

func (fc RoutingRuleForwardingConfigurationAttributes) BackendPoolName() terra.StringValue {
	return terra.ReferenceAsString(fc.ref.Append("backend_pool_name"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CacheDuration() terra.StringValue {
	return terra.ReferenceAsString(fc.ref.Append("cache_duration"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CacheEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(fc.ref.Append("cache_enabled"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CacheQueryParameterStripDirective() terra.StringValue {
	return terra.ReferenceAsString(fc.ref.Append("cache_query_parameter_strip_directive"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CacheQueryParameters() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](fc.ref.Append("cache_query_parameters"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CacheUseDynamicCompression() terra.BoolValue {
	return terra.ReferenceAsBool(fc.ref.Append("cache_use_dynamic_compression"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) CustomForwardingPath() terra.StringValue {
	return terra.ReferenceAsString(fc.ref.Append("custom_forwarding_path"))
}

func (fc RoutingRuleForwardingConfigurationAttributes) ForwardingProtocol() terra.StringValue {
	return terra.ReferenceAsString(fc.ref.Append("forwarding_protocol"))
}

type RoutingRuleRedirectConfigurationAttributes struct {
	ref terra.Reference
}

func (rc RoutingRuleRedirectConfigurationAttributes) InternalRef() (terra.Reference, error) {
	return rc.ref, nil
}

func (rc RoutingRuleRedirectConfigurationAttributes) InternalWithRef(ref terra.Reference) RoutingRuleRedirectConfigurationAttributes {
	return RoutingRuleRedirectConfigurationAttributes{ref: ref}
}

func (rc RoutingRuleRedirectConfigurationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return rc.ref.InternalTokens()
}

func (rc RoutingRuleRedirectConfigurationAttributes) CustomFragment() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("custom_fragment"))
}

func (rc RoutingRuleRedirectConfigurationAttributes) CustomHost() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("custom_host"))
}

func (rc RoutingRuleRedirectConfigurationAttributes) CustomPath() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("custom_path"))
}

func (rc RoutingRuleRedirectConfigurationAttributes) CustomQueryString() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("custom_query_string"))
}

func (rc RoutingRuleRedirectConfigurationAttributes) RedirectProtocol() terra.StringValue {
	return terra.ReferenceAsString(rc.ref.Append("redirect_protocol"))
}

func (rc RoutingRuleRedirectConfigurationAttributes) RedirectType() terra.StringValue {
...
type BackendPoolState struct {
	...
	Backend           []BackendPoolBackendState `json:"backend"`
}

type BackendPoolBackendState struct {
...
type RoutingRuleState struct {
	...
	ForwardingConfiguration []RoutingRuleForwardingConfigurationState `json:"forwarding_configuration"`
	RedirectConfiguration   []RoutingRuleRedirectConfigurationState   `json:"redirect_configuration"`
}

type RoutingRuleForwardingConfigurationState struct {
...
type RoutingRuleRedirectConfigurationState struct {
