...
type Request struct {
	...
	// RequestQueryParameter: min=0
	QueryParameter []RequestQueryParameter `hcl:"query_parameter,block" validate:"min=0"`
...
type RequestQueryParameter struct {
	...
	// Values: set of string, optional
	Values terra.SetValue[terra.StringValue] `hcl:"values,attr"`
	// RequestQueryParameterExample: min=0
	Example []RequestQueryParameterExample `hcl:"example,block" validate:"min=0"`
}

type RequestQueryParameterExample struct {
	// Description: string, optional
	Description terra.StringValue `hcl:"description,attr"`
	// ExternalValue: string, optional
	ExternalValue terra.StringValue `hcl:"external_value,attr"`
...
func (r RequestAttributes) QueryParameter() terra.ListValue[RequestQueryParameterAttributes] {
	return terra.ReferenceAsList[RequestQueryParameterAttributes](r.ref.Append("query_parameter"))
}
...
type RequestQueryParameterAttributes struct {
	ref terra.Reference
}

func (qp RequestQueryParameterAttributes) InternalRef() (terra.Reference, error) {
	return qp.ref, nil
}

func (qp RequestQueryParameterAttributes) InternalWithRef(ref terra.Reference) RequestQueryParameterAttributes {
	return RequestQueryParameterAttributes{ref: ref}
}

func (qp RequestQueryParameterAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return qp.ref.InternalTokens()
}

func (qp RequestQueryParameterAttributes) DefaultValue() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("default_value"))
}

func (qp RequestQueryParameterAttributes) Description() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("description"))
}

func (qp RequestQueryParameterAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("name"))
}

func (qp RequestQueryParameterAttributes) Required() terra.BoolValue {
	return terra.ReferenceAsBool(qp.ref.Append("required"))
}

func (qp RequestQueryParameterAttributes) SchemaId() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("schema_id"))
}

func (qp RequestQueryParameterAttributes) Type() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("type"))
}

func (qp RequestQueryParameterAttributes) TypeName() terra.StringValue {
	return terra.ReferenceAsString(qp.ref.Append("type_name"))
}

func (qp RequestQueryParameterAttributes) Values() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](qp.ref.Append("values"))
}

func (qp RequestQueryParameterAttributes) Example() terra.ListValue[RequestQueryParameterExampleAttributes] {
	return terra.ReferenceAsList[RequestQueryParameterExampleAttributes](qp.ref.Append("example"))
}

type RequestQueryParameterExampleAttributes struct {
	ref terra.Reference
}

func (e RequestQueryParameterExampleAttributes) InternalRef() (terra.Reference, error) {
	return e.ref, nil
}

func (e RequestQueryParameterExampleAttributes) InternalWithRef(ref terra.Reference) RequestQueryParameterExampleAttributes {
	return RequestQueryParameterExampleAttributes{ref: ref}
}

func (e RequestQueryParameterExampleAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return e.ref.InternalTokens()
}

func (e RequestQueryParameterExampleAttributes) Description() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("description"))
}

func (e RequestQueryParameterExampleAttributes) ExternalValue() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("external_value"))
}

func (e RequestQueryParameterExampleAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("name"))
}

func (e RequestQueryParameterExampleAttributes) Summary() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("summary"))
}

func (e RequestQueryParameterExampleAttributes) Value() terra.StringValue {
	return terra.ReferenceAsString(e.ref.Append("value"))
}
...
type RequestState struct {
	...
	QueryParameter []RequestQueryParameterState `json:"query_parameter"`
...
type RequestQueryParameterState struct {
	DefaultValue string                              `json:"default_value"`
	Description  string                              `json:"description"`
	Name         string                              `json:"name"`
	Required     bool                                `json:"required"`
	...
	TypeName     string                              `json:"type_name"`
	Values       []string                            `json:"values"`
	Example      []RequestQueryParameterExampleState `json:"example"`
}

type RequestQueryParameterExampleState struct {
	Description   string `json:"description"`
	ExternalValue string `json:"external_value"`
	Name          string `json:"name"`
	Summary       string `json:"summary"`
