...
type Configuration struct {
	...
	// ConfigurationConfigFile: min=0
	ConfigFile []ConfigurationConfigFile `hcl:"config_file,block" validate:"min=0"`
	// ConfigurationProtectedFile: min=0
	ProtectedFile []ConfigurationProtectedFile `hcl:"protected_file,block" validate:"min=0"`
}
...
func (c ConfigurationAttributes) ConfigFile() terra.SetValue[ConfigurationConfigFileAttributes] {
	return terra.ReferenceAsSet[ConfigurationConfigFileAttributes](c.ref.Append("config_file"))
}

func (c ConfigurationAttributes) ProtectedFile() terra.SetValue[ConfigurationProtectedFileAttributes] {
	return terra.ReferenceAsSet[ConfigurationProtectedFileAttributes](c.ref.Append("protected_file"))
}

type ConfigurationConfigFileAttributes struct {
	ref terra.Reference
}

func (cf ConfigurationConfigFileAttributes) InternalRef() (terra.Reference, error) {
	return cf.ref, nil
}

func (cf ConfigurationConfigFileAttributes) InternalWithRef(ref terra.Reference) ConfigurationConfigFileAttributes {
	return ConfigurationConfigFileAttributes{ref: ref}
}

func (cf ConfigurationConfigFileAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return cf.ref.InternalTokens()
}

func (cf ConfigurationConfigFileAttributes) Content() terra.StringValue {
	return terra.ReferenceAsString(cf.ref.Append("content"))
}

func (cf ConfigurationConfigFileAttributes) VirtualPath() terra.StringValue {
	return terra.ReferenceAsString(cf.ref.Append("virtual_path"))
}

type ConfigurationProtectedFileAttributes struct {
	ref terra.Reference
}

func (pf ConfigurationProtectedFileAttributes) InternalRef() (terra.Reference, error) {
	return pf.ref, nil
}

func (pf ConfigurationProtectedFileAttributes) InternalWithRef(ref terra.Reference) ConfigurationProtectedFileAttributes {
	return ConfigurationProtectedFileAttributes{ref: ref}
}

func (pf ConfigurationProtectedFileAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return pf.ref.InternalTokens()
}

func (pf ConfigurationProtectedFileAttributes) Content() terra.StringValue {
	return terra.ReferenceAsString(pf.ref.Append("content"))
}

func (pf ConfigurationProtectedFileAttributes) VirtualPath() terra.StringValue {
...
type ConfigurationState struct {
	...
	ConfigFile    []ConfigurationConfigFileState    `json:"config_file"`
	ProtectedFile []ConfigurationProtectedFileState `json:"protected_file"`
}

type ConfigurationConfigFileState struct {
	Content     string `json:"content"`
	VirtualPath string `json:"virtual_path"`
}

type ConfigurationProtectedFileState struct {
	Content     string `json:"content"`
	VirtualPath string `json:"virtual_path"`
}
