...
type Incident struct {
	// CreateIncidentEnabled: bool, required
	CreateIncidentEnabled terra.BoolValue `hcl:"create_incident_enabled,attr" validate:"required"`
	// IncidentGrouping: required
	Grouping *IncidentGrouping `hcl:"grouping,block" validate:"required"`
}

type IncidentGrouping struct {
	// ByAlertDetails: list of string, optional
	ByAlertDetails terra.ListValue[terra.StringValue] `hcl:"by_alert_details,attr"`
	// ByCustomDetails: list of string, optional
	ByCustomDetails terra.ListValue[terra.StringValue] `hcl:"by_custom_details,attr"`
	// ByEntities: list of string, optional
	ByEntities terra.ListValue[terra.StringValue] `hcl:"by_entities,attr"`
...
func (i IncidentAttributes) InternalRef() (terra.Reference, error) {
	return i.ref, nil
}

func (i IncidentAttributes) InternalWithRef(ref terra.Reference) IncidentAttributes {
	return IncidentAttributes{ref: ref}
}

func (i IncidentAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return i.ref.InternalTokens()
}

func (i IncidentAttributes) CreateIncidentEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(i.ref.Append("create_incident_enabled"))
}

func (i IncidentAttributes) Grouping() terra.ListValue[IncidentGroupingAttributes] {
	return terra.ReferenceAsList[IncidentGroupingAttributes](i.ref.Append("grouping"))
}

type IncidentGroupingAttributes struct {
	ref terra.Reference
}

func (g IncidentGroupingAttributes) InternalRef() (terra.Reference, error) {
	return g.ref, nil
}

func (g IncidentGroupingAttributes) InternalWithRef(ref terra.Reference) IncidentGroupingAttributes {
	return IncidentGroupingAttributes{ref: ref}
}

func (g IncidentGroupingAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return g.ref.InternalTokens()
}

func (g IncidentGroupingAttributes) ByAlertDetails() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](g.ref.Append("by_alert_details"))
}

func (g IncidentGroupingAttributes) ByCustomDetails() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](g.ref.Append("by_custom_details"))
}

func (g IncidentGroupingAttributes) ByEntities() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](g.ref.Append("by_entities"))
}

func (g IncidentGroupingAttributes) Enabled() terra.BoolValue {
	return terra.ReferenceAsBool(g.ref.Append("enabled"))
}

func (g IncidentGroupingAttributes) EntityMatchingMethod() terra.StringValue {
	return terra.ReferenceAsString(g.ref.Append("entity_matching_method"))
}

func (g IncidentGroupingAttributes) LookbackDuration() terra.StringValue {
	return terra.ReferenceAsString(g.ref.Append("lookback_duration"))
}

func (g IncidentGroupingAttributes) ReopenClosedIncidents() terra.BoolValue {
...
type IncidentState struct {
	CreateIncidentEnabled bool                    `json:"create_incident_enabled"`
	Grouping              []IncidentGroupingState `json:"grouping"`
}

type IncidentGroupingState struct {
	ByAlertDetails        []string `json:"by_alert_details"`
	ByCustomDetails       []string `json:"by_custom_details"`
	ByEntities            []string `json:"by_entities"`
