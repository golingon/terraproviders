...
type Suppression struct {
	...
	// SuppressionSchedule: optional
	Schedule *SuppressionSchedule `hcl:"schedule,block"`
}
...
func (s SuppressionAttributes) Schedule() terra.ListValue[SuppressionScheduleAttributes] {
	return terra.ReferenceAsList[SuppressionScheduleAttributes](s.ref.Append("schedule"))
}

type SuppressionScheduleAttributes struct {
	ref terra.Reference
}

func (s SuppressionScheduleAttributes) InternalRef() (terra.Reference, error) {
	return s.ref, nil
}

func (s SuppressionScheduleAttributes) InternalWithRef(ref terra.Reference) SuppressionScheduleAttributes {
	return SuppressionScheduleAttributes{ref: ref}
}

func (s SuppressionScheduleAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return s.ref.InternalTokens()
}

func (s SuppressionScheduleAttributes) EndDateUtc() terra.StringValue {
	return terra.ReferenceAsString(s.ref.Append("end_date_utc"))
}

func (s SuppressionScheduleAttributes) RecurrenceMonthly() terra.SetValue[terra.NumberValue] {
	return terra.ReferenceAsSet[terra.NumberValue](s.ref.Append("recurrence_monthly"))
}

func (s SuppressionScheduleAttributes) RecurrenceWeekly() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](s.ref.Append("recurrence_weekly"))
}

func (s SuppressionScheduleAttributes) StartDateUtc() terra.StringValue {
...
type SuppressionState struct {
	...
	Schedule       []SuppressionScheduleState `json:"schedule"`
}

type SuppressionScheduleState struct {
