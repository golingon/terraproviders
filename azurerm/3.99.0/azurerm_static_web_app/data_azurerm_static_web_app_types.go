...
type DataBasicAuthAttributes struct {
	ref terra.Reference
}

func (ba DataBasicAuthAttributes) InternalRef() (terra.Reference, error) {
	return ba.ref, nil
}

func (ba DataBasicAuthAttributes) InternalWithRef(ref terra.Reference) DataBasicAuthAttributes {
	return DataBasicAuthAttributes{ref: ref}
}

func (ba DataBasicAuthAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ba.ref.InternalTokens()
}

func (ba DataBasicAuthAttributes) Environments() terra.StringValue {
	return terra.ReferenceAsString(ba.ref.Append("environments"))
}
...
type DataBasicAuthState struct {
