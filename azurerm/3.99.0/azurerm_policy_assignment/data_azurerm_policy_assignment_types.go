...
type DataNonComplianceMessageAttributes struct {
	ref terra.Reference
}

func (ncm DataNonComplianceMessageAttributes) InternalRef() (terra.Reference, error) {
	return ncm.ref, nil
}

func (ncm DataNonComplianceMessageAttributes) InternalWithRef(ref terra.Reference) DataNonComplianceMessageAttributes {
	return DataNonComplianceMessageAttributes{ref: ref}
}

func (ncm DataNonComplianceMessageAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ncm.ref.InternalTokens()
}

func (ncm DataNonComplianceMessageAttributes) Content() terra.StringValue {
	return terra.ReferenceAsString(ncm.ref.Append("content"))
}

func (ncm DataNonComplianceMessageAttributes) PolicyDefinitionReferenceId() terra.StringValue {
...
type DataNonComplianceMessageState struct {
