...
func (pdzc PrivateDnsZoneConfigsAttributes) RecordSets() terra.ListValue[PrivateDnsZoneConfigsRecordSetsAttributes] {
	return terra.ReferenceAsList[PrivateDnsZoneConfigsRecordSetsAttributes](pdzc.ref.Append("record_sets"))
}

type PrivateDnsZoneConfigsRecordSetsAttributes struct {
	ref terra.Reference
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) InternalRef() (terra.Reference, error) {
	return rs.ref, nil
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) InternalWithRef(ref terra.Reference) PrivateDnsZoneConfigsRecordSetsAttributes {
	return PrivateDnsZoneConfigsRecordSetsAttributes{ref: ref}
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return rs.ref.InternalTokens()
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) Fqdn() terra.StringValue {
	return terra.ReferenceAsString(rs.ref.Append("fqdn"))
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) IpAddresses() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](rs.ref.Append("ip_addresses"))
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(rs.ref.Append("name"))
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) Ttl() terra.NumberValue {
	return terra.ReferenceAsNumber(rs.ref.Append("ttl"))
}

func (rs PrivateDnsZoneConfigsRecordSetsAttributes) Type() terra.StringValue {
...
type PrivateDnsZoneConfigsState struct {
	...
	RecordSets       []PrivateDnsZoneConfigsRecordSetsState `json:"record_sets"`
}

type PrivateDnsZoneConfigsRecordSetsState struct {
	Fqdn        string   `json:"fqdn"`
	IpAddresses []string `json:"ip_addresses"`
	Name        string   `json:"name"`
