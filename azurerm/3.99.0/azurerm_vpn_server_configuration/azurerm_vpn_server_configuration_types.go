...
type Radius struct {
	...
	// RadiusServer: min=0
	Server []RadiusServer `hcl:"server,block" validate:"min=0"`
	// RadiusServerRootCertificate: min=0
	ServerRootCertificate []RadiusServerRootCertificate `hcl:"server_root_certificate,block" validate:"min=0"`
}
...
type RadiusServerRootCertificate struct {
	// Name: string, required
	Name terra.StringValue `hcl:"name,attr" validate:"required"`
	// PublicCertData: string, required
	PublicCertData terra.StringValue `hcl:"public_cert_data,attr" validate:"required"`
...
func (r RadiusAttributes) Server() terra.ListValue[RadiusServerAttributes] {
	return terra.ReferenceAsList[RadiusServerAttributes](r.ref.Append("server"))
}

func (r RadiusAttributes) ServerRootCertificate() terra.SetValue[RadiusServerRootCertificateAttributes] {
	return terra.ReferenceAsSet[RadiusServerRootCertificateAttributes](r.ref.Append("server_root_certificate"))
}
...
func (s RadiusServerAttributes) InternalRef() (terra.Reference, error) {
	return s.ref, nil
}

func (s RadiusServerAttributes) InternalWithRef(ref terra.Reference) RadiusServerAttributes {
	return RadiusServerAttributes{ref: ref}
}

func (s RadiusServerAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return s.ref.InternalTokens()
}

func (s RadiusServerAttributes) Address() terra.StringValue {
	return terra.ReferenceAsString(s.ref.Append("address"))
}

func (s RadiusServerAttributes) Score() terra.NumberValue {
	return terra.ReferenceAsNumber(s.ref.Append("score"))
}

func (s RadiusServerAttributes) Secret() terra.StringValue {
	return terra.ReferenceAsString(s.ref.Append("secret"))
}

type RadiusServerRootCertificateAttributes struct {
	ref terra.Reference
}

func (src RadiusServerRootCertificateAttributes) InternalRef() (terra.Reference, error) {
	return src.ref, nil
}

func (src RadiusServerRootCertificateAttributes) InternalWithRef(ref terra.Reference) RadiusServerRootCertificateAttributes {
	return RadiusServerRootCertificateAttributes{ref: ref}
}

func (src RadiusServerRootCertificateAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return src.ref.InternalTokens()
}

func (src RadiusServerRootCertificateAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(src.ref.Append("name"))
}

func (src RadiusServerRootCertificateAttributes) PublicCertData() terra.StringValue {
...
type RadiusState struct {
	...
	Server                []RadiusServerState                `json:"server"`
	ServerRootCertificate []RadiusServerRootCertificateState `json:"server_root_certificate"`
}
...
type RadiusServerRootCertificateState struct {
	Name           string `json:"name"`
	PublicCertData string `json:"public_cert_data"`
}
