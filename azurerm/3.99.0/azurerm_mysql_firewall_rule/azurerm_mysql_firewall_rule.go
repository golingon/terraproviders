...
package azurerm_mysql_firewall_rule
...
// Resource represents the Terraform resource azurerm_mysql_firewall_rule.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermMysqlFirewallRuleState
...
func (amfr *Resource) Attributes() azurermMysqlFirewallRuleAttributes {
	return azurermMysqlFirewallRuleAttributes{ref: terra.ReferenceResource(amfr)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (amfr *Resource) ImportState(state io.Reader) error {
	amfr.state = &azurermMysqlFirewallRuleState{}
...
func (amfr *Resource) State() (*azurermMysqlFirewallRuleState, bool) {
	return amfr.state, amfr.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (amfr *Resource) StateMust() *azurermMysqlFirewallRuleState {
	if amfr.state == nil {
...
// Args contains the configurations for azurerm_mysql_firewall_rule.
type Args struct {
...
type azurermMysqlFirewallRuleAttributes struct {
	ref terra.Reference
}

// EndIpAddress returns a reference to field end_ip_address of azurerm_mysql_firewall_rule.
func (amfr azurermMysqlFirewallRuleAttributes) EndIpAddress() terra.StringValue {
...
func (amfr azurermMysqlFirewallRuleAttributes) Id() terra.StringValue {
	return terra.ReferenceAsString(amfr.ref.Append("id"))
}

// Name returns a reference to field name of azurerm_mysql_firewall_rule.
func (amfr azurermMysqlFirewallRuleAttributes) Name() terra.StringValue {
...
func (amfr azurermMysqlFirewallRuleAttributes) ResourceGroupName() terra.StringValue {
...
func (amfr azurermMysqlFirewallRuleAttributes) ServerName() terra.StringValue {
...
func (amfr azurermMysqlFirewallRuleAttributes) StartIpAddress() terra.StringValue {
	return terra.ReferenceAsString(amfr.ref.Append("start_ip_address"))
}

func (amfr azurermMysqlFirewallRuleAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](amfr.ref.Append("timeouts"))
}

type azurermMysqlFirewallRuleState struct {
