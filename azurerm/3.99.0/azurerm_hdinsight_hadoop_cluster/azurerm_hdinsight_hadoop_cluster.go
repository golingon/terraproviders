...
// Resource represents the Terraform resource azurerm_hdinsight_hadoop_cluster.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermHdinsightHadoopClusterState
...
func (ahhc *Resource) Attributes() azurermHdinsightHadoopClusterAttributes {
	return azurermHdinsightHadoopClusterAttributes{ref: terra.ReferenceResource(ahhc)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (ahhc *Resource) ImportState(state io.Reader) error {
	ahhc.state = &azurermHdinsightHadoopClusterState{}
...
func (ahhc *Resource) State() (*azurermHdinsightHadoopClusterState, bool) {
	return ahhc.state, ahhc.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (ahhc *Resource) StateMust() *azurermHdinsightHadoopClusterState {
	if ahhc.state == nil {
...
// Args contains the configurations for azurerm_hdinsight_hadoop_cluster.
type Args struct {
...
type azurermHdinsightHadoopClusterAttributes struct {
	ref terra.Reference
}

// ClusterVersion returns a reference to field cluster_version of azurerm_hdinsight_hadoop_cluster.
func (ahhc azurermHdinsightHadoopClusterAttributes) ClusterVersion() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) HttpsEndpoint() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) Id() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) Location() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) Name() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) ResourceGroupName() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) SshEndpoint() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) Tags() terra.MapValue[terra.StringValue] {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) Tier() terra.StringValue {
...
func (ahhc azurermHdinsightHadoopClusterAttributes) TlsMinVersion() terra.StringValue {
	return terra.ReferenceAsString(ahhc.ref.Append("tls_min_version"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) ComponentVersion() terra.ListValue[ComponentVersionAttributes] {
	return terra.ReferenceAsList[ComponentVersionAttributes](ahhc.ref.Append("component_version"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) ComputeIsolation() terra.ListValue[ComputeIsolationAttributes] {
	return terra.ReferenceAsList[ComputeIsolationAttributes](ahhc.ref.Append("compute_isolation"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) DiskEncryption() terra.ListValue[DiskEncryptionAttributes] {
	return terra.ReferenceAsList[DiskEncryptionAttributes](ahhc.ref.Append("disk_encryption"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Extension() terra.ListValue[ExtensionAttributes] {
	return terra.ReferenceAsList[ExtensionAttributes](ahhc.ref.Append("extension"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Gateway() terra.ListValue[GatewayAttributes] {
	return terra.ReferenceAsList[GatewayAttributes](ahhc.ref.Append("gateway"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Metastores() terra.ListValue[MetastoresAttributes] {
	return terra.ReferenceAsList[MetastoresAttributes](ahhc.ref.Append("metastores"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Monitor() terra.ListValue[MonitorAttributes] {
	return terra.ReferenceAsList[MonitorAttributes](ahhc.ref.Append("monitor"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Network() terra.ListValue[NetworkAttributes] {
	return terra.ReferenceAsList[NetworkAttributes](ahhc.ref.Append("network"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Roles() terra.ListValue[RolesAttributes] {
	return terra.ReferenceAsList[RolesAttributes](ahhc.ref.Append("roles"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) SecurityProfile() terra.ListValue[SecurityProfileAttributes] {
	return terra.ReferenceAsList[SecurityProfileAttributes](ahhc.ref.Append("security_profile"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) StorageAccount() terra.ListValue[StorageAccountAttributes] {
	return terra.ReferenceAsList[StorageAccountAttributes](ahhc.ref.Append("storage_account"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) StorageAccountGen2() terra.ListValue[StorageAccountGen2Attributes] {
	return terra.ReferenceAsList[StorageAccountGen2Attributes](ahhc.ref.Append("storage_account_gen2"))
}

func (ahhc azurermHdinsightHadoopClusterAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](ahhc.ref.Append("timeouts"))
}

type azurermHdinsightHadoopClusterState struct {
