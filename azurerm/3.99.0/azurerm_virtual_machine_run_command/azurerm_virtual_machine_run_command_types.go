...
type Source struct {
	...
	// SourceScriptUriManagedIdentity: optional
	ScriptUriManagedIdentity *SourceScriptUriManagedIdentity `hcl:"script_uri_managed_identity,block"`
}

type SourceScriptUriManagedIdentity struct {
	// ClientId: string, optional
	ClientId terra.StringValue `hcl:"client_id,attr"`
	// ObjectId: string, optional
	ObjectId terra.StringValue `hcl:"object_id,attr"`
...
func (s SourceAttributes) ScriptUriManagedIdentity() terra.ListValue[SourceScriptUriManagedIdentityAttributes] {
	return terra.ReferenceAsList[SourceScriptUriManagedIdentityAttributes](s.ref.Append("script_uri_managed_identity"))
}

type SourceScriptUriManagedIdentityAttributes struct {
	ref terra.Reference
}

func (sumi SourceScriptUriManagedIdentityAttributes) InternalRef() (terra.Reference, error) {
	return sumi.ref, nil
}

func (sumi SourceScriptUriManagedIdentityAttributes) InternalWithRef(ref terra.Reference) SourceScriptUriManagedIdentityAttributes {
	return SourceScriptUriManagedIdentityAttributes{ref: ref}
}

func (sumi SourceScriptUriManagedIdentityAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return sumi.ref.InternalTokens()
}

func (sumi SourceScriptUriManagedIdentityAttributes) ClientId() terra.StringValue {
	return terra.ReferenceAsString(sumi.ref.Append("client_id"))
}

func (sumi SourceScriptUriManagedIdentityAttributes) ObjectId() terra.StringValue {
...
type SourceState struct {
	...
	ScriptUriManagedIdentity []SourceScriptUriManagedIdentityState `json:"script_uri_managed_identity"`
}

type SourceScriptUriManagedIdentityState struct {
	ClientId string `json:"client_id"`
	ObjectId string `json:"object_id"`
}
