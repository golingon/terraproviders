...
type Restore struct {
	...
	// RestoreDatabase: min=0
	Database []RestoreDatabase `hcl:"database,block" validate:"min=0"`
	// RestoreGremlinDatabase: min=0
	GremlinDatabase []RestoreGremlinDatabase `hcl:"gremlin_database,block" validate:"min=0"`
}
...
type RestoreGremlinDatabase struct {
...
func (r RestoreAttributes) Database() terra.SetValue[RestoreDatabaseAttributes] {
	return terra.ReferenceAsSet[RestoreDatabaseAttributes](r.ref.Append("database"))
}

func (r RestoreAttributes) GremlinDatabase() terra.ListValue[RestoreGremlinDatabaseAttributes] {
	return terra.ReferenceAsList[RestoreGremlinDatabaseAttributes](r.ref.Append("gremlin_database"))
}

type RestoreDatabaseAttributes struct {
	ref terra.Reference
}

func (d RestoreDatabaseAttributes) InternalRef() (terra.Reference, error) {
	return d.ref, nil
}

func (d RestoreDatabaseAttributes) InternalWithRef(ref terra.Reference) RestoreDatabaseAttributes {
	return RestoreDatabaseAttributes{ref: ref}
}

func (d RestoreDatabaseAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return d.ref.InternalTokens()
}

func (d RestoreDatabaseAttributes) CollectionNames() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](d.ref.Append("collection_names"))
}

func (d RestoreDatabaseAttributes) Name() terra.StringValue {
	return terra.ReferenceAsString(d.ref.Append("name"))
}

type RestoreGremlinDatabaseAttributes struct {
	ref terra.Reference
}

func (gd RestoreGremlinDatabaseAttributes) InternalRef() (terra.Reference, error) {
	return gd.ref, nil
}

func (gd RestoreGremlinDatabaseAttributes) InternalWithRef(ref terra.Reference) RestoreGremlinDatabaseAttributes {
	return RestoreGremlinDatabaseAttributes{ref: ref}
}

func (gd RestoreGremlinDatabaseAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return gd.ref.InternalTokens()
}

func (gd RestoreGremlinDatabaseAttributes) GraphNames() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](gd.ref.Append("graph_names"))
}

func (gd RestoreGremlinDatabaseAttributes) Name() terra.StringValue {
...
type RestoreState struct {
	...
	Database                []RestoreDatabaseState        `json:"database"`
	GremlinDatabase         []RestoreGremlinDatabaseState `json:"gremlin_database"`
}
...
type RestoreGremlinDatabaseState struct {
