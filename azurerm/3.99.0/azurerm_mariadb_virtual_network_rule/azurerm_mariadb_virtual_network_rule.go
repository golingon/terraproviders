...
package azurerm_mariadb_virtual_network_rule
...
// Resource represents the Terraform resource azurerm_mariadb_virtual_network_rule.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermMariadbVirtualNetworkRuleState
...
func (amvnr *Resource) Attributes() azurermMariadbVirtualNetworkRuleAttributes {
	return azurermMariadbVirtualNetworkRuleAttributes{ref: terra.ReferenceResource(amvnr)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (amvnr *Resource) ImportState(state io.Reader) error {
	amvnr.state = &azurermMariadbVirtualNetworkRuleState{}
...
func (amvnr *Resource) State() (*azurermMariadbVirtualNetworkRuleState, bool) {
	return amvnr.state, amvnr.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (amvnr *Resource) StateMust() *azurermMariadbVirtualNetworkRuleState {
	if amvnr.state == nil {
...
// Args contains the configurations for azurerm_mariadb_virtual_network_rule.
type Args struct {
	// Id: string, optional
...
type azurermMariadbVirtualNetworkRuleAttributes struct {
	ref terra.Reference
}

// Id returns a reference to field id of azurerm_mariadb_virtual_network_rule.
func (amvnr azurermMariadbVirtualNetworkRuleAttributes) Id() terra.StringValue {
...
func (amvnr azurermMariadbVirtualNetworkRuleAttributes) Name() terra.StringValue {
...
func (amvnr azurermMariadbVirtualNetworkRuleAttributes) ResourceGroupName() terra.StringValue {
	return terra.ReferenceAsString(amvnr.ref.Append("resource_group_name"))
}

// ServerName returns a reference to field server_name of azurerm_mariadb_virtual_network_rule.
func (amvnr azurermMariadbVirtualNetworkRuleAttributes) ServerName() terra.StringValue {
	return terra.ReferenceAsString(amvnr.ref.Append("server_name"))
}

// SubnetId returns a reference to field subnet_id of azurerm_mariadb_virtual_network_rule.
func (amvnr azurermMariadbVirtualNetworkRuleAttributes) SubnetId() terra.StringValue {
	return terra.ReferenceAsString(amvnr.ref.Append("subnet_id"))
}

func (amvnr azurermMariadbVirtualNetworkRuleAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](amvnr.ref.Append("timeouts"))
}

type azurermMariadbVirtualNetworkRuleState struct {
	Id                string         `json:"id"`
