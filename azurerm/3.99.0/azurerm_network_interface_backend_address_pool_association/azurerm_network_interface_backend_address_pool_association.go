...
package azurerm_network_interface_backend_address_pool_association
...
// Resource represents the Terraform resource azurerm_network_interface_backend_address_pool_association.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermNetworkInterfaceBackendAddressPoolAssociationState
...
func (anibapa *Resource) Attributes() azurermNetworkInterfaceBackendAddressPoolAssociationAttributes {
	return azurermNetworkInterfaceBackendAddressPoolAssociationAttributes{ref: terra.ReferenceResource(anibapa)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (anibapa *Resource) ImportState(state io.Reader) error {
	anibapa.state = &azurermNetworkInterfaceBackendAddressPoolAssociationState{}
...
func (anibapa *Resource) State() (*azurermNetworkInterfaceBackendAddressPoolAssociationState, bool) {
	return anibapa.state, anibapa.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (anibapa *Resource) StateMust() *azurermNetworkInterfaceBackendAddressPoolAssociationState {
...
// Args contains the configurations for azurerm_network_interface_backend_address_pool_association.
type Args struct {
...
type azurermNetworkInterfaceBackendAddressPoolAssociationAttributes struct {
	ref terra.Reference
}
...
func (anibapa azurermNetworkInterfaceBackendAddressPoolAssociationAttributes) BackendAddressPoolId() terra.StringValue {
...
func (anibapa azurermNetworkInterfaceBackendAddressPoolAssociationAttributes) Id() terra.StringValue {
...
func (anibapa azurermNetworkInterfaceBackendAddressPoolAssociationAttributes) IpConfigurationName() terra.StringValue {
...
func (anibapa azurermNetworkInterfaceBackendAddressPoolAssociationAttributes) NetworkInterfaceId() terra.StringValue {
	return terra.ReferenceAsString(anibapa.ref.Append("network_interface_id"))
}

func (anibapa azurermNetworkInterfaceBackendAddressPoolAssociationAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](anibapa.ref.Append("timeouts"))
}

type azurermNetworkInterfaceBackendAddressPoolAssociationState struct {
