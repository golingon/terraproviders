...
type NodeType struct {
	...
	// NodeTypeApplicationPorts: optional
	ApplicationPorts *NodeTypeApplicationPorts `hcl:"application_ports,block"`
	// NodeTypeEphemeralPorts: optional
	EphemeralPorts *NodeTypeEphemeralPorts `hcl:"ephemeral_ports,block"`
}

type NodeTypeApplicationPorts struct {
...
type NodeTypeEphemeralPorts struct {
	// EndPort: number, required
	EndPort terra.NumberValue `hcl:"end_port,attr" validate:"required"`
	// StartPort: number, required
	StartPort terra.NumberValue `hcl:"start_port,attr" validate:"required"`
...
type UpgradePolicy struct {
	...
	// UpgradePolicyDeltaHealthPolicy: optional
	DeltaHealthPolicy *UpgradePolicyDeltaHealthPolicy `hcl:"delta_health_policy,block"`
	// UpgradePolicyHealthPolicy: optional
	HealthPolicy *UpgradePolicyHealthPolicy `hcl:"health_policy,block"`
}

type UpgradePolicyDeltaHealthPolicy struct {
...
type UpgradePolicyHealthPolicy struct {
...
func (nt NodeTypeAttributes) ApplicationPorts() terra.ListValue[NodeTypeApplicationPortsAttributes] {
	return terra.ReferenceAsList[NodeTypeApplicationPortsAttributes](nt.ref.Append("application_ports"))
}

func (nt NodeTypeAttributes) EphemeralPorts() terra.ListValue[NodeTypeEphemeralPortsAttributes] {
	return terra.ReferenceAsList[NodeTypeEphemeralPortsAttributes](nt.ref.Append("ephemeral_ports"))
}

type NodeTypeApplicationPortsAttributes struct {
	ref terra.Reference
}

func (ap NodeTypeApplicationPortsAttributes) InternalRef() (terra.Reference, error) {
	return ap.ref, nil
}

func (ap NodeTypeApplicationPortsAttributes) InternalWithRef(ref terra.Reference) NodeTypeApplicationPortsAttributes {
	return NodeTypeApplicationPortsAttributes{ref: ref}
}

func (ap NodeTypeApplicationPortsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ap.ref.InternalTokens()
}

func (ap NodeTypeApplicationPortsAttributes) EndPort() terra.NumberValue {
	return terra.ReferenceAsNumber(ap.ref.Append("end_port"))
}

func (ap NodeTypeApplicationPortsAttributes) StartPort() terra.NumberValue {
	return terra.ReferenceAsNumber(ap.ref.Append("start_port"))
}

type NodeTypeEphemeralPortsAttributes struct {
	ref terra.Reference
}

func (ep NodeTypeEphemeralPortsAttributes) InternalRef() (terra.Reference, error) {
	return ep.ref, nil
}

func (ep NodeTypeEphemeralPortsAttributes) InternalWithRef(ref terra.Reference) NodeTypeEphemeralPortsAttributes {
	return NodeTypeEphemeralPortsAttributes{ref: ref}
}

func (ep NodeTypeEphemeralPortsAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return ep.ref.InternalTokens()
}

func (ep NodeTypeEphemeralPortsAttributes) EndPort() terra.NumberValue {
	return terra.ReferenceAsNumber(ep.ref.Append("end_port"))
}

func (ep NodeTypeEphemeralPortsAttributes) StartPort() terra.NumberValue {
...
func (up UpgradePolicyAttributes) DeltaHealthPolicy() terra.ListValue[UpgradePolicyDeltaHealthPolicyAttributes] {
	return terra.ReferenceAsList[UpgradePolicyDeltaHealthPolicyAttributes](up.ref.Append("delta_health_policy"))
}

func (up UpgradePolicyAttributes) HealthPolicy() terra.ListValue[UpgradePolicyHealthPolicyAttributes] {
	return terra.ReferenceAsList[UpgradePolicyHealthPolicyAttributes](up.ref.Append("health_policy"))
}

type UpgradePolicyDeltaHealthPolicyAttributes struct {
	ref terra.Reference
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) InternalRef() (terra.Reference, error) {
	return dhp.ref, nil
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) InternalWithRef(ref terra.Reference) UpgradePolicyDeltaHealthPolicyAttributes {
	return UpgradePolicyDeltaHealthPolicyAttributes{ref: ref}
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return dhp.ref.InternalTokens()
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) MaxDeltaUnhealthyApplicationsPercent() terra.NumberValue {
	return terra.ReferenceAsNumber(dhp.ref.Append("max_delta_unhealthy_applications_percent"))
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) MaxDeltaUnhealthyNodesPercent() terra.NumberValue {
	return terra.ReferenceAsNumber(dhp.ref.Append("max_delta_unhealthy_nodes_percent"))
}

func (dhp UpgradePolicyDeltaHealthPolicyAttributes) MaxUpgradeDomainDeltaUnhealthyNodesPercent() terra.NumberValue {
	return terra.ReferenceAsNumber(dhp.ref.Append("max_upgrade_domain_delta_unhealthy_nodes_percent"))
}

type UpgradePolicyHealthPolicyAttributes struct {
	ref terra.Reference
}

func (hp UpgradePolicyHealthPolicyAttributes) InternalRef() (terra.Reference, error) {
	return hp.ref, nil
}

func (hp UpgradePolicyHealthPolicyAttributes) InternalWithRef(ref terra.Reference) UpgradePolicyHealthPolicyAttributes {
	return UpgradePolicyHealthPolicyAttributes{ref: ref}
}

func (hp UpgradePolicyHealthPolicyAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return hp.ref.InternalTokens()
}

func (hp UpgradePolicyHealthPolicyAttributes) MaxUnhealthyApplicationsPercent() terra.NumberValue {
	return terra.ReferenceAsNumber(hp.ref.Append("max_unhealthy_applications_percent"))
}

func (hp UpgradePolicyHealthPolicyAttributes) MaxUnhealthyNodesPercent() terra.NumberValue {
...
type NodeTypeState struct {
	...
	ApplicationPorts          []NodeTypeApplicationPortsState `json:"application_ports"`
	EphemeralPorts            []NodeTypeEphemeralPortsState   `json:"ephemeral_ports"`
}

type NodeTypeApplicationPortsState struct {
	EndPort   float64 `json:"end_port"`
	StartPort float64 `json:"start_port"`
}

type NodeTypeEphemeralPortsState struct {
	EndPort   float64 `json:"end_port"`
	StartPort float64 `json:"start_port"`
}
...
type UpgradePolicyState struct {
	...
	DeltaHealthPolicy             []UpgradePolicyDeltaHealthPolicyState `json:"delta_health_policy"`
	HealthPolicy                  []UpgradePolicyHealthPolicyState      `json:"health_policy"`
}

type UpgradePolicyDeltaHealthPolicyState struct {
...
type UpgradePolicyHealthPolicyState struct {
