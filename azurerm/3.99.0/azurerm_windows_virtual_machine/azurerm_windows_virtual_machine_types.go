...
type GalleryApplication struct {
	...
	// TreatFailureAsDeploymentFailureEnabled: bool, optional
	TreatFailureAsDeploymentFailureEnabled terra.BoolValue `hcl:"treat_failure_as_deployment_failure_enabled,attr"`
...
type OsImageNotification struct {
...
func (ga GalleryApplicationAttributes) AutomaticUpgradeEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(ga.ref.Append("automatic_upgrade_enabled"))
}
...
func (ga GalleryApplicationAttributes) TreatFailureAsDeploymentFailureEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(ga.ref.Append("treat_failure_as_deployment_failure_enabled"))
}
...
type OsImageNotificationAttributes struct {
	ref terra.Reference
}

func (oin OsImageNotificationAttributes) InternalRef() (terra.Reference, error) {
	return oin.ref, nil
}

func (oin OsImageNotificationAttributes) InternalWithRef(ref terra.Reference) OsImageNotificationAttributes {
	return OsImageNotificationAttributes{ref: ref}
}

func (oin OsImageNotificationAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return oin.ref.InternalTokens()
}

func (oin OsImageNotificationAttributes) Timeout() terra.StringValue {
	return terra.ReferenceAsString(oin.ref.Append("timeout"))
}
...
type GalleryApplicationState struct {
	...
	Tag                                    string  `json:"tag"`
	TreatFailureAsDeploymentFailureEnabled bool    `json:"treat_failure_as_deployment_failure_enabled"`
...
type OsImageNotificationState struct {
