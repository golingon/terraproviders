...
package azurerm_mariadb_database
...
// Resource represents the Terraform resource azurerm_mariadb_database.
type Resource struct {
	Name      string
	Args      Args
	state     *azurermMariadbDatabaseState
...
func (amd *Resource) Attributes() azurermMariadbDatabaseAttributes {
	return azurermMariadbDatabaseAttributes{ref: terra.ReferenceResource(amd)}
}

// ImportState imports the given attribute values into [Resource]'s state.
func (amd *Resource) ImportState(state io.Reader) error {
	amd.state = &azurermMariadbDatabaseState{}
...
func (amd *Resource) State() (*azurermMariadbDatabaseState, bool) {
	return amd.state, amd.state != nil
}

// StateMust returns the state for [Resource]. Panics if the state is nil.
func (amd *Resource) StateMust() *azurermMariadbDatabaseState {
	if amd.state == nil {
...
// Args contains the configurations for azurerm_mariadb_database.
type Args struct {
...
type azurermMariadbDatabaseAttributes struct {
	ref terra.Reference
}

// Charset returns a reference to field charset of azurerm_mariadb_database.
func (amd azurermMariadbDatabaseAttributes) Charset() terra.StringValue {
...
func (amd azurermMariadbDatabaseAttributes) ResourceGroupName() terra.StringValue {
...
func (amd azurermMariadbDatabaseAttributes) ServerName() terra.StringValue {
	return terra.ReferenceAsString(amd.ref.Append("server_name"))
}

func (amd azurermMariadbDatabaseAttributes) Timeouts() TimeoutsAttributes {
	return terra.ReferenceAsSingle[TimeoutsAttributes](amd.ref.Append("timeouts"))
}

type azurermMariadbDatabaseState struct {
