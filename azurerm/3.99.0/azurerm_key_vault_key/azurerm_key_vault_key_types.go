...
type RotationPolicy struct {
	...
	// RotationPolicyAutomatic: optional
	Automatic *RotationPolicyAutomatic `hcl:"automatic,block"`
}

type RotationPolicyAutomatic struct {
...
func (rp RotationPolicyAttributes) Automatic() terra.ListValue[RotationPolicyAutomaticAttributes] {
	return terra.ReferenceAsList[RotationPolicyAutomaticAttributes](rp.ref.Append("automatic"))
}

type RotationPolicyAutomaticAttributes struct {
	ref terra.Reference
}

func (a RotationPolicyAutomaticAttributes) InternalRef() (terra.Reference, error) {
	return a.ref, nil
}

func (a RotationPolicyAutomaticAttributes) InternalWithRef(ref terra.Reference) RotationPolicyAutomaticAttributes {
	return RotationPolicyAutomaticAttributes{ref: ref}
}

func (a RotationPolicyAutomaticAttributes) InternalTokens() (hclwrite.Tokens, error) {
	return a.ref.InternalTokens()
}

func (a RotationPolicyAutomaticAttributes) TimeAfterCreation() terra.StringValue {
	return terra.ReferenceAsString(a.ref.Append("time_after_creation"))
}

func (a RotationPolicyAutomaticAttributes) TimeBeforeExpiry() terra.StringValue {
...
type RotationPolicyState struct {
	...
	Automatic          []RotationPolicyAutomaticState `json:"automatic"`
}

type RotationPolicyAutomaticState struct {
