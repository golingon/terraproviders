...
func (ic DataIpConfigurationAttributes) ApplicationSecurityGroupIds() terra.SetValue[terra.StringValue] {
	return terra.ReferenceAsSet[terra.StringValue](ic.ref.Append("application_security_group_ids"))
}

func (ic DataIpConfigurationAttributes) GatewayLoadBalancerFrontendIpConfigurationId() terra.StringValue {
