...
type SiteConfigApplicationStack struct {
	...
	// SiteConfigApplicationStackDocker: min=0
	Docker []SiteConfigApplicationStackDocker `hcl:"docker,block" validate:"min=0"`
}

type SiteConfigApplicationStackDocker struct {
...
func (sc SiteConfigAttributes) AppServiceLogs() terra.ListValue[SiteConfigAppServiceLogsAttributes] {
	return terra.ReferenceAsList[SiteConfigAppServiceLogsAttributes](sc.ref.Append("app_service_logs"))
}
...
func (asl SiteConfigAppServiceLogsAttributes) InternalWithRef(ref terra.Reference) SiteConfigAppServiceLogsAttributes {
	return SiteConfigAppServiceLogsAttributes{ref: ref}
}
...
func (as SiteConfigApplicationStackAttributes) Docker() terra.ListValue[SiteConfigApplicationStackDockerAttributes] {
	return terra.ReferenceAsList[SiteConfigApplicationStackDockerAttributes](as.ref.Append("docker"))
}
...
func (d SiteConfigApplicationStackDockerAttributes) InternalWithRef(ref terra.Reference) SiteConfigApplicationStackDockerAttributes {
	return SiteConfigApplicationStackDockerAttributes{ref: ref}
}
...
type SiteConfigApplicationStackState struct {
	...
	Docker                   []SiteConfigApplicationStackDockerState `json:"docker"`
}

type SiteConfigApplicationStackDockerState struct {
