...
import (
	"encoding/json"
	"fmt"
	paloaltolocalrulestackoutboundtrustcertificateassociation "github.com/golingon/terraproviders/azurerm/3.74.0/paloaltolocalrulestackoutboundtrustcertificateassociation"
