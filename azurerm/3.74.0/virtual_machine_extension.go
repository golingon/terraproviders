...
import (
	"encoding/json"
	"fmt"
	virtualmachineextension "github.com/golingon/terraproviders/azurerm/3.74.0/virtualmachineextension"
...
func (vme virtualMachineExtensionAttributes) ProvisionAfterExtensions() terra.ListValue[terra.StringValue] {
	return terra.ReferenceAsList[terra.StringValue](vme.ref.Append("provision_after_extensions"))
}
