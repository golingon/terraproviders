...
import (
	"encoding/json"
	"fmt"
	storageaccountcustomermanagedkey "github.com/golingon/terraproviders/azurerm/3.74.0/storageaccountcustomermanagedkey"
...
func (sacmk storageAccountCustomerManagedKeyAttributes) FederatedIdentityClientId() terra.StringValue {
	return terra.ReferenceAsString(sacmk.ref.Append("federated_identity_client_id"))
}
...
func (sacmk storageAccountCustomerManagedKeyAttributes) KeyVaultUri() terra.StringValue {
	return terra.ReferenceAsString(sacmk.ref.Append("key_vault_uri"))
}
