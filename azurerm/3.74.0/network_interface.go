...
import (
	"encoding/json"
	"fmt"
	networkinterface "github.com/golingon/terraproviders/azurerm/3.74.0/networkinterface"
...
func (ni networkInterfaceAttributes) AuxiliaryMode() terra.StringValue {
	return terra.ReferenceAsString(ni.ref.Append("auxiliary_mode"))
}

// AuxiliarySku returns a reference to field auxiliary_sku of azurerm_network_interface.
func (ni networkInterfaceAttributes) AuxiliarySku() terra.StringValue {
	return terra.ReferenceAsString(ni.ref.Append("auxiliary_sku"))
}
