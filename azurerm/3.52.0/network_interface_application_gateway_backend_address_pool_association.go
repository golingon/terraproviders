...
import (
	"encoding/json"
	"fmt"
	networkinterfaceapplicationgatewaybackendaddresspoolassociation "github.com/golingon/terraproviders/azurerm/3.52.0/networkinterfaceapplicationgatewaybackendaddresspoolassociation"
