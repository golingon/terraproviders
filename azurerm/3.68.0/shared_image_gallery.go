...
import (
	"encoding/json"
	"fmt"
	sharedimagegallery "github.com/golingon/terraproviders/azurerm/3.68.0/sharedimagegallery"
...
type SharedImageGalleryArgs struct {
	...
	// Sharing: optional
	Sharing *sharedimagegallery.Sharing `hcl:"sharing,block"`
	// Timeouts: optional
...
func (sig sharedImageGalleryAttributes) Sharing() terra.ListValue[sharedimagegallery.SharingAttributes] {
	return terra.ReferenceAsList[sharedimagegallery.SharingAttributes](sig.ref.Append("sharing"))
}
...
type sharedImageGalleryState struct {
	...
	Sharing           []sharedimagegallery.SharingState `json:"sharing"`
