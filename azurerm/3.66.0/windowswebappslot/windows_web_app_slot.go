...
func (sc SiteConfigAttributes) VirtualApplication() terra.SetValue[VirtualApplicationAttributes] {
	return terra.ReferenceAsSet[VirtualApplicationAttributes](sc.ref.Append("virtual_application"))
}
...
func (va VirtualApplicationAttributes) VirtualDirectory() terra.SetValue[VirtualDirectoryAttributes] {
	return terra.ReferenceAsSet[VirtualDirectoryAttributes](va.ref.Append("virtual_directory"))
}
