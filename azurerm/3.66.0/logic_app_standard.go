...
import (
	"encoding/json"
	"fmt"
	logicappstandard "github.com/golingon/terraproviders/azurerm/3.66.0/logicappstandard"
...
func (las logicAppStandardAttributes) AutoSwapSlotName() terra.StringValue {
