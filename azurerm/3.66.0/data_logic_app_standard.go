...
import (
	datalogicappstandard "github.com/golingon/terraproviders/azurerm/3.66.0/datalogicappstandard"
...
// AutoSwapSlotName returns a reference to field auto_swap_slot_name of azurerm_logic_app_standard.
func (las dataLogicAppStandardAttributes) AutoSwapSlotName() terra.StringValue {
	return terra.ReferenceAsString(las.ref.Append("auto_swap_slot_name"))
}
