...
import (
	"encoding/json"
	"fmt"
	sharedimageversion "github.com/golingon/terraproviders/azurerm/3.75.0/sharedimageversion"
...
func (siv sharedImageVersionAttributes) DeletionOfReplicatedLocationsEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(siv.ref.Append("deletion_of_replicated_locations_enabled"))
}
