...
import (
	"encoding/json"
	"fmt"
	appconfiguration "github.com/golingon/terraproviders/azurerm/3.75.0/appconfiguration"
...
type AppConfigurationArgs struct {
	...
	// Replica: min=0
	Replica []appconfiguration.Replica `hcl:"replica,block" validate:"min=0"`
	// Timeouts: optional
...
func (ac appConfigurationAttributes) Replica() terra.SetValue[appconfiguration.ReplicaAttributes] {
	return terra.ReferenceAsSet[appconfiguration.ReplicaAttributes](ac.ref.Append("replica"))
}
...
type appConfigurationState struct {
	...
	Replica                 []appconfiguration.ReplicaState           `json:"replica"`
