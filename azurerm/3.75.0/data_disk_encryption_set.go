...
import (
	datadiskencryptionset "github.com/golingon/terraproviders/azurerm/3.75.0/datadiskencryptionset"
...
type DataDiskEncryptionSetArgs struct {
	...
	// Identity: min=0
	Identity []datadiskencryptionset.Identity `hcl:"identity,block" validate:"min=0"`
	// Timeouts: optional
...
func (des dataDiskEncryptionSetAttributes) KeyVaultKeyUrl() terra.StringValue {
	return terra.ReferenceAsString(des.ref.Append("key_vault_key_url"))
}
...
func (des dataDiskEncryptionSetAttributes) Identity() terra.ListValue[datadiskencryptionset.IdentityAttributes] {
	return terra.ReferenceAsList[datadiskencryptionset.IdentityAttributes](des.ref.Append("identity"))
}
