...
import (
	"encoding/json"
	"fmt"
	paloaltolocalrulestackoutboundtrustcertificateassociation "github.com/golingon/terraproviders/azurerm/3.75.0/paloaltolocalrulestackoutboundtrustcertificateassociation"
