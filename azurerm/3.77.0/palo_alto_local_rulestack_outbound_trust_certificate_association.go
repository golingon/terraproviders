...
import (
	"encoding/json"
	"fmt"
	paloaltolocalrulestackoutboundtrustcertificateassociation "github.com/golingon/terraproviders/azurerm/3.77.0/paloaltolocalrulestackoutboundtrustcertificateassociation"
