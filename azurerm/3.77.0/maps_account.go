...
import (
	"encoding/json"
	"fmt"
	mapsaccount "github.com/golingon/terraproviders/azurerm/3.77.0/mapsaccount"
...
func (ma mapsAccountAttributes) LocalAuthenticationEnabled() terra.BoolValue {
	return terra.ReferenceAsBool(ma.ref.Append("local_authentication_enabled"))
}
