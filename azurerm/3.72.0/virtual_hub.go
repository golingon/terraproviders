...
import (
	"encoding/json"
	"fmt"
	virtualhub "github.com/golingon/terraproviders/azurerm/3.72.0/virtualhub"
...
func (vh virtualHubAttributes) VirtualRouterAutoScaleMinCapacity() terra.NumberValue {
	return terra.ReferenceAsNumber(vh.ref.Append("virtual_router_auto_scale_min_capacity"))
}
