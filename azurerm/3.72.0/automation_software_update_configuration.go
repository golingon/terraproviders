...
import (
	"encoding/json"
	"fmt"
	automationsoftwareupdateconfiguration "github.com/golingon/terraproviders/azurerm/3.72.0/automationsoftwareupdateconfiguration"
...
type AutomationSoftwareUpdateConfigurationArgs struct {
	...
	// Linux: optional
	Linux *automationsoftwareupdateconfiguration.Linux `hcl:"linux,block"`
	// PostTask: optional
	PostTask *automationsoftwareupdateconfiguration.PostTask `hcl:"post_task,block"`
	// PreTask: optional
	PreTask *automationsoftwareupdateconfiguration.PreTask `hcl:"pre_task,block"`
	// Schedule: required
	Schedule *automationsoftwareupdateconfiguration.Schedule `hcl:"schedule,block" validate:"required"`
	// Target: optional
