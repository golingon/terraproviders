...
import (
	"encoding/json"
	"fmt"
	mssqlvirtualmachine "github.com/golingon/terraproviders/azurerm/3.72.0/mssqlvirtualmachine"
...
type MssqlVirtualMachineArgs struct {
	...
	WsfcDomainCredential *mssqlvirtualmachine.WsfcDomainCredential `hcl:"wsfc_domain_credential,block"`
}
...
func (mvm mssqlVirtualMachineAttributes) SqlVirtualMachineGroupId() terra.StringValue {
	return terra.ReferenceAsString(mvm.ref.Append("sql_virtual_machine_group_id"))
}
...
func (mvm mssqlVirtualMachineAttributes) WsfcDomainCredential() terra.ListValue[mssqlvirtualmachine.WsfcDomainCredentialAttributes] {
	return terra.ReferenceAsList[mssqlvirtualmachine.WsfcDomainCredentialAttributes](mvm.ref.Append("wsfc_domain_credential"))
}
...
type mssqlVirtualMachineState struct {
	...
	WsfcDomainCredential          []mssqlvirtualmachine.WsfcDomainCredentialState `json:"wsfc_domain_credential"`
}
