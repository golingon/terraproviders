...
import (
	"encoding/json"
	"fmt"
	networkinterfaceapplicationsecuritygroupassociation "github.com/golingon/terraproviders/azurerm/3.58.0/networkinterfaceapplicationsecuritygroupassociation"
