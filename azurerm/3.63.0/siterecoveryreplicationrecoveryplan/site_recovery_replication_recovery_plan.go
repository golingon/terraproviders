...
func (rg RecoveryGroupAttributes) PostAction() terra.ListValue[PostActionAttributes] {
	return terra.ReferenceAsList[PostActionAttributes](rg.ref.Append("post_action"))
}

func (rg RecoveryGroupAttributes) PreAction() terra.ListValue[PreActionAttributes] {
	return terra.ReferenceAsList[PreActionAttributes](rg.ref.Append("pre_action"))
}
