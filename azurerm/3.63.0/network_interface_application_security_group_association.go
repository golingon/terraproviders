...
import (
	"encoding/json"
	"fmt"
	networkinterfaceapplicationsecuritygroupassociation "github.com/golingon/terraproviders/azurerm/3.63.0/networkinterfaceapplicationsecuritygroupassociation"
